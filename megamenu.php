<nav id="menu_categories" class="wide"><button type="button" class="navbar-toggler">
    ...
    <div class="d-md-flex d-none justify-content-around navbar-collapse" id="menu_navbar">
        <ul class="navbar-nav mx-md-n2 my-auto">
            <li class="nav-item --noBold"><a href="#" target="_self" title="Konsole" class="nav-link">Herbaty
                    <hr class="menu-item-underline">
                </a></li>
            <li class="nav-item --noBold"><a href="#" target="_self" title="Elektronika" class="nav-link">Kawy
                    <hr class="menu-item-underline">
                </a>
                    ...
                    <div class="mega-container col-12">
                        ...
                        <!-- <div class="col-4 d-flex">
                            ...
                            <li class="mega-menu-photo">
                                ...
                                <a href="#" title="name"><img src="./img/Kawa.jpg"
                                        alt="Kawa ziarnista Lavazza Espresso Italiano 1kg" /></a>

                                <a href="#" title="name" class="d-block mt-3 text-center"><span class="p-name">Kawa
                                        ziarnista Jesienna MK Cafe 250g</span></a>
        ...
        <li class="nav-item --noBold"><a href="# target=" _self" title="Nowości" class="nav-link">Nowości
                <hr class="menu-item-underline">
            </a></li>
        <li class="nav-item --noBold"><a href="#" target="_self" title="Bestsellery" class="nav-link">Bestsellery
                <hr class="menu-item-underline">
            </a></li>
        <li class="nav-item --noBold"><a href="#" target="_blank" title="Załóż sklep" class="nav-link">Kategorie</a>
        </li>
        </ul>
    </div>
</nav>