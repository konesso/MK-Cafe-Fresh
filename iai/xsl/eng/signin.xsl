																						...
																						<iaixsl:if test="@name = $social_media_name">
																							<div id="cookie_login_social" class="iai_accounts tooltip --top">
																									<span id="cookie_login_social_desc" class="iai_accounts">
																													Log in with <strong>IdoAccounts</strong> via <iaixsl:value-of select="$social_media_name"/>, and your shipping details will be completed automatically based on previous orders.
																									</span>
																							</div>
                                            </iaixsl:if>
                                            <iaixsl:choose>
																								...
																								<span id="cookie_login_social_desc">
																										<iaixsl:choose>
																												<iaixsl:when test="not(/shop/client_data/@iai_accounts = 'consent')">
																														...
																														Log in again via <iaixsl:value-of select="$social_media_name"/>, so we can be sure it's you. 
																												</iaixsl:when>
																												<iaixsl:otherwise>
																														<iaixsl:attribute name="class">iai_accounts</iaixsl:attribute>
																														Log in with <strong>IdoAccounts</strong> via <iaixsl:value-of select="$social_media_name"/>, and your shipping details will be completed automatically based on previous orders.
