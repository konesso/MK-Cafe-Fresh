            ...
            <div class="n54531_outline_sub">
                ...
                <iaixsl:choose>
                    ...
                    <iaixsl:when test="page/return/@type='order_invalidpoints'">
                        <h3 class="return_label">An error with product purchased for points has occurred. <a href="/contact.php">Contact the shop staff</a>.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'account_disabled'">
                        <h3 class="return_label">The specified account does not exist.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'account_passremind'">
                        <h3 class="return_label">If you have an account in our store, a message has been sent to your e-mail address, which allows you to automatically log in. Change of password will be possible after signing in to your personal information edition.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'order_minimal_wholesale'">
                        <h3 class="return_label">
                            Minimal order value too low.
                            <iaixsl:if test="page/return/@extra">
                                <br/>Minimal value of a wholesale order is 
                                <iaixsl:value-of select="page/return/@extra"/><iaixsl:value-of select="currency/@name"/>
                            </iaixsl:if>
                        </h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'shipping_error'">
                        <h3 class="return_label">Przepraszamy, ale nie dostarczamy produktów do wybranego kraju dostawy. Jeżeli chciałbyś złożyć zamówienie w naszym sklepie - <a href="/contact.php">contact us</a> w celu dodania możliwości dostarczania przesyłek do Twojego kraju.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'payment_error'">
                        <div class="paymentReturn__wrapper --return --error">
                            ...
                            <span class="paymentReturn__header">
                                <span>Pay for the accepted order number<span class="order_id"><iaixsl:attribute name="data-id"><iaixsl:value-of select="page/return/@referer"/></iaixsl:attribute><iaixsl:value-of select="page/return/@orderNumber"/></span></span>
                                <iaixsl:choose>
                                    <iaixsl:when test="/shop/page/return/@checkoutType = 'idosell'">
                    ...
                    <iaixsl:when test="page/return/@type='stock_transfer'">
                        <h3 class="return_label">You cannot place an order as the selected products are from different stocks. <a href="/contact.php">Contact the shop staff</a> to receive information how to complete an order.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type='page_only_register'">
                        <h3 class="return_label">The page available only for signed users. <a class="loginPopUpShow" href="/signin.php" title="Zaloguj się">Log in.</a></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='page_only_unregister'">
                        <h3 class="return_label">The page available for unsigned users only. <a href="/login.php?operation=logout" title="Wyloguj się">Sign out.</a></h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'products_not_found'">
                        <h3 class="return_label">Szukany produkt nie został znaleziony. Skorzystaj z <a href="/searching.php" title="Kliknij, aby przejść do wyszukiwarki zaawansowanej">advanced search tool</a>.</h3>
                    </iaixsl:when>
