...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
	...
	<iaixsl:variable name="affiliate">EARN WITH US</iaixsl:variable>
	<iaixsl:variable name="rma">COMPLAINT DEPARTMENT (RMA)</iaixsl:variable>
	

	<section id="Sitemap" class="sitemap_tree">
		<h1 class="headline">
			<span class="headline__name">Site map</span>
		</h1>
			...
			<div class="sitemap_tree__wrapper">
				...
				<iaixsl:choose>
					<iaixsl:when test="@id='mainpage'">
						<label class="sitemap_tree__label">Info</label>
					</iaixsl:when>
					<iaixsl:when test="@id='searchpage'">
						<label class="sitemap_tree__label">Assortment</label>
					</iaixsl:when>
					<iaixsl:otherwise>
						<label class="sitemap_tree__label">Customer account</label>
					</iaixsl:otherwise>
				</iaixsl:choose>
