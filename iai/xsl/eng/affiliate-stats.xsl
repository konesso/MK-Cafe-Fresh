...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
  ...
  <iaixsl:variable name="affiliate_1">Links</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">Banners</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">Rebate code</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">Flash adverts</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">PHP adverts</iaixsl:variable>
  <iaixsl:variable name="affiliate_6">JavaScript adverts</iaixsl:variable>
  <iaixsl:if test="page/affiliate_statistics">
    ...
    <section class="affiliate --stats mb-4">
      <div class="affiliate__desc mb-4">
        A list of all redirections to the on-line shop referred by you can be found below.
      </div>
