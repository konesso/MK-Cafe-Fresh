							...
							<div class="form-group --radio">
								...
								<div class="form-control-static">
									<div class="f-group --radio">
										...
										<label class="f-label" for="client_vat_payer_k">domestic</label>
									</div>
									...
									<div class="f-group --radio">
										...
										<label class="f-label" for="client_vat_payer_w">european commonwealth</label>
									</div>
					...
					<iaixsl:choose>
						<iaixsl:when test="/shop/page/client-data/@operation = 'register' and /shop/action/registration_options/wholesale">
							<div class="cn_wrapper choose_other_form">
								<i class="icon-wholesaler-register"/> Are you a wholesaler? Use the <a>
						...
						<iaixsl:when test="/shop/page/client-data/@operation = 'register-wholesale-add' and /shop/action/registration_options/retail">
							<div class="cn_wrapper choose_other_form">
								<i class="icon-register-card"/> Are you a retail customer? Use the <a>
								...
								<div class="form-control-static">
									<iaixsl:if test="not( (page/client-data/@operation = 'register-wholesale-add') or (page/client-data/@operation = 'edit-wholesale-add') or (page/client-data/@operation = 'edit-wholesale-edit') )">
										<div class="f-group --radio">
											...
											<label class="f-label" for="client_type2">Individual</label>
										</div>
									</iaixsl:if>
									<div class="f-group --radio">
										...
										<label class="f-label" for="client_type1">Company</label>
									</div>
								</div>
							</div>
										...
										<div class="col-12 px-0">
											<div class="dropdown cn_dropdown">
                                                <div class="addresses-editable">
                                                    ...
                                                    * An address that has already been used cannot be edited.
                                                </div>
            ...
            <iaixsl:if test="not(/shop/page/client-data/payer_data/@use = 'hide')">
				...
				<iaixsl:if test="$client_new_mode != 'onceorder'">
								...
								<div class="form-group has-feedback --radio">
									...
									<div>
										...
										<div class="f-group --radio">
											...
											<label class="f-label" for="client_generate_password1">Do not change the password</label>
										</div>
										<div class="f-group --radio">
											<input type="radio" name="client_generate_password" id="client_generate_password2" value="no" class="f-control">
												<iaixsl:if test="not(/shop/page/client-data/@register='true')"><iaixsl:attribute name="name">client_generate_password_n</iaixsl:attribute></iaixsl:if>
											</input>
											<label class="f-label" for="client_generate_password2">Change your password</label>
										</div>
									</div>
								</div>
							</iaixsl:if>
                    ...
                    <iaixsl:if test="$client_new_mode = 'edit'"><iaixsl:attribute name="autocomplete">current-password</iaixsl:attribute></iaixsl:if>
									...
									<span class="form-control-feedback"/>
									<a href="#show_pass" class="show_pass"><i class="icon-visibility"/> Show password</a>
						...
						<iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
							<div class="checkbox">
								<label>
									...
									</input>I am an EU VAT payer. I order without VAT and I commit to settle VAT in my country. The shop will verify the EU VAT in the VIES system.
								</label>
							</div>
						</iaixsl:if>
						<iaixsl:choose>
							...
							<div class="form-group">
								<div class="checkbox">
									<label>
										...
										</input>  I want to receive SMS Newsletter (future unsubscription possible)
                        ...
                        <iaixsl:choose>
                            ...
                            <iaixsl:when test="/shop/page/client-data/@active_card and not(/shop/page/client-data/@active_card='')">
                                ...
                                <p class="rebate_card_desc">
                                    You can change your active discount card by providing the new number above. Check details of guaranteed discounts, go to <a href="/client-rebate.php" title="Twoje rabaty">Your discounts</a>.
                                </p>
                            </iaixsl:when>
                            <iaixsl:otherwise>
                                <div class="form-group">
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/eng/envelope.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/eng/client_new_form.js.gzip?r=1696937760"></script>
