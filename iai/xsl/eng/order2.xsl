...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
	...
	<iaixsl:variable name="grossPriceOrder2"> incl. VAT</iaixsl:variable>
	...
	<div class="n57856_order_overtaker">
		<form class="order2_form">
			...
			<div class="big_label order2_info_label">
				<span class="n57856_label d-none d-lg-block" id="labels">Details:
				</span>
			</div>
							...
							<iaixsl:choose>
								...
								<iaixsl:when test="/shop/page/order2/orderdetails/@express_checkout = 'true' and /shop/page/order2/orderdetails/@payment_id = '236' and (not(page/order2/deliveryaddress/@phone) or page/order2/deliveryaddress/@phone = '')">
									<span class="order2_info1_sub_phone --no-phone">
										...
										<span class="order2_info1_sub_phone_label">phone no: </span>
										...
										<span class="f-group --small order2_info1_sub_phone_empty">
											...
											<label class="f-label" for="order2TelInput">Phone number</label>
							...
							<iaixsl:if test="/shop/basket/delivery_time/@days and not(basket/@shipping_undefined = 'true')">
									...
									<span>
										<iaixsl:choose>
											<iaixsl:when test="(/shop/page/order2/orderdetails/@deliveryid = '0-0') or (/shop/page/order2/orderdetails/@deliveryid = '0-1')">
												<span class="delivery_time_order_text">Pick up your order - </span>
											</iaixsl:when>
											<iaixsl:otherwise>
												<span class="delivery_time_order_text">Expected delivery - </span>
											</iaixsl:otherwise>
										</iaixsl:choose>
								...
								<iaixsl:if test="/shop/allow_division_order/@turn_on = 'yes' and /shop/basket/shipping_division_time/@week_amount">
									<div class="shipping_time_division">
										...
										<span>
											Products with longer waiting times - ready to ship <span class="order2__division_literal">after </span>
											<strong/>
										</span>
									</div>
								</iaixsl:if>
					...
					<div class="basketedit_summary_sub">
						...
						<div class="basketedit_summary_right">
							...
							<div class="basketedit_total_summary">
								...
								<strong>
									<iaixsl:value-of select="/shop/basket/summary/total_to_pay/@value_formatted"/><iaixsl:if test="not($priceTypeVat = '')"><span class="price_vat"> incl. VAT</span></iaixsl:if>
								</strong>
							...
							<iaixsl:if test="not($returns_agree_control)">
								<div class="order2_terms_wrapper_sub">
									<label class="order2_cancel">
										...
										<i class="css-label"/>
										<span><i class="icon-need"/>  I have acknowledged
											<a target="_blank"><iaixsl:attribute name="title">Withdrawal from the agreement</iaixsl:attribute><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/order_cancel/@url"/></iaixsl:attribute>my rights to withdraw from the agreement</a><iaixsl:text>.</iaixsl:text>
										</span>
									</label>
								</div>
							</iaixsl:if>
							...
							<iaixsl:if test="page/order2/ordersproducts//product[@product_type = 'product_virtual']">
								<div class="order2_terms_wrapper_sub virtual">
									<label class="order2_virtual">
										...
										<i class="css-label"/>
										<span><i class="icon-need"/>  I want immediate access to the digital content and I acknowledge that thereby I lose my right to cancel once the service has begun.</span>
									</label>
								</div>
							</iaixsl:if>
							...
							<iaixsl:if test="page/order2/ordersproducts//product[@product_type = 'product_service']">
								<div class="order2_terms_wrapper_sub service">
									<label class="order2_service">
										...
										<i class="css-label"/>
										<span><i class="icon-need"/>  I agree to the starting of the service and I acknowledge that I lose my right to cancel once the service has been fully performed.</span>
									</label>
								</div>
							</iaixsl:if>
						...
						<div class="basketedit_summary_buttons table_display">
							<div class="btn_wrapper">
								<input class="btn --solid --large order2_button_order terms_required" type="submit">
									<iaixsl:choose>
										<iaixsl:when test="/shop/page/order2/orderdetails/@express_checkout = 'true'">
											<iaixsl:attribute name="value">Confirm purchase</iaixsl:attribute>
										</iaixsl:when>
										
										<iaixsl:when test="/shop/page/order2/orderdetails/@payment_id = '203'">
											<iaixsl:attribute name="value">I order and pay later</iaixsl:attribute>
										</iaixsl:when>
										...
										<iaixsl:otherwise>
											<iaixsl:attribute name="value">Order and pay</iaixsl:attribute>
										</iaixsl:otherwise>
									</iaixsl:choose>
								...
								<div class="button_legend">
									<i class="icon-need"/> Fields marked with asterisk are required.
								</div>
							</div>
						</div>
					</div>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/eng/envelope.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/eng/order2.js.gzip?r=1696937760"></script>
