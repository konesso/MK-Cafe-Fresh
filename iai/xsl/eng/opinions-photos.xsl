		...
		<iaixsl:when test="count(page/opinions-photos/opinions/opinion[@image_small or @image_large]) &gt; 0">
			...
			<div id="opinions">
				...
				<p class="opinions-description">
					Do you want to add your photo? You can do this by writing a review and adding your photo about one of the products. To find such products faster, please use <a href="/products-bought.php">list of purchased products</a>.
					<iaixsl:if test="page/opinions-photos/opinions/@product_photo_loyalty_points">
					<br/>

						You will receive from us for each opinion with a photo <iaixsl:value-of select="page/opinions-photos/opinions/@product_photo_loyalty_points"/> 
						point. in the loyalty program.</iaixsl:if>
		...
		<iaixsl:otherwise>
			<div id="opinions" class="d-flex flex-column align-items-center --empty">
				...
				<p class="opinions-description">
					...
					Add a picture to your review of any product. To find such products faster, please use <a href="/products-bought.php">list of purchased products</a>.
					<iaixsl:if test="false">
					
					<br/>
						You will receive from us for each opinion with a photo %s
						point. in the loyalty program.</iaixsl:if> 
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/eng/envelope.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/eng/opinions_photos_display.js.gzip?r=1696937760"></script>
