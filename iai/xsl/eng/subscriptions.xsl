...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
	...
	<iaixsl:if test="/shop/page/products/navigation/filtering/filter/@id='filter_instock'"> </iaixsl:if>
        ...
        <!-- (subscriptions_list, 63775d578a87c0.84408745.3)-->
	<iaixsl:variable name="subscriptionProductsHidden">2</iaixsl:variable>
	<div class="subscriptions_list">
		<iaixsl:attribute name="data-display"><iaixsl:value-of select="/shop/page/subscriptions/@display"/></iaixsl:attribute>
		<div class="subscriptions_list__header">
			<h1 class="headline">
				<span class="headline__name">
					<iaixsl:choose>
						<iaixsl:when test="/shop/page/subscriptions/@display = 'active'">
							List of active subscriptions
						</iaixsl:when>
						<iaixsl:otherwise>
							List of terminated subscriptions
						</iaixsl:otherwise>
					</iaixsl:choose>
				</span>
			</h1>
			<iaixsl:if test="(/shop/page/subscriptions/@display = 'active' and /shop/action/subscriptions_terminated/@count != 0) or (/shop/page/subscriptions/@display != 'active' and /shop/action/subscriptions_active/@count != 0) ">
				<div class="subscriptions_list__see_also">
					<span class="subscriptions_list__see_also_text">See also: </span>
					<a class="subscriptions_list__see_also_link">
						<iaixsl:choose>
							<iaixsl:when test="/shop/page/subscriptions/@display = 'active'">
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/subscriptions_terminated/@url"/></iaixsl:attribute>List of terminated subscriptions
							</iaixsl:when>
							<iaixsl:otherwise>
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/subscriptions_active/@url"/></iaixsl:attribute>List of active subscriptions
							</iaixsl:otherwise>
						</iaixsl:choose>
					</a>
				</div>
		...
		<div class="subscriptions_list__subscriptions subscriptions">
			<iaixsl:for-each select="/shop/page/subscriptions/subscription">
				<iaixsl:variable name="subscriptionProductsCount"><iaixsl:value-of select="count(products/product)"/></iaixsl:variable>
				<div class="subscriptions__item">
					<iaixsl:if test="$subscriptionProductsCount &gt; $subscriptionProductsHidden">
						<iaixsl:attribute name="class">subscriptions__item --more</iaixsl:attribute>
					</iaixsl:if>
					<div class="subscriptions__products">
						<iaixsl:for-each select="products/product">
							<div class="subscriptions__product">
								<iaixsl:if test="position() = $subscriptionProductsHidden">
									<iaixsl:attribute name="class">subscriptions__product --last-visible</iaixsl:attribute>
								</iaixsl:if>
								<a class="subscriptions__product_icon">
								...
								<div class="subscriptions__product_info">
									<a class="subscriptions__product_name">
										<iaixsl:attribute name="href"><iaixsl:value-of select="@url"/></iaixsl:attribute>
										<iaixsl:value-of select="@name"/>
									</a>
									<div class="subscriptions__product_details">
										...
										<iaixsl:if test="@symbol != ''">
											<div class="subscriptions__product_detail --symbol">
												<span class="subscriptions__product_detail_name">Symbol:</span>
												<span class="subscriptions__product_detail_value"><iaixsl:value-of select="@symbol"/></span>
											</div>
										</iaixsl:if>
										<iaixsl:if test="size/@name != '' and size/@id != 'uniw'">
											<div class="subscriptions__product_detail --size">
												<span class="subscriptions__product_detail_name">Size:</span>
												<span class="subscriptions__product_detail_value"><iaixsl:value-of select="size/@name"/></span>
											</div>
										</iaixsl:if>
									</div>
								</div>
					...
					<div class="subscriptions__info">
						<div class="subscriptions__price">
							...
							<span> / every <span class="subscriptions__product_price_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="@days_in_period"/> days</span></span>
						</div>
						<div class="subscriptions__dates">
							<div class="subscriptions__date --order">
								<span class="subscriptions__date_name">Next delivery</span>
								<strong class="subscriptions__date_value">
									<span class="subscriptions__day_name">
										<iaixsl:choose>
											<iaixsl:when test="dates/@next_order_week_day = 1">
												Monday
											</iaixsl:when>
											<iaixsl:when test="dates/@next_order_week_day = 2">
												Tuesday
											</iaixsl:when>
											<iaixsl:when test="dates/@next_order_week_day = 3">
												Wednesday
											</iaixsl:when>
											<iaixsl:when test="dates/@next_order_week_day = 4">
												Thursday
											</iaixsl:when>
											<iaixsl:when test="dates/@next_order_week_day = 5">
												Friday
											</iaixsl:when>
											<iaixsl:when test="dates/@next_order_week_day = 6">
												Saturday
											</iaixsl:when>
											<iaixsl:when test="dates/@next_order_week_day = 7">
												Sunday
											</iaixsl:when>
										</iaixsl:choose>
									</span>
									<iaixsl:variable name="next_order_time"><iaixsl:value-of select="dates/@date_next_order"/></iaixsl:variable>
									...
									<span class="subscriptions__date_wrapper"> (<span><iaixsl:value-of select="$next_order_time_formatted"/></span>)</span>
								</strong>
							</div>
							<div class="subscriptions__date --payment">
								<span class="subscriptions__date_name">Date of next payment</span>
								<strong class="subscriptions__date_value">
									<span class="subscriptions__day_name">
										<iaixsl:choose>
											<iaixsl:when test="dates/@next_payment_week_day = 1">
												Monday
											</iaixsl:when>
											<iaixsl:when test="dates/@next_payment_week_day = 2">
												Tuesday
											</iaixsl:when>
											<iaixsl:when test="dates/@next_payment_week_day = 3">
												Wednesday
											</iaixsl:when>
											<iaixsl:when test="dates/@next_payment_week_day = 4">
												Thursday
											</iaixsl:when>
											<iaixsl:when test="dates/@next_payment_week_day = 5">
												Friday
											</iaixsl:when>
											<iaixsl:when test="dates/@next_payment_week_day = 6">
												Saturday
											</iaixsl:when>
											<iaixsl:when test="dates/@next_payment_week_day = 7">
												Sunday
											</iaixsl:when>
										</iaixsl:choose>
									</span>
									<iaixsl:variable name="next_payment_time"><iaixsl:value-of select="dates/@date_next_payment"/></iaixsl:variable>
									...
									<span class="subscriptions__date_wrapper"> (<span><iaixsl:value-of select="$next_payment_time_formatted"/></span>)</span>
								</strong>
							</div>
						</div>
						<div class="subscriptions__payment">
							<span class="subscriptions__payment_icon">
								<img>
									<iaixsl:attribute name="src"><iaixsl:value-of select="payment/@method_icon"/></iaixsl:attribute>
									<iaixsl:attribute name="alt"><iaixsl:value-of select="payment/@card_number"/></iaixsl:attribute>
								</img>
							</span>
							<strong class="subscriptions__payment_card"><iaixsl:value-of select="payment/@card_number"/></strong>
						</div>
						<div class="subscriptions__link">
							<a class="subscriptions__link_value">
								<iaixsl:attribute name="href"><iaixsl:value-of select="@url"/></iaixsl:attribute>
								Settings
							</a>
						</div>
					</div>
					<iaixsl:if test="count(products/product) &gt; $subscriptionProductsHidden">
						<a href="#moreProducts" class="subscriptions__more_products">
							<iaixsl:attribute name="data-literal">Hide</iaixsl:attribute>
							+<iaixsl:value-of select="count(products/product) - $subscriptionProductsHidden"/> subscription products
						</a>
					</iaixsl:if>
				</div>
			</iaixsl:for-each>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/eng/envelope.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_filter.js.gzip?r=1696937760"></script><script src="/gfx/eng/subscriptions_list.js.gzip?r=1696937760"></script>
