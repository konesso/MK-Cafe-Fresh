									...
									<iaixsl:choose>
										<iaixsl:when test="(position() - 1 = ($thumbnailsCount - $videoCount)) and ($imagesSum &gt; ($thumbnailsCount - $videoCount))">
											...
											<a class="photos__link --nav --more">
												...
												<span class="photos__more_bottom">more</span>
											</a>
										</iaixsl:when>
										<iaixsl:otherwise>
			...
			<div class="product_name__block --info d-flex mb-2">
				...
				<iaixsl:if test="/shop/page/projector/comments/@avg &gt; 0">
					<div class="product_name__sub --notes d-flex">
						...
						<a class="product_name__note_link" href="#opinions_section">Opinions (<iaixsl:value-of select="/shop/page/projector/comments/@all"/>)</a>
					</div>
				</iaixsl:if>
		...
		<iaixsl:if test="/shop/page/projector/product/subscriptions/subscription and not(/shop/page/projector/product/subscriptions/@only_subscription)">
			<div class="projector_details__purchase --subscription projector_purchase f-group --radio">
				...
				<label class="f-label" for="radioSubscriptionTrue">
					<strong class="projector_purchase__label">Subscription</strong>
					<iaixsl:if test="/shop/page/projector/product/subscriptions/subscription[rebate]">
						<span class="projector_purchase__yousave">
							...
							<span class="projector_purchase__yousave_before">(Discount </span>
							...
							<span class="projector_purchase__yousave_after"> for subscription)</span>
						</span>
					</iaixsl:if>
				</label>
			</div>
			...
			<div class="projector_details__purchase --normal projector_purchase f-group --radio">
				...
				<label class="f-label" for="radioSubscriptionFalse">
					<strong class="projector_purchase__label">One-time purchase</strong>
						...
						<span class="projector_purchase__price_wrapper">
							<iaixsl:choose>
								<iaixsl:when test="/shop/page/projector/product/sizes/prices and /shop/page/projector/product/sizes/prices/@maxprice_formatted != /shop/page/projector/product/sizes/prices/@minprice_formatted">
									<span class="projector_purchase__price_before">from</span>
		...
		<div class="projector_details__wrapper">
			...
			<iaixsl:if test="/shop/page/projector/subscriptions_rebates/rebate[@renewals_number_from != '1'] and /shop/page/projector/product/subscriptions/subscription">
				<div class="projector_details__subscription_rebates projector_subscription_rebates">
					...
					<iaixsl:variable name="subcriptionRebateText">From the %s delivery in this subscription, the discount will be -%s</iaixsl:variable>
			...
			<div id="projector_prices_wrapper" class="projector_details__prices projector_prices">
				...
				<div class="projector_prices__price_wrapper">
								...
								<iaixsl:when test="/shop/page/projector/product/bundle_price/@percent_diff and /shop/page/projector/product/bundle_price/@percent_diff &gt; 0 and /shop/page/projector/product/bundle_price/@amount_diff_gross &gt; 0">
									<iaixsl:choose>
										<iaixsl:when test="/shop/page/projector/bundled/@collection = 'true'">
											<span class="projector_prices__percent_after">% buying in collection)</span>
										</iaixsl:when>
										<iaixsl:otherwise>
											<span class="projector_prices__percent_after">% when buying in a set)</span>
										</iaixsl:otherwise>
									</iaixsl:choose>
								</iaixsl:when>
								<iaixsl:otherwise>
					...
					<div class="projector_prices__info">
						...
						<iaixsl:if test="/shop/page/projector/bundled/@collection = 'true'">
							<span class="projector_prices__collection_selected"> selected products</span>
						</iaixsl:if>
						
						<iaixsl:if test="/shop/page/projector/product/subscriptions/subscription">
							<span class="projector_prices__period"> every <span class="projector_prices__period_value"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="$firstDaysInPeriod"/></iaixsl:attribute><iaixsl:value-of select="$firstDaysInPeriod"/> days</span></span>
						</iaixsl:if>
					</div>
				</div>
				...
				<iaixsl:if test="($var_omnibus != '' and $var_omnibus_short != 'true') or ($var_show_omnibus_short_fallback = 'true')">
					<div class="projector_prices__lowest_price omnibus_price --hidden">
						...
						<span class="omnibus_price__text">Lowest price in 30 days before discount: </span><span id="projector_omnibus_price_value" class="omnibus_price__value"><iaixsl:value-of select="$var_omnibus"/></span>
					</div>
				</iaixsl:if>
				...
				<iaixsl:if test="/shop/page/projector/product/sizes/@unit_sellby != '1'">
					<div class="projector_prices__sellby">
						<span class="projector_prices__sellby_label">Sold by:</span>
						...
						<iaixsl:choose>
							<iaixsl:when test="not(/shop/basket/@login)">
								<span id="projector_button_points_basket" class="projector_prices__points_buy --span">
									<iaixsl:attribute name="title">Sign in to buy this product with points</iaixsl:attribute>
									<span class="projector_prices__points_price_text">You can buy for </span>
									<span class="projector_prices__points_price" id="projector_price_points"><iaixsl:value-of select="page/projector/product/price/@points"/><span class="projector_currency"> pts.</span></span>
								</span>
							</iaixsl:when>
							<iaixsl:otherwise>
			...
			<iaixsl:if test="page/projector/product/sizes/size[1]/price/rebateNumber and not(page/projector/product/@product_type = 'product_virtual')">
				<div class="projector_details__multipack projector_multipack" id="projector_rebateNumber">
					<strong class="projector_multipack__label">Order more, pay less!</strong>
			...
			<iaixsl:if test="/shop/page/projector/product/subscriptions/subscription">
				<div class="projector_details__subscription projector_subscription">
					...
					<span class="projector_subscription__label">Shipping every</span>
					<div class="projector_subscription__sub">
						<iaixsl:for-each select="/shop/page/projector/product/subscriptions/subscription">
							...
							<a class="projector_subscription__item">
								...
								<span class="projector_subscription__name"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="@days_in_period"/> days</span>
							</a>
						</iaixsl:for-each>
					</div>
				</div>
									...
									<iaixsl:for-each select="/shop/page/projector/product/versions/version">
										<option>
											...
											<iaixsl:if test="@amount = '0'">
												...
												<iaixsl:attribute name="label"><iaixsl:value-of select="@name"/> (sold out)</iaixsl:attribute>
											</iaixsl:if>
											<iaixsl:attribute name="data-link"><iaixsl:value-of select="@link"/></iaixsl:attribute>
											<iaixsl:if test="@gfx">
							...
							<select name="projector_sizes" id="projector_sizes_select" class="projector_sizes__select f-select --placeholder">
								...
								<iaixsl:for-each select="/shop/page/projector/product/sizes/size">
									<option>
										...
										<iaixsl:if test="@amount = '0'">
											<iaixsl:attribute name="class">--disabled</iaixsl:attribute>
											<iaixsl:attribute name="label"><iaixsl:value-of select="@description"/> (sold out)</iaixsl:attribute>
										</iaixsl:if>
			...
			<iaixsl:if test="page/projector/product/price/@advanceprice_formatted">
				<div class="projector_details__advanceprice" id="projector_advanceprice_wrapper">
					Before we process the order with this product, the prepayment in the amount of <b id="projector_advanceprice"><iaixsl:choose><iaixsl:when test="not($nettoPrice = '')"><iaixsl:value-of select="page/projector/product/price/@advanceprice_net_formatted"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="page/projector/product/price/@advanceprice_formatted"/></iaixsl:otherwise></iaixsl:choose></b>. may be required. Detailed information will be provided in the order summary, before its placement.
				</div>
			</iaixsl:if>
        ...
        <div class="projector_buy__wrapper">
          <iaixsl:if test="not((/shop/page/projector/product/@product_type = 'product_virtual') or (/shop/page/projector/product/@product_type = 'product_bundle' and not(count(/shop/page/projector/bundled/product[@product_type = 'product_virtual']) = 0)))">
            ...
            <iaixsl:choose>
              ...
              <iaixsl:attribute name="data-subscription-name">Subscribe</iaixsl:attribute>
              <iaixsl:attribute name="data-normal-name">Add to basket</iaixsl:attribute>
							Subscribe
						</iaixsl:when>
					...
					<a class="projector_buy__shopping_list" href="#addToShoppingList">
						<iaixsl:attribute name="title">Click to add a product to your shopping list</iaixsl:attribute>
					</a>
				</div>
			...
			<div class="projector_details__tell_availability projector_tell_availability" id="projector_tell_availability">
				...
				<div class="projector_tell_availability__block --link">
					<a class="projector_tell_availability__link btn --solid --outline --solid --extrasmall" href="#tellAvailability">Notify of availability</a>
				</div>
				<div class="projector_tell_availability__block --dialog" id="tell_availability_dialog">
					<h6 class="headline">
						<span class="headline__name">Product sold out</span>
					</h6>
					<div class="projector_tell_availability__info_top">
						<span>You will receive an email notification from us when the product is available again.</span>
					</div>
					...
					<div class="projector_tell_availability__info1">
						<span>Data is processed in accordance with the </span><a><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/private_policy/@url"/></iaixsl:attribute>privacy policy</a><span>. By submitting data, you accept privacy policy provisions. </span>
					</div>
			...
			<div class="projector_details__info projector_info">
				...
				<div id="projector_status" class="projector_info__item --status projector_status">
					...
					<div id="projector_shipping_unknown" class="projector_status__unknown">
						...
						<span class="projector_status__unknown_text">
							<a target="_blank"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/contact/link/@url"/></iaixsl:attribute>Contact the shop staff</a>, in order to estimate time of preparing this product for shipment.
						</span>
					</div>
					...
					<div id="projector_status_wrapper" class="projector_status__wrapper">
						...
						<iaixsl:if test="not(/shop/page/projector/product/@product_type = 'product_service')">
							<div id="projector_shipping_info" class="projector_status__info">
								<iaixsl:attribute name="style">display:none</iaixsl:attribute>
								<strong class="projector_status__info_label" id="projector_delivery_label">Shipment </strong>
								...
								<iaixsl:if test="not(/shop/page/projector/product/@product_type = 'product_bundle')">
									<span class="projector_status__info_amount" id="projector_amount"><iaixsl:attribute name="style">display:none</iaixsl:attribute> (%d in stock)</span>
								</iaixsl:if>
							</div>
						</iaixsl:if>
					</div>
					...
					<a class="projector_shipping__info projector_info__link" href="#shipping_info">
						<iaixsl:choose>
							<iaixsl:when test="/shop/page/projector/product/smile or (/shop/basket/@shipping = '0.00' and /shop/page/projector/product/sizes/size/delivery/@shipping = '0.00') or (/shop/basket/@shippinglimitfree &gt; 0 and /shop/page/projector/product/sizes/size/delivery/@limitfree &gt; 0)">
								<span class="projector_shipping__text">Free and fast delivery</span><iaixsl:if test="/shop/basket/@shippinglimitfree &gt; 0 and /shop/basket/@toshippingfree &gt; 0 and /shop/page/projector/product/sizes/size/delivery/@limitfree &gt; 0"><span class="projector_shipping__text_from"> from </span><span class="projector_shipping__price"><iaixsl:value-of select="/shop/basket/@shippinglimitfree_formatted"/></span></iaixsl:if>
							</iaixsl:when>
							<iaixsl:otherwise>
				...
				<iaixsl:if test="not(/shop/action/stocks/@available = 'false')">
					<div class="projector_info__item --stocks projector_stocks">
						...
						<iaixsl:choose>
							...
							<iaixsl:otherwise>
								<span class="projector_stocks__info projector_info__link">This product is not available in a stationary store</span>
							</iaixsl:otherwise>
						</iaixsl:choose>
				...
				<iaixsl:if test="/shop/page/projector/product/subscriptions/subscription">
					<div class="projector_info__item --subscription projector_subscription_info">
						...
						<span class="projector_subscription_info__info projector_info__link">Subscription, i.e. a recurring purchase, renews automatically</span>
					</div>
				</iaixsl:if>
				...
				<iaixsl:if test="/shop/page/projector/product/subscriptions/subscription">
					<div class="projector_info__item --abort-subscription projector_abort_subscription_info">
						...
						<span class="projector_abort_subscription_info__info projector_info__link">Abort at any time without a notice period</span>
					</div>
				</iaixsl:if>
				...
				<iaixsl:if test="page/projector/product/payment/instalment">
					<div class="projector_info__item --instalments projector_instalments">
						...
						<span class="projector_instalments__info projector_info__link">Buy by instalments (<a class="projector_instalments__link" href="#showInstalments">calculate instalment</a>)</span>
				...
				<div class="projector_info__item --points projector_points_recive" id="projector_price_points_recive_wrapper">
					...
					<span class="projector_points_recive__info projector_info__link"><span class="projector_points_recive__text">After purchase you will receive </span><span class="projector_points_recive__value" id="projector_points_recive_points"><iaixsl:value-of select="page/projector/product/price/@points_recive"/> pts.</span></span>
				</div>
			</div>
		</div>
			...
			<div class="projector_smile">
				<div class="projector_smile__block --main">
					...
					<span class="projector_smile__inpost">
						<span class="projector_smile__inpost_text">Free delivery to parcel machines</span>
				...
				<div class="projector_smile__block --desc">
					<a class="projector_smile__link" href="#more">More information</a>
				</div>
			</div>
										...
										<div class="f-group">
											<input class="f-control">
												<iaixsl:if test="settings/min">
													<iaixsl:attribute name="placeholder">Fill in the required field</iaixsl:attribute>
												...
												<iaixsl:choose>
													<iaixsl:when test="settings/type = 'string'">
														<iaixsl:if test="settings/min and not(settings/min = '0')">
															<span class="configurator__limit --min --string">Min. number of characters <iaixsl:value-of select="settings/min"/></span>
														</iaixsl:if>
														<iaixsl:if test="settings/max">
															<span class="configurator__limit --max --string">Max. number of characters <iaixsl:value-of select="settings/max"/></span>
														</iaixsl:if>
													</iaixsl:when>
													<iaixsl:otherwise>
														<iaixsl:if test="settings/min">
															<span class="configurator__limit --min --digit">Minimum value <iaixsl:value-of select="settings/min"/></span>
														</iaixsl:if>
														<iaixsl:if test="settings/max">
															<span class="configurator__limit --max --digit">Maximum value <iaixsl:value-of select="settings/max"/></span>
														</iaixsl:if>
													</iaixsl:otherwise>
												</iaixsl:choose>
											</div>
	...
	<iaixsl:if test="page/projector/bundled/product">
		...
		<div id="projector_bundle_product" class="projector_bundle">
			...
			<iaixsl:if test="/shop/page/projector/bundled/@left_quantity and (not(/shop/page/projector/product/bundle_price/@amount_diff_gross = '0.00') or (not($nettoPrice = '') and not(/shop/page/projector/product/bundle_price/@amount_diff_net = '0.00')))">
				<div class="projector_bundle__rebate">
					<h2 class="projector_bundle__rebate_label">Gain a discount when buying products from the collection </h2>
					<div class="projector_bundle__rebate_wrapper">
						<span class="projector_bundle__rebate_description">Select at least <iaixsl:value-of select="/shop/page/projector/bundled/@left_quantity"/> products and get a discount!</span>
					</div>
				</div>
			</iaixsl:if>
                    ...
                    <iaixsl:attribute name="alt"><iaixsl:value-of select="name"/></iaixsl:attribute>
						...
						<div class="projector_bundle__info">
							...
							<div class="projector_bundle__availability_quantity" style="display:none;">
								...
								<span>Product available in smaller quantities. </span>
								<a class="projector_bundle__availability_quantity_link"><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:choose><iaixsl:when test="/shop/page/projector/bundled/@collection='true'">Buy outside the collection</iaixsl:when><iaixsl:otherwise>Buy outside the set</iaixsl:otherwise></iaixsl:choose></a>
							</div>
												...
												<iaixsl:for-each select="item">
													<option>
														...
														<iaixsl:if test="count(/shop/page/projector/bundled/product/multiversions/multi_version) = 1 and /shop/page/projector/bundled/product/versions/version[@product_id = $currentProductId]/@amount = '0'">
															<iaixsl:attribute name="class">--disabled</iaixsl:attribute>
															<iaixsl:attribute name="label"><iaixsl:value-of select="$value_name"/> (sold out)</iaixsl:attribute>
														</iaixsl:if>
														<iaixsl:attribute name="data-values_id"><iaixsl:value-of select="values/@id"/></iaixsl:attribute>
														<iaixsl:attribute name="data-value"><iaixsl:value-of select="position()"/></iaixsl:attribute>
														<iaixsl:attribute name="data-product"><iaixsl:value-of select="products/product/@product_id"/></iaixsl:attribute>
											...
											<iaixsl:when test="price/@value &gt; 0">
												<div class="product__promo d-flex flex-column">
													<iaixsl:if test="bundle_price/@price_gross &gt; price/@value">
														<span class="price --max">
															...
															<iaixsl:if test="price/@omnibus_price or ($var_show_omnibus_short_fallback = 'true')">
																<span class="omnibus_label --hidden"><iaixsl:if test="price/@omnibus_price"><iaixsl:attribute name="class">omnibus_label</iaixsl:attribute></iaixsl:if>Regular price: </span>
															</iaixsl:if>
													...
													<iaixsl:if test="price/@omnibus_price or ($var_show_omnibus_short_fallback = 'true')">
														<div class="product__promo_omnibus omnibus_price --hidden">
															...
															<span class="omnibus_price__text">Lowest price in 30 days before discount: </span><span class="omnibus_price__value"><iaixsl:value-of select="price/@omnibus_price_formatted"/></span>
														</div>
													</iaixsl:if>
												...
												<iaixsl:if test="bundle_price/@percent_diff &gt; 0">
													<div class="product__promo_info_wrapper d-none">
														<span class="product__promo_info">Cheaper in the set by <iaixsl:value-of select="substring-before(bundle_price/@percent_diff, '.')"/>%</span>
													</div>
												</iaixsl:if>
											</iaixsl:when>
											<iaixsl:otherwise>
												...
												<div class="product__promo d-flex flex-column">
													<iaixsl:if test="bundle_price/@price_net &gt; price/@price_net">
														<span class="price --max">
															...
															<iaixsl:if test="price/@omnibus_price_net or ($var_show_omnibus_short_fallback = 'true')">
																<span class="omnibus_label --hidden"><iaixsl:if test="price/@omnibus_price_net"><iaixsl:attribute name="class">omnibus_label</iaixsl:attribute></iaixsl:if>Regular price: </span>
															</iaixsl:if>
													...
													<iaixsl:if test="price/@omnibus_price_net or ($var_show_omnibus_short_fallback = 'true')">
														<div class="product__promo_omnibus omnibus_price --hidden">
															...
															<span class="omnibus_price__text">Lowest price in 30 days before discount: </span><span class="omnibus_price__value"><iaixsl:value-of select="price/@omnibus_price_net_formatted"/></span>
														</div>
													</iaixsl:if>
									...
									<div class="product__prices">
										...
										<iaixsl:choose>
											<iaixsl:when test="price/@value &gt; 0">
												...
												<iaixsl:if test="bundle_price/@percent_diff &gt; 0">
													<div class="product__promo_info_wrapper d-none">
														<span class="product__promo_info">Cheaper in the collection by <iaixsl:value-of select="substring-before(bundle_price/@percent_diff, '.')"/>%</span>
													</div>
												</iaixsl:if>
											</iaixsl:when>
											<iaixsl:otherwise>
	...
	<iaixsl:if test="/shop/page/projector/product/traits/trait[not(contains(@groupdescription, 'gs1:'))]">
		<section id="projector_producttraits" class="traits">
			...
			<iaixsl:if test="count(/shop/page/projector/product/traits/trait[not(contains(@groupdescription, 'gs1:')) and not(@groupid = preceding-sibling::trait/@groupid)]) &gt; $howManyTraits">
				<a href="#showAllTraits" class="traits__all d-none">Show all</a>
			</iaixsl:if>
		</section>
	</iaixsl:if>
<!-- (projector_dictionary, 610bfe05ce44a8.16915901.7)-->
	
	<iaixsl:variable name="product_producer_label">Brand</iaixsl:variable>
	<iaixsl:variable name="product_code_label">Symbol</iaixsl:variable>
	<iaixsl:variable name="product_producer_code_label">Producer code</iaixsl:variable>
						...
						<div class="dictionary__values">
							<div class="dictionary__value">
								<a class="dictionary__value_txt">
									...
									<iaixsl:attribute name="title">Click to view all products from this brand</iaixsl:attribute>
						...
						<iaixsl:otherwise>
							...
							<div class="dictionary__param mb-4">
								...
								<div class="dictionary__name mr-1">
									...
									<span class="dictionary__name_txt"><iaixsl:value-of disable-output-escaping="yes" select="@name"/><iaixsl:if test="desc != ''"><a href="#showDescription" class="dictionary__more">More</a></iaixsl:if></span>
									<iaixsl:choose>
										<iaixsl:when test="@gfx_desktop and @gfx_tablet and @gfx_mobile">
								...
								<div class="dictionary__values">
									<iaixsl:for-each select="values/value">
										...
										<div class="dictionary__value">
											...
											<span class="dictionary__value_txt"><iaixsl:value-of disable-output-escaping="yes" select="@value"/><iaixsl:if test="desc != ''"><a href="#showDescription" class="dictionary__more">More</a></iaixsl:if></span>
											<iaixsl:choose>
												<iaixsl:when test="@gfx_desktop and @gfx_tablet and @gfx_mobile">
...
<!-- (projector_enclosures, 60dd8e831c1df2.28516371.4)-->
        ...
        <!-- (projector_product_questions, 61b0b188cb3eb7.53805735.3)-->
			<section id="product_questions_list" class="questions mb-5 col-12">
				...
				<iaixsl:if test="count(page/projector/questions/question)">
					<div class="questions__label headline">
						<span class="questions__label_txt headline__name">Your previous questions regarding this product</span>
					</div>
				</iaixsl:if>
				...
				<div class="questions__wrapper row align-items-start">
					...
					<div class="questions__block --banner col-12 col-md-5 col-lg-4">
						<div class="questions__banner">
							<strong class="questions__banner_item --label">Do you need help? Do you have any questions?</strong>
							<span class="questions__banner_item --text">Ask a question and we'll respond promptly, publishing the most interesting questions and answers for others.</span>
			...
			<section id="product_askforproduct" class="askforproduct mb-5 col-12">
				...
				<iaixsl:variable name="label_askforproduct">Ask a question</iaixsl:variable>
				<iaixsl:variable name="privacy_text1_askforproduct">Data is processed in accordance with the </iaixsl:variable>
	...
	<section id="opinions_section" class="row mb-4 mx-n3">
		...
		<iaixsl:variable name="more_opinions">View more</iaixsl:variable>
					...
					<div class="col-12 col-sm-6 col-md-12">
						<iaixsl:if test="/shop/page/projector/comments/opinions/opinion[@confirmedByPurchase = 'true']">
							<div class="opinions_filter_confirmed f-group --checkbox">
								...
								<label class="f-label" for="opinions_filter_confirmed">Show only reviews confirmed by purchase</label>
							</div>
						</iaixsl:if>
									...
									<div class="opinions_element_opinion_bottom">
										...
										<div class="rate_opinion">
											...
											<a href="" class="opinion_rate_yes">
												...
												<i class="icon-thumbs-up-empty"/> Yes <span class="rate_count"><iaixsl:value-of select="@rate_yes"/></span>
											</a>
											<a href="" class="opinion_rate_no">
												<input name="opinionState" type="hidden">
													<iaixsl:attribute name="value">negative</iaixsl:attribute>
												</input>
												<i class="icon-thumbs-down"/> No <span class="rate_count"><iaixsl:value-of select="@rate_no"/></span>
											</a>
						...
						<div class="opinion_add_photos col-12 col-sm-7">
							<div class="opinion_add_photos_wrapper d-flex align-items-center">
								<span class="opinion_add_photos_text">
									<i class="icon-file-image"/>  Add your own product photo:
								</span>
	...
	<iaixsl:if test="/shop/action_alert/@type = 'add_basket'">
		<div id="menu_preloader_add" class="added">
			<h2 class="headline added__headline p-0">
				<span class="headline__name added__headline_name">Added to basket</span>
			</h2>
			<div class="added__block">
              ...
              <iaixsl:otherwise>
					...
					<div class="added__prices product__prices">
						...
						<iaixsl:if test="/shop/action_alert/products/product/add_basket_info/size/@count &gt; 1">
							<span class="price --value">
								<span class="price__value_text">Value: </span>
					...
					<div class="added__buttons justify-content-center align-items-center">
						<a class="added__button --close" href="#close">Continue shopping</a>
										...
										<a class="headline">
											...
											<span class="headline__name">
												<iaixsl:choose>
													...
													<iaixsl:otherwise>You can also add</iaixsl:otherwise>
												</iaixsl:choose>
											</span>
...
<template id="expchck_login_verify_pin">
  <div class="expchck_login --verify_pin d-flex flex-column">
	...
	<script src="/gfx/eng/envelope.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_alert.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_compare.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_shoppinglist.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_additionalpayments.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_omnibus.js.gzip?r=1696937760"></script><script src="/gfx/eng/express_checkout.js.gzip?r=1696937760"></script><script src="/gfx/eng/projector_photos.js.gzip?r=1696937760"></script><script src="/gfx/eng/projector_productname.js.gzip?r=1696937760"></script><script src="/gfx/eng/projector_details.js.gzip?r=1696937760"></script><script src="/gfx/eng/projector_configurator.js.gzip?r=1696937760"></script><script src="/gfx/eng/projector_bundle_zone.js.gzip?r=1696937760"></script><script src="/gfx/eng/projector_components_hiding.js.gzip?r=1696937760"></script><script src="/gfx/eng/projector_projector_opinons_form.js.gzip?r=1696937760"></script><script src="/gfx/eng/projector_cms_sizes.js.gzip?r=1696937760"></script>
