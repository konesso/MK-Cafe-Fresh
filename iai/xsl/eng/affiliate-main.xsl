...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (affiliate_main_cms, 60dd8e86f23039.05771477.9)-->
	<iaixsl:choose>
		<iaixsl:when test="not(page/@type='affiliate-not-active')">
			<section class="affiliate --main">
				<span class="headline">
				...
				<iaixsl:if test="page/text/body">
					<div class="affiliate__cms cm">
						<iaixsl:value-of disable-output-escaping="yes" select="page/text/body"/>
					</div>
				</iaixsl:if>
				<div id="affiliate_main_menu" class="row bg_alter mx-0 px-sm-3 py-3 py-sm-5">
					<div class="affiliate__module --stats mb-3 mb-sm-5 col-12 col-md-6">
						<div class="p-3">
							<h3 class="mb-2">
								Statistics 
							</h3>
							<div class="d-flex align-items-start mb-3">
								<i class="icon-signal d-none d-sm-flex align-items-center justify-content-center flex-shrink-0 mr-2"/>
								Measuring the effectiveness of affiliate partners. The tool assesses the effectiveness of all affiliate partners and includes the sorting option.
							</div>
							<div class="d-flex justify-content-end flex-wrap flex-sm-nowrap mt-2">
								<a class="btn --solid mr-sm-2 mb-2 mb-sm-0" href="affiliate-stats.php">
									<iaixsl:attribute name="title">List of redirections to the store from your recommendation</iaixsl:attribute>
									Your redirections
								</a>
								<a class="btn --solid mr-sm-2 mb-2 mb-sm-0" href="affiliate-orders.php">
					...
					<div class="affiliate__module --generator mb-3 mb-sm-5 col-12 col-md-6">
						<div class="p-3">
							<h3 class="mb-2">
								Codes and banners generator
							</h3>
							<div class="d-flex align-items-start mb-3">
								<i class="icon-cog-alt d-none d-sm-flex align-items-center justify-content-center flex-shrink-0 mr-2"/>
								Ability to prepare ready-to-use advertisements (flash and static pictures). The panel enables retrieving HTML code with an affiliate link.
							</div>
							<div class="d-flex justify-content-end flex-wrap flex-sm-nowrap mt-2">
								<a class="btn --solid mr-sm-2 mb-2 mb-sm-0" href="affiliate-generator.php?generate=promoCodes">
									<iaixsl:attribute name="title">Rebate code</iaixsl:attribute>
									Rebate code
								</a>
								<a class="btn --solid mr-sm-2 mb-2 mb-sm-0" href="affiliate-generator.php?generate=html">
									<iaixsl:attribute name="title">HTML code generator</iaixsl:attribute>
									HTML code
								</a>
								<a class="btn --solid mr-sm-2 mb-2 mb-sm-0" href="affiliate-generator.php?generate=php">
					...
					<div class="affiliate__module --calculations mb-3 mb-sm-5 mb-md-0 col-12 col-md-6">
						<div class="p-3">
							<h3 class="mb-2">
								Settlements
							</h3>
							<div class="d-flex align-items-start mb-3">
								<i class="icon-users d-none d-sm-flex align-items-center justify-content-center flex-shrink-0 mr-2"/>
								Settling cash flows on your affiliate partner account.
							</div>
							<div class="d-flex justify-content-end flex-wrap flex-sm-nowrap mt-2">
					...
					<div class="affiliate__module --resources col-12 col-md-6">
						<div class="p-3">
							<h3 class="mb-2">
								Available funds
							</h3>
							<div class="d-flex align-items-start mb-3">
								<i class="icon-credit-card d-none d-sm-flex align-items-center justify-content-center flex-shrink-0 mr-2"/>
								The tool enables fund withdrawal or exchanging funds for gift vouchers.
							</div>
							<div class="d-flex justify-content-end flex-wrap flex-sm-nowrap mt-2">
		...
		<iaixsl:otherwise>
			<div class="affiliate__info">
				The affiliate program is inactive in the store.
			</div>
		</iaixsl:otherwise>
	</iaixsl:choose>
