...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (rma_add_cms, 60dd8e76dbccd6.03994951.9)-->
...
<iaixsl:attribute name="class">rma_add_cms_label  big_label</iaixsl:attribute>
    ...
    <!-- (rma_add_form, 60dd8e8828f0a0.04076273.3)-->
            ...
            <form id="rma_add_form" method="post" action="/rma-add.php">
                ...
                <div class="rma_add_form_section" id="rma_add_form_section1">
                    <div class="rma_add_form_sectionheader">
                        <span class="rma_add_form_sectionheader">Billing and shipping information</span>
                    </div>
                    <iaixsl:if test="not(page/rma/@action = 'view')">
                    ...
                    <div class="rma_add_form_sectionsub row" id="rma_add_form_subsection2">
                        ...
                        <div class="rma_add_form_box" id="rma_add_form_box4">
                            ...
                            <div class="rma_add_form_descval">
                                <iaixsl:choose>
                                    <iaixsl:when test="page/rma/@action = 'view'">
                                        <span class="rma_add_form_desc">Defect description:</span>
                                        ...
                                        <iaixsl:choose>
                                            <iaixsl:when test="page/rma/@action = 'view'">
                                                <iaixsl:choose>
                                                    ...
                                                    <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 't'">Money to be used for future purchases</iaixsl:when>
                                                </iaixsl:choose>
                                            </iaixsl:when>
                                            <iaixsl:otherwise>
                                                ...
                                                <iaixsl:choose>
                                                    <iaixsl:when test="@type = 'p'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/standards/need.gif?r=1696937716"><iaixsl:attribute name="alt">This field is required to place an order</iaixsl:attribute></img>
                                                                <img src="/gfx/standards/correct.png?r=1696937716" class="rma_correct_img" id="rma_add_przekaz_on" style="display:none;"/>
                                                                <img src="/gfx/standards/incorrect.png?r=1696937716" class="rma_correct_img" id="rma_add_przekaz_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                                                    ...
                                                    <iaixsl:when test="@type = 'b'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/standards/need.gif?r=1696937716"><iaixsl:attribute name="alt">This field is required to place an order</iaixsl:attribute></img>
                                                                <img src="/gfx/standards/correct.png?r=1696937716" class="rma_correct_img" id="rma_add_bankaccount_on" style="display:none;"/>
                                                                <img src="/gfx/standards/incorrect.png?r=1696937716" class="rma_correct_img" id="rma_add_bankaccount_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
                                                    ...
                                                    <iaixsl:when test="@type = 'c'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/standards/need.gif?r=1696937716"><iaixsl:attribute name="alt">This field is required to place an order</iaixsl:attribute></img>
                                                                <img src="/gfx/standards/correct.png?r=1696937716" class="rma_correct_img" id="rma_add_czek_on" style="display:none;"/>
                                                                <img src="/gfx/standards/incorrect.png?r=1696937716" class="rma_correct_img" id="rma_add_czek_off" style="display:none;"/>
                                                            </iaixsl:if>
                                                        </span>
