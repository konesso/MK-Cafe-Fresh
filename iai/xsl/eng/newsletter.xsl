                                        ...
                                        <form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="$account_email_info">
                                                    <p class="col-md-6 col-12">You are already subscribed to our newsletter. E-mail address assigned to your account is <b><iaixsl:value-of select="/shop/page/client/@email"/></b>. You can unsubscribe at any moment by clicking on the button below.</p>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
