    ...
    <iaixsl:choose>
        ...
        <section class="affiliate --resources --withdraw mb-4">
          <div class="affiliate__desc mb-4">
            ...
            <iaixsl:value-of select="page/shop/@minpayment"/><iaixsl:value-of select="/shop/currency/@name"/>
             and not more than the funds available on your account. Next, click on "Request commission payment&quot;.
          </div>
            ...
            <iaixsl:choose>
              <iaixsl:when test="page/client/@paymenttype = 'cash'">
                <div class="f-group --radio">
                  ...
                  <label class="f-label mx-1" for="voucher">Voucher </label>
                  <input type="radio" name="method" class="f-control" value="cash" id="cash"/>
                  <label class="f-label mx-1" for="cash">Wire transfer</label>
                </div>
              </iaixsl:when>
              <iaixsl:otherwise>
                <span class="mb-3">This sum will be withdrawn as a voucher.</span>
              </iaixsl:otherwise>
            </iaixsl:choose>
      ...
      <iaixsl:otherwise>
        <div class="affiliate__info">
          There are no funds available on your account currently.
        </div>
      </iaixsl:otherwise>
    </iaixsl:choose>
  </iaixsl:if>
<!-- (affiliate_resources_list, 60dd8e84da9e33.27373055.2)-->
  <iaixsl:variable name="affiliate_1">Date of withdrawal</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">Withdrawal type</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">Voucher id</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">Expires on</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">Total</iaixsl:variable>
  <iaixsl:variable name="affiliate_6">Used</iaixsl:variable>
            ...
            <span class="status --table">
              <iaixsl:choose>
                ...
                <iaixsl:otherwise>
                  ...
                  <span>Accepted <small>(<iaixsl:value-of select="@status"/>)</small></span>
                </iaixsl:otherwise>
              </iaixsl:choose>
            </span>
          </span>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/eng/envelope.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/eng/affiliate_resources_form.js.gzip?r=1696937760"></script>
