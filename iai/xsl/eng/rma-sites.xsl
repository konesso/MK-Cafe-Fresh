                ...
                <iaixsl:choose>
                    <iaixsl:when test="count(page/pickups/pickup) &gt; 1">
                    	<div class="progress__item --rma --fourth --active d-md-none py-3">
        					...
        					<div class="progress__text">
        						<strong class="progress__name">Select the return acceptance point address</strong>
        					</div>
        				</div>
                        <h1 class="big_label return_label d-none d-md-block">Select the return acceptance point address</h1>
                    ...
                    <iaixsl:otherwise>
                    	<div class="progress__item --rma --fourth --active d-md-none py-3">
        					...
        					<div class="progress__text">
        						<strong class="progress__name">Return acceptance point address</strong>
        					</div>
        				</div>
                        <h1 class="big_label return_label d-none d-md-block">Return acceptance point address</h1>
