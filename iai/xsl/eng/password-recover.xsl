        ...
        <!-- (password-recover, 60dd8e7e14d055.39041804.3)-->
            ...
            <div id="signin_password_recovery">
                ...
                <div class="row flex-column align-items-center ">
                    <p class="reminder_desc col-12 col-sm-6 mb-3">An e-mail that allows you to automatically log in has been sent to your e-mail address. Changing the password will be possible after logging in.</p>
