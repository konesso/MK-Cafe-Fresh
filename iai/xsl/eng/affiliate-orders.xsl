...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (affiliate_orders_list, 60dd8e841e03e1.60115378.2)-->
  <iaixsl:variable name="affiliate_1">Customer id</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">Account created on</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">Number of orders</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">Total value of placed orders</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">Number of completed orders</iaixsl:variable>
  <iaixsl:variable name="affiliate_6">Value of completed orders</iaixsl:variable>
  <iaixsl:variable name="affiliate_7">(shipping costs not included)</iaixsl:variable>
  <iaixsl:if test="not(page/@type='affiliate-not-active')">
    ...
    <iaixsl:choose>
      <iaixsl:when test="count(page/orders/client)">
        <section class="affiliate --orders mb-4">
          <div class="affiliate__desc mb-4">
            Individuals who have purchased or created an account in our shop, thanks to your recommendation, are listed in the table below. Given sums relate to orders placed with your partnership. To view detailed information about a particular person, click on a customer id.
          </div>

          <div class="affiliate__table --six table">
            <div class="table__row --head">
              <span class="table__cell d-flex justify-content-between flex-md-wrap"><iaixsl:value-of select="$affiliate_1"/></span>
              <span class="table__cell d-flex justify-content-between flex-md-wrap"><iaixsl:value-of select="$affiliate_2"/></span>
              <span class="table__cell d-flex justify-content-between flex-md-wrap"><iaixsl:value-of select="$affiliate_3"/></span>
              <span class="table__cell d-flex justify-content-between flex-md-wrap"><iaixsl:value-of select="$affiliate_4"/></span>
              <span class="table__cell d-flex justify-content-between flex-md-wrap"><iaixsl:value-of select="$affiliate_5"/></span>
              <span class="table__cell d-flex justify-content-between flex-md-wrap"><iaixsl:value-of select="$affiliate_6"/><small class="d-block"><iaixsl:value-of select="$affiliate_7"/></small></span>
            </div>
            <iaixsl:for-each select="page/orders/client">
            <div class="table__row mb-5 mb-md-0 p-3 p-md-0">
                <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_1"/></span><a><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:value-of select="@nr"/></a></span>
                <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_2"/></span><iaixsl:value-of select="@setDate"/></span>
                <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_3"/></span><iaixsl:value-of select="@totalCount"/></span>
                <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_4"/></span><iaixsl:value-of select="@totalSum_formatted"/></span>
                <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_5"/></span><iaixsl:value-of select="@sentCount"/></span>
                <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_6"/><small class="d-block"><iaixsl:value-of select="$affiliate_7"/></small></span><iaixsl:value-of select="@sentSum_formatted"/></span>
              </div>
            </iaixsl:for-each>
            <iaixsl:if test="page/orders/client_sum">
              <div class="table__row --summary mb-5 mb-md-0 p-3 p-md-0">
                <span class="table__cell d-flex justify-content-between">Total</span>
                <span class="table__cell d-none d-md-flex justify-content-between"/>
                <span class="table__cell d-none d-md-flex justify-content-between"/>
                <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_4"/></span><iaixsl:value-of select="page/orders/client_sum/@totalSum_formatted"/></span>
                <span class="table__cell d-none d-md-flex justify-content-between"/>
                <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_6"/><small class="d-block"><iaixsl:value-of select="$affiliate_7"/></small></span><iaixsl:value-of select="page/orders/client_sum/@sentSum_formatted"/></span>
              </div>
            </iaixsl:if>
          </div>
        </section>
...
<!-- (affiliate_orders_paging, 60dd8e7f4593b9.16001856.3)-->
