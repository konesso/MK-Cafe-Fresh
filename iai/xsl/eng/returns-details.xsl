...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (returns_details_cms, 60dd8e77e38865.24114429.2)-->
    ...
    <!-- (returns_details_form, 61f913c7c80b92.84644434.3)-->
	<iaixsl:variable name="nettoPriceReturnDetails"><iaixsl:if test="/shop/page/@price_type = 'net'">true</iaixsl:if></iaixsl:variable>
	<iaixsl:variable name="grossPriceReturnDetails"> incl. VAT</iaixsl:variable>
	<iaixsl:if test="page/@display = 'details'">
		...
		<div class="step7 returnDetails">

			<div id="orderdetails_info" class="returnDetails__wrapper">
				<div class="returnDetails__info">
					<div class="returnDetails__infoStatus">
						<div class="returnDetails__icon">
							<iaixsl:attribute name="class">prepaid-icon status-<iaixsl:value-of select="page/details/@status"/></iaixsl:attribute>
							<i>
								<iaixsl:attribute name="class"><iaixsl:choose><iaixsl:when test="page/details/@status=1">icon-clock</iaixsl:when><iaixsl:when test="page/details/@status=2">icon-ok</iaixsl:when><iaixsl:when test="page/details/@status=3">icon-remove</iaixsl:when><iaixsl:when test="page/details/@status=13">icon-remove</iaixsl:when><iaixsl:when test="page/details/@status=14">icon-remove</iaixsl:when><iaixsl:when test="page/details/@status=15">icon-clock</iaixsl:when><iaixsl:when test="page/details/@status=16">icon-remove</iaixsl:when><iaixsl:when test="page/details/@status=17">icon-ok</iaixsl:when><iaixsl:when test="page/details/@status=18">icon-ok</iaixsl:when></iaixsl:choose></iaixsl:attribute>
							</i>
						</div>
						<div class="returnDetails__status">
									...
									<div class="moreInfo orderdetails_info__more d-none d-md-flex">
											...
											<div style="display:none;" class="moreInfo__desc"><iaixsl:value-of disable-output-escaping="yes" select="page/details/@status_description"/></div>
															...
															<div class="orderdetails_info__dates">
																	<span>Return no: <iaixsl:value-of select="page/details/@id"/></span>
																	<iaixsl:if test="not(page/details/@status_description = '')">
					...
					<iaixsl:if test="/shop/page/return_method">
						<div class="returnDetails__method">
							<div class="returnDetails__method_name">
								<img class="returnDetails__method_icon">
							...
							<div class="returnDetails__method_desc">
								<iaixsl:choose>
				...
				<div class="returnDetails__list">
					<iaixsl:choose>
						
						<iaixsl:when test="page/return_method/@id=1">
							<iaixsl:variable name="returns_1">Download the return form and shipping label.</iaixsl:variable>
							<iaixsl:variable name="returns_1_2">Store staff will need it.</iaixsl:variable>
							<iaixsl:variable name="returns_1_3">Download the return form</iaixsl:variable>

							<iaixsl:variable name="returns_2">Pack the returned goods and attach the printed return form.</iaixsl:variable>
							<iaixsl:variable name="returns_2_2">The document will facilitate the handling of your return.</iaixsl:variable>
							
							<iaixsl:variable name="returns_3">Deliver the parcel yourself at </iaixsl:variable>
							<iaixsl:variable name="returns_3_2">Check the opening hours of the drop-off point before departure.</iaixsl:variable>
							
							<div class="returnDetails__listItem --first">
								<span class="returnDetails__listCounter">1</span>
								<div class="returnDetails__listDesc">
									<b><iaixsl:value-of select="$returns_1"/></b>
									<span><iaixsl:value-of select="$returns_1_2"/></span>
								</div>
								<div class="returnDetails__listIcons --button">
									<a class="btn --solid --medium" target="blank">
										<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/documentlink/@url"/></iaixsl:attribute>
										<iaixsl:value-of select="$returns_1_3"/>
									</a>
								</div>
							</div>

							<div class="returnDetails__listItem --second">
								<span class="returnDetails__listCounter">2</span>
								<div class="returnDetails__listDesc">
									<b><iaixsl:value-of select="$returns_2"/></b>
									<span><iaixsl:value-of select="$returns_2_2"/></span>
								</div>
								<div class="returnDetails__listIcons">
									<img src="/gfx/standards/returns_3.svg?r=1696937716" alt="return"/>
									<img src="/gfx/standards/arrow.svg?r=1696937716" alt="arrow"/>
									<img src="/gfx/standards/returns_4.svg?r=1696937716" alt="return"/>
								</div>
							</div>
							<div class="returnDetails__listItem --third">
								<span class="returnDetails__listCounter">3</span>
								<div class="returnDetails__listDesc">
									<b>
										<iaixsl:value-of select="$returns_3"/>
										<iaixsl:if test="page/return_method/@id=1 or page/return_method/@id=3">
											<a>
												<iaixsl:attribute name="href"><iaixsl:value-of select="page/pickup/link"/></iaixsl:attribute>
												<iaixsl:attribute name="title"> return point address.</iaixsl:attribute>
													return point address.
											</a>
										</iaixsl:if>
									</b>
									<span><iaixsl:value-of select="$returns_3_2"/></span>
								</div>
								<div class="returnDetails__listIcons">
									<img src="/gfx/standards/returns_9.svg?r=1696937716" alt="return"/>
									<img src="/gfx/standards/arrow.svg?r=1696937716" alt="arrow"/>
									<img src="/gfx/standards/returns_1.svg?r=1696937716" alt="return"/>
								</div>
							</div>

						</iaixsl:when>
						
						<iaixsl:when test="page/return_method/@id=2 or page/return_method/@id=5">
							<iaixsl:variable name="returns_1">Download the return form and shipping label.</iaixsl:variable>
							<iaixsl:variable name="returns_1_2">The label will be needed to ship the package.</iaixsl:variable>
							<iaixsl:variable name="returns_1_3">Download the form and the shipping label</iaixsl:variable>

							<iaixsl:variable name="returns_2">Pack the returned goods and attach the printed return form.</iaixsl:variable>
							<iaixsl:variable name="returns_2_2">Attach the attached label to the package. The document will facilitate the handling of your return.</iaixsl:variable>
							
							<iaixsl:variable name="returns_3">Send the parcel in accordance with the instructions provided in the return form.</iaixsl:variable>
							<iaixsl:variable name="returns_3_2">Remember that the package has a courier label attached.</iaixsl:variable>
							...
							<div class="returnDetails__listItem --second">
								...
								<div class="returnDetails__listIcons">
									<img src="/gfx/standards/returns_3.svg?r=1696937716" alt="return"/>
									<img src="/gfx/standards/arrow.svg?r=1696937716" alt="arrow"/>
									<img src="/gfx/standards/returns_7.svg?r=1696937716" alt="return"/>
								</div>
							</div>
							<div class="returnDetails__listItem --third">
								<span class="returnDetails__listCounter">3</span>
								...
								<div class="returnDetails__listIcons">
									<img src="/gfx/standards/returns_2.svg?r=1696937716" alt="return"/>
									<img src="/gfx/standards/arrow.svg?r=1696937716" alt="arrow"/>
									<img src="/gfx/standards/returns_5.svg?r=1696937716" alt="return"/>
								</div>
							</div>

						</iaixsl:when>
						
						<iaixsl:when test="page/return_method/@id=4">
							<iaixsl:variable name="returns_1">Download the return form and the return code.</iaixsl:variable>
							<iaixsl:variable name="returns_1_2">The return code will be needed to send a parcel in a parcel locker.</iaixsl:variable>
							<iaixsl:variable name="returns_1_3">Download the return form and code</iaixsl:variable>

							<iaixsl:variable name="returns_2">Pack the returned goods and, if you can, print and attach the return form.</iaixsl:variable>
							<iaixsl:variable name="returns_2_2">The document will facilitate the handling of your return.</iaixsl:variable>
							
							<iaixsl:variable name="returns_3">Send the parcel at the InPost parcel locker or PaczkoPunkt.</iaixsl:variable>
							...
							<div class="returnDetails__listItem --third">
								<iaixsl:if test="page/return_method/@return_code">
								<iaixsl:attribute name="class">returnDetails__listItem --third --inpostCode</iaixsl:attribute>
								</iaixsl:if>
								<span class="returnDetails__listCounter">3</span>
								<div class="returnDetails__listDesc">
									<b>
									...
									<span>
									<iaixsl:choose>
										<iaixsl:when test="page/return_method/@return_code">
											Use the generated return code:
										</iaixsl:when>
										<iaixsl:otherwise>
											Use the generated return code that you will find in the downloaded form.
										</iaixsl:otherwise>
									</iaixsl:choose>
									</span>
								</div>
								<div class="returnDetails__listIcons">
									<iaixsl:choose>
										<iaixsl:when test="page/return_method/@return_code">
											<strong><iaixsl:value-of select="page/return_method/@return_code"/></strong>
										</iaixsl:when>
										<iaixsl:otherwise>
											<img src="/gfx/standards/returns_2.svg?r=1696937716" alt="return"/>
										</iaixsl:otherwise>
									...
									<img src="/gfx/standards/arrow.svg?r=1696937716" alt="arrow"/>
									<img>
										<iaixsl:attribute name="src"><iaixsl:value-of select="page/return_method/@icon"/></iaixsl:attribute>
										<iaixsl:attribute name="alt"><iaixsl:value-of select="page/return_method/@name"/></iaixsl:attribute>
									</img>
								</div>
							</div>
						...
						<iaixsl:otherwise>
							...
							<iaixsl:variable name="returns_3">Send the parcel on </iaixsl:variable>
							<iaixsl:variable name="returns_3_2">You will find the address at the bottom of the page.</iaixsl:variable>
							...
							<div class="returnDetails__listItem --third">
								...
								<div class="returnDetails__listIcons">
									<img src="/gfx/standards/returns_6.svg?r=1696937716" alt="return"/>
									<img src="/gfx/standards/arrow.svg?r=1696937716" alt="arrow"/>
									<img src="/gfx/standards/returns_1.svg?r=1696937716" alt="return"/>
								</div>
							</div>
			...
			<iaixsl:if test="page/returnproducts/products">
				...
				<div id="return_order_products" class="mb-5">
					<h2 class="orderdetails_label"><span>Products in complaint</span></h2>
												...
												<iaixsl:for-each select="bundled/product">
													<li>
														...
														<iaixsl:if test="not(@size_id = 'uniw') or ((version) and (not(version/@product_name='')))">
															(<iaixsl:if test="not(@size_id = 'uniw')">Size: <b><iaixsl:value-of select="@size_desc"/></b></iaixsl:if>
											...
											<iaixsl:choose>
												<iaixsl:when test="@quantity != '1'">
													<iaixsl:choose>
														...
														<iaixsl:otherwise>
															<iaixsl:choose>
																<iaixsl:when test="not($nettoPriceReturnDetails = '') and not($priceTypeVat = '')">
																	...
																	<span class="ordered_product__price_gross gross_price">(<span class="price_vat"><iaixsl:value-of select="@bruttoworth_formatted"/></span><iaixsl:value-of select="$grossPriceReturnDetails"/>)</span>
																</iaixsl:when>
																<iaixsl:otherwise>
			...
			<iaixsl:if test="/shop/page/repayment_method">
				<div id="returnDetails_repaymentMethod" class="mb-6">
					<h3 class="orderdetails_label">
						<span>Form of return</span>
					</h3>
						...
						<div class="return_detials_shipment_desc">
							<iaixsl:choose>
								<iaixsl:when test="/shop/page/repayment_method/@id = 't'">
									<b class="product_name">Customer balance</b>
									<div class="return_description">
								...
								<iaixsl:when test="/shop/page/repayment_method/@id = 'b'">
									<b class="product_name">Wire transfer</b>
									<div class="return_description">
										If repair or replacement of the product is not possible, therefund will be sent via a wire transfer to the provided account number.
									</div>
								</iaixsl:when>
								<iaixsl:when test="/shop/page/repayment_method/@id = 'tc'">
									<b class="product_name">Restore a trade credit</b>
									<div class="return_description">
			...
			<iaixsl:if test="/shop/page/remarks">
				<div id="returnDetails_remarks" class="mb-6">
					<h3 class="orderdetails_label">
						<span>Comments to the return</span>
					</h3>
					<div>
			...
			<iaixsl:if test="/shop/page/pickup/name">
				<div id="returnDetails_adress" class="mb-6">
					<h3 class="orderdetails_label">
						<span>Return acceptance point address</span>
					</h3>
			...
			<iaixsl:if test="$txt_54116_1 and count(page/documents/document) &gt; 0">
				<div id="returnDetails_documents" class="mb-6">
					<h3 class="orderdetails_label">
	...
	<div id="returnDetails_summary" class="returnDetails__summary">
		<div class="returnDetails__summarySub">
			...
			<iaixsl:if test="/shop/page/costs/cost[@type='shipping']/@value_formatted">
				<div class="returnDetails__summaryItem">
					<label>Delivery cost refund:</label>
			...
			<iaixsl:if test="/shop/page/costs/cost[@type='shop_shipping']/@value_formatted">
				<div class="returnDetails__summaryItem">
					<label>Costs of the reshipment:</label>
			...
			<iaixsl:if test="/shop/page/costs/@value_formatted">
				<div class="returnDetails__summaryItem --sum">
					...
					<strong id="currencytotal_prepaid"><iaixsl:value-of select="/shop/page/costs/@value_formatted"/><span class="price_vat"><iaixsl:value-of select="$grossPriceReturnDetails"/></span></strong>
				</div>
			</iaixsl:if>
		...
		<div class="">
			<div class="returnDetails__buttons">
				<iaixsl:if test="/shop/page/editlink/@url">
					<a class="btn --solid --medium --outline prepaid-edit">
						<iaixsl:attribute name="title">Clik to modify complaint.</iaixsl:attribute>
						<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/editlink/@url"/></iaixsl:attribute>Modify complaint</a>
				</iaixsl:if>
				<iaixsl:if test="/shop/page/cancellink/@url">
					<a class="btn --solid --medium --outline prepaid-cancel">
						...
						<iaixsl:attribute name="title">Cancel a return</iaixsl:attribute>
