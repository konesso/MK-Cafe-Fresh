...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
    ...
    <!-- (returns_methods_form, 61f913c71c2595.35784940.3)-->
        ...
        <iaixsl:if test="page/@type = 'return_products' and page/@display = 'method'">
            ...
            <iaixsl:variable name="n69372_p_txt">Form of return</iaixsl:variable>
...
<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/returnsProducts/@url"/></iaixsl:attribute>
                ...
                <div class="progress__item --rma --third --active d-md-none py-3">
					...
					<div class="progress__text">
						<strong class="progress__name">Choose a method of a return</strong>
					</div>
				</div>

                <h1 class="big_label return_label d-none d-md-block">Choose a method of a return</h1>
