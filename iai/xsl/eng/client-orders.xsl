			...
			<iaixsl:when test="page/orders/@mode = 'rma'">
				...
				<div class="progress__item --rma --first d-md-none --active py-3">
							...
							<div class="progress__text">
								<strong class="progress__name">Choose an order in which you want to create a product complaint</strong>
							</div>
						</div>
				<div class="client_order__labelWrapper my-2">
					<h1 class="big_label d-none d-md-block">
						Select the order from which you wish to claim products
					</h1>
					<div>
						<span class="progress__listIcon"/>
						<a href="client-orders.php?display=closed"><iaixsl:if test="/shop/action/clientOrders/@url"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientOrders/@url"/>?display=closed</iaixsl:attribute></iaixsl:if>List of completed orders</a>
					</div>
				</div>

        <div class="progress__rmaHelper">
          <span class="progress__iconRMA"/> A convenient wizard guides you step by step through the process.
        </div>
			...
			<iaixsl:when test="page/orders/@mode = 'returns'">
				...
				<div class="progress__item --rma --first d-md-none --active py-3">
							...
							<div class="progress__text">
								<strong class="progress__name">Choose the order from which you want to return products</strong>
							</div>
						</div>
				<div class="client_order__labelWrapper my-2">
					<h1 class="big_label d-none d-md-block">
			...
			<iaixsl:when test="page/orders/@mode = 'closed'">
				<div class="client_order__labelWrapper my-2">
					...
					<div>
            <span class="progress__listIcon"/>
            <a href="client-orders.php?display=opened"><iaixsl:if test="/shop/action/clientOrders/@url"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientOrders/@url"/>?display=opened</iaixsl:attribute></iaixsl:if>List of orders currently in progress</a>
          </div>
				</div>
			</iaixsl:when>
			<iaixsl:otherwise>
									...
									<div><iaixsl:attribute name="class">btn-icon prepaid-icon status-<iaixsl:value-of select="$status_order"/></iaixsl:attribute>
										<iaixsl:choose>
											...
											<iaixsl:when test="$status_order = 'wp'">
												<span><i class="icon-clock"/></span>
												<small>awaiting packaging deadline</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'wr'">
												<span><i class="icon-clock"/></span>
												<small>awaiting collection date</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'wd'">
												<span><i class="icon-clock"/></span>
												<small>awaiting posting deadline</small>
											</iaixsl:when>
								...
								<td>
									<iaixsl:choose>
										<iaixsl:when test="@returns_url">
											<a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@returns_url"/></iaixsl:attribute><span><i class="icon-plus"/></span><small>Select</small></a>
										</iaixsl:when>
										<iaixsl:when test="@rma_url">
											<a class="btn see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@rma_url"/></iaixsl:attribute><span><i class="icon-plus"/></span><small>Select the products to claim</small></a>
										</iaixsl:when>
										<iaixsl:otherwise>
											<a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@orderdetails"/></iaixsl:attribute><span><i class="icon-plus"/></span><small>more</small></a>
										</iaixsl:otherwise>
									</iaixsl:choose>
								</td>
							</tr>
