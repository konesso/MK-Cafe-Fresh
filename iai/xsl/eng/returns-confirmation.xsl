...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (returns_confirmation_cms, 60dd8e77c0c7b5.42258900.2)-->
    ...
    <!-- (returns_confirmation_form, 60dd8e7b94cfc9.15254466.6)-->
                                ...
                                <div class="order2_info1" id="order2_box_1">
                                    <div class="order2_info1_sub">
                                        ...
                                        <iaixsl:if test="page/orderclient/@nip">
                                            VAT Number: <iaixsl:value-of select="page/orderclient/@nip"/><br/>
                                        </iaixsl:if>
                                        e-mail
                                        <iaixsl:value-of select="page/orderclient/@email"/><br/>
                                    </div>

                                    <a class="order2_button_change_address mt-2 mt-sm-0">
                                ...
                                <iaixsl:choose>
                                    <iaixsl:when test="page/pickup">
                                        <h3 class="order2_info1" id="order2_nagl_2a">
                                            Return acceptance point address
                                        </h3>
                                        <div class="order2_info1" id="order2_box_2b">
                                            ...
                                            <a class="order2_button_change_address mt-2 mt-sm-0" target="_blank">
                            ...
                            <table class="order2_table">
                                <tr>
                                    ...
                                    <th class="order2_price">
                                        Unit price <span class="price_vat"> incl. VAT</span>
                                    </th>
                                    <th class="order2_quantity">
                                        Quantity 
                                    </th>
                                    <th class="order2_worth">
                                        Value<span class="price_vat"> incl. VAT</span>
                                    </th>
                                </tr>
                                ...
                                <div class="basketedit_summary_right">
                                    ...
                                    <iaixsl:if test="/shop/page/costs/@value_formatted">
                                        <div class="basketedit_total_summary">
                                            ...
                                            <strong>
                                                <iaixsl:value-of select="/shop/page/costs/@value_formatted"/><span class="price_vat"> incl. VAT</span>
                                            </strong>
                                        </div>
                                    </iaixsl:if>
