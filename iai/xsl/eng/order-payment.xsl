...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (order_payment_creditcard, 60dd8e7de60038.90616607.3)-->
        ...
        <form class="payment_card">
            ...
            <iaixsl:for-each select="page/payform/item">
                <iaixsl:choose>
                    <iaixsl:when test="@name = 'creditCard[system]'">
                        <div class="payment_card_formel cc_wrapper">
                            ...
                            <span class="payment_card_need">
                                <img src="/gfx/standards/need.gif?r=1696937716" class="payment_card_nedd_img"><iaixsl:attribute name="alt">This field is required to make a payment</iaixsl:attribute><iaixsl:attribute name="title">This field is required to place an order</iaixsl:attribute></img>
                                <img src="/gfx/standards/correct.png?r=1696937716" class="payment_card_correct_img" style="display:none;"/><img src="/gfx/standards/incorrect.png?r=1696937716" class="payment_card_wrong_img" style="display:none;"/>
                    ...
                    <iaixsl:when test="@name = 'creditCard[name]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_name" class="payment_card_formel">First and last name:</label>
            ...
            <div class="credit_card_submit">
                <button class="btn --solid --large credit_card_submit disabled" type="submit">
                    <iaixsl:attribute name="title">Make a payment</iaixsl:attribute>
                    Make a payment
                </button>
