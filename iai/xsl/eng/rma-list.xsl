...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (rma_list_cms, 60dd8e7677cbd3.87896906.9)-->
...
<iaixsl:attribute name="class">rma_list_cms_label  big_label</iaixsl:attribute>
    ...
    <!-- (rma_list_data, 61f913c8d54967.47575577.1)-->
                        ...
                        <tbody>
                            <iaixsl:for-each select="/shop/page/rma/item">
                                <tr>
                                        ...
                                        <div>
                                            ...
                                            <iaixsl:choose>
                                                ...
                                                <iaixsl:when test="@status=15">
                                                    <span><i class="icon-clock"/> </span>
                                                    <small>Complaint generated - awaiting store response</small>
                                                </iaixsl:when>
                                                ...
                                                <iaixsl:when test="@status=19">
                                                    <span><i class="icon-ok"/></span>
                                                    <small>Complaint provisionally verified - we are waiting for the claimed products to be sent</small>
                                                </iaixsl:when>
                                                ...
                                                <iaixsl:when test="@status=26">
                                                    <span><i class="icon-ok"/></span>
                                                    <small>Complaint handled positively - Sent new product without waiting for the original</small>
                                                </iaixsl:when>
                                    ...
                                    <td class="ord">
                                        <a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@url"/></iaixsl:attribute><span><i class="icon-plus"/></span><small>Select</small></a>
                                    </td>
                                </tr>
                            </iaixsl:for-each>
                        </tbody>
                ...
                <div class="rma_list_data_outline">
                    ...
                    <div class="rma_list_data_addbutton">
                        <a href="rma-add.php" class="btn --solid --medium rma_list_data_addbutton">
                            ...
                            <iaixsl:attribute name="title"><i class="icon-pencil"/> Add a complaint</iaixsl:attribute>
                            <span class="img_button_edytujaddbutton"/>
                            <div class="addbutton_maintxt"><i class="icon-pencil"/> Add a complaint</div>
                                            ...
                                            <iaixsl:for-each select="page/list/close/item">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="rma_list_item_operation">
                                                        more <i class="icon-angle-down"/>
                                                    </span>
                                                    <span class="rma_list_item_operation ophidden">
                                                        less information <i class="icon-angle-up"/>
                                                    </span>
                                                </div>
                                                                    ...
                                                                    <iaixsl:if test="stock/@link !=''">
                                                                        <div class="rma_list_itemstock_link">
                                                                            <a class="rma_list_itemstock_link">
                                                                                ...
                                                                                more information <i class="icon-double-angle-right"/>
                                                                            </a>
                                                                        </div>
                                                                    </iaixsl:if>
                                                                </div>
                                                            ...
                                                            <div class="rma_list_itembuttons">
                                                                <iaixsl:if test="documents/postdocument ">
                                                                    <a class="btn --solid --medium rma_list_button_etykieta" target="_blank">
                                                                        ...
                                                                        <i class="icon-print"/> Print the address label
                                                                    </a>
                                                                </iaixsl:if>
                                                                <iaixsl:if test="documents/letterofcomplaint">
                                                                    <a class="btn --solid --medium rma_list_button_wydrukuj" target="_blank">
                                                                        ...
                                                                        <i class="icon-print"/> Print the complaint form
                                                                    </a>
                                                                </iaixsl:if>
                                                                <iaixsl:if test="@edit_link and (@edit_link != '')">
                                                                    <a class="btn --solid --medium rma_list_button_edit">
                                                                        ...
                                                                        <i class="icon-pencil"/> Edit the complaint
                                                                    </a>
                                                                </iaixsl:if>
                                                                ...
                                                                <iaixsl:if test="@cancel_link and (@cancel_link != '')">
                                                                    <a class="btn --solid --medium rma_list_button_cancel">
                                                                        ...
                                                                        <i class="icon-remove"/> Cancel the complaint
                                                                    </a>
                                                                </iaixsl:if>
                                                            </div>
                                                        </div>
