        ...
        <iaixsl:if test="page/@display = 'details'">
                        ...
                        <div class="prepaid-status">
                            ...
                            <strong>
                                <iaixsl:choose>
                                    ...
                                    <iaixsl:when test="page/details/@status=2">
                                        Complaint handled positively
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=3">
                                        Complaint rejected
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=4">
                                        Complaint being handled - Product was sent for testing
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=5">
                                        Complaint being handled - Product sent to the producer
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=6">
                                        Complaint being handled - Repair in progress
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=7">
                                        Complaint rejected - No defect has been found
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=8">
                                        Complaint rejected - Defect caused by improper use
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=9">
                                        Complaint rejected - the warranty period has been exceeded
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=10">
                                        Complaint handled positively - Refund - Payment processing
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=11">
                                        Complaint handled positively - Refund - Payout
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=12">
                                        Complaint handled positively - Replacement for a new product
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=13">
                                        Complaint handled positively - Replacement for a different product
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=14">
                                        Complaint has not been delivered
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=15">
                                        Complaint generated - awaiting store response
                                    </iaixsl:when>
                                    ...
                                    <iaixsl:when test="page/details/@status=18">
                                        Complaint canceled by the customer
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=19">
                                        Complaint provisionally verified - we are waiting for the claimed products to be sent
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=20">
                                        Complaint not handled
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=21">
                                    ...
                                    <iaixsl:when test="page/details/@status=25">
                                        Complaint handled positively - Return shipment sent to the customer
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=26">
                                        Complaint handled positively - Sent new product without waiting for the original
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=27">
                                        Complaint handled positively - Recipient's data change on the sales document
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=28">
                                        Complaint being handled - Repair completed
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=29">
                                        Complaint being handled - Requires additional information from the customer
                                    </iaixsl:when>
                                    <iaixsl:when test="page/details/@status=30">
                                        Complaint rejected - Return shipment sent to the customer
                                    </iaixsl:when>
                                </iaixsl:choose>
                            </strong>
                            ...
                            <div class="orderdetails_info__dates">
                                <span>Complaint no: <iaixsl:value-of select="page/details/@id"/></span>
                                <iaixsl:if test="not(page/details/@status_description = '')">
                    ...
                    <div class="orderdetails_documentlink">
                        ...
                        <div class="documentlink_image row">
                            <div class="document_img_1 col-12 col-sm-4">
                                ...
                                <span>Print notification of the complaint and labels</span>
                            </div>
                            ...
                            <div class="document_img_3 col-12 col-sm-4">
                                ...
                                <span>Send the package with the claimed products.</span>
                            </div>
                        </div>
                        <iaixsl:if test="/shop/page/documentlink/@url">
                            <div class="return_wrapper2">
                                <a class="btn --solid --large" target="blank">
                                    ...
                                    Print a complaint notification
                        ...
                        <form class="rma_added_files" method="post" enctype="multipart/form-data">
                            ...
                            <div class="rma_af_input">
                                ...
                                <div class="rma_af_files">
                                    ...
                                    <a href="#addMoreAttachments" class="rma_af_addMoreAttachments">Add another attachment</a>

                                </div>
                                <div class="rma_af_buttons">
                                    <a class="btn --icon-left icon-paperclip rma_attach_file">
                                        Attach photos documenting the defect in the description
                                    </a>
            ...
            <iaixsl:if test="page/returnproducts/products">
                ...
                <div id="return_order_products" class="mb-4 pb-md-1">
                    <h2 class="orderdetails_label"><span>Products in return</span></h2>
			...
			<div class="returnDetails__summarySub">
				<iaixsl:if test="/shop/page/costs/cost[@type='products']/@value_formatted">
					<div class="returnDetails__summaryItem">
						<label>The value of the products in the return: </label>
				...
				<div class="returnDetails__buttons">
					<iaixsl:if test="/shop/page/editlink/@url">
						<a class="btn --solid --large --outline prepaid-edit">
							...
							<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/editlink/@url"/></iaixsl:attribute>Modify return
						</a>
					</iaixsl:if>
					<iaixsl:if test="/shop/page/cancellink/@url">
						<a class="btn --large --outline prepaid-cancel">
							<iaixsl:attribute name="onclick">return confirm(&apos;Cancellation of the return can not be undone. To continue, press "Cancel the complaint&quot;.&gt;&apos;)</iaixsl:attribute>
