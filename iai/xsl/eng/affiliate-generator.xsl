      ...
      <form class="affiliate --generator --content --js px-sm-4 pb-4" method="POST">
        ...
        <div class="f-group">
          <div class="f-feedback">
            ...
            <label for="affiliate__link" class="f-label">Select products which will be visible on the advert.</label>
            <span class="f-control-feedback"/>
            <a href="#check" class="affiliate__button --check btn --solid mt-2">Check products</a>
          </div>
        </div>
        <span class="headline">
          <span class="headline__name">
        ...
        <div class="affiliate__desc mb-2">Customize an advert by setting the display parameters, size and color. To open the toolbox, click on the colorful icon</div>
        <div class="row">
          <div class="col-12 col-md-6">
            <strong class="d-block mb-4">Display options</strong>
            <div class="row">
              <div class="col-12">
                <iaixsl:choose>
                  <iaixsl:when test="count(/shop/language/option) = 1">
                  ...
                  <iaixsl:otherwise>
                    <select class="f-select --small" name="language">
                      <iaixsl:attribute name="data-label">Language: </iaixsl:attribute>
                      <iaixsl:for-each select="/shop/language/option">
                        <option>
                          <iaixsl:attribute name="value"><iaixsl:value-of select="@id"/></iaixsl:attribute>
                          <iaixsl:value-of select="@name"/>
                ...
                <iaixsl:choose>
                  ...
                  <iaixsl:otherwise>
                    <select class="f-select --small" name="currency">
                      <iaixsl:attribute name="data-label">Prices in: </iaixsl:attribute>
                      <iaixsl:for-each select="/shop/currency/option">
                        <option>
                          <iaixsl:attribute name="value"><iaixsl:value-of select="@id"/></iaixsl:attribute>
              ...
              <div class="col-12">
                <select class="f-select --small" name="products_count">
                  <iaixsl:attribute name="data-label">Products quantity: </iaixsl:attribute>
                  <option>
              ...
              <div class="col-12">
                <select class="f-select --small" name="products_uklad">
                  <iaixsl:attribute name="data-label">Products arrangement: </iaixsl:attribute>
                  <option>
                    <iaixsl:attribute name="value">horizontal</iaixsl:attribute>
                    horizontal
                  </option>
                  <option>
                    <iaixsl:attribute name="value">vertical</iaixsl:attribute>
                    vertical
                  </option>
                </select>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small ">
                  ...
                  <label for="banner_width" class="f-label">Width of a single product (px)</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small ">
                  <input id="banner_height" class="f-control" type="text" name="banner_height" value="300"/>
                  <label for="banner_height" class="f-label">Height of a single product (px)</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small ">
                  <input id="image_width" class="f-control" type="text" name="image_width" value="225"/>
                  <label for="image_width" class="f-label">Width of a product image (px)</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small ">
                  <input id="image_height" class="f-control" type="text" name="image_height" value="220"/>
                  <label for="image_height" class="f-label">Height of a product image (px)</label>
                </div>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6">
            <strong class="d-block mb-4">Color scheme</strong>
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="f-group --small --color">
                  <input id="color3" class="f-control" type="text" name="color3" maxlength="7" value="#000000"/>
                  <label for="color3" class="f-label">Product name color</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 align-self-center mb-2 mb-sm-0">
                <div class="f-group --checkbox">
                  ...
                  <label for="nazwa_bold" class="f-label">Bold</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small --color">
                  <input id="color4" class="f-control" type="text" name="color4" maxlength="7" value="#d9592b"/>
                  <label for="color4" class="f-label">Price color</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 align-self-center mb-2 mb-sm-0">
                <div class="f-group --checkbox">
                  <input id="cena_bold" class="f-control" type="checkbox" name="cena_bold"/>
                  <label for="cena_bold" class="f-label">Bold</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small --color">
                  <input id="color5" class="f-control" type="text" name="color5" maxlength="7" value="#8d8d8d"/>
                  <label for="color5" class="f-label">Crossed out price color</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 align-self-center mb-2 mb-sm-0">
                <div class="f-group --checkbox">
                  <input id="cena_promo_bold" class="f-control" type="checkbox" name="cena_promo_bold"/>
                  <label for="cena_promo_bold" class="f-label">Bold</label>
                </div>
              </div>
              <div class="col-12">
                <div class="f-group --radio d-flex align-items-center">
                  <span class="mr-2 d-flex align-items-center ">Frame:</span>
                  <input name="border_radio" class="f-control" type="radio" id="border_radio1" value="nie" checked="checked"/><label for="border_radio1" class="f-label">sun</label>
                  <input name="border_radio" class="f-control" type="radio" id="border_radio2" value="tak"/><label for="border_radio2" class="f-label">yes</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 d-none" id="border_color">
                <div class="f-group --small --color">
                  ...
                  <label for="color1" class="f-label">Frame color</label>
                </div>
              </div>
              <div class="col-12 col-sm-3 d-none" id="border_width">
                <div class="f-group --small ">
                  ...
                  <label for="border_width" class="f-label">Weight (px)</label>
                </div>
              </div>
              <div class="col-12">
                <div class="f-group --radio d-flex align-items-center">
                  <span class="mr-2 d-flex align-items-center ">Background:</span>
                  <input name="background_radio" class="f-control" type="radio" id="background_radio1" value="nie" checked="checked"/><label for="background_radio1" class="f-label">sun</label>
                  <input name="background_radio" class="f-control" type="radio" id="background_radio2" value="tak"/><label for="background_radio2" class="f-label">yes</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 d-none" id="background">
                <div class="f-group --small --color">
                  ...
                  <label for="color2" class="f-label">Background color</label>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="affiliate__desc mb-2">To preview your advert with the selected settings, click on "Advert preview&quot;.</div>
        <a href="#preview" class="affiliate__button --preview btn --solid ">Show advert preview</a>
        ...
        <div class="affiliate__desc mb-2">After clicking on the "Generate JavaScript code" button, the JavaScript code appears. You can copy and paste the code to your website. Click on this button every time you introduce changes to advert settings.</div>
        <div class="f-group">
          <textarea class="f-control" readonly="true" cols="65" rows="4" name="output"/>
        </div>
        <a href="#generate" class="affiliate__button --generate btn --solid">Generate JavaScript code</a>
      </form>
    </section>
</iaixsl:if>
      ...
      <form class="affiliate --generator --content --php px-sm-4 pb-4" method="POST">
        ...
        <div class="f-group">
          <div class="f-feedback">
            ...
            <label for="affiliate__link" class="f-label">Enter the URL to a product list or to a single product card.</label>
            <span class="f-control-feedback"/>
            <a href="#check" class="affiliate__button --check btn --solid mt-2">Check products</a>
          </div>
        </div>
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-3 d-none" id="border_width">
                <div class="f-group --small ">
                  <input id="border_width" class="f-control" type="text" name="border_width" value="1"/>
                  <label for="border_width" class="f-label">Weight </label>
                </div>
              </div>
              <div class="col-12">
                <div class="f-group --radio d-flex align-items-center">
        ...
        <div class="affiliate__desc mb-2">
          <p>After clicking on "Generate PHP code", a sample PHP code appears. You can copy and paste it to your script. You can also freely modify this code.</p>
          <p>This script will download the XML file encoded in UTF-8. To display Polish characters properly, set the appropriate coding in the code input and output. Output encoding must be consistent with the encoding which you use on your website. Default encoding is:</p>
          <ul class="ml-4">
            <li>input (INPUT_ENCODING): UTF-8</li>
            <li>output – displayed on your website (OUTPUT_ENCODING): ISO-8859-2</li>
          </ul>
          <p>This is the appropriate setting for PHP5. For PHP4 and earlier, it is required to set the input encoding to ISO-8859-2. The most popular available coding in PHP is:</p>
          <ul class="ml-4">
            <li>UTF-8</li>
            <li>Windows-1251</li>
            <li>Windows-1252</li>
          ...
          <p>An iconv() function is used for conversion of the received XML, available for PHP from the version 4.0.5. Support of selected characters sets depends on the implementation of iconv() function in your system. Please note that in some systems the iconv() function does not work as expected. In such cases the libiconv library should be installed. For more information about the iconv() function and coding features, go to <a href="http://php.net/"/></p>
        </div>
        <div class="f-group">
          <textarea class="f-control" readonly="true" cols="65" rows="4" name="output"/>
        </div>
        <a href="#generate" class="affiliate__button --generate btn --solid">Generate PHP code</a>
      </form>
    </section>
  </iaixsl:if>
        ...
        <iaixsl:when test="page/generator/rebate_codes/rebate_code">
          ...
          <div class="row mb-4">
            <div class="col-12 col-md-4 affiliate__manual d-flex align-items-center flex-wrap flex-md-nowrap">
              <span>
                <strong class="mb-2">Choose code</strong>
                We provide an individual code, connected with your affiliate account in our shop.
              </span>
            </div>
            <div class="col-12 col-md-4 affiliate__manual d-flex align-items-center flex-wrap flex-md-nowrap">
              <span>
                <strong class="mb-2">Promote discount codes</strong>
                Share a given discount code, for example in social media or on your website.
              </span>
            </div>
            <div class="col-12 col-md-4 affiliate__manual d-flex align-items-center flex-wrap flex-md-nowrap">
              <span>
                <strong class="mb-2">Earn money</strong>
                Part of the amount paid by customers who used this discount code will be returned to your account.
              </span>
            </div>
          </div>
          <div class="affiliate__desc mb-4">Do you want to get money for you and your friends? If yes, just send a discount code to your friends.</div>
          <div class="row mb-4">
                  ...
                  <span class="affiliate__tooltip pb-1 d-block">
                    ...
                    <small class="affiliate__tooltip --content">
                      ...
                      <iaixsl:if test="series/item">
                        <span class="d-block pt-1">On selected series</span>
                      ...
                      <iaixsl:if test="main_cat/item">
                        <span class="d-block pt-1">For selected categories</span>
          ...
          <div class="affiliate__desc mb-4">If you are an experienced developer and you want to adjust a discount code button to your needs, click the button below.</div>
          <div class="f-group">
            <a class="affiliate__button --develop btn --solid --medium" href="#develop"> I AM A DEVELOPER </a>
          </div>
          <form class="affiliate__form --code" method="POST">
            <span class="headline">
              <span class="headline__name">
                Step 1 – Choose a discount code
              </span>
            </span>
            <div class="affiliate__desc mb-4">Below you can find a list of all active discount codes in the affiliate stores</div>
            <div class="row mb-4">
              <div class="col-12 col-sm-6">
                <select class="f-select" name="promo_codes_shop">
                  <iaixsl:attribute name="data-label">Choose shop: </iaixsl:attribute>
                ...
                <select class="f-select" name="promo_codes_code">
                  <iaixsl:attribute name="data-label">Choose code: </iaixsl:attribute>
                ...
                <iaixsl:for-each select="/shop/page/generator/rebate_codes/rebate_code">
                  <div class="rebates_active__wrapper d-sm-flex align-items-sm-center p-2 p-sm-4 mb-2">
                    ...
                    <div class="rebates_active__sub --name">
                      <span class="rebates_active__name">Choosen code:<strong><iaixsl:value-of select="@number"/></strong></span>
                    </div>
                    <div class="rebates_active__sub --info">
                      ...
                      <iaixsl:if test="@max_order &gt; 0 and $max_order_value != ''">
                        <div class="rebates_active__param --max_order">
                          The maximum value of products in a basket: 
              ...
              <div class="col-12 col-md-6">
                ...
                <div class="f-group --radio">
                  <input name="promo_code_radio" class="f-control" type="radio" id="promo_code_radio1" value="0-0" checked="checked"/>
									<label for="promo_code_radio1" class="f-label --text"><a>Text link</a></label>
                </div>
                <div class="f-group --radio">
                  <input name="promo_code_radio" class="f-control" type="radio" id="promo_code_radio2" value="0-1"/>
									<label for="promo_code_radio2" class="f-label --text_icon"><a><i class="icon-tags"/> Text link + icon</a></label>
                </div>
                <div class="f-group --radio">
								...
								<div class="row mb-4">
									<div class="col-12 col-md-6">
										<div class="f-group --small">
											<input id="promo_code_text" class="f-control" type="text" name="promo_code_text">
												<iaixsl:attribute name="value">Click in order to activate the code: %s</iaixsl:attribute>
											</input>
											<label for="promo_code_text" class="f-label">Text on the button</label>
										</div>
									</div>
									<div class="col-12 col-md-6">
										<div class="f-group --small">
											...
											<label for="promo_code_text_size" class="f-label">Text size (px)</label>
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="f-group --color --small">
											<input id="color3" class="f-control" type="text" name="color3" maxlength="7" value="#000000"/>
											<label for="color3" class="f-label">Text color</label>
										</div>
									</div>
									...
									<div class="col-12 col-sm-3 align-self-center mb-2 mb-sm-0">
										<div class="f-group --checkbox">
											...
											<label for="nazwa_radius" class="f-label">Rounding</label>
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="f-group --color --small">
											<input id="color4" class="f-control" type="text" name="color4" maxlength="7" value="#000000"/>
											<label for="color4" class="f-label">Icon color</label>
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="f-group --color --small">
											<input id="color5" class="f-control" type="text" name="color5" maxlength="7" value="#000000"/>
											<label for="color5" class="f-label">Background color</label>
										</div>
									</div>
									<div class="col-12">
										<div class="f-group --radio d-flex flex-wrap flex-sm-nowrap align-items-center">
											<span class="col-12 px-0 col-sm flex-sm-grow-0 mr-2 d-flex align-items-center ">Choose icon:</span>
            ...
            <div class="affiliate__desc mb-4">To preview your discount code button with the selected settings, click on "Show button preview&quot;.</div>
            <a href="#preview" class="affiliate__button --previewCode btn --solid ">Show button preview</a>
	...
	<iaixsl:if test="page/generator/@type='html'">
		<section class="affiliate --generator --content --html px-sm-4 pb-4">
			...
			<div class="row">
				<div class="col-12 col-sm-6">
					<div class="f-group">
						...
						<label for="affiliate__link" class="f-label">Enter www address a customer will be redirected to (example: http://storename.com/)</label>
					</div>
				</div>
				<div class="col-12 col-sm-6">
					<div class="f-group">
						...
						<label for="affiliate__link_name" class="f-label">Enter content of the link (necessary for generating the code as a link)</label>
					</div>
				</div>
			</div>
			<span class="headline">
			...
			<iaixsl:choose>
				...
				<iaixsl:otherwise>
					<div class="affiliate__info">No banners to choose.</div>
				</iaixsl:otherwise>
			</iaixsl:choose>
			<span class="headline">
				<span class="headline__name">
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/eng/envelope.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/eng/affiliate_generator_javascript.js.gzip?r=1696937760"></script><script src="/gfx/eng/affiliate_generator_code.js.gzip?r=1696937760"></script><script src="/gfx/eng/affiliate_generator_html.js.gzip?r=1696937760"></script>
