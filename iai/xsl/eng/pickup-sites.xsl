...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css"/>
			...
			<script src="/gfx/eng/pickup_sites_list.js.gzip?r=1696937760"></script>
...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (pickup_sites_cms, 60dd8e7b11c730.16605429.2)-->
        ...
        <!-- (pickup_sites_list, 61b0b16c48f6f9.34207492.5)-->
		...
		<iaixsl:variable name="requires_client_number">Customer number in the courier system:</iaixsl:variable>
		...
		<script class="ajaxLoad">
			...
			var Holidays = {}; var Holidays_stocks = [];
				...
				<iaixsl:for-each select="page/pickups/selected/pickup">
					...
					&quot;markerIconUrl&quot;: &quot;<iaixsl:value-of select="marker_icon_url"/>&quot;
				</iaixsl:for-each>
			};
		</script>
							...
							<div class="locationField_sub">
								...
								<div id="locationField">
									<input id="autocomplete_location" onFocus="geolocate()" type="text">
									  <iaixsl:attribute name="data-country">
                      <iaixsl:value-of select="/shop/page/pickups/deliveryaddress/@country_long"/>
										</iaixsl:attribute>
									...
									<a class="btn --solid --medium">
										...
										<span class="d-sm-none"><i class="icon-search"/></span>
									</a>
								</div>
							</div>
						</iaixsl:when>
							...
							<div class="asideContainer_pickup">
								...
								<iaixsl:for-each select="page/pickups/*/pickup">
									...
									<label class="pickup_point">
										...
										<iaixsl:attribute name="data-icon"><iaixsl:value-of select="marker_icon_url"/></iaixsl:attribute>
										<div class="pickup_point_sub">
											<iaixsl:choose>
												<iaixsl:when test="marker_icon_url">
													<img>
														<iaixsl:attribute name="src"><iaixsl:value-of select="marker_icon_url"/></iaixsl:attribute>
											...
											<div class="pickup_point_details">
												...
												<iaixsl:if test="requires_client_number/text() = 'true'">
													<input type="text" name="client_courier_number" disabled="true" required="required">
														<iaixsl:attribute name="placeholder">Customer number in the courier system:</iaixsl:attribute>
													</input>
												</iaixsl:if>
												<iaixsl:if test="info">
														...
														<div class="timeText">
															<iaixsl:choose>
																...
																<iaixsl:when test="delivery_time">
																	Preparing the order for personal collection will take 
																	...
																	<iaixsl:if test="delivery_time/@hour  &gt; 0">
																		<iaixsl:value-of select="delivery_time/@hour"/> hours. 
																	</iaixsl:if>
																...
																<iaixsl:when test="delivery_time/@days = '0'">
																	<iaixsl:choose>
																		...
																		<iaixsl:otherwise>
																			Preparing the order for personal collection will take <iaixsl:value-of select="delivery_time/@hour"/>
																			<iaixsl:choose>
																...
																<iaixsl:otherwise>
																	Preparing the order for personal collection will take <iaixsl:value-of select="delivery_time/@days"/>
																	<iaixsl:choose>
																		<iaixsl:when test="delivery_time/@days = '1'">
																			 day
																		</iaixsl:when>
					...
					<label class="pickup_point" required="required" data-id="" data-requires_client_number="" data-longitude="" data-latitude="" for="">
						<div class="pickup_point_sub">
							...
							<div class="pickup_point_details">
								...
								<div class="morePickup"><i class="icon-chevron-down"/></div>
							</div>
