									...
									<li class="filters__item mb-2">
										<div class="f-group --small --checkbox mb-0">
											...
											<label for="filter_nextday_form" class="f-label">
												...
												<span class="--name">
													Następnego dnia <strong>24 hours</strong>
												</span>
											</label>
										</div>
									</li>
	...
	<iaixsl:if test="/shop/page/subscription">
		...
		<div class="subscription_settings">
			...
			<h1 class="headline">
				...
				<iaixsl:variable name="terminatedSubscriptionText">Terminated subscription no. %s</iaixsl:variable>
				<iaixsl:variable name="subscriptionSettingsText">Subscription no. %s settings</iaixsl:variable>
			...
			<div class="subscription_settings__wrapper">
				...
				<iaixsl:if test="$status != 'finished'">
					<div class="subscription_settings__dates">
						<h4 class="subscription_settings__label">Delivery dates</h4>
						<div class="subscription_settings__dates_wrapper">
							<div class="subscription_settings__date --upcoming">
								<span class="subscription_settings__date_label">Nearest:</span>
							...
							<div class="subscription_settings__date --next">
								...
								<span class="subscription_settings__date_label">Another every <span class="subscription_settings__date_label_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/> days</span>:</span>
								<strong class="subscription_settings__date_value">
									<span class="subscription_settings__day_name">
										<iaixsl:choose>
							...
							<iaixsl:if test="/shop/page/subscription/@max_days_number_next_order != 0">
								<div class="subscription_settings__calendar_info">
									<div class="subscription_settings__info --upcoming">
										<h4 class="subscription_settings__label">Date of next delivery</h4>
										<p class="subscription_settings__info_text">You can change the date of the next delivery up to <span class="subscription_settings__info_text_period"><iaixsl:attribute name="data-change-literal-days-up-to"><iaixsl:value-of select="/shop/page/subscription/@max_days_number_next_order"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@max_days_number_next_order"/> days</span> from the date currently set.</p>
									</div>
									<div class="subscription_settings__info --next">
										<h4 class="subscription_settings__label">Date of next delivery and subsequent deliveries</h4>
										<p class="subscription_settings__info_text">All deliveries will be made every <span class="subscription_settings__info_text_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/> days</span> from the date indicated.</p>
									</div>
								</div>
								...
								<div class="subscription_settings__change --upcoming">
									<a href="#changeUpcomingDate" class="subscription_settings__change_link">Change only the date of next delivery</a>
								</div>
								<div class="subscription_settings__change --next">
									<a href="#changeNextDate" class="subscription_settings__change_link">Change the date of the next delivery and subsequent deliveries</a>
								</div>
								<iaixsl:if test="/shop/page/subscription/@next_order_in_progress = 'true' and not($dateNextOrder &gt; $maxNextDate) and not($minNextDate &gt; $maxNextDate)">
									<div class="subscription_settings__disabled_change">
										Order has been shipped, change of dates will be possible after delivery.
									</div>
								</iaixsl:if>
							</iaixsl:if>
						</div>
						<iaixsl:choose>
							...
							<iaixsl:when test="/shop/page/subscription/@max_days_number_next_order != 0">
								<p class="subscription_settings__dates_description">You can change the date of the next delivery up to <span class="subscription_settings__dates_description_period"><iaixsl:attribute name="data-change-literal-days-up-to"><iaixsl:value-of select="/shop/page/subscription/@max_days_number_next_order"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@max_days_number_next_order"/> days</span> from the date currently set. If you change the next delivery date it will move the date of the next payment (applies to the next delivery within this subscription).</p>
							</iaixsl:when>
							<iaixsl:otherwise>
								<p class="subscription_settings__dates_description">The ability to change the delivery date is not available for this subscription.</p>
							</iaixsl:otherwise>
						</iaixsl:choose>
					</div>
				</iaixsl:if>
				...
				<div class="subscription_settings__shipping">
					<h4 class="subscription_settings__label">Delivery address</h4>
							...
							<div class="subscription_settings__address">
								...
								<div class="subscription_settings__address_wrapper">
									...
									<iaixsl:if test="@phone and @phone != ''">
										<span class="subscription_settings__address_item --phone"><span class="subscription_settings__address_phone_txt">phone no: </span><span class="subscription_settings__address_phone_value"><iaixsl:value-of select="@phone"/></span></span>
									</iaixsl:if>
								</div>
					...
					<a href="#addNewAddress" class="subscription_settings__address_add">Add a new address</a>
				</div>
				
				<iaixsl:if test="$status != 'finished'">
					<div class="subscription_settings__payment">
						<h4 class="subscription_settings__label">Payment method</h4>
						<div class="subscription_settings__card">
							...
							<a href="#cancelSubscription" class="subscription_settings__card_edit">Disconnect card</a>
						</div>
					</div>
				</iaixsl:if>
				
				<div class="subscription_settings__delivery_wrapper">
					<h4 class="subscription_settings__label">Delivery method</h4>
					<div class="subscription_settings__delivery">
						...
						<div class="subscription_settings__product_price">
							...
							<span> / every <span class="subscription_settings__product_price_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/> days</span></span>
						</div>
					</div>
				</div>
				
				<div class="subscription_settings__products_wrapper">
					<h4 class="subscription_settings__label">Subscription products</h4>
								...
								<div class="subscription_settings__product_info">
									...
									<div class="subscription_settings__product_details">
										<div class="subscription_settings__product_detail --quantity">
											<span class="subscription_settings__product_detail_name">Quantity:</span>
										...
										<iaixsl:if test="size/@name != '' and size/@id != 'uniw'">
											<div class="subscription_settings__product_detail --size">
												<span class="subscription_settings__product_detail_name">Size:</span>
			...
			<div class="subscription_settings__summary">
				<iaixsl:if test="$status = 'nonpayment'">
					<div class="subscription_settings__message menu_messages_error">
						<p>Wystąpił problem z płatnością. <a><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/contact"/></iaixsl:attribute>Contact the shop staff</a>.</p>
					</div>
				</iaixsl:if>
				<div class="subscription_settings__price">
					...
					<span> / every <span class="subscription_settings__price_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/> days</span></span>
				</div>
				<iaixsl:if test="$status != 'finished'">
				...
				<iaixsl:if test="$status != 'finished'">
					<div class="subscription_settings__payment_date">
						<span class="subscription_settings__payment_date_name">Date of next payment</span>
				...
				<div class="subscription_settings__buttons">
					...
					<a class="subscription_settings__list">
						<iaixsl:choose>
							<iaixsl:when test="$status = 'finished'">
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/subscriptions_terminated/@url"/></iaixsl:attribute>Return to the list of terminated subscriptions
							</iaixsl:when>
							<iaixsl:otherwise>
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/subscriptions_active/@url"/></iaixsl:attribute>Return to the list of active subscriptions
							</iaixsl:otherwise>
						</iaixsl:choose>
					</a>
					<iaixsl:if test="$status != 'finished'">
		...
		<iaixsl:if test="$status != 'finished'">
			<div class="subscription_cancel">
				<h4 class="subscription_cancel__label">Are you sure you want to end your subscription and disconnect your card?</h4>
				<div class="subscription_cancel__description">Once completed, you will not be able to renew it. This will require placing a new order.</div>
				<div class="subscription_cancel__order">
					...
					<span class="subscription_cancel__order_text --first">The next delivery for</span>
				...
				<div class="subscription_cancel__buttons">
					<a href="#abortCancellation" class="subscription_cancel__abort btn --solid --medium">Abort operation</a>
					<a class="subscription_cancel__terminate" data-ignore-status="true"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/subscription/@termination_url"/></iaixsl:attribute>Yes, I want to end my subscription and disconnect my card</a>
				</div>
			</div>
			<template id="subscription_address_form">
				<form class="subscription_address f-group" action="/ajax/client-new.php?addDeliveryAddress=true" method="post">
					...
					<h5 class="subscription_address__label">Delivery address</h5>
				...
				<div class="subscription_settings__address">
					<div class="subscription_settings__address_wrapper">
						...
						<span class="subscription_settings__address_item --phone">
							<span class="subscription_settings__address_phone_txt">phone no: </span><span class="subscription_settings__address_phone_value"><iaixsl:value-of select="@phone"/></span>
						</span>
					</div>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/eng/envelope.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_filter.js.gzip?r=1696937760"></script><script src="/gfx/eng/subscription_settings.js.gzip?r=1696937760"></script>
