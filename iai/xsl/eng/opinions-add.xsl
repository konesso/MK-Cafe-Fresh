...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (opinions_add_aggregator, 60dd8e7e943151.91162670.4)-->
				...
				<div class="notes">
					...
					<iaixsl:for-each select="page/opinions/opinion_order/notes/note">
						<a href="#" class="opinion_star">
							...
							<iaixsl:attribute name="data-rel"><iaixsl:value-of select="@value"/></iaixsl:attribute>
							<iaixsl:attribute name="title">
				...
				<div class="opinion_products__wrapper">
					...
					<div class="opinion_products__block --opinion col-md-8">
						...
						<div class="opinion_products__photo d-md-flex">
							...
							<div class="f-button">
								<button class="btn --medium --solid" type="submit">Send an opinion</button>
							</div>
						</div>
					</div>
				</div>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/eng/envelope.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/eng/opinions_add_aggregator.js.gzip?r=1696937760"></script>
