...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
  ...
  <iaixsl:variable name="affiliate_1">Date of the grant commission</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">Valid from</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">Valid to</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">Your salary</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">Description</iaixsl:variable>
                  ...
                  <iaixsl:variable name="orderid"><iaixsl:choose><iaixsl:when test="@orderid"><iaixsl:value-of select="@orderid"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="@id"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable> 
                    <iaixsl:choose>
                      <iaixsl:when test="@type = 'gd'">
                        Direct salary for the order <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'rd'">
                      Direct salary for the order has been canceled  <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'gi'">
                        Indirect salary for the order <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'ri'">
                        Indirect salary for the order has been canceled <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'gv'">
                        Generated voucher with ID <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'rv'">
                        Blocked voucher with ID <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'gc'">
                        Cash payout has been done 
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'rc'">
                        Cash payout has been rejected 
                      </iaixsl:when>
