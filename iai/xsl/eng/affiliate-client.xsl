...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
  ...
  <iaixsl:variable name="affiliate_1">Order id</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">date of order</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">Date of shipment</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">Order value</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">Products quantity</iaixsl:variable>
  <iaixsl:variable name="affiliate_6">Payment method</iaixsl:variable>
  <iaixsl:variable name="affiliate_7">Status</iaixsl:variable>
  <iaixsl:variable name="affiliate_8">Partner</iaixsl:variable>
  <iaixsl:variable name="affiliate_9">Commission</iaixsl:variable>
