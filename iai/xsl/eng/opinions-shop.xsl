                        ...
                        <strong class="opinions_element_confirmed_text"><iaixsl:choose><iaixsl:when test="@confirmedByPurchase = 'true'">Opinion confirmed by purchase</iaixsl:when><iaixsl:otherwise>Opinion not confirmed by purchase</iaixsl:otherwise></iaixsl:choose></strong>
										...
										<div class="opinions_shop__opinion_bottom d-flex justify-content-between align-items-center flex-wrap">
											...
											<div class="opinions_shop__rate d-flex align-items-center ml-auto mb-2">
												...
												<a href="#thumbs_up" class="opinions_shop__thumbs --up ml-3"><i class="icon-thumbs-up-empty"/> Yes <span class="opinions_shop__rate_count"><iaixsl:value-of select="@rate_yes"/></span></a>
												<a href="#thumbs_down" class="opinions_shop__thumbs --down ml-3"><i class="icon-thumbs-down"/> No <span class="opinions_shop__rate_count"><iaixsl:value-of select="@rate_no"/></span></a>
											</div>
										</div>
            ...
            <div class="opinions_element_confirmed --false">
              <strong class="opinions_element_confirmed_text"/>
					...
					<div class="opinions_shop__opinion_bottom d-flex justify-content-between align-items-center flex-wrap">
						...
						<div class="opinions_shop__rate d-flex align-items-center ml-auto mb-2">
							<span class="opinions_shop__rate_text">Was the opinion helpful?</span>
							<a href="#thumbs_up" class="opinions_shop__thumbs --up ml-3"><i class="icon-thumbs-up-empty"/> Yes <span class="opinions_shop__rate_count"/></a>
							<a href="#thumbs_down" class="opinions_shop__thumbs --down ml-3"><i class="icon-thumbs-down"/> No <span class="opinions_shop__rate_count"/></a>
						</div>
					</div>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/eng/envelope.js.gzip?r=1696937760"></script><script src="/gfx/eng/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/eng/opinions_shop_display.js.gzip?r=1696937760"></script>
