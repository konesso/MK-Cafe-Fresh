			...
			<div class="col-12 col-md-6">
				<section class="order__payments mb-3 mb-md-5">
											...
											<span class="order__payments_names d-flex flex-column mr-2 align-items-md-center flex-md-row">
												<iaixsl:choose>
													<iaixsl:when test="@method_as_group = 'true' or (not(/shop/page/order1/groupList/item[@id = $groupID]) and not(@id = '153'))">
														<iaixsl:choose>
															<iaixsl:when test="@id = '2'">
																<strong class="order__payments_name d-block">Waren Bon</strong>
															</iaixsl:when>
															<iaixsl:when test="@id = '190'">
																<strong class="order__payments_name d-block">Geschenkkarte</strong>
															</iaixsl:when>
															<iaixsl:otherwise>
													...
													<iaixsl:when test="$groupID = 'simple_transfer'">
														<strong class="order__payments_name d-block">Überweisung</strong>
													</iaixsl:when>
													<iaixsl:when test="$groupID = 'transfer'">
														<strong class="order__payments_name d-block">Online-Überweisung</strong>
													</iaixsl:when>
													<iaixsl:when test="$groupID = 'card'">
														<strong class="order__payments_name d-block">Zahlungskarte</strong>
													</iaixsl:when>
													<iaixsl:when test="$groupID = 'installment'">
														<strong class="order__payments_name d-block">Ratenzahlung</strong>
													</iaixsl:when>
													...
													<iaixsl:when test="@id = '153'">
														<strong class="order__payments_name d-block">Handelskreditzahlung</strong>
													</iaixsl:when>
													<iaixsl:otherwise>
					...
					<iaixsl:if test="/shop/basket/groups/group/types/type[@value = 'subscription'] and not(/shop/page/order1/prepaid_methods/item) and not(count(/shop/page/order1/shipping/delivery[@type = 'dvp']) &gt; 0)">
						<div class="order__payments_subscription_info">Die Bezahlung des Abonnements ist nur mit einer Zahlungskarte möglich.</div>
					</iaixsl:if>
				</section>
			</div>
				...
				<section class="order__delivery --normal mb-3 mb-md-5">
												...
												<iaixsl:choose>
													...
													<iaixsl:when test="not(@sameday='true')">
														<iaixsl:choose>
															<iaixsl:when test="@id = '0-1' or @id='0-0'">
																<iaixsl:for-each select="/shop/page/order1/stocks/stock[@selected = 'selected']">
																	<iaixsl:choose>
																		...
																		<iaixsl:otherwise>
																			<span class="order__delivery_desc_item --txt">Ihre Bestellung abholen - </span>
																					...
																					<iaixsl:when test="@pickup_days &gt; 0">
																						<iaixsl:choose>
																							<iaixsl:when test="@pickup_hours &gt; 0">
																								...
																								Versand in <iaixsl:value-of select="@pickup_days + 1"/> Tage 
																							</iaixsl:when>
																							<iaixsl:otherwise>
																								<iaixsl:attribute name="data-pickup_days"><iaixsl:value-of select="@pickup_days"/></iaixsl:attribute>
																								Versand in <iaixsl:value-of select="@pickup_days"/>
																								<iaixsl:choose>
																					...
																					<iaixsl:otherwise>
																						<iaixsl:choose>
																							<iaixsl:when test="@pickup_minutes &gt; 0">
																								Versand in <iaixsl:value-of select="@pickup_hours + 1"/> Stunden. 
																							</iaixsl:when>
																							<iaixsl:otherwise>
																								Versand in <iaixsl:value-of select="@pickup_hours"/>
																								<iaixsl:choose>
															...
															<iaixsl:otherwise>
																<span class="order__delivery_desc_item --txt">Voraussichtliche Lieferung - </span>
																<span class="order__delivery_desc_item --value">
															...
															<strong class="order__delivery_price">
																<iaixsl:choose>
																	<iaixsl:when test="@cost &gt; 0">
																		<iaixsl:if test="@limitfree &gt; 0"><iaixsl:attribute name="title">Von <iaixsl:value-of select="@limitfree_formatted"/> gratis</iaixsl:attribute></iaixsl:if>
					...
					<div class="order__time align-items-center p-2 flex-wrap justify-content-center px-sm-3">
						...
						<div class="order__time_calendar mt-1 mt-sm-0 ml-sm-3">
							<a href="#preferred_delivery_day" class="order__time_btn btn --icon-left icon-clock py-0">Wählen Sie einen anderen Zustelltag</a>
						</div>
					</div>
					...
					<section class="order__delivery --division mb-3 mb-md-5">
						...
						<div class="headline">
							<span class="headline__name --prepaid">
								...
								<span class="headline__name_txt">Lieferoptionen für Produkte verfügbar <span class="headline__division_literal">Versand in </span></span>
								<span class="headline__division_time">
							...
							<span class="headline__name --dvp">
								...
								<span class="headline__name_txt">Nachnahme Lieferoptionen für Produkte verfügbar <span class="headline__division_literal">Versand in </span></span>
								<span class="headline__division_time">
									<iaixsl:attribute name="data-weeks"><iaixsl:value-of select="/shop/basket/shipping_division_time/@week_amount"/></iaixsl:attribute>
									<iaixsl:attribute name="data-days"><iaixsl:value-of select="/shop/basket/shipping_division_time/@days"/></iaixsl:attribute>
									<iaixsl:attribute name="data-week_day"><iaixsl:value-of select="/shop/basket/shipping_division_time/@week_day"/></iaixsl:attribute>
																						...
																						<iaixsl:when test="@pickup_days_division &gt; 0">
																							<iaixsl:choose>
																								<iaixsl:when test="@pickup_hours_division &gt; 0">
																									...
																									Versand in <iaixsl:value-of select="@pickup_days_division + 1"/> Tage 
																								</iaixsl:when>
																								<iaixsl:otherwise>
																									<iaixsl:attribute name="data-pickup_days"><iaixsl:value-of select="@pickup_days_division"/></iaixsl:attribute>
																									Versand in <iaixsl:value-of select="@pickup_days_division"/>
																									<iaixsl:choose>
																						...
																						<iaixsl:otherwise>
																							<iaixsl:choose>
																								<iaixsl:when test="@pickup_minutes_division &gt; 0">
																									Versand in <iaixsl:value-of select="@pickup_hours_division + 1"/> Stunden. 
																								</iaixsl:when>
																								<iaixsl:otherwise>
																									Versand in <iaixsl:value-of select="@pickup_hours_division"/>
																									<iaixsl:choose>
				...
				<iaixsl:if test="/shop/client_data/client_balance/limit/@value &gt; '0'">
					<div class="summary__limits pb-2 mb-2 pb-md-0 mb-md-0">
						...
						<div class="summary__limit --touse d-flex justify-content-between align-items-center">
							<span class="summary__limit_label">Verfügbarer Kreditlimit:</span>
			...
			<div class="summary__sub --right">
				<div class="summary__calculations">
					...
					<div class="summary__calculation --active --shipping">
						<span class="summary__calculation_label">Versand ab:</span>
					...
					<div class="summary__calculation --active --rebate">
						<span class="summary__calculation_label">Rabatt:</span>
					...
					<iaixsl:if test="/shop/client_data/client_balance/balance/@is_selected_and_allowed_order='true' and /shop/client_data/client_balance/balance[@is_selected_and_allowed_order='true']/@value != 0">
						<div class="summary__calculation --active --balance">
							<span class="summary__calculation_label">Per Saldo bezahlt:<br/>(Überzahlungen auf dem Kundenkonto)</span>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/ger/envelope.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/ger/order1.js.gzip?r=1696937760"></script>
