...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (sitemap_tree, 60dd8e84c6f9c6.95387836.4)-->
	
	<iaixsl:variable name="login">Login</iaixsl:variable>
	...
	<iaixsl:variable name="affiliate">VERDIENEN SIE MIT UNS</iaixsl:variable>
	<iaixsl:variable name="rma">REKLAMATIONSABTEILUNG (RMA)</iaixsl:variable>
	

	<section id="Sitemap" class="sitemap_tree">
		<h1 class="headline">
			<span class="headline__name">Seitmap</span>
		</h1>

		
		<iaixsl:for-each select="page/sitemap/item[@id='mainpage' or @id='searchpage' or @id='clientpage']">
			<div class="sitemap_tree__wrapper">
				<iaixsl:attribute name="class">sitemap_tree__wrapper --<iaixsl:value-of select="@id"/></iaixsl:attribute>
				<iaixsl:choose>
					<iaixsl:when test="@id='mainpage'">
						<label class="sitemap_tree__label">Informationen</label>
					</iaixsl:when>
					<iaixsl:when test="@id='searchpage'">
						<label class="sitemap_tree__label">Sortiment</label>
					</iaixsl:when>
					<iaixsl:otherwise>
						<label class="sitemap_tree__label">Kundenkonto</label>
					</iaixsl:otherwise>
				</iaixsl:choose>
				<ul class="sitemap_tree__list --nav">
					<iaixsl:for-each select="item">
						<li class="sitemap_tree__item --nav">
							<a class="sitemap_tree__link --nav">
								<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
								<iaixsl:choose>
									<iaixsl:when test="../@id='clientpage'">
										<iaixsl:choose>
		...
		<iaixsl:for-each select="page/sitemap/item/item[@id='producers' or @id='series']">
			<div class="sitemap_tree__wrapper">
				<iaixsl:attribute name="class">sitemap_tree__wrapper --<iaixsl:value-of select="@id"/></iaixsl:attribute>
				<label class="sitemap_tree__label"><iaixsl:value-of select="@name"/></label>
				<ul class="sitemap_tree__list --nav">
					<iaixsl:for-each select="item">
						<li class="sitemap_tree__item --nav">
							<a class="sitemap_tree__link --nav">
		...
		<iaixsl:if test="page/sitemap/item/item/@id='traits'">
			<div class="sitemap_tree__wrapper --traits">
				<label class="sitemap_tree__label"><iaixsl:value-of select="page/sitemap/item/item[@id='traits']/@name"/></label>
				<ul class="sitemap_tree__list --nav">
					<iaixsl:for-each select="page/sitemap/item/item[@id='traits']/item">
						<li class="sitemap_tree__item --nav">
							<a class="sitemap_tree__link --nav"><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute><iaixsl:value-of select="@name"/></a>
								<iaixsl:if test="item">
									<ul class="sitemap_tree__list --subnav">
										<iaixsl:for-each select="item">
											<li class="sitemap_tree__item --subnav">
												<a class="sitemap_tree__link --subnav"><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute><iaixsl:value-of select="@name"/></a>
											</li>
										</iaixsl:for-each>
									</ul>
								</iaixsl:if>
		...
		<iaixsl:for-each select="page/sitemap/item/item[@id='tree1' or @id='tree2' or @id='categories']">
			<div class="sitemap_tree__wrapper">
				<iaixsl:attribute name="class">sitemap_tree__wrapper --<iaixsl:value-of select="@id"/></iaixsl:attribute>
				<label class="sitemap_tree__label"><iaixsl:value-of select="@name"/></label>
				<ul class="sitemap_tree__list --nav">
							...
							<iaixsl:if test="item">
								<ul class="sitemap_tree__list --subnav">
									<iaixsl:for-each select="item">
										...
										<a class="sitemap_tree__link --subnav"><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute><iaixsl:value-of select="@name"/></a>
											<iaixsl:if test="item">
												<ul class="sitemap_tree__list --subsubnav">
													<iaixsl:for-each select="item">
														<li class="sitemap_tree__item --subsubnav">
														<a class="sitemap_tree__link --subsubnav"><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute><iaixsl:value-of select="@name"/></a>
															<iaixsl:if test="item">
																<ul class="sitemap_tree__list --subsubsubnav">
																	<iaixsl:for-each select="item">
																		<li class="sitemap_tree__item --subsubsubnav">
																			<a class="sitemap_tree__link --subsubsubnav"><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute><iaixsl:value-of select="@name"/></a>
																		</li>
																	</iaixsl:for-each>
																</ul>
															</iaixsl:if>
