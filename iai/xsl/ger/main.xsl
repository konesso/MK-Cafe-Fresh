						...
						<h2>
								...
								<iaixsl:when test="/shop/integrations/instagram/@headline_own = 'true'">
    								<a class="headline" target="blank">
    								  ...
    								  <iaixsl:attribute name="title">@wir auf Instagram</iaixsl:attribute>
    								  @wir auf Instagram
    								</a>
								</iaixsl:when>
								<iaixsl:otherwise>
                  <span class="headline" target="blank">
    									<iaixsl:choose>
    										...
    										<iaixsl:otherwise>
    										  <a class="headlin__name" target="blank">
    								        <iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="/shop/integrations/instagram/@profile_url"/></iaixsl:attribute>
    								        <iaixsl:attribute name="title">@<iaixsl:value-of select="/shop/integrations/instagram/@profile_name"/> auf Instagram</iaixsl:attribute>
    											  @<iaixsl:value-of select="/shop/integrations/instagram/@profile_name"/> auf Instagram
    											</a>
    											<a class="headline__after" target="blank">
														<iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="/shop/integrations/instagram/@profile_url"/></iaixsl:attribute>
														<iaixsl:attribute name="title">Schau dir unser Profil auf Instagram an</iaixsl:attribute>
