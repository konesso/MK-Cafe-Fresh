...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (product_stocks_cms, 60dd8e7652f465.93282684.9)-->
    ...
    <!-- (product_stocks_list, 614c5cf17f9072.72506872.2)-->
			<div id="product_stocks_list">
				...
				<div class="product_stocks_list_productinfo product_wrapper">
					...
					<iaixsl:variable name="var_size_min_formatted"><iaixsl:choose><iaixsl:when test="not($nettoPrice = '')"><iaixsl:value-of select="/shop/page/product/price/@size_min_net_formatted"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="/shop/page/product/price/@size_min_formatted"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
					<iaixsl:variable name="var_size_max_formatted"><iaixsl:choose><iaixsl:when test="not($nettoPrice = '')"><iaixsl:value-of select="/shop/page/product/price/@size_max_net_formatted"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="/shop/page/product/price/@size_max_formatted"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
					<iaixsl:variable name="var_points"><iaixsl:value-of select="/shop/page/product/price/@points"/></iaixsl:variable>
					<iaixsl:variable name="var_value"><iaixsl:choose><iaixsl:when test="not($nettoPrice = '')"><iaixsl:value-of select="/shop/page/product/price/@price_net"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="/shop/page/product/price/@value"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
					<iaixsl:variable name="var_price_formatted"><iaixsl:choose><iaixsl:when test="not($nettoPrice = '')"><iaixsl:value-of select="/shop/page/product/price/@price_net_formatted"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="/shop/page/product/price/@price_formatted"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
					<iaixsl:variable name="var_maxprice_formatted"><iaixsl:choose><iaixsl:when test="not($nettoPrice = '')"><iaixsl:value-of select="/shop/page/product/price/@maxprice_net_formatted"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="/shop/page/product/price/@maxprice_formatted"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
													...
													<b>
														<iaixsl:choose>
															<iaixsl:when test="available/@status = 'enable'">
																<i class="icon-check"/> Verfügbar 
															</iaixsl:when>
															<iaixsl:when test="available/@status = 'disable'">
																<i class="icon-remove"/> Nicht verfügbar 
															</iaixsl:when>
															<iaixsl:when test="available/@status = 'order'">
																<i class="icon-clock"/> Auf Kundenbestellung
															</iaixsl:when>
														</iaixsl:choose>
													</b>
													<div class="icon_next">
