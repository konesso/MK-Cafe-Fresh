	...
	<iaixsl:if test="/shop/page/subscription">
		...
		<div class="subscription_settings">
			...
			<h1 class="headline">
				...
				<iaixsl:variable name="terminatedSubscriptionText">Abonnement gekündigt Nr. %s</iaixsl:variable>
				<iaixsl:variable name="subscriptionSettingsText">Einstellungen des Abonnements Nr. %s</iaixsl:variable>
			...
			<div class="subscription_settings__wrapper">
				...
				<iaixsl:if test="$status != 'finished'">
					<div class="subscription_settings__dates">
						<h4 class="subscription_settings__label">Liefertermine</h4>
						<div class="subscription_settings__dates_wrapper">
							<div class="subscription_settings__date --upcoming">
								<span class="subscription_settings__date_label">Nächstgelegene:</span>
							...
							<div class="subscription_settings__date --next">
								...
								<span class="subscription_settings__date_label">Eine weitere alle <span class="subscription_settings__date_label_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/> Tage</span>:</span>
								<strong class="subscription_settings__date_value">
									<span class="subscription_settings__day_name">
										<iaixsl:choose>
							...
							<iaixsl:if test="/shop/page/subscription/@max_days_number_next_order != 0">
								<div class="subscription_settings__calendar_info">
									<div class="subscription_settings__info --upcoming">
										<h4 class="subscription_settings__label">Datum der nächsten Lieferung</h4>
										<p class="subscription_settings__info_text">Sie können das Datum der nächsten Lieferung bis zu <span class="subscription_settings__info_text_period"><iaixsl:attribute name="data-change-literal-days-up-to"><iaixsl:value-of select="/shop/page/subscription/@max_days_number_next_order"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@max_days_number_next_order"/> Tage</span> nach dem aktuell eingestellten Datum ändern.</p>
									</div>
									<div class="subscription_settings__info --next">
										<h4 class="subscription_settings__label">Datum der nächsten Lieferung und der Folgelieferungen</h4>
										<p class="subscription_settings__info_text">Alle Lieferungen erfolgen alle <span class="subscription_settings__info_text_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/> Tage</span> ab dem angegebenen Datum.</p>
									</div>
								</div>
								...
								<div class="subscription_settings__change --upcoming">
									<a href="#changeUpcomingDate" class="subscription_settings__change_link">Ändern Sie nur das Datum der nächsten Lieferung</a>
								</div>
								<div class="subscription_settings__change --next">
									<a href="#changeNextDate" class="subscription_settings__change_link">Ändern Sie das Datum der nächsten Lieferung und der Folgelieferungen</a>
								</div>
								<iaixsl:if test="/shop/page/subscription/@next_order_in_progress = 'true' and not($dateNextOrder &gt; $maxNextDate) and not($minNextDate &gt; $maxNextDate)">
									<div class="subscription_settings__disabled_change">
										Die Bestellung wurde versandt, Terminänderungen sind nach der Lieferung möglich.
									</div>
								</iaixsl:if>
							</iaixsl:if>
						</div>
						<iaixsl:choose>
							...
							<iaixsl:when test="/shop/page/subscription/@max_days_number_next_order != 0">
								<p class="subscription_settings__dates_description">Sie können das Datum der nächsten Lieferung bis zu <span class="subscription_settings__dates_description_period"><iaixsl:attribute name="data-change-literal-days-up-to"><iaixsl:value-of select="/shop/page/subscription/@max_days_number_next_order"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@max_days_number_next_order"/> Tage</span> nach dem aktuell eingestellten Datum ändern. Wenn Sie das Datum der nächsten Lieferung ändern, verschiebt sich auch das Datum der nächsten Zahlung (gilt für die nächste Lieferung innerhalb dieses Abonnements).</p>
							</iaixsl:when>
							<iaixsl:otherwise>
								<p class="subscription_settings__dates_description">Die Möglichkeit, das Lieferdatum zu ändern, ist für dieses Abonnement nicht verfügbar.</p>
							</iaixsl:otherwise>
						</iaixsl:choose>
					</div>
				</iaixsl:if>
				...
				<div class="subscription_settings__shipping">
					<h4 class="subscription_settings__label">Lieferadresse</h4>
							...
							<div class="subscription_settings__address">
								...
								<div class="subscription_settings__address_wrapper">
									...
									<iaixsl:if test="@phone and @phone != ''">
										<span class="subscription_settings__address_item --phone"><span class="subscription_settings__address_phone_txt">Telefonnummer: </span><span class="subscription_settings__address_phone_value"><iaixsl:value-of select="@phone"/></span></span>
									</iaixsl:if>
								</div>
								
								<iaixsl:if test="@editable = 'yes'">
									<a href="#addressEdit" class="subscription_settings__address_edit">Edit</a>
								</iaixsl:if>
							</div>
						</iaixsl:for-each>
					</div>
					<a href="#addNewAddress" class="subscription_settings__address_add">Neue Adresse hinzufügen</a>
				</div>
				
				<iaixsl:if test="$status != 'finished'">
					<div class="subscription_settings__payment">
						<h4 class="subscription_settings__label">Zahlung</h4>
						<div class="subscription_settings__card">
							...
							<a href="#cancelSubscription" class="subscription_settings__card_edit">Karte abtrennen</a>
						</div>
					</div>
				</iaixsl:if>
				
				<div class="subscription_settings__delivery_wrapper">
					<h4 class="subscription_settings__label">Liefermethode</h4>
					<div class="subscription_settings__delivery">
						...
						<div class="subscription_settings__product_price">
							...
							<span> / alle <span class="subscription_settings__product_price_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/> Tage</span></span>
						</div>
					</div>
				</div>
				
				<div class="subscription_settings__products_wrapper">
					<h4 class="subscription_settings__label">Produkte im Abonnement</h4>
								...
								<div class="subscription_settings__product_info">
									...
									<div class="subscription_settings__product_details">
										<div class="subscription_settings__product_detail --quantity">
											<span class="subscription_settings__product_detail_name">Menge:</span>
										...
										<iaixsl:if test="size/@name != '' and size/@id != 'uniw'">
											<div class="subscription_settings__product_detail --size">
												<span class="subscription_settings__product_detail_name">Größe:</span>
			...
			<div class="subscription_settings__summary">
				<iaixsl:if test="$status = 'nonpayment'">
					<div class="subscription_settings__message menu_messages_error">
						<p>Wystąpił problem z płatnością. <a><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/contact"/></iaixsl:attribute>Kontaktieren Sie den Shopservice</a>.</p>
					</div>
				</iaixsl:if>
				<div class="subscription_settings__price">
					...
					<span> / alle <span class="subscription_settings__price_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/> Tage</span></span>
				</div>
				<iaixsl:if test="$status != 'finished'">
				...
				<iaixsl:if test="$status != 'finished'">
					<div class="subscription_settings__payment_date">
						<span class="subscription_settings__payment_date_name">Datum der nächsten Zahlung</span>
				...
				<div class="subscription_settings__buttons">
					...
					<a class="subscription_settings__list">
						<iaixsl:choose>
							<iaixsl:when test="$status = 'finished'">
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/subscriptions_terminated/@url"/></iaixsl:attribute>Zurück zur Liste der beendeten Abonnements
							</iaixsl:when>
							<iaixsl:otherwise>
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/subscriptions_active/@url"/></iaixsl:attribute>Zurück zur Liste der aktiven Abonnements
							</iaixsl:otherwise>
						</iaixsl:choose>
					</a>
					<iaixsl:if test="$status != 'finished'">
		...
		<iaixsl:if test="$status != 'finished'">
			<div class="subscription_cancel">
				<h4 class="subscription_cancel__label">Sind Sie sicher, dass Sie Ihr Abonnement beenden und Ihre Karte abmelden möchten?</h4>
				<div class="subscription_cancel__description">Einmal abgeschlossen, können Sie ihn nicht mehr verlängern. Dazu müssen Sie eine neue Bestellung aufgeben.</div>
				<div class="subscription_cancel__order">
					...
					<span class="subscription_cancel__order_text --first">Die nächste Lieferung für</span>
				...
				<div class="subscription_cancel__buttons">
					<a href="#abortCancellation" class="subscription_cancel__abort btn --solid --medium">Abbrechen der Aktion</a>
					<a class="subscription_cancel__terminate" data-ignore-status="true"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/subscription/@termination_url"/></iaixsl:attribute>Ja, ich möchte mein Abonnement beenden und meine Karte abmelden</a>
				</div>
			</div>
			<template id="subscription_address_form">
				<form class="subscription_address f-group" action="/ajax/client-new.php?addDeliveryAddress=true" method="post">
					...
					<h5 class="subscription_address__label">Lieferadresse</h5>
				...
				<div class="subscription_settings__address">
					<div class="subscription_settings__address_wrapper">
						...
						<span class="subscription_settings__address_item --phone">
							<span class="subscription_settings__address_phone_txt">Telefonnummer: </span><span class="subscription_settings__address_phone_value"><iaixsl:value-of select="@phone"/></span>
						</span>
					</div>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/ger/envelope.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_filter.js.gzip?r=1696937760"></script><script src="/gfx/ger/subscription_settings.js.gzip?r=1696937760"></script>
