  ...
  <iaixsl:if test="page/generator">
	...
	<section class="affiliate --generator --menu px-sm-4 pb-sm-4">
		...
		<iaixsl:if test="page/generator/@type='html' or page/generator/@type='js' or page/generator/@type='php'">
			...
			<iaixsl:choose>
				<iaixsl:when test="page/generator/@type='html'">Folgender Generator dient zur Erstellung eines HTML-Codes, den Sie kopieren und auf Ihre Seite einfügen können. Auf diese Weise erstellen Sie einen Banner, der zur Seite unseres Shops führt. Wird ein Kunde durch das Anklicken des Banners unsere Seite besuchen und während der Sitzung ein Konto erstellen und eine Bestellung aufgeben, oder zumindest ein Konto eröffnen, werden Sie von seinen Bestellungen profitieren.</iaixsl:when>
				<iaixsl:when test="page/generator/@type='js'">Folgender Generator dient zur Erstellung eines JavaScript-Codes, den Sie kopieren und auf Ihre Seite einfügen können. Auf diese Weise erstellen Sie einen Banner, der zur Seite unseres Shops führt. Wird ein Kunde durch das Anklicken des Banners unsere Seite besuchen und während der Sitzung ein Konto erstellen und eine Bestellung aufgeben, oder zumindest ein Konto eröffnen, werden Sie von seinen Bestellungen profitieren.</iaixsl:when>
				<iaixsl:when test="page/generator/@type='php'">Folgender Generator dient zur Erstellung eines PHP-Codes, den Sie kopieren und auf Ihre Seite einfügen können. Auf diese Weise erstellen Sie einen Banner, der zur Seite unseres Shops führt. Wird ein Kunde durch das Anklicken des Banners unsere Seite besuchen und während der Sitzung ein Konto erstellen und eine Bestellung aufgeben, oder zumindest ein Konto eröffnen, werden Sie von seinen Bestellungen profitieren.</iaixsl:when>
			</iaixsl:choose>
			</div>
		</iaixsl:if>
	</section>
      ...
      <form class="affiliate --generator --content --js px-sm-4 pb-4" method="POST">
        ...
        <div class="f-group">
          <div class="f-feedback">
            ...
            <label for="affiliate__link" class="f-label">Geben Sie die URL zu den Produkten ein, die in der Werbung erscheinen sollen.</label>
            <span class="f-control-feedback"/>
            <a href="#check" class="affiliate__button --check btn --solid mt-2">Produkte prüfen</a>
          </div>
        </div>
        <span class="headline">
          <span class="headline__name">
        ...
        <div class="affiliate__desc mb-2">Passen Sie das Aussehen der Werbung an, indem Sie die Anzeigeparameter, die Größe und die Farbgebung einstellen. Um den Farbwähler zu öffnen, klicken Sie auf das bunte Symbol</div>
        <div class="row">
          <div class="col-12 col-md-6">
            <strong class="d-block mb-4">Anzeigeeinstellungen</strong>
            <div class="row">
              <div class="col-12">
                <iaixsl:choose>
                  <iaixsl:when test="count(/shop/language/option) = 1">
                  ...
                  <iaixsl:otherwise>
                    <select class="f-select --small" name="language">
                      <iaixsl:attribute name="data-label">Sprache: </iaixsl:attribute>
                      <iaixsl:for-each select="/shop/language/option">
                        <option>
                          <iaixsl:attribute name="value"><iaixsl:value-of select="@id"/></iaixsl:attribute>
                          <iaixsl:value-of select="@name"/>
                ...
                <iaixsl:choose>
                  ...
                  <iaixsl:otherwise>
                    <select class="f-select --small" name="currency">
                      <iaixsl:attribute name="data-label">Währung: </iaixsl:attribute>
                      <iaixsl:for-each select="/shop/currency/option">
                        <option>
                          <iaixsl:attribute name="value"><iaixsl:value-of select="@id"/></iaixsl:attribute>
              ...
              <div class="col-12">
                <select class="f-select --small" name="products_count">
                  <iaixsl:attribute name="data-label">Anzahl der Produkte: </iaixsl:attribute>
                  <option>
              ...
              <div class="col-12">
                <select class="f-select --small" name="products_uklad">
                  <iaixsl:attribute name="data-label">Anordnung der Produkte: </iaixsl:attribute>
                  <option>
                    <iaixsl:attribute name="value">horizontal</iaixsl:attribute>
                    horizontal
                  </option>
                  <option>
                    <iaixsl:attribute name="value">vertikal</iaixsl:attribute>
                    vertikal
                  </option>
                </select>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small ">
                  ...
                  <label for="banner_width" class="f-label">Breite eines Produkts (px)</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small ">
                  <input id="banner_height" class="f-control" type="text" name="banner_height" value="300"/>
                  <label for="banner_height" class="f-label">Höhe eines Produkts (px)</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small ">
                  <input id="image_width" class="f-control" type="text" name="image_width" value="225"/>
                  <label for="image_width" class="f-label">Breites Grafikprodukt (px)</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small ">
                  <input id="image_height" class="f-control" type="text" name="image_height" value="220"/>
                  <label for="image_height" class="f-label">Höhe Grafikprodukt (px)</label>
                </div>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6">
            <strong class="d-block mb-4">Farbgebung</strong>
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="f-group --small --color">
                  <input id="color3" class="f-control" type="text" name="color3" maxlength="7" value="#000000"/>
                  <label for="color3" class="f-label">Farbe des Produktnamens</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 align-self-center mb-2 mb-sm-0">
                <div class="f-group --checkbox">
                  ...
                  <label for="nazwa_bold" class="f-label">Fettschrift</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small --color">
                  <input id="color4" class="f-control" type="text" name="color4" maxlength="7" value="#d9592b"/>
                  <label for="color4" class="f-label">Farbe des Preises</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 align-self-center mb-2 mb-sm-0">
                <div class="f-group --checkbox">
                  <input id="cena_bold" class="f-control" type="checkbox" name="cena_bold"/>
                  <label for="cena_bold" class="f-label">Fettschrift</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small --color">
                  <input id="color5" class="f-control" type="text" name="color5" maxlength="7" value="#8d8d8d"/>
                  <label for="color5" class="f-label">Farbe des durchgeschtrichenen Preises</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 align-self-center mb-2 mb-sm-0">
                <div class="f-group --checkbox">
                  <input id="cena_promo_bold" class="f-control" type="checkbox" name="cena_promo_bold"/>
                  <label for="cena_promo_bold" class="f-label">Fettschrift</label>
                </div>
              </div>
              <div class="col-12">
                <div class="f-group --radio d-flex align-items-center">
                  <span class="mr-2 d-flex align-items-center ">Rahmen:</span>
                  <input name="border_radio" class="f-control" type="radio" id="border_radio1" value="nie" checked="checked"/><label for="border_radio1" class="f-label">son</label>
                  <input name="border_radio" class="f-control" type="radio" id="border_radio2" value="tak"/><label for="border_radio2" class="f-label">ja</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 d-none" id="border_color">
                <div class="f-group --small --color">
                  ...
                  <label for="color1" class="f-label">Farbe des Rahmens</label>
                </div>
              </div>
              <div class="col-12 col-sm-3 d-none" id="border_width">
                <div class="f-group --small ">
                  ...
                  <label for="border_width" class="f-label">Dicke (px)</label>
                </div>
              </div>
              <div class="col-12">
                <div class="f-group --radio d-flex align-items-center">
                  <span class="mr-2 d-flex align-items-center ">Hintergrund:</span>
                  <input name="background_radio" class="f-control" type="radio" id="background_radio1" value="nie" checked="checked"/><label for="background_radio1" class="f-label">son</label>
                  <input name="background_radio" class="f-control" type="radio" id="background_radio2" value="tak"/><label for="background_radio2" class="f-label">ja</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 d-none" id="background">
                <div class="f-group --small --color">
                  ...
                  <label for="color2" class="f-label">Hintergrundfarbe</label>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="affiliate__desc mb-2">Um zu prüfen, wie die Werbung mit den obigen Einstellungen aussehen wird, klicken Sie auf die Schaltfläche "Vorschau der Werbung anzeigen&quot;.</div>
        <a href="#preview" class="affiliate__button --preview btn --solid ">Vorschau der Werbung anzeigen</a>
        ...
        <div class="affiliate__desc mb-2">Nach dem Anklicken der Schaltfläche "JavaScript-Code generieren" erscheint ein JavaScript-Code, den Sie kopieren und auf Ihre Seite einfügen können. Klicken Sie auf diese Schaltfläche jedes Mal, nachdem Sie Ihre Werbungseinstellungen geändert haben.</div>
        <div class="f-group">
          <textarea class="f-control" readonly="true" cols="65" rows="4" name="output"/>
        </div>
        <a href="#generate" class="affiliate__button --generate btn --solid">JavaScriptcode generieren</a>
      </form>
    </section>
</iaixsl:if>
      ...
      <form class="affiliate --generator --content --php px-sm-4 pb-4" method="POST">
        ...
        <div class="f-group">
          <div class="f-feedback">
            ...
            <label for="affiliate__link" class="f-label">Geben Sie die URL zur Produktliste oder zur Karte des einzelnen Produkts an.</label>
            <span class="f-control-feedback"/>
            <a href="#check" class="affiliate__button --check btn --solid mt-2">Produkte prüfen</a>
          </div>
        </div>
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-3 d-none" id="border_width">
                <div class="f-group --small ">
                  <input id="border_width" class="f-control" type="text" name="border_width" value="1"/>
                  <label for="border_width" class="f-label">Dicke </label>
                </div>
              </div>
              <div class="col-12">
                <div class="f-group --radio d-flex align-items-center">
        ...
        <div class="affiliate__desc mb-2">
          <p>Nach dem Anklicken der Schaltfläche "PHP-Code generieren" erscheint ein PHP-Code, den Sie kopieren und in Ihr Script einfügen können. Sie können den Code beliebig ändern.</p>
          <p>Das Script wird im Format UTF-8 codiert. Das Script wird den in UTF-8 kodierten XML herunterladen. Damit die deutschen Zeichen richtig gezeigt werden, stellen Sie im Code die entsprechende Ein- und Ausgangskodierung ein. Die Ausgangskodierung muss mit der Kodierung übereinstimmen, die Sie auf Ihrer Seite benutzen. Standardmäßig definiert ist:</p>
          <ul class="ml-4">
          ...
          <p>Diese Einstellung ist für PHP5 geeignet. Im Falle von PHP4 und vorherigen Versionen soll die Eingangskodierung auf ISO-8859-2 gesetzt werden. Zu den meist verbreiteten Kodierungen in PHP gehören:</p>
          <ul class="ml-4">
            <li>UTF-8</li>
            <li>Windows-1251</li>
            <li>Windows-1252</li>
          ...
          <p>Zur Konversion dazu enthaltene xml werden in der Funktion iconv() verwendet, erhältlich für PHP ab der Version 4.0.5. Bedienungen den bestimmten Zeichenvorrat ist von der Umsetzung der inconv()in Ihrem System abhängig. Bitte beachten Sie, dass die Funktion in einigen Systemen, nicht wie erwartet funktioniert. In solchen Fällen soll man die libiconv Bibliothek installieren. Mehr Informationen zum Thema iconv und Kodierung finden Sie hier <a href="http://php.net/"/></p>
        </div>
        <div class="f-group">
          <textarea class="f-control" readonly="true" cols="65" rows="4" name="output"/>
        </div>
        <a href="#generate" class="affiliate__button --generate btn --solid">PHP-Code generieren</a>
      </form>
    </section>
  </iaixsl:if>
    ...
    <section class="affiliate --generator --content --code px-sm-4 pb-4">
      ...
      <iaixsl:choose>
        <iaixsl:when test="page/generator/rebate_codes/rebate_code">
          <div class="affiliate__desc mb-4">Das Verdienen mit Codes kostet Sie nichts, es erfordert nur Ihr Engagement und Ihre Zeit, die Sie in die Werbung investieren werden.<br/>Sprawdź jak jest to proste i zacznij zarabiać pieniądze. </div>
          <div class="row mb-4">
            <div class="col-12 col-md-4 affiliate__manual d-flex align-items-center flex-wrap flex-md-nowrap">
              <span>
                <strong class="mb-2">Kode auswählen</strong>
                Wir stellen Ihnen einen individuellen Kode, der mit Ihrem Partnerkonto in unserem Geschäft verbunden ist.
              </span>
            </div>
            <div class="col-12 col-md-4 affiliate__manual d-flex align-items-center flex-wrap flex-md-nowrap">
              <span>
                <strong class="mb-2">Rabattkodes bewerben</strong>
                Sharen Sie den ausgewählten Kode, z.B. auf sozialen Netzwerken oder auf Ihrer Webseite.
              </span>
            </div>
            <div class="col-12 col-md-4 affiliate__manual d-flex align-items-center flex-wrap flex-md-nowrap">
              <span>
                <strong class="mb-2">Geld verdienen</strong>
                Auf Ihr Konto kehrt ein Teil der von Kunden, die diesen Rabattkode verwendet haben, eingezahlten Summe zurück.
              </span>
            </div>
          </div>
          <div class="affiliate__desc mb-4">Sie möchten eine unglaubliche finanzielle Vergütung für sich und Ihre Freunde erhalten? Lautet die Antwort „ja“, dann kopieren Sie den Rabattkode und schicken Sie ihn Ihren Bekannten.</div>
          <div class="row mb-4">
                  ...
                  <span class="affiliate__tooltip pb-1 d-block">
                    ...
                    <small class="affiliate__tooltip --content">
                      ...
                      <iaixsl:if test="series/item">
                        <span class="d-block pt-1">Auf ausgewählten Serien</span>
                      ...
                      <iaixsl:if test="main_cat/item">
                        <span class="d-block pt-1">Für ausgewählte Kategorien</span>
          ...
          <div class="affiliate__desc mb-4">Wenn Sie ein erfahrener Programmist sind und die Anpassungsmöglichkeiten des Buttons mit dem Rabattkode erweitern möchten, klicken Sie den Button unten.</div>
          <div class="f-group">
            <a class="affiliate__button --develop btn --solid --medium" href="#develop"> Ich bin ein Programmist</a>
          </div>
          <form class="affiliate__form --code" method="POST">
            ...
            <div class="affiliate__desc mb-4">Unten befindet sich eine Liste aller in Geschäften, die am Partnerprogramm teilnehmen, aktiven  Sonderangebotskodes</div>
            <div class="row mb-4">
              <div class="col-12 col-sm-6">
                <select class="f-select" name="promo_codes_shop">
                  <iaixsl:attribute name="data-label">Geschäft auswählen: </iaixsl:attribute>
                ...
                <select class="f-select" name="promo_codes_code">
                  <iaixsl:attribute name="data-label">Kode auswählen: </iaixsl:attribute>
                ...
                <iaixsl:for-each select="/shop/page/generator/rebate_codes/rebate_code">
                  <div class="rebates_active__wrapper d-sm-flex align-items-sm-center p-2 p-sm-4 mb-2">
                    ...
                    <div class="rebates_active__sub --name">
                      <span class="rebates_active__name">Ausgewählter Kode:<strong><iaixsl:value-of select="@number"/></strong></span>
                    </div>
                    <div class="rebates_active__sub --info">
                      ...
                      <iaixsl:if test="@max_order &gt; 0 and $max_order_value != ''">
                        <div class="rebates_active__param --max_order">
                          Der maximale Wert der Produkte im Warenkorb: 
              ...
              <div class="col-12 col-md-6">
                ...
                <div class="f-group --radio">
                  <input name="promo_code_radio" class="f-control" type="radio" id="promo_code_radio1" value="0-0" checked="checked"/>
									<label for="promo_code_radio1" class="f-label --text"><a>Textlink</a></label>
                </div>
                <div class="f-group --radio">
                  <input name="promo_code_radio" class="f-control" type="radio" id="promo_code_radio2" value="0-1"/>
									<label for="promo_code_radio2" class="f-label --text_icon"><a><i class="icon-tags"/> Textlink + Icon</a></label>
                </div>
                <div class="f-group --radio">
                  <input name="promo_code_radio" class="f-control" type="radio" id="promo_code_radio3" value="1-0"/>
									<label for="promo_code_radio3" class="f-label --button"><a class="btn --solid">Button</a></label>
                </div>
                <div class="f-group --radio">
                  <input name="promo_code_radio" class="f-control" type="radio" id="promo_code_radio4" value="1-1"/>
									<label for="promo_code_radio4" class="f-label --button_icon"><a class="btn --solid"><i class="icon-tags"/> Button + Icon</a></label>
                </div>
              </div>
              <div class="col-12 col-md-6">
                <span class="headline">
								...
								<div class="row mb-4">
									<div class="col-12 col-md-6">
										<div class="f-group --small">
											<input id="promo_code_text" class="f-control" type="text" name="promo_code_text">
												<iaixsl:attribute name="value">Anklicken, um den Kode zu aktivieren: %s</iaixsl:attribute>
											</input>
											<label for="promo_code_text" class="f-label">Text auf dem Button</label>
										</div>
									</div>
									<div class="col-12 col-md-6">
										<div class="f-group --small">
											...
											<label for="promo_code_text_size" class="f-label">Textgröße (px)</label>
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="f-group --color --small">
											<input id="color3" class="f-control" type="text" name="color3" maxlength="7" value="#000000"/>
											<label for="color3" class="f-label">Textfarbe</label>
										</div>
									</div>
									...
									<div class="col-12 col-sm-3 align-self-center mb-2 mb-sm-0">
										<div class="f-group --checkbox">
											...
											<label for="nazwa_radius" class="f-label">Rundung</label>
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="f-group --color --small">
											<input id="color4" class="f-control" type="text" name="color4" maxlength="7" value="#000000"/>
											<label for="color4" class="f-label">Icon-Farbe</label>
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="f-group --color --small">
											<input id="color5" class="f-control" type="text" name="color5" maxlength="7" value="#000000"/>
											<label for="color5" class="f-label">Hintergrundfarbe</label>
										</div>
									</div>
									<div class="col-12">
										<div class="f-group --radio d-flex flex-wrap flex-sm-nowrap align-items-center">
											<span class="col-12 px-0 col-sm flex-sm-grow-0 mr-2 d-flex align-items-center ">Icon auswählen:</span>
            ...
            <div class="affiliate__desc mb-4">Klicken Sie auf "Vorschau der Schaltflächen anzeigen", um eine Vorschau Ihrer Rabattcode-Schaltfläche mit den ausgewählten Einstellungen anzuzeigen&quot;.</div>
            <a href="#preview" class="affiliate__button --previewCode btn --solid ">Vorschau der Schaltflächen anzeigen</a>
	...
	<iaixsl:if test="page/generator/@type='html'">
		<section class="affiliate --generator --content --html px-sm-4 pb-4">
			...
			<div class="row">
				<div class="col-12 col-sm-6">
					<div class="f-group">
						...
						<label for="affiliate__link" class="f-label">Geben Sie die URL der Seite ein, auf die der Kunde geleitet wird (Beispiel: http://shopname.de/)</label>
					</div>
				</div>
				<div class="col-12 col-sm-6">
					<div class="f-group">
						...
						<label for="affiliate__link_name" class="f-label">Geben Sie den Inhalt des Verweiszeichens ein (unbediengt, wenn der Code als Verweiszeichen generiert wird)</label>
					</div>
				</div>
			</div>
			<span class="headline">
			...
			<iaixsl:choose>
				...
				<iaixsl:otherwise>
					<div class="affiliate__info">Keine Banner zur Auswahl.</div>
				</iaixsl:otherwise>
			</iaixsl:choose>
			<span class="headline">
				<span class="headline__name">
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/ger/envelope.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/ger/affiliate_generator_javascript.js.gzip?r=1696937760"></script><script src="/gfx/ger/affiliate_generator_code.js.gzip?r=1696937760"></script><script src="/gfx/ger/affiliate_generator_html.js.gzip?r=1696937760"></script>
