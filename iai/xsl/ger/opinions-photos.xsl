...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (opinions_photos_display, 60dd8e876d5374.77837218.5)-->
		<iaixsl:choose>
		<iaixsl:when test="count(page/opinions-photos/opinions/opinion[@image_small or @image_large]) &gt; 0">
			...
			<div id="opinions">
				...
				<p class="opinions-description">
					Möchten Sie Ihr Foto hinzufügen? Sie können dies tun, indem Sie eine Bewertung schreiben und Ihr Foto zu einem der Produkte hinzufügen. Um solche Produkte schneller zu finden, verwenden Sie bitte <a href="/products-bought.php">Liste der gekauften Produkte</a>.
					<iaixsl:if test="page/opinions-photos/opinions/@product_photo_loyalty_points">
					<br/>

						Sie erhalten von uns für jede Meinung ein Foto <iaixsl:value-of select="page/opinions-photos/opinions/@product_photo_loyalty_points"/> 
						Punkt. im Treueprogramm.</iaixsl:if>
		...
		<iaixsl:otherwise>
			<div id="opinions" class="d-flex flex-column align-items-center --empty">
				<div class="opinions_icon_wrapper"><i class="icon-opinions-empty"/></div>
				...
				<p class="opinions-description">
					...
					Fügen Sie Ihrer Bewertung eines Produkts ein Bild hinzu. Um solche Produkte schneller zu finden, verwenden Sie bitte <a href="/products-bought.php">Liste der gekauften Produkte</a>.
					<iaixsl:if test="false">
					
					<br/>
						Sie erhalten von uns für jede Meinung ein Foto %s
						Punkt. im Treueprogramm.</iaixsl:if> 
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/ger/envelope.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/ger/opinions_photos_display.js.gzip?r=1696937760"></script>
