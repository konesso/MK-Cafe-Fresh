...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (affiliate_calculations_list, 60dd8e83cac149.65539594.2)-->
  <iaixsl:variable name="affiliate_1">Datum der Provisionsbewilligung</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">Gültig ab</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">Gültig bis</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">Ihre Vergütung</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">Beschreibung</iaixsl:variable>
  <iaixsl:if test="page/calculations">
    ...
    <iaixsl:choose>
      <iaixsl:when test="count(page/calculations/payment)">
        <section class="affiliate --calculations mb-4">
          <div class="affiliate__desc mb-4">
            ...
            <ol class="pl-5">
              <li>
                ...
                <strong class="affiliate_calculations__total"><iaixsl:value-of select="page/payments/@total_formatted"/></strong>
              </li>
              <li>  
                Gesamtsumme der reduzierten Provisionen aus Warenrückgaben: 
                <strong class="affiliate_calculations__returned"><iaixsl:value-of select="page/payments/@returns_formatted"/></strong>           
              </li>
            </ol>
          ...
          <div class="affiliate__table --five table">
            ...
            <iaixsl:for-each select="page/calculations/payment">
              <div class="table__row mb-5 mb-md-0 p-3 p-md-0">
                ...
                <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_2"/></span><iaixsl:value-of select="@available_from"/></span>
                <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_3"/></span><iaixsl:value-of select="@valid_until"/></span>
                <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_4"/></span><iaixsl:if test="not(0 &gt; @value)">+</iaixsl:if><iaixsl:value-of select="@value_formatted"/></span>
                <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_5"/></span>
                  <iaixsl:variable name="orderid"><iaixsl:choose><iaixsl:when test="@orderid"><iaixsl:value-of select="@orderid"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="@id"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable> 
                    <iaixsl:choose>
                      <iaixsl:when test="@type = 'gd'">
                        Direkte Vergütung für die Bestellung <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'rd'">
                      Direkte Vergütung für die Bestellung wurde annulliert  <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'gi'">
                        Indirekte Vergütung für die Bestellung <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'ri'">
                        Indirekte Vergütung für die Bestellung wurde annulliert <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'gv'">
                        Ein Gutschein mit der folgenden Nummer wurde erstellt <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'rv'">
                        Der Gutschein mit der folgenden Nummer wurde gesperrt <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'gc'">
                        Das Bargeld wurde ausgezahlt 
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'rc'">
                        Die Barauszahlung wurde abgelehnt 
                      </iaixsl:when>
...
<!-- (affiliate_calculations_paging, 60dd8e7f07d1f0.26319465.3)-->
