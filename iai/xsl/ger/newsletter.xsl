                                        ...
                                        <form action="/settings.php" method="post" class="newsletter_form row flex-column align-items-center">
                                            ...
                                            <iaixsl:choose>
                                                <iaixsl:when test="$account_email_info">
                                                    <p class="col-md-6 col-12">Sie haben unseren Newsletter bereits abonniert. Auf Ihr Konto E-Mail-Adresse zugeordnet ist <b><iaixsl:value-of select="/shop/page/client/@email"/></b>. Sie können den Newsletter-Service jederzeit abbstellen, indem Sie auf die folgende Schaltfläche klicken.</p>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
