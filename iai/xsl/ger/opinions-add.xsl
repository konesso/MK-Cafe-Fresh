				...
				<div class="opinion_products__wrapper">
					...
					<div class="opinion_products__block --opinion col-md-8">
						...
						<div class="opinion_products__photo d-md-flex">
							...
							<div class="f-button">
								<button class="btn --medium --solid" type="submit">Bewertung abschicken</button>
							</div>
						</div>
					</div>
				</div>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/ger/envelope.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/ger/opinions_add_aggregator.js.gzip?r=1696937760"></script>
