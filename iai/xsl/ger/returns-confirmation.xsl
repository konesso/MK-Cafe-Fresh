                            ...
                            <table class="order2_table">
                                <tr>
                                    ...
                                    <th class="order2_worth">
                                        Preis<span class="price_vat"> inkl. MwSt</span>
                                    </th>
                                </tr>
                                ...
                                <div class="basketedit_summary_right">
                                    ...
                                    <iaixsl:if test="/shop/page/costs/@value_formatted">
                                        <div class="basketedit_total_summary">
                                            ...
                                            <strong>
                                                <iaixsl:value-of select="/shop/page/costs/@value_formatted"/><span class="price_vat"> inkl. MwSt</span>
                                            </strong>
                                        </div>
                                    </iaixsl:if>
