...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (orders_rebates, 60dd8e784f94d0.59397576.1)-->
   ...
   <!-- (client-orders, 61f913c6db4cb5.94540049.5)-->
	...
	<div class="client_order">
		<iaixsl:choose>
			<iaixsl:when test="page/orders/@mode = 'rma'">
				...
				<div class="progress__item --rma --first d-md-none --active py-3">
							<div class="progress__icons">
								<div class="progress__icon --mobile d-md-none">
									<span class="progress__step"><strong>1</strong><span>/6</span></span>
									<svg class="progress__svg"><circle class="progress__circle_back"/><circle class="progress__circle"/></svg>
								</div>
							</div>
							<div class="progress__text">
								<strong class="progress__name">Bitte wählen Sie die Bestellung aus von welcher Sie die Ware zurückgeben möchten</strong>
							</div>
						</div>
				<div class="client_order__labelWrapper my-2">
					<h1 class="big_label d-none d-md-block">
						Wählen Sie den Auftrag, aus dem Sie Waren reklamieren möchten
					</h1>
					<div>
						<span class="progress__listIcon"/>
						<a href="client-orders.php?display=closed"><iaixsl:if test="/shop/action/clientOrders/@url"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientOrders/@url"/>?display=closed</iaixsl:attribute></iaixsl:if>Die Liste der bereits abgeschlossenen Bestellungen</a>
					</div>
				</div>

        <div class="progress__rmaHelper">
          <span class="progress__iconRMA"/> Ein praktischer Assistent führt Sie Schritt für Schritt durch den Prozess.
        </div>
			...
			<iaixsl:when test="page/orders/@mode = 'returns'">
				<div class="progress_bar_wrapper pb_step1">
					...
					<div class="_step _step3">
						...
						<p>
							<i/>
							<b>auswählen</b> Warenrücksendungen
						</p>
					</div>
					<div class="_step _step4">
						<span>4</span>
					...
					<div class="_step _step5">
						...
						<p>
							<i/>
							<b>auswählen</b> Wiederherstellung
						</p>
					</div>
					<div class="_step _step6">
						<span>6</span>
				...
				<div class="progress__item --rma --first d-md-none --active py-3">
							...
							<div class="progress__text">
								<strong class="progress__name">Bitte wählen Sie die Bestellung aus, aus der Sie einen oder mehrere Artikel zurücksenden möchten</strong>
							</div>
						</div>
				<div class="client_order__labelWrapper my-2">
					<h1 class="big_label d-none d-md-block">
			...
			<iaixsl:when test="page/orders/@mode = 'closed'">
				<div class="client_order__labelWrapper my-2">
					...
					<div>
            <span class="progress__listIcon"/>
            <a href="client-orders.php?display=opened"><iaixsl:if test="/shop/action/clientOrders/@url"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientOrders/@url"/>?display=opened</iaixsl:attribute></iaixsl:if>Die Liste der offenen Bestellungen</a>
          </div>
				</div>
			</iaixsl:when>
			<iaixsl:otherwise>
		...
		<iaixsl:choose>
			<iaixsl:when test="/shop/page/orders/item">
				...
				<table class="orders" cellspacing="0" cellpadding="0">
					<iaixsl:attribute name="class">ui-responsive table-stroke ui-table ui-table-reflow orders<iaixsl:if test="page/orders/@mode = 'rma'"> --rma_list</iaixsl:if></iaixsl:attribute>
					<thead>
						<tr>
							<th id="orders_th1">
								Bestellungs-ID
						...
						<iaixsl:for-each select="/shop/page/orders/item">
							...
							<tr>
								...
								<td>
									...
									<td class="rma__price">
										<b><iaixsl:value-of select="@cost_formatted"/></b>
									</td>
									<td class="rma__status">
										<iaixsl:choose>
									...
									<div><iaixsl:attribute name="class">btn-icon prepaid-icon status-<iaixsl:value-of select="$status_order"/></iaixsl:attribute>
										<iaixsl:choose>
											...
											<iaixsl:when test="$status_order = 't'">
												<span><iaixsl:choose><iaixsl:when test="@personal_collection = 'yes'"><i class="icon-box"/></iaixsl:when><iaixsl:otherwise><i class="icon-truck"/> </iaixsl:otherwise></iaixsl:choose></span>
											...
											<iaixsl:when test="$status_order = 'i'">
												<span><i class="icon-remove"/></span>
												<small>Bestellung abgelehnt</small>
											</iaixsl:when>
											...
											<iaixsl:when test="$status_order = 'z'">
												<span><i class="icon-back"/></span>
												<small>die Rückgabe</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'h'">
												<span><i class="icon-pause"/></span>
											...
											<iaixsl:when test="$status_order = 'j'">
												<span><i class="icon-paperclip"/></span>
												<small>gebündelt</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'a'">
												<span><i class="icon-calendar"/></span>
												<small>in Bearbeitung</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'b'">
												<span><i class="icon-box"/></span>
												<small>wird gepackt</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'wp'">
												<span><i class="icon-clock"/></span>
												<small>warten auf die Verpackungsfrist</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'wr'">
												<span><i class="icon-clock"/></span>
												<small>abholtermin steht noch aus</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'wd'">
												<span><i class="icon-clock"/></span>
												<small>warten auf den Abgabetermin</small>
											</iaixsl:when>
								...
								<td>
									<iaixsl:choose>
										<iaixsl:when test="@returns_url">
											<a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@returns_url"/></iaixsl:attribute><span><i class="icon-plus"/></span><small>auswählen</small></a>
										</iaixsl:when>
										<iaixsl:when test="@rma_url">
											<a class="btn see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@rma_url"/></iaixsl:attribute><span><i class="icon-plus"/></span><small>Wählen Sie die zu beanspruchenden Waren aus</small></a>
										</iaixsl:when>
										<iaixsl:otherwise>
											<a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@orderdetails"/></iaixsl:attribute><span><i class="icon-plus"/></span><small>mehr</small></a>
										</iaixsl:otherwise>
									</iaixsl:choose>
								</td>
							</tr>
...
<!-- (client_orders_paging, 60dd8e7fa8b092.52997174.4)-->
        <iaixsl:variable name="prev_page"/>
        <iaixsl:variable name="next_page">Nächste Seite</iaixsl:variable>

        <iaixsl:if test="page/orders/navigation/@total &gt; page/orders/navigation/@portions">
