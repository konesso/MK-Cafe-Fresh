...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (shoppinglist_manage, 61f913c9037c60.97603384.8)-->
	...
	<iaixsl:variable name="var_net_gross_prices"/>
	<section class="shopping_list mb-5">
		<iaixsl:if test="not(/shop/page/@is_owner = 'true')">
			<iaixsl:attribute name="data-is_owner">false</iaixsl:attribute>
		</iaixsl:if>
		<iaixsl:attribute name="data-list_id"><iaixsl:value-of select="/shop/page/list/@id"/></iaixsl:attribute>
		<div class="shopping_list__block --header sl_header d-flex align-items-center justify-content-between mb-2 justify-content-md-start mb-3">
			<h2 class="sl_header__headline headline px-0 py-2 m-0 mr-2">
				<span class="headline__name" data-list_name="true"><iaixsl:value-of disable-output-escaping="yes" select="/shop/page/list/@name"/></span>
			</h2>
			<span class="sl_header__total d-none d-md-block mr-md-2">
				<span class="sl_header__total_before">(Anzahl der Produkte: </span>
				<span class="sl_header__total_count" data-list_count="true"><iaixsl:value-of select="/shop/page/list/@count"/></span>
				<span class="sl_header__total_after">)</span>
			</span>
			<div class="sl_header__options ml-md-auto">
				<a href="#mobileOptions" class="sl_header__mobile d-md-none"/>
				<a href="#share" class="sl_header__share d-none d-md-flex align-items-md-center">Diese Liste teilen</a>
			</div>
		</div>
		<div class="shopping_list__block --settings sl_settings d-flex mx-n1 mx-md-n2">
			<div class="sl_settings__item --group px-1 px-md-2">
				<a href="#groupEdit" class="sl_settings__group d-block">
					<span class="sl_settings__group_button --mobile d-flex align-items-center btn --outline --large --icon-left mb-2 mb-sm-3 d-md-none">Gruppenbearbeitung</span>
					<span class="sl_settings__group_button --desktop btn --outline --icon-left mb-2 d-none mb-sm-3 d-md-inline-block">Gruppenbearbeitung</span>
				</a>
			</div>
			<iaixsl:if test="/shop/page/navigation/@sort">
				<form class="sl_settings__item --sort px-0 col-sm-4 px-sm-1 col-md-auto px-md-2" action="/settings.php">
					<span class="sl_settings__label --sort">Sortieren</span>
					<select class="sl_settings__select --sort --small-md" name="sort_order">
						<option value="name-a">Sortieren nach Name aufsteigend</option>
						<option value="name-d">Sortieren nach Name absteigend</option>
						<option value="price-a">Sortieren nach Preis aufsteigend</option>
						<option value="price-d">Sortieren nach Preis absteigend</option>
						<option value="date-a">Sortieren nach Datum aufsteigend</option>
						<option value="date-d">Sortieren nach Datum absteigend</option>
					</select>
				</form>
			</iaixsl:if>
			<iaixsl:if test="/shop/page/navigation/category">
				<form class="sl_settings__item --category px-0 col-sm-4 px-sm-1 col-md-auto px-md-2" action="/settings.php">
					<span class="sl_settings__label --category">Kategorie</span>
					<select class="sl_settings__select --category --small-md --placeholder" name="category">
						<option>Wählen Sie eine Kategorie</option>
						<iaixsl:for-each select="/shop/page/navigation/category">
			...
			<div class="sl_settings__item --view d-flex ml-auto align-items-center mb-2 mb-sm-3 px-1 px-md-2">
				<span class="sl_settings__label --view">Ansicht</span>
				<div class="sl_settings__view d-flex">
					<a href="#gallery" class="sl_settings__view_link --gallery --active btn --outline p-1 d-flex align-items-center justify-content-center ml-2"/>
					<a href="#list" class="sl_settings__view_link --list btn --outline p-1 d-flex align-items-center justify-content-center ml-2"/>
				</div>
			</div>
		</div>
		<div class="shopping_list__block --products sl_products row">
			<iaixsl:for-each select="/shop/page/products-list/product">
				<iaixsl:variable name="product_id"><iaixsl:value-of select="@id"/></iaixsl:variable>
				<iaixsl:variable name="product_size"><iaixsl:value-of select="sizes/size/@type"/></iaixsl:variable>
				<iaixsl:variable name="product_sellby"><iaixsl:value-of select="sizes/@unit_sellby"/></iaixsl:variable>
				<div class="sl_products__product col-6 py-3 col-md-4 py-lg-4">
					<iaixsl:if test="@product_type = 'product_bundle' or @product_type = 'product_configurable'">
						<iaixsl:attribute name="data-bundle">true</iaixsl:attribute>
					</iaixsl:if>
					<iaixsl:if test="sizes/size[1]/availability/@status = 'disable' or (not($var_net_prices = '') and price/@price_net = 0) or ($var_net_prices = '' and price/@value = 0)">
						<iaixsl:attribute name="data-disabled">true</iaixsl:attribute>
					</iaixsl:if>
					<iaixsl:attribute name="data-product_id"><iaixsl:value-of select="$product_id"/></iaixsl:attribute>
					<iaixsl:attribute name="data-product_size"><iaixsl:value-of select="$product_size"/></iaixsl:attribute>
					<iaixsl:attribute name="data-sellby"><iaixsl:value-of select="$product_sellby"/></iaixsl:attribute>
					<iaixsl:choose>
						<iaixsl:when test="/shop/basket/product[@id = $product_id and size/@type = $product_size]">
							<iaixsl:attribute name="data-set_quantity"><iaixsl:value-of select="/shop/basket/product[@id = $product_id and size/@type = $product_size]/size/@ordered + $product_sellby"/></iaixsl:attribute>
							<iaixsl:attribute name="data-additional"><iaixsl:value-of select="/shop/basket/product[@id = $product_id and size/@type = $product_size]/additional/@hash"/></iaixsl:attribute>
						</iaixsl:when>
						<iaixsl:otherwise>
							<iaixsl:attribute name="data-set_quantity"><iaixsl:value-of select="$product_sellby"/></iaixsl:attribute>
						</iaixsl:otherwise>
					</iaixsl:choose>
					<div class="sl_products__item --top">
						<div class="sl_products__select f-group --checkbox">
							<input type="checkbox" class="f-control sl_products__select_input">
								<iaixsl:attribute name="id">checkboxSelect<iaixsl:value-of select="position()"/></iaixsl:attribute>
							</input>
							<label class="sl_products__select_label f-label">
								<iaixsl:attribute name="for">checkboxSelect<iaixsl:value-of select="position()"/></iaixsl:attribute>
							</label>
						</div>
						<iaixsl:if test="/shop/page/@is_owner = 'true'">
							<div class="sl_products__remove --top">
								<a href="#remove" class="sl_products__link --remove">
									<iaixsl:attribute name="title">Klicken Sie, um ein Produkt aus dieser Liste zu entfernen</iaixsl:attribute>
								</a>
							</div>
						</iaixsl:if>
						<a class="sl_products__icon d-flex justify-content-center align-items-center">
							<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
              <iaixsl:choose>
                <iaixsl:when test="icon_second and not(icon_second = '' or icon_second = '/')">
                  <picture>
                    ...
                    <img src="/gfx/standards/loader.gif?r=1696937716" class="b-lazy">
                      <iaixsl:attribute name="data-src-small"><iaixsl:value-of disable-output-escaping="yes" select="icon_small_second"/></iaixsl:attribute>
                      <iaixsl:attribute name="data-src"><iaixsl:value-of disable-output-escaping="yes" select="icon_second"/></iaixsl:attribute>
                      <iaixsl:attribute name="alt"><iaixsl:value-of disable-output-escaping="yes" select="name"/></iaixsl:attribute>
                    </img>                    
                  </picture>
                </iaixsl:when>
                    ...
                    <iaixsl:attribute name="alt"><iaixsl:value-of disable-output-escaping="yes" select="name"/></iaixsl:attribute>
							...
							<iaixsl:if test="sizes/size[1]/availability/@status = 'disable' or (not($var_net_prices = '') and price/@price_net = 0) or ($var_net_prices = '' and price/@value = 0)">
								<strong class="label_icons">
									<span class="label --disable">Ausverkauft</span>
								</strong>
							</iaixsl:if>
						</a>
					</div>
					<h3 class="sl_products__item --name">
						<a class="sl_products__name d-block">
							<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
							<span class="sl_products__name_txt"><iaixsl:value-of disable-output-escaping="yes" select="name"/></span>
							<iaixsl:if test="not(sizes/size[1]/@type = 'uniw')">
								<span class="sl_products__param --size"><iaixsl:value-of select="sizes/size/@description"/></span>
							</iaixsl:if>
							<iaixsl:if test="versions and not(versions/@name = '')">
								<span class="sl_products__param --version"><iaixsl:value-of select="versions/version[@id = $product_id]/@name"/></span>
							</iaixsl:if>
						</a>
					</h3>
					<div class="sl_products__item --prices">
						<iaixsl:choose>
							<iaixsl:when test="$var_net_prices and not($var_net_prices = '')">
								<iaixsl:choose>
									<iaixsl:when test="price/@price_net = 0">
										<a class="sl_products__price --phone" href="/contact.php">Preis auf Anfrage</a>
									</iaixsl:when>
									<iaixsl:otherwise>
										<strong class="sl_products__price --main --net"><iaixsl:value-of select="price/@price_net_formatted"/><span class="sl_products__vat --net"><iaixsl:value-of select="$var_net_prices"/></span></strong>
										<iaixsl:if test="$var_net_gross_prices and not($var_net_gross_prices = '')">
											<strong class="sl_products__price --gross"><iaixsl:value-of select="price/@price_formatted"/><span class="sl_products__vat --gross"><iaixsl:value-of select="$var_net_gross_prices"/></span></strong>
										</iaixsl:if>
									</iaixsl:otherwise>
								</iaixsl:choose>
							</iaixsl:when>
							<iaixsl:otherwise>
								<iaixsl:choose>
									...
									<iaixsl:otherwise>
										<strong class="sl_products__price --main"><iaixsl:value-of select="price/@price_formatted"/></strong>
									</iaixsl:otherwise>
								</iaixsl:choose>
							</iaixsl:otherwise>
						</iaixsl:choose>
					</div>
					<div class="sl_products__item --actions">
						<iaixsl:if test="/shop/page/@is_owner = 'true'">
							<div class="sl_products__move">
								<a href="#move" class="sl_products__link --move btn --outline p-1 d-flex align-items-center justify-content-center">
									<iaixsl:attribute name="title">Klicken Sie auf, um ein Produkt in eine andere Liste zu verschieben/zu kopieren</iaixsl:attribute>
								</a>
								<div class="sl_products__move_options p-4 px-sm-0 p-md-3">
									<a href="#close" class="sl_products__option --close d-none align-items-center d-md-flex"/>
									<a href="#move" class="sl_products__option --move d-flex align-items-center mb-2">In eine andere Liste verschieben</a>
									<a href="#copy" class="sl_products__option --copy d-flex align-items-center">In eine andere Liste kopieren</a>
								</div>
							</div>
						</iaixsl:if>
						<iaixsl:choose>
							<iaixsl:when test="@product_type = 'product_bundle' or @product_type = 'product_configurable'">
								<a href="#card" class="sl_products__card btn --solid --secondary">
									<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
									<iaixsl:attribute name="title">Klicken Sie, um zur Produktkarte zu gelangen</iaixsl:attribute>
									Zur Produktkarte
								</a>
							</iaixsl:when>
							<iaixsl:otherwise>
								<div class="sl_products__buy_wrapper">
									<div class="sl_products__number_wrapper">
										<button class="sl_products__number_down" type="button">-</button>
										<input class="sl_products__quantity" type="number" name="number">
											<iaixsl:if test="sizes/size/availability/@status = 'disable'">
											...
											<iaixsl:attribute name="data-amount"><iaixsl:value-of select="sizes/size/@amount"/></iaixsl:attribute>
											<iaixsl:attribute name="value">
												<iaixsl:choose>
													<iaixsl:when test="/shop/basket/product[@id = $product_id and size/@type = $product_size]">
														<iaixsl:value-of select="/shop/basket/product[@id = $product_id and size/@type = $product_size]/size/@ordered"/>
													</iaixsl:when>
													<iaixsl:otherwise>0</iaixsl:otherwise>
												</iaixsl:choose>
											</iaixsl:attribute>
										...
										<button class="sl_products__number_up" type="button">+</button>
									</div>
									<a href="#buy" class="sl_products__buy btn --solid">
										<iaixsl:attribute name="title">Klicken Sie hier, um es in den Warenkorb zu legen</iaixsl:attribute>
										In den Warenkorb
									</a>
								</div>
							</iaixsl:otherwise>
						...
						<iaixsl:if test="/shop/page/@is_owner = 'true'">
							<div class="sl_products__remove --actions">
								<a href="#remove" class="sl_products__link --remove">
									<iaixsl:attribute name="title">Klicken Sie, um ein Produkt aus dieser Liste zu entfernen</iaixsl:attribute>
								</a>
							</div>
		...
		<div class="shopping_list__block --footer sl_footer">
			<div class="sl_footer__wrapper row flex-nowrap mx-sm-0 py-md-3">
				<div class="sl_footer__item --select f-group --checkbox col-3 align-self-center pl-sm-0 col-md-auto ">
					<input type="checkbox" class="f-control sl_footer__all" id="checkboxSelectAll"/>
					<label for="checkboxSelectAll" class="sl_footer__label f-label p-0 d-flex flex-column align-items-center justify-content-center d-md-block">Alle auswählen</label>
				</div>
				<iaixsl:if test="/shop/page/@is_owner = 'true'">
					<div class="sl_footer__item --move col-3 col-md-auto">
						<a href="#move" class="sl_footer__link --move d-flex flex-column align-items-center justify-content-center flex-md-row">
							<iaixsl:attribute name="title">Klicken Sie auf , um ausgewählte Produkte in eine andere Liste zu verschieben/zu kopieren</iaixsl:attribute>
							Verschieben / Kopieren<span> zu einer anderen Liste</span>
						</a>
						<div class="sl_footer__move_options p-4 px-sm-0 py-md-3">
							<a href="#close" class="sl_footer__option --close d-none align-items-center d-md-flex px-md-3 px-lg-4"/>
							<a href="#move" class="sl_footer__option --move d-flex align-items-center mb-2 px-md-3 mb-md-0 px-lg-4">In eine andere Liste verschieben</a>
							<a href="#copy" class="sl_footer__option --copy d-flex align-items-center px-md-3 px-lg-4">In eine andere Liste kopieren</a>
						</div>
					</div>
					<div class="sl_footer__item --remove col-3 col-md-auto">
						<a href="#remove" class="sl_footer__link --remove d-flex flex-column align-items-center justify-content-center flex-md-row">
							<iaixsl:attribute name="title">Klicken Sie auf, um die ausgewählten Produkte aus dieser Liste zu entfernen</iaixsl:attribute>
							Aus dieser Liste entfernen
						</a>
					</div>
				</iaixsl:if>
				<div class="sl_footer__item --buy col-3 col-md-auto">
					<a href="#buy" class="sl_footer__link --buy btn --solid d-flex flex-column align-items-center justify-content-center flex-md-row">
						<iaixsl:attribute name="title">Klicken Sie, um ausgewählte Produkte in den Warenkorb zu legen</iaixsl:attribute>
						In den Warenkorb
					</a>
				</div>
			</div>
		</div>
		<div class="shopping_list__block --manage sl_manage">
			<div class="sl_manage__sub --mobile sl_m_manage sl_dialog d-md-none">
				<div class="sl_m_manage__wrapper sl_dialog__wrapper">
					<div class="sl_m_manage__item --current">
						<div class="sl_m_manage__top --current d-flex align-items-center justify-content-between mb-2">
							<strong class="sl_m_manage__label --current sl_dialog_close mr-2" data-list_name="true">
								<iaixsl:value-of disable-output-escaping="yes" select="/shop/page/list/@name"/>
							</strong>
						</div>
						<div class="sl_m_manage__options">
							<div class="sl_m_manage__option --share py-4">
								<a href="#share" class="sl_m_manage__link --share align-items-center">Diese Liste teilen</a>
								<iaixsl:if test="/shop/page/@is_owner = 'true'">
									<iaixsl:choose>
										<iaixsl:when test="/shop/page/list/@shared = 'true'">
											<a href="#stop" class="sl_m_manage__link --stop align-items-center mt-2">Freigabe dieser Liste deaktivieren</a>
										</iaixsl:when>
										<iaixsl:otherwise>
											<a href="#start" class="sl_m_manage__link --start align-items-center mt-2">Freigabe dieser Liste aktivieren</a>
										</iaixsl:otherwise>
									</iaixsl:choose>
								</iaixsl:if>
							</div>
							<iaixsl:if test="/shop/page/@is_owner = 'true'">
								<div class="sl_m_manage__option --change-name py-4">
									<a href="#change-name" class="sl_m_manage__link --change-name align-items-center">Umbenennen der Liste</a>
									<form class="sl_change_name align-items-center">
										<div class="sl_change_name__group f-group --small mb-0">
											<input type="text" class="sl_change_name__input f-control" required="required"/>
											<label class="sl_change_name__label f-label" data-list_name="true"><iaixsl:value-of disable-output-escaping="yes" select="/shop/page/list/@name"/></label>
										</div>
										<button type="submit" class="sl_change_name__button btn --solid ml-2 ml-md-3">Umbenennen</button>
									</form>
								</div>
								<div class="sl_m_manage__option --remove py-4">
									<a href="#remove" class="sl_m_manage__link --remove align-items-center">Diese Liste löschen</a>
									<div class="sl_remove align-items-center justify-content-center">
										<div class="sl_remove__label mr-2">
											<span class="sl_remove__txt_before">Entfernen Sie die Liste &apos;</span>
											<span class="sl_remove__name" data-list_name="true"><iaixsl:value-of disable-output-escaping="yes" select="/shop/page/list/@name"/></span>
											<span class="sl_remove__txt_after">&apos;?</span>
										</div>
										<div class="sl_remove__sure d-flex">
											<a href="#yes" class="sl_remove__link --yes btn --outline mr-2">Ja</a>
											<a href="#no" class="sl_remove__link --no btn --outline --secondary">Nein</a>
										</div>
									</div>
								</div>
							</iaixsl:if>
					...
					<div class="sl_m_manage__item --other mx-n4 mb-n4 p-4">
						<div class="sl_m_manage__top --other mb-1">
							<strong class="sl_m_manage__label --other">Andere Einkaufslisten</strong>
						</div>
						<div class="sl_m_manage__lists" data-empty="false">
							<iaixsl:if test="/shop/shopping_lists/@count = '1'">
								<iaixsl:attribute name="data-empty">true</iaixsl:attribute>
							</iaixsl:if>
							<div class="sl_m_manage__list d-flex align-items-center py-2" data-list_skeleton="true" data-list_id="true" data-shared="true">
								<a class="sl_m_manage__list_sub align-items-center mr-1" data-list_href="true">
									<span class="sl_m_manage__list_name" data-list_name="true"/>
									<span class="sl_m_manage__list_count" data-list_count="true">0</span>
								</a>
								<form class="sl_change_name align-items-center">
									<div class="sl_change_name__group f-group --small mb-0">
										<input type="text" class="sl_change_name__input f-control" required="required"/>
										<label class="sl_change_name__label f-label" data-list_name="true"/>
									</div>
									<button type="submit" class="sl_change_name__button btn --solid ml-2 ml-md-3">Umbenennen</button>
								</form>
								<div class="sl_remove align-items-center justify-content-center">
									<div class="sl_remove__label mr-2">
										<span class="sl_remove__txt_before">Entfernen Sie die Liste &apos;</span>
										<span class="sl_remove__name" data-list_name="true"/>
										<span class="sl_remove__txt_after">&apos;?</span>
									</div>
									<div class="sl_remove__sure d-flex">
										<a href="#yes" class="sl_remove__link --yes btn --outline mr-2">Ja</a>
								...
								<a href="#change-name" class="sl_m_manage__edit --change-name btn --outline align-items-center justify-content-center ml-auto"/>
								<a href="#remove" class="sl_m_manage__edit --remove btn --outline align-items-center justify-content-center ml-2"/>
							</div>
							<iaixsl:for-each select="/shop/shopping_lists/list[not(@id = /shop/page/list/@id)]">
								<div class="sl_m_manage__list d-flex align-items-center py-2">
									<iaixsl:attribute name="data-list_id"><iaixsl:value-of select="@id"/></iaixsl:attribute>
									<iaixsl:if test="@shared = 'true'">
										<iaixsl:attribute name="data-shared">true</iaixsl:attribute>
									</iaixsl:if>
									<a class="sl_m_manage__list_sub align-items-center mr-1">
										<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
										<span class="sl_m_manage__list_name" data-list_name="true"><iaixsl:value-of disable-output-escaping="yes" select="@name"/></span>
										<span class="sl_m_manage__list_count" data-list_count="true"><iaixsl:value-of select="@count"/></span>
									</a>
									<form class="sl_change_name align-items-center">
										<div class="sl_change_name__group f-group --small mb-0">
											<input type="text" class="sl_change_name__input f-control" required="required"/>
											<label class="sl_change_name__label f-label" data-list_name="true"><iaixsl:value-of disable-output-escaping="yes" select="@name"/></label>
										</div>
										<button type="submit" class="sl_change_name__button btn --solid ml-2 ml-md-3">Umbenennen</button>
									</form>
									<div class="sl_remove align-items-center justify-content-center">
										<div class="sl_remove__label mr-2">
											<span class="sl_remove__txt_before">Entfernen Sie die Liste &apos;</span>
											<span class="sl_remove__name" data-list_name="true"><iaixsl:value-of disable-output-escaping="yes" select="@name"/></span>
											<span class="sl_remove__txt_after">&apos;?</span>
										</div>
										<div class="sl_remove__sure d-flex">
											<a href="#yes" class="sl_remove__link --yes btn --outline mr-2">Ja</a>
			...
			<div class="sl_manage__sub --desktop sl_d_manage sl_dialog d-none d-md-flex">
				<div class="sl_d_manage__wrapper sl_dialog__wrapper">
					<a class="sl_d_manage__close" href=""/>
					<div class="sl_d_manage__top mb-3">
						<strong class="sl_d_manage__label">Einkaufslisten</strong>
					</div>
					<div class="sl_d_manage__lists" data-empty="false">
						<iaixsl:if test="not(/shop/shopping_lists/list)">
							<iaixsl:attribute name="data-empty">true</iaixsl:attribute>
						</iaixsl:if>
						<div class="sl_d_manage__list d-flex align-items-center py-2" data-list_skeleton="true" data-list_id="true" data-shared="true">
							<a class="sl_d_manage__list_sub align-items-center mr-1" data-list_href="true">
								<span class="sl_d_manage__list_name" data-list_name="true"/>
								<span class="sl_d_manage__list_count" data-list_count="true">0</span>
							</a>
							<form class="sl_change_name align-items-center">
								<div class="sl_change_name__group f-group --small mb-0">
									<input type="text" class="sl_change_name__input f-control" required="required"/>
							...
							<a href="#change-name" class="sl_d_manage__edit --change-name btn --outline align-items-center justify-content-center ml-auto"/>
							<a href="#remove" class="sl_d_manage__edit --remove btn --outline align-items-center justify-content-center ml-2"/>
						</div>
						<iaixsl:for-each select="/shop/shopping_lists/list">
							<div class="sl_d_manage__list d-flex align-items-center py-2">
								<iaixsl:attribute name="data-list_id"><iaixsl:value-of select="@id"/></iaixsl:attribute>
								<iaixsl:if test="@id = /shop/page/list/@id">
									<iaixsl:attribute name="data-current">true</iaixsl:attribute>
								</iaixsl:if>
								...
								<a class="sl_d_manage__list_sub align-items-center mr-1">
									<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
									<span class="sl_d_manage__list_name" data-list_name="true"><iaixsl:value-of disable-output-escaping="yes" select="@name"/></span>
									<span class="sl_d_manage__list_count" data-list_count="true"><iaixsl:value-of select="@count"/></span>
								</a>
								<form class="sl_change_name align-items-center">
									<div class="sl_change_name__group f-group --small mb-0">
										<input type="text" class="sl_change_name__input f-control" required="required"/>
		...
		<div class="shopping_list__block --share sl_share sl_dialog">
			<div class="sl_share__wrapper sl_dialog__wrapper">
				<div class="sl_share__top mb-3 mb-md-4">
					<strong class="sl_share__label sl_dialog_close">Teilen Sie die Liste</strong>
					<iaixsl:if test="/shop/page/@is_owner = 'true'">
						<p class="sl_share__description d-block">Jeder, der einen Link auf die Liste hat, kann sie einsehen, aber nicht bearbeiten.</p>
					</iaixsl:if>
				</div>
				<div class="sl_share__options">
					<div class="sl_share__option --copy py-4 d-md-flex justify-content-md-between">
						<a href="#copy" class="sl_share__link --copy d-flex align-items-center">Kopieren Sie den Link zu dieser Einkaufsliste</a>
						<div class="sl_share__copy d-flex align-items-center mt-2 ml-md-2 mt-md-0">
							<span class="sl_share__copy_txt ml-2 align-items-center ml-md-0 mr-md-2">Kopiert</span>
							<input type="text" class="sl_share__copy_input" readonly="readonly">
								<iaixsl:attribute name="value"><iaixsl:value-of select="/shop/page/list/share/@link"/></iaixsl:attribute>
							</input>
						</div>
					</div>
					<div class="sl_share__option --mail py-4 d-md-flex justify-content-md-between">
						<a class="sl_share__link --mail d-flex align-items-center">
							<iaixsl:attribute name="href">mailto:?subject=Sehen Sie sich meine Einkaufsliste an - <iaixsl:value-of disable-output-escaping="yes" select="/shop/page/list/@name"/>&amp;body=Link: <iaixsl:value-of select="/shop/page/list/share/@link"/></iaixsl:attribute>
							Einen Link zu dieser Einkaufsliste per E-Mail senden
						</a>
					</div>
				</div>
				<iaixsl:if test="/shop/page/@is_owner = 'true'">
					<div class="sl_share__stop">
						<iaixsl:choose>
							<iaixsl:when test="/shop/page/list/@shared = 'true'">
								<a href="#stop" class="sl_share__link --stop d-flex align-items-center">Freigabe dieser Liste deaktivieren</a>
							</iaixsl:when>
							<iaixsl:otherwise>
								<a href="#start" class="sl_share__link --start d-flex align-items-center">Freigabe dieser Liste aktivieren</a>
							</iaixsl:otherwise>
						</iaixsl:choose>
					</div>
				</iaixsl:if>
		...
		<iaixsl:if test="/shop/page/@is_owner = 'true'">
			<div class="shopping_list__block --move sl_move sl_dialog">
				<div class="sl_move__wrapper sl_dialog__wrapper">
					<div class="sl_move__item --top sl_dialog_close mb-2">
						<strong class="sl_move__label --move">In eine andere Liste verschieben</strong>
						<strong class="sl_move__label --copy">In eine andere Liste kopieren</strong>
					</div>
					<div class="sl_move__item --lists" data-empty="false">
						<iaixsl:if test="not(/shop/shopping_lists/list)">
							<iaixsl:attribute name="data-empty">true</iaixsl:attribute>
						</iaixsl:if>
						<div class="sl_move__list f-group --radio m-0 d-md-flex align-items-md-center justify-content-md-between" data-list_skeleton="true" data-list_id="true" data-shared="true">
							<input type="radio" name="move" class="sl_move__input f-control" id="slMoveRadioSelect" data-list_position="true"/>
							<label for="slMoveRadioSelect" class="sl_move__group_label f-label py-4" data-list_position="true">
								<span class="sl_move__sub d-flex align-items-center">
									<span class="sl_move__name" data-list_name="true"/>
									<span class="sl_move__count" data-list_count="true">0</span>
								</span>
							</label>
							<button class="sl_move__button --desktop btn --solid ml-md-2">
								<span class="sl_move__button_txt --move">Verschieben</span>
								<span class="sl_move__button_txt --copy">Kopieren</span>
							</button>
						</div>
						<iaixsl:for-each select="/shop/shopping_lists/list[not(@id = /shop/page/list/@id)]">
							<div class="sl_move__list f-group --radio m-0 d-md-flex align-items-md-center justify-content-md-between">
								<iaixsl:attribute name="data-list_id"><iaixsl:value-of select="@id"/></iaixsl:attribute>
								<iaixsl:if test="@shared = 'true'">
									<iaixsl:attribute name="data-shared">true</iaixsl:attribute>
								</iaixsl:if>
								<input type="radio" name="move" class="sl_move__input f-control">
									<iaixsl:attribute name="id">slMoveRadioSelect<iaixsl:value-of select="position()"/></iaixsl:attribute>
									<iaixsl:if test="position() = 1">
										<iaixsl:attribute name="checked">checked</iaixsl:attribute>
									</iaixsl:if>
								</input>
								<label class="sl_move__group_label f-label py-4">
									<iaixsl:attribute name="for">slMoveRadioSelect<iaixsl:value-of select="position()"/></iaixsl:attribute>
									<span class="sl_move__sub d-flex align-items-center">
										<span class="sl_move__name" data-list_name="true"><iaixsl:value-of disable-output-escaping="yes" select="@name"/></span>
										<span class="sl_move__count" data-list_count="true"><iaixsl:value-of select="@count"/></span>
									</span>
								</label>
								<button class="sl_move__button --desktop btn --solid ml-md-2">
									<span class="sl_move__button_txt --move">Verschieben</span>
					...
					<div class="sl_move__item --mobile mt-4 d-flex justify-content-center d-md-none">
						<button class="sl_move__button --mobile btn --solid --large">
							<span class="sl_move__button_txt --move">Verschieben</span>
							<span class="sl_move__button_txt --copy">Kopieren</span>
						</button>
					</div>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
        ...
        <!-- (menu_shoppinglist, 6374c7c8e99458.25728203.3)-->
		</footer>
	</iaixsl:if>
	<iaixsl:variable name="projector_script_bottom">true</iaixsl:variable>
	...
	<script src="/gfx/ger/envelope.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_shoppinglist.js.gzip?r=1696937760"></script><script src="/gfx/ger/shoppinglist_manage.js.gzip?r=1696937760"></script>
