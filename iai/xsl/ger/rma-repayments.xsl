...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (rma_repayments_cms, 60dd8e787c1c70.46078782.2)-->
    ...
    <!-- (rma_repayments_form, 61f913c8540824.92342060.3)-->
...
<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/rmaProducts/@url"/></iaixsl:attribute>
                    ...
                    <a class="_step _step3">
<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/rmaMethod/@url"/></iaixsl:attribute>
                        <span>3</span>
                        <p>
                            <i/>
...
<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/backlink/@url"/></iaixsl:attribute>
                ...
                <div class="progress__item --rma --fifth --active d-md-none py-3">
					<div class="progress__icons">
						<div class="progress__icon --mobile d-md-none">
							<span class="progress__step"><strong>5</strong><span>/6</span></span>
							<svg class="progress__svg"><circle class="progress__circle_back"/><circle class="progress__circle"/></svg>
						</div>
					</div>
					<div class="progress__text">
						<strong class="progress__name">Wählen Sie, wie und in welcher Form Sie Ihre Beschwerde einreichen möchten </strong>
					</div>
				</div>

                <h1 class="big_label return_label d-none d-md-block">Wählen Sie, wie und in welcher Form Sie Ihre Beschwerde einreichen möchten </h1>

                  <div id="complaint_method" class="complain_method">
                    <div class="complain_method__description">Teilen Sie dem Geschäft mit, ob Sie das Produkt ersetzen, den Mangel beheben, den Preis mindern oder den Vertrag kündigen möchten. Wenn eine Reparatur oder ein Ersatz nicht möglich ist, erstattet der Shop den Betrag in der unten angegebenen Form.</div>
                    <div class="complain_method__select">
                      <select class="complain_method__select complain_select" name="complain_method">
                        <option value="first_val">auswählen</option>
                        <option value="Wymiana towaru">
                          <iaixsl:attribute name="value">Ersetzung von Waren</iaixsl:attribute>
                          Ersetzung von Waren
                        </option>
                        <option value="Usunięcie wady">
                          <iaixsl:attribute name="value">Behebung eines Mangels</iaixsl:attribute>
                          Behebung eines Mangels
                        </option>
                        <option value="Obniżenie ceny">
                          <iaixsl:attribute name="value">Preisnachlass</iaixsl:attribute>
                          Preisnachlass
                        </option>
                        <option value="Odstąpienie od umowy">
                          <iaixsl:attribute name="value">Widerruf</iaixsl:attribute>
                          Widerruf
                        </option>
                      </select>
                    </div>
