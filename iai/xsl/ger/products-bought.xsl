...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (products_bought_list, 614c5cf1278845.84048440.5)-->
	
	<iaixsl:variable name="changePrice"><iaixsl:if test="/shop/page/@price_type = 'net'"><iaixsl:value-of select="$priceTypeText"/></iaixsl:if></iaixsl:variable>
	<iaixsl:variable name="select_sort_label"/>
	<iaixsl:variable name="select_portionpb_label"/>
	<iaixsl:variable name="select_sort_label_bottom"/>
	<iaixsl:variable name="select_portionpb_label_bottom"/>
		...
		<div class="col-12 products-bought__list-wrapper">
			<div id="products-bought__list" class="products-bought__list">
				<div class="products-bought__list-header row d-none d-md-flex pb-2">
					<div class="products-bought__header-name col-6"/>
					<div class="products-bought__header-date col-2">Letzter Einkauf</div>
					<div class="products-bought__header-price col-2">Aktueller Preis<span class="price_vat"><iaixsl:value-of select="$changePrice"/></span></div>
				</div>
								...
								<div class="row align-items-center products-bought__product-inner">
									...
									<div class="col-md-1 col-12 mb-3 mb-md-0">
										<div class="products-bought__product-icon">
											<a>
												<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
												<img class="basket_prod rwd-src" alt="Szczegoly" src="/gfx/standards/loader.gif?r=1696937716">
									...
									<div class="col-md-2 col-12 mb-3 mb-md-0">
										<div class="products-bought__product-price">
											<span class="d-block d-md-none">Aktueller Preis</span>
											<iaixsl:choose>
												...
												<iaixsl:otherwise>
													<iaixsl:if test="sizes/size[@buy_date]/price/@maxprice and sizes/size[@buy_date]/price/@maxprice != ''">
														<iaixsl:choose>
															<iaixsl:when test="not($changePrice = '')">
																<span class="products-bought__product-maxprice">
																	<span class="omnibus_label">Normaler Preis: </span>
													...
													<iaixsl:if test="sizes/size[@buy_date]/price/@omnibus_price">
														<div class="products-bought__lowest_price omnibus_price">
															<span class="omnibus_price__text">Niedrigster Preis in 30 Tagen vor Rabatt: </span><span class="omnibus_price__value"><iaixsl:choose><iaixsl:when test="not($changePrice = '')"><iaixsl:value-of select="sizes/size[@buy_date]/price/@omnibus_price_net_formatted"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="sizes/size[@buy_date]/price/@omnibus_price_formatted"/></iaixsl:otherwise></iaixsl:choose></span>
														</div>
													</iaixsl:if>
												</iaixsl:otherwise>
											</iaixsl:choose>
											...
											<iaixsl:choose>
												...
												<iaixsl:otherwise>
													<a class="btn --solid">
														...
														<iaixsl:attribute name="title">In den Warenkorb</iaixsl:attribute>
														In den Warenkorb
													</a>
												</iaixsl:otherwise>
											</iaixsl:choose>
		...
		<div class="col-12">
			<div class="products-bought__products-button">
				<div class="products-bought__checkbox-all f-group --checkbox">
					...
					<label class="f-label">Alle auswählen</label>
				</div>
