...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (client_new_cms, 60dd8e7ac01704.75042056.9)-->
            <iaixsl:if test="page/text/body">
                <iaixsl:variable name="loginedit_cms_label">Zusatzinformationen</iaixsl:variable>
							...
							<div class="form-group --radio">
								...
								<div class="form-control-static">
									<div class="f-group --radio">
										...
										<label class="f-label" for="client_vat_payer_k">inländisch</label>
									</div>
									...
									<div class="f-group --radio">
										...
										<label class="f-label" for="client_vat_payer_w">EU-intern</label>
									</div>
									...
									<div class="f-group --radio">
										...
										<label class="f-label" for="client_vat_payer_e">export</label>
									</div>
								</div>
							</div>
					...
					<iaixsl:choose>
						<iaixsl:when test="/shop/page/client-data/@operation = 'register' and /shop/action/registration_options/wholesale">
							<div class="cn_wrapper choose_other_form">
								<i class="icon-wholesaler-register"/> Sind sie ein großhändler? Verwenden Sie das <a>
						...
						<iaixsl:when test="/shop/page/client-data/@operation = 'register-wholesale-add' and /shop/action/registration_options/retail">
							<div class="cn_wrapper choose_other_form">
								<i class="icon-register-card"/> Sind Sie ein Privatkunde? Verwenden Sie das <a>
								...
								<div class="form-control-static">
									<iaixsl:if test="not( (page/client-data/@operation = 'register-wholesale-add') or (page/client-data/@operation = 'edit-wholesale-add') or (page/client-data/@operation = 'edit-wholesale-edit') )">
										<div class="f-group --radio">
											...
											<label class="f-label" for="client_type2">Privatperson</label>
										</div>
									</iaixsl:if>
									<div class="f-group --radio">
										...
										<div class="col-12 px-0">
											<div class="dropdown cn_dropdown">
                                                <div class="addresses-editable">
                                                    ...
                                                    * Eine bereits verwendete Adresse kann nicht bearbeitet werden.
                                                </div>
            ...
            <iaixsl:if test="not(/shop/page/client-data/payer_data/@use = 'hide')">
				...
				<iaixsl:if test="$client_new_mode != 'onceorder'">
								...
								<div class="form-group has-feedback --radio">
									...
									<div>
										...
										<div class="f-group --radio">
											...
											<label class="f-label" for="client_generate_password1">Den Passwort nicht ändern</label>
										</div>
										<div class="f-group --radio">
											<input type="radio" name="client_generate_password" id="client_generate_password2" value="no" class="f-control">
												<iaixsl:if test="not(/shop/page/client-data/@register='true')"><iaixsl:attribute name="name">client_generate_password_n</iaixsl:attribute></iaixsl:if>
											</input>
											<label class="f-label" for="client_generate_password2">Ändern Sie Ihr Passwort</label>
										</div>
									</div>
								</div>
							</iaixsl:if>
                    ...
                    <iaixsl:if test="$client_new_mode = 'edit'"><iaixsl:attribute name="autocomplete">current-password</iaixsl:attribute></iaixsl:if>
									...
									<span class="form-control-feedback"/>
									<a href="#show_pass" class="show_pass"><i class="icon-visibility"/> Passwort anzeigen</a>
						...
						<iaixsl:if test="not(/shop/contact/owner/@vat_registered = 'false')">
							<div class="checkbox">
								<label>
									...
									</input>Ich bin ein EU-Mehrwertsteuerzahler. Ich bestelle ohne Mehrwertsteuer und verpflichte mich dazu, die Mehrwertsteuer in meinem eigenen Land abzurechnen. Der Verkäufer wird die EU-Mehrwertsteuer im MIAS-System überprüfen.
								</label>
							</div>
						</iaixsl:if>
						<iaixsl:choose>
							...
							<div class="form-group">
								<div class="checkbox">
									<label>
										...
										</input>  Ja, ich möchte den SMS-Newsletter erhalten (SMS-Newsletter kann jederzeit wieder abbestellt werden)
					...
					<div class="clientnew_buttons">
						<div id="formErrors" class="formErrors">
							<div class="formErrors__icon">
								...
								<strong>Es gibt Fehler im Formular </strong>
							</div>
                        ...
                        <iaixsl:choose>
                            ...
                            <iaixsl:when test="/shop/page/client-data/@active_card and not(/shop/page/client-data/@active_card='')">
                                ...
                                <p class="rebate_card_desc">
                                    Sie kӧnnen die aktive Rabattkarte wechseln. Geben Sie bitte die neue Nummer oben ein. Gehen Sie zu Ihrer Rabattliste und prüfen Sie die Details der <a href="/client-rebate.php" title="Twoje rabaty">gewährten Rabatte</a>.
                                </p>
                            </iaixsl:when>
                            <iaixsl:otherwise>
                                <div class="form-group">
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/ger/envelope.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/ger/client_new_form.js.gzip?r=1696937760"></script>
