		...
		<div class="subscriptions_list__header">
			<h1 class="headline">
				<span class="headline__name">
					<iaixsl:choose>
						...
						<iaixsl:otherwise>
							Liste der abgeschlossenen Abonnements
						</iaixsl:otherwise>
					</iaixsl:choose>
				</span>
			</h1>
			<iaixsl:if test="(/shop/page/subscriptions/@display = 'active' and /shop/action/subscriptions_terminated/@count != 0) or (/shop/page/subscriptions/@display != 'active' and /shop/action/subscriptions_active/@count != 0) ">
				<div class="subscriptions_list__see_also">
					<span class="subscriptions_list__see_also_text">Siehe auch: </span>
					<a class="subscriptions_list__see_also_link">
						<iaixsl:choose>
							<iaixsl:when test="/shop/page/subscriptions/@display = 'active'">
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/subscriptions_terminated/@url"/></iaixsl:attribute>Liste der abgeschlossenen Abonnements
							</iaixsl:when>
							<iaixsl:otherwise>
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/subscriptions_active/@url"/></iaixsl:attribute>Liste der aktiven Abonnements
							</iaixsl:otherwise>
						</iaixsl:choose>
					</a>
				</div>
				...
				<div class="subscriptions__item">
									...
									<div class="subscriptions__product_details">
										...
										<iaixsl:if test="size/@name != '' and size/@id != 'uniw'">
											<div class="subscriptions__product_detail --size">
												<span class="subscriptions__product_detail_name">Größe:</span>
					...
					<div class="subscriptions__info">
						<div class="subscriptions__price">
							...
							<span> / alle <span class="subscriptions__product_price_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="@days_in_period"/> Tage</span></span>
						</div>
						<div class="subscriptions__dates">
							<div class="subscriptions__date --order">
								<span class="subscriptions__date_name">Nächste Lieferung</span>
							...
							<div class="subscriptions__date --payment">
								<span class="subscriptions__date_name">Datum der nächsten Zahlung</span>
								<strong class="subscriptions__date_value">
									<span class="subscriptions__day_name">
										<iaixsl:choose>
					...
					<iaixsl:if test="count(products/product) &gt; $subscriptionProductsHidden">
						<a href="#moreProducts" class="subscriptions__more_products">
							<iaixsl:attribute name="data-literal">Verbirg</iaixsl:attribute>
							+<iaixsl:value-of select="count(products/product) - $subscriptionProductsHidden"/> Produkte im Abonnement
						</a>
					</iaixsl:if>
				</div>
			</iaixsl:for-each>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/ger/envelope.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_filter.js.gzip?r=1696937760"></script><script src="/gfx/ger/subscriptions_list.js.gzip?r=1696937760"></script>
