                ...
                <iaixsl:choose>
                    <iaixsl:when test="@name = 'creditCard[system]'">
                        <div class="payment_card_formel cc_wrapper">
                            ...
                            <span class="payment_card_need">
                                <img src="/gfx/standards/need.gif?r=1696937716" class="payment_card_nedd_img"><iaixsl:attribute name="alt">Dieses Feld muss ausgefüllt werden, um Ihre Zahlung zu tätigen</iaixsl:attribute><iaixsl:attribute name="title">Dieses Feld muss ausgefüllt werden, um die Bestellung aufzugeben</iaixsl:attribute></img>
                    ...
                    <iaixsl:when test="@name = 'creditCard[number]'">
                        <div class="payment_card_formel">
                            <label for="credit_card_number" class="payment_card_formel">Kartennummer:</label>
