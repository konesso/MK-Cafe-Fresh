                        ...
                        <tbody>
                            <iaixsl:for-each select="/shop/page/rma/item">
                                <tr>
                                        ...
                                        <div>
                                            ...
                                            <iaixsl:choose>
                                                ...
                                                <iaixsl:when test="@status=15">
                                                    <span><i class="icon-clock"/> </span>
                                                    <small>Beschwerde erstellt - Antwort des Geschäfts abwarten</small>
                                                </iaixsl:when>
                                                ...
                                                <iaixsl:when test="@status=19">
                                                    <span><i class="icon-ok"/></span>
                                                    <small>Beschwerde vorläufig geprüft - wir warten auf die Zusendung der reklamierten Produkte</small>
                                                </iaixsl:when>
                                    ...
                                    <td class="ord">
                                        <a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@url"/></iaixsl:attribute><span><i class="icon-plus"/></span><small>auswählen</small></a>
                                    </td>
                                </tr>
                            </iaixsl:for-each>
                        </tbody>
                ...
                <div class="rma_list_data_outline">
                    ...
                    <div class="rma_list_data_addbutton">
                        <a href="rma-add.php" class="btn --solid --medium rma_list_data_addbutton">
                            ...
                            <iaixsl:attribute name="title"><i class="icon-pencil"/> Reklamation hinzuzufügen</iaixsl:attribute>
                            <span class="img_button_edytujaddbutton"/>
                            <div class="addbutton_maintxt"><i class="icon-pencil"/> Reklamation hinzuzufügen</div>
                                            ...
                                            <iaixsl:for-each select="page/list/close/item">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="rma_list_item_operation">
                                                        mehr <i class="icon-angle-down"/>
                                                    </span>
                                                    <span class="rma_list_item_operation ophidden">
                                                        weniger Informationen <i class="icon-angle-up"/>
                                                    </span>
                                                </div>
                                                                    ...
                                                                    <iaixsl:if test="stock/@link !=''">
                                                                        <div class="rma_list_itemstock_link">
                                                                            <a class="rma_list_itemstock_link">
                                                                                ...
                                                                                mehr Informationen <i class="icon-double-angle-right"/>
                                                                            </a>
                                                                        </div>
                                                                    </iaixsl:if>
                                                                </div>
                                                            ...
                                                            <div class="rma_list_itembuttons">
                                                                <iaixsl:if test="documents/postdocument ">
                                                                    <a class="btn --solid --medium rma_list_button_etykieta" target="_blank">
                                                                        ...
                                                                        <i class="icon-print"/> Adressenetikett ausdrucken
                                                                    </a>
                                                                </iaixsl:if>
                                                                <iaixsl:if test="documents/letterofcomplaint">
                                                                    <a class="btn --solid --medium rma_list_button_wydrukuj" target="_blank">
                                                                        ...
                                                                        <i class="icon-print"/> Reklamationsmeldung ausdrucken
                                                                    </a>
                                                                </iaixsl:if>
                                                                <iaixsl:if test="@edit_link and (@edit_link != '')">
                                                                    <a class="btn --solid --medium rma_list_button_edit">
                                                                        ...
                                                                        <i class="icon-pencil"/> Reklamation bearbeiten
                                                                    </a>
                                                                </iaixsl:if>
                                                                ...
                                                                <iaixsl:if test="@cancel_link and (@cancel_link != '')">
                                                                    <a class="btn --solid --medium rma_list_button_cancel">
                                                                        ...
                                                                        <i class="icon-remove"/> Reklamation stornieren
                                                                    </a>
                                                                </iaixsl:if>
                                                            </div>
                                                        </div>
