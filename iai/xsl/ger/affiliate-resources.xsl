...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (affiliate_resources_form, 60dd8e84b52373.86599897.3)-->
  <iaixsl:if test="page/resources">
    ...
    <iaixsl:choose>
      <iaixsl:when test="not((0 &gt; page/payments/@total) or (page/payments/@total = '0.00'))">
        <section class="affiliate --resources --withdraw mb-4">
          <div class="affiliate__desc mb-4">
            Aktueller Stand Ihres Partnerkontos beträgt:
            <ol class="pl-5">
              <li>
                Vollständiger Kontostand: 
                <strong><iaixsl:value-of select="page/payments/@total_formatted"/></strong>
              </li>
              <li>
                Gesamtsumme der reduzierten Provisionen aus Warenrückgaben: 
                <strong><iaixsl:value-of select="page/payments/@returns_formatted"/></strong>
              </li>
            </ol>
            <iaixsl:if test="page/client/@loyalty_points = 'true'">
              Die Provision für Bestellungen von gewonnenen Kunden wird in Form von Punkten auf Ihr <a href="/affiliate-main.php">Saldo im Loyalitätsprogramm</a>
            </iaixsl:if>
            ...
            <iaixsl:value-of select="page/shop/@minpayment"/><iaixsl:value-of select="/shop/currency/@name"/>
             und nicht höher als die auf Ihrem Konto gesammelten Mittel. Anschließend klicken Sie auf die Schaltfläche "Kommission Zahlungsantrag&quot;.
          </div>
          <form class="d-flex flex-column align-items-center justify-content-center p-4 bg_alter" method="post">
            <div class="d-flex align-items-center f-group">
              Der Betrag für Rückerstattung beträgt 
              <input class="affiliate__input --amount f-control mx-1" type="number" name="amount" value="0">
                <iaixsl:attribute name="max"><iaixsl:value-of select="page/payments/@total"/></iaixsl:attribute>
                <iaixsl:attribute name="data-min"><iaixsl:value-of select="page/shop/@minpayment"/></iaixsl:attribute>
              </input>
              ,
              <input class="affiliate__input --cent f-control mx-1" type="number" name="cent" min="0" max="99" value="00" maxlength="2"/>
              <iaixsl:value-of select="/shop/currency/@name"/>
            </div>
            <iaixsl:choose>
              <iaixsl:when test="page/client/@paymenttype = 'cash'">
                <div class="f-group --radio">
                  <input type="radio" name="method" class="f-control" value="voucher" id="voucher" checked="checked"/>
                  <label class="f-label mx-1" for="voucher">Gutschein </label>
                  <input type="radio" name="method" class="f-control" value="cash" id="cash"/>
                  <label class="f-label mx-1" for="cash">Überweisung</label>
                </div>
              </iaixsl:when>
              <iaixsl:otherwise>
                <span class="mb-3">Der obige Wert wird in Form eines Gutscheins ausgezahlt.</span>
              </iaixsl:otherwise>
            </iaixsl:choose>
            <button type="submit" class="affiliate__submit btn --solid --medium">
              Kommission Zahlungsantrag
            </button>
          </form>
        </section>
      </iaixsl:when>
      <iaixsl:otherwise>
        <div class="affiliate__info">
          Im Moment haben Sie keine Mittel zur Auszahlung.
        </div>
      </iaixsl:otherwise>
    </iaixsl:choose>
  </iaixsl:if>
<!-- (affiliate_resources_list, 60dd8e84da9e33.27373055.2)-->
  <iaixsl:variable name="affiliate_1">Auszahlungsdatum</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">Art der Auszahlung</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">Gutscheinnummer</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">Gültig bis</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">Betrag</iaixsl:variable>
  <iaixsl:variable name="affiliate_6">Verwendet</iaixsl:variable>
  <iaixsl:variable name="affiliate_7">Status</iaixsl:variable>
  <iaixsl:if test="page/resources/resource">
    <section class="affiliate__table --seven table mb-4">
      <div class="table__row --head">
        <span class="table__cell d-flex justify-content-between"><iaixsl:value-of select="$affiliate_1"/></span>
        <span class="table__cell d-flex justify-content-between"><iaixsl:value-of select="$affiliate_2"/></span>
        <span class="table__cell d-flex justify-content-between"><iaixsl:value-of select="$affiliate_3"/></span>
        <span class="table__cell d-flex justify-content-between"><iaixsl:value-of select="$affiliate_4"/></span>
        <span class="table__cell d-flex justify-content-between"><iaixsl:value-of select="$affiliate_5"/></span>
        <span class="table__cell d-flex justify-content-between"><iaixsl:value-of select="$affiliate_6"/></span>
        <span class="table__cell d-flex justify-content-between"><iaixsl:value-of select="$affiliate_7"/></span>
      </div>
      <iaixsl:for-each select="page/resources/resource">
        <div class="table__row mb-5 mb-md-0 p-3 p-md-0">
          <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_1"/></span><iaixsl:value-of select="@date"/></span>
          <span class="table__cell d-flex justify-content-between">
            <span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_2"/></span>
            <iaixsl:choose>
          ...
          <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_3"/></span><iaixsl:value-of select="@idkey"/></span>
          <span class="table__cell d-flex justify-content-between">
            <span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_4"/></span>
            <iaixsl:choose>
          ...
          <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_5"/></span><iaixsl:value-of select="@amount_formatted"/></span>
          <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_6"/></span><iaixsl:value-of select="@used_formatted"/></span>
          <span class="table__cell d-flex justify-content-between">
            <span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_7"/></span>
            <span class="status --table">
              <iaixsl:choose>
                <iaixsl:when test="@status = 'n'">
                  <iaixsl:attribute name="class">status --table --uncompleted</iaixsl:attribute>
                  <span>Nicht eingelöst</span>
                </iaixsl:when>
                <iaixsl:when test="@status = 'y'">
                  <iaixsl:attribute name="class">status --table --completed</iaixsl:attribute>
                  <span>Eingelöst</span>
                </iaixsl:when>
                <iaixsl:when test="@status = 'b'">
                  <iaixsl:attribute name="class">status --table --blocked</iaixsl:attribute>
                  <span>Gesperrt</span>
                </iaixsl:when>
                <iaixsl:when test="@status = '0000-00-00'">
                  <iaixsl:attribute name="class">status --table --waiting</iaixsl:attribute>
                  <span>Ausstehende Genehmigung </span>
                </iaixsl:when>
                <iaixsl:when test="@status = 'Odrzucono'">
                  <iaixsl:attribute name="class">status --table --rejected</iaixsl:attribute>
                  <span><iaixsl:value-of select="@status"/></span>
                </iaixsl:when>
                <iaixsl:otherwise>
                  <iaixsl:attribute name="class">status --table --confirmed</iaixsl:attribute>
                  <span>Bestätigt <small>(<iaixsl:value-of select="@status"/>)</small></span>
                </iaixsl:otherwise>
              </iaixsl:choose>
            </span>
          </span>
...
<!-- (affiliate_resources_paging, 60dd8e7f576118.87343244.3)-->
        <iaixsl:variable name="prev_page"/>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/ger/envelope.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/ger/affiliate_resources_form.js.gzip?r=1696937760"></script>
