...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!-- (envelope, 60dd8eb7808547.00364708.18)-->
	...
	<iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
		...
		<head>
			...
			<script src="/gfx/ger/pickup_sites_list.js.gzip?r=1696937760"></script>
														...
														<div class="timeText">
															<iaixsl:choose>
																...
																<iaixsl:when test="delivery_time">
																	Vorbereitungszeit zur persönlichen Entgegennahme 
																	...
																	<iaixsl:if test="delivery_time/@hour  &gt; 0">
																		<iaixsl:value-of select="delivery_time/@hour"/> Stunden. 
																	</iaixsl:if>
																...
																<iaixsl:when test="delivery_time/@days = '0'">
																	<iaixsl:choose>
																		...
																		<iaixsl:otherwise>
																			Vorbereitungszeit zur persönlichen Entgegennahme <iaixsl:value-of select="delivery_time/@hour"/>
																			<iaixsl:choose>
																...
																<iaixsl:otherwise>
																	Vorbereitungszeit zur persönlichen Entgegennahme <iaixsl:value-of select="delivery_time/@days"/>
																	<iaixsl:choose>
																		<iaixsl:when test="delivery_time/@days = '1'">
																			 Tages
																		</iaixsl:when>
