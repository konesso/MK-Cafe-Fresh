...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (rma_open_form, 60dd8e85d229c6.87373710.3)-->
			<section class="rma_open mb-4">
				
				<h1 class="rma_open__label headline">
					<span class="rma_open__label_txt headline__name">Bitte wählen Sie die Bestellung aus von welcher Sie die Ware zurückgeben möchten</span>
				</h1>
                ...
                <iaixsl:choose>
                    ...
                    <iaixsl:otherwise>
						<form action="/rma-open.php" method="post" class="rma_open__form row flex-column align-items-center mb-4" novalidate="novalidate">
							...
							<iaixsl:variable name="button_legend_rma_open"/>
