...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (rma_products_cms, 60dd8e780c7f19.73082819.2)-->
    ...
    <!-- (rma_products_list, 61f913c6f3b9d2.49558513.8)-->
		<iaixsl:if test="page/@type = 'rma_products' and page/@display = 'add'">
			<div class="step2">
				...
				<div class="progress__item --rma --second --active d-md-none py-3">
					<div class="progress__icons">
						<div class="progress__icon --mobile d-md-none">
							<span class="progress__step"><strong>2</strong><span>/6</span></span>
							<svg class="progress__svg"><circle class="progress__circle_back"/><circle class="progress__circle"/></svg>
						</div>
					</div>
					<div class="progress__text">
						<strong class="progress__name">Artikel auswählen</strong>
					</div>
				</div>

				<h1 class="big_label return_label d-none d-md-block">Wählen Sie die zu reklamierenden Waren aus und beschreiben Sie den Mangel</h1>
				...
				<iaixsl:if test="page/products">
					...
					<form class="returns_productslist" action="/rma-method.php?type=multiproduct" method="post">
						...
						<div id="basketedit_productslist" class="basketedit_productslist return_productslist rma">
							<div class="rma__list">
								<div class="rma__row --head">

									<div class="rma__name --name">
										<iaixsl:choose>
                      ...
                      <iaixsl:otherwise>
                        Produkt
                                    ...
                                    <div class="rma__name --warranty productslist_product_warranty">
                                        Garantie
                                    </div>

									
									<iaixsl:if test="/shop/page/products/product/@required_from_special_offer = 'true' and $required_from_special_offer != ''">
										<div class="rma__name --special">
											
										</div>
									</iaixsl:if>

                  <div class="rma__name --comment productslist_product_comment">
                    Beschreibung
                  </div>

                  <div class="rma__name --attachments productslist_product_attachments">
										Anhänge (Fotos)
									</div>
									<div class="rma__name --quantity">
                    <iaixsl:choose>
                      <iaixsl:when test="page/@type = 'rma_products'">
                        Menge auswählen
                      </iaixsl:when>
                  ...
                  <iaixsl:variable name="quantity"><iaixsl:value-of select="@quantity"/></iaixsl:variable>

									<div class="rma__row --items productslist_item">
                    <iaixsl:if test="@selected_quantity &gt; 0">
                      <iaixsl:attribute name="class">rma__row --items productslist_item --opened</iaixsl:attribute>
                    </iaixsl:if>
                    <iaixsl:attribute name="data-quantity"><iaixsl:value-of select="$quantity"/></iaixsl:attribute>
										<div class="rma__col --photo productslist_product_photo">
											<a>
												<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                        <iaixsl:choose>
                          ...
                          <iaixsl:otherwise>
                            <img>
                              ...
                              <iaixsl:attribute name="alt"><iaixsl:value-of disable-output-escaping="yes" select="name/text()"/></iaixsl:attribute>
										...
										<div class="rma__col --name productslist_product_name">
											<h3>
												<a>
													<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                      ...
                      <div class="productslist_product__sizeWrapper">
                      ...
                      <div class="productslist_product_price">
                        <strong class="price"><iaixsl:value-of select="@bruttoworth_formatted"/></strong> <span class="price_unit"> / <iaixsl:value-of select="@quantity"/><iaixsl:text disable-output-escaping="yes">&amp;nbsp;</iaixsl:text><iaixsl:value-of select="size/@unit"/></span>
                      </div>

										</div>

											<div class="rma__col --warranty productslist_product_warranty d-sm-flex">
                        <iaixsl:if test="warranty/@name">
                            <iaixsl:attribute name="class">rma__col --warranty productslist_product_warranty d-flex</iaixsl:attribute>
                        </iaixsl:if>
												<span/>
												...
												<iaixsl:if test="not(warranty/@gfx) and warranty/@name">
													<div class="productslist_warranty">
														<iaixsl:value-of disable-output-escaping="yes" select="warranty/@name"/>
														<iaixsl:if test="not(warranty/text() = '') and not(warranty/text() = ' ')">
															<div class="productslist_warranty_info__more orderdetails_info__more d-none d-md-flex">
																<a href="#showDescription" class="productslist_warranty_info__show d-none d-md-flex">Mehr</a>
																	<div style="display:none;" class="productslist_warranty_info__desc"><p><iaixsl:value-of disable-output-escaping="yes" select="warranty/text()"/></p></div>
															</div>
															<a href="#showDescription" class="moreInfo__show d-md-none">Mehr</a>
															<div style="display:none;" class="moreInfo__desc"><p><iaixsl:value-of disable-output-escaping="yes" select="warranty/text()"/></p></div>
														</iaixsl:if>
													</div>
										...
										<iaixsl:if test="/shop/page/products/product/@required_from_special_offer = 'true' and $required_from_special_offer != ''">
											<div class="rma__col --special productslist_product_special_offer d-none d-sm-block">
												<iaixsl:if test="@required_from_special_offer = 'true'">
                    ...
                    <div class="rma__col --mobileSeparator d-sm-none"/>

                    
										<div class="rma__col --comment productslist_product_comment has-feedback has-required">
                      <div class="rma__label d-sm-none">Beschreibung:</div>
                      <textarea>
                    ...
                    <div class="rma__col --atachment productslist_product_attachments">
                      <iaixsl:if test="not(@allowReturn='0') and not(@allowReturn='2')">
												<a href="#addComment">
													<iaixsl:attribute name="title">kliknij aby dodać załącznik</iaixsl:attribute>
													<i class="icon-image"/> 
                          <span>
                            <span>Foto hinzufügen</span>
                            <span>(oder anderen Anhang)</span>
                          </span>
												</a>

												<div class="rma__attachment d-none">
                          <iaixsl:attribute name="data-id">comment_photo[<iaixsl:value-of select="@id"/>][<iaixsl:value-of select="size/@type"/>][<iaixsl:choose><iaixsl:when test="additional/@hash"><iaixsl:value-of select="additional/@hash"/></iaixsl:when><iaixsl:otherwise>0</iaixsl:otherwise></iaixsl:choose>][]</iaixsl:attribute>
                            ...
                            <label>
                              <iaixsl:attribute name="for">comment_photo[<iaixsl:value-of select="@id"/>][<iaixsl:value-of select="size/@type"/>][<iaixsl:choose><iaixsl:when test="additional/@hash"><iaixsl:value-of select="additional/@hash"/></iaixsl:when><iaixsl:otherwise>0</iaixsl:otherwise></iaixsl:choose>][]</iaixsl:attribute>
                                <span class="fakeButton">Datei auswählen</span>
                                <input type="file" name="comment_photo" data-events="false">
                                  ...
                                  <iaixsl:attribute name="id">comment_photo[<iaixsl:value-of select="@id"/>][<iaixsl:value-of select="size/@type"/>][<iaixsl:choose><iaixsl:when test="additional/@hash"><iaixsl:value-of select="additional/@hash"/></iaixsl:when><iaixsl:otherwise>0</iaixsl:otherwise></iaixsl:choose>][]</iaixsl:attribute>
                                  <iaixsl:attribute name="size">20</iaixsl:attribute>
                                </input>
                                <span class="prodl_comment_foto__imageName">Keine Datei ausgewählt</span>
                            </label>
													</div>
													<div class="prodl_comment_button">
														<a href="#addMoreFiles" class="addMoreFiles">
															Einen weiteren Anhang hinzufügen</a>
													</div>
												</div>
										...
										<div class="rma__col --quantity productslist_product_quantity">
											
											<iaixsl:choose>
												<iaixsl:when test="@allowReturn='0'">
													<div class="productslist_product_info">
														<div class="btn-icon allowReturn_1">
															<small><i class="icon-remove-sign"/></small>
												...
												<iaixsl:when test="@allowReturn='2'">
													<div class="productslist_product_info">
														<div class="btn-icon allowReturn_2">
															<small><i class="icon-question"/></small>
															<span>Vergewissern Sie sich, dass Sie den Anspruch auf dieses Produkt geltend machen können, und achten Sie dabei besonders auf den Tag, an dem Sie das Produkt erhalten haben, und auf die Garantiezeit. <a href="/#">Ich möchte die Ware reklamieren</a>.</span>
														</div>
													</div>
												</iaixsl:when>
											</iaixsl:choose>
											<iaixsl:if test="not(@allowReturn='0')">
                        <div class="rma__label d-sm-none">Menge:</div>
												<div>
													<iaixsl:choose>
														<iaixsl:when test="change_group/@id">
															...
															<span class="productslist_quantity" style="display:none;">
																<a href="#delQuantity" class="delQuantity"><i class="icon-minus"/></a>
																...
																<a href="#addQuantity" class="addQuantity"><i class="icon-plus"/></a>
                                ...
                                <iaixsl:variable name="selectedQuantity"><iaixsl:value-of select="@selected_quantity"/></iaixsl:variable>
                                <iaixsl:variable name="sellby"><iaixsl:value-of select="size/@unit_sellby"/></iaixsl:variable>
                                ...
                                <select class="f-select">
                                  ...
                                  <iaixsl:for-each select="/descendant::node()[not(position() * $sellby &gt; $quantity) and not(position() &gt; 5)]">
                                    <option>
                                      <iaixsl:if test="position() = $selectedQuantity">
                                        <iaixsl:attribute name="selected">selected</iaixsl:attribute>
                                      </iaixsl:if>
                                      <iaixsl:attribute name="value"><iaixsl:value-of select="position() * $sellby"/></iaixsl:attribute>
                                      <iaixsl:value-of select="position() * $sellby"/>
                                    </option>
                                  </iaixsl:for-each>
                                  <iaixsl:if test="$quantity &gt; 5">
                                    <option value="more">
                                      mehr
                                    </option>
                                  </iaixsl:if>
                                </select>
                                <div class="productslist_quantity__more d-none">
                                  <input class="productslist_quantity__more_input" type="number">
                                    <iaixsl:attribute name="name">set_quantity[<iaixsl:value-of select="position()"/>]</iaixsl:attribute>
                                    <iaixsl:attribute name="data-prev"><iaixsl:value-of select="@selected_quantity"/></iaixsl:attribute>
                                    <iaixsl:attribute name="data-max"><iaixsl:value-of select="@quantity"/></iaixsl:attribute>
                                    ...
                                    <iaixsl:attribute name="step"><iaixsl:value-of select="size/@unit_sellby"/></iaixsl:attribute>
										...
										<div class="rma__col --action productslist_product_action">
                  ...
                  <a href="#addComplain" class="d-sm-none rma__toggleComplain">
                    <span>
                      <iaixsl:choose>
                        <iaixsl:when test="@selected_quantity &gt; 0">
                          Zrezygnuj z reklamacji
                        </iaixsl:when>
                        <iaixsl:otherwise>
                          <i class="icon-plus"/>Produkt reklamieren
                        </iaixsl:otherwise>
                      </iaixsl:choose>
                    </span>
                  </a>
                ...
                <iaixsl:choose>
                  <iaixsl:when test="/shop/page/@type = 'rma_products'">
                    Produkt auswählen
                  </iaixsl:when>
                  <iaixsl:otherwise>
                    Weiter
