...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
			...
			<iaixsl:if test="not(action/set_render/item) or (action/set_render/item/@name = 'content')">
				<div id="content" class="span9">
					...
					<!-- (noproduct_product_request_form, 60dd8ecb5a6352.68386043.2)-->
            <section class="noproduct my-5">
                <div class="noproduct__icon"><i class="icon-noproduct"/></div>
                <h3 class="noproduct__label mb-2">Das gesuchte Produkt wurde nicht gefunden.</h3>
                <p>Versuchen Sie, genauere Parameter anzugeben. Verwenden Sie <a href="/searching.php" title="Kliknij, aby przejść do wyszukiwarki zaawansowanej">erweiterte Suchmaschine</a>.</p>
                    ...
                    <iaixsl:if test="/shop/basket/@login">
                        <form class="noproduct__form" method="post" novalidate="novalidate">
                            ...
                            <div class="noproduct__inputs mt-5">
                                <p class="mb-3">Bevor Sie uns ein Produkt melden, vergewissern Sie sich, dass es nicht bereits in der <a href="products-requests.php" title="Przejdź do listy poszukiwanych produktów">Ihre Liste der gewünschten Produkte</a>.</p>
                                <div class="f-group">
                                ...
                                <div class="d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <p><i class="icon-need"/> Felder mit einem Stern gekennzeichneten Felder sind Pflicht</p>
                                </div>
                            </div>
                        </form>
                    </iaixsl:if>
        ...
        <!-- (noproduct_hotspot_zone1, 614c5cef56f517.37206702.5)-->
				...
				<iaixsl:choose>
					...
					<div class="products d-flex flex-wrap">
						<iaixsl:for-each select="/shop/page/additional/hotspot/products_zone1/*">
							...
							<div class="product col-6 col-sm-4 col-lg-3 py-3">
...
<!-- (noproduct_cms, 60dd8e7d4a9d62.71225336.9)-->
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/ger/envelope.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_omnibus.js.gzip?r=1696937760"></script><script src="/gfx/ger/noproduct_product_request_form.js.gzip?r=1696937760"></script>
