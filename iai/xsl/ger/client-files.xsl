...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (client_files_files, 60dd8e7bd6c090.77789436.5)-->
						...
						<iaixsl:for-each select="/shop/page/client_files/product_data">
							<div class="n68137_file">
								...
								<div class="n68137_files_description">
									...
									<div class="n68137_files_description_order"><span class="n68137_desc_label">Bestellungs-ID:</span><span class="n68137_desc_value"><a class="n68137_desc_value"><iaixsl:attribute name="href"><iaixsl:value-of select="@order_link"/></iaixsl:attribute><iaixsl:value-of select="@order_sn"/></a></span></div>
					...
					<div class="n68137_files">
						<iaixsl:for-each select="/shop/page/client_files/product_data">
							<div class="n68137_file">
								...
								<div class="n68137_files_description">
									<a class="n68137_desc_name"><iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute><iaixsl:value-of select="@name"/></a>
									<div class="n68137_files_description_order"><span class="n68137_desc_label">Bestellungs-ID:</span><a class="n68137_desc_value"><iaixsl:attribute name="href"><iaixsl:value-of select="@order_link"/></iaixsl:attribute><iaixsl:value-of select="@order_sn"/></a></div>
									<div class="n68137_files_description_availability">
										<span class="n68137_desc_label">Verfügbarkeit:</span>
										<span class="n68137_desc_value">
											<iaixsl:choose>
								...
								<iaixsl:if test="@available='y'">
									<a class="btn --solid n68137_files_buy">
										<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>In den Warenkorb
									</a>
								</iaixsl:if>
								<div class="clearDiv"/>
							</div>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/ger/envelope.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/ger/client_files_files.js.gzip?r=1696937760"></script>
