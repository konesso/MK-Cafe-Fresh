...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <iaixsl:variable name="token_expired">Der Link zum Zugriff auf Ihre Daten ist nicht mehr gültig. Um auf die Daten in Ihrem Konto zuzugreifen, verwenden Sie bitte <a title="Zaloguj się" href="/signin.php">strony logowania</a>.</iaixsl:variable>

        <iaixsl:variable name="too_much_product">Maximal können Sie bestellen </iaixsl:variable>

        <iaixsl:variable name="not_enough_product">Minimum müssen Sie bestellen </iaixsl:variable>

        <iaixsl:variable name="too_much_product_size">Maximal können Sie bestellen </iaixsl:variable>

        <iaixsl:variable name="not_enough_product_size">Minimum müssen Sie bestellen </iaixsl:variable>
            ...
            <div class="n54531_outline_sub">
                ...
                <iaixsl:choose>
                    ...
                    <iaixsl:when test="page/return/@type='token_expired' and $token_expired">
                        <h3 class="return_label">Der Link zum Zugriff auf Ihre Daten ist nicht mehr gültig. Um auf die Daten in Ihrem Konto zuzugreifen, verwenden Sie bitte <a title="Zaloguj się" href="/signin.php">strony logowania</a>.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='too_much_product' and $too_much_product">
                        <h3 class="return_label"><iaixsl:value-of select="$too_much_product"/><iaixsl:value-of select="/shop/page/return/param/@value"/> St.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='not_enough_product' and $not_enough_product">
                        <h3 class="return_label"><iaixsl:value-of select="$not_enough_product"/><iaixsl:value-of select="/shop/page/return/param/@value"/> St.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type='order_invalidpoints'">
                        <h3 class="return_label">Es ist ein Fehler mit dem Produkt aufgetreten, das Sie gegen Punkte erwerben wollten. <a href="/contact.php">Kontaktieren Sie den Shopservice</a>.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'returncancel_error'">
                        <h3 class="return_label">&quot;Rücksendungen können nicht storniert werden. Kontakt <a href="contact.php"> Dienstleistung </a> um detaillierte Informationen zu erhalten.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'account_disabled'">
                        <h3 class="return_label">Das angegebene Konto existiert nicht.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'account_passremind'">
                        <h3 class="return_label">Wenn Sie ein Konto in unserem Shop haben, wurde eine Nachricht an Ihre E-Mail-Adresse gesendet, die es Ihnen ermöglicht, sich automatisch einzuloggen. Ändern Sie Ihr Passwort, nachdem Sie sich bei der Ausgabe Ihrer persönlichen Daten angemeldet haben..</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'wisheslist_empty'">
                        ...
                        <h3 class="return_label">Einkaufsliste ist leer.</h3>
                    ...
                    <iaixsl:when test="page/return/@type = 'shipping_error'">
                        <h3 class="return_label">Przepraszamy, ale nie dostarczamy produktów do wybranego kraju dostawy. Jeżeli chciałbyś złożyć zamówienie w naszym sklepie - <a href="/contact.php">kontaktieren unseren Kundenservice</a> um die Möglichkeit der Zustellung von Sendungen in Ihr Land hinzuzufügen.</h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'payment_error'">
                        <div class="paymentReturn__wrapper --return --error">
                            ...
                            <span class="paymentReturn__header">
                                <span>Bezahlen Sie für die akzeptierte Bestellnummer<span class="order_id"><iaixsl:attribute name="data-id"><iaixsl:value-of select="page/return/@referer"/></iaixsl:attribute><iaixsl:value-of select="page/return/@orderNumber"/></span></span>
                                <iaixsl:choose>
                                    <iaixsl:when test="/shop/page/return/@checkoutType = 'idosell'">
                    ...
                    <iaixsl:when test="page/return/@type='stock_transfer'">
                        <h3 class="return_label">Sie können keine Bestellung aufgeben, weil sich die Produkte, die Sie bestellen möchten, in verschiedenen Lagern befinden. <a href="/contact.php">Kontaktieren Sie den Shopservice</a> für Informationen darüber, wie Sie Ihre Bestellung abschließen können.</h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='insurance_error'">
                        <h3 class="return_label">Bei der Versicherung Ihrer Bestellung ist ein Fehler aufgetreten und sie wurde nicht registriert. <a href="/contact.php">Skontaktuj się z obsługą sklepu w celu wyjaśnienia sytuacji. </a>  </h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type='page_only_register'">
                        <h3 class="return_label">Die Seite ist nur für eingeloggte Kunden verfügbar. <a class="loginPopUpShow" href="/signin.php" title="Zaloguj się">Einloggen.</a></h3>
                    </iaixsl:when>

                    <iaixsl:when test="page/return/@type='page_only_unregister'">
                        <h3 class="return_label">Die Seite ist nur für nicht eingeloggte Kunden verfügbar. <a href="/login.php?operation=logout" title="Wyloguj się">Ausloggen.</a></h3>
                    </iaixsl:when>
                    ...
                    <iaixsl:when test="page/return/@type = 'products_not_found'">
                        <h3 class="return_label">Das von Ihnen gesuchte Produkt wurde nicht gefunden. Verwenden Sie <a href="/searching.php" title="Kliknij, aby przejść do wyszukiwarki zaawansowanej">eine fortgeschrittene Suchmaschine</a>.</h3>
                    </iaixsl:when>
