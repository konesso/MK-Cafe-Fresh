...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (affiliate_stats_list, 60dd8e848b1179.16333976.2)-->
  <iaixsl:variable name="affiliate_1">Einfache Links</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">Banner</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">Rabatt-Codes</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">Flash-Werbungen</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">PHP-Werbungen</iaixsl:variable>
  <iaixsl:variable name="affiliate_6">JavaScript-Werbungen</iaixsl:variable>
  <iaixsl:if test="page/affiliate_statistics">
    ...
    <section class="affiliate --stats mb-4">
      <div class="affiliate__desc mb-4">
        Unten befindet sich die Zusammenstellung aller Weiterleitugen zum Shop aufgrund Ihrer Empfehlung.
      </div>
      <div class="affiliate__table --two table --vertical mb-5 mb-md-0 p-3 p-md-0">
        <iaixsl:for-each select="page/affiliate_statistics/item">
          <div class="table__row">
            <iaixsl:choose>
              <iaixsl:when test="@name = 'plain'">
                <span class="table__cell"><iaixsl:value-of select="$affiliate_1"/></span>
              </iaixsl:when>
              <iaixsl:when test="@name = 'banner'">
                <span class="table__cell"><iaixsl:value-of select="$affiliate_2"/></span>
              </iaixsl:when>
              <iaixsl:when test="@name = 'promo_code'">
                <span class="table__cell"><iaixsl:value-of select="$affiliate_3"/></span>
              </iaixsl:when>
              <iaixsl:when test="@name = 'flash'">
                <span class="table__cell"><iaixsl:value-of select="$affiliate_4"/></span>
              </iaixsl:when>
              <iaixsl:when test="@name = 'php'">
                <span class="table__cell"><iaixsl:value-of select="$affiliate_5"/></span>
              </iaixsl:when>
              <iaixsl:when test="@name = 'jscode'">
                <span class="table__cell"><iaixsl:value-of select="$affiliate_6"/></span>
              </iaixsl:when>
            </iaixsl:choose>
            <span class="table__cell"><iaixsl:value-of select="@count"/></span>
          </div>
        </iaixsl:for-each>
      </div>
    </section>
