...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
  ...
  <iaixsl:variable name="affiliate_1">Kunden-ID</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">Datum der Kontoerstellung</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">Anzahl der aufgegebenen Bestellungen</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">Wert der aufgegebenen Bestellungen</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">Anzahl der abgeschlossenen Bestellungen</iaixsl:variable>
  <iaixsl:variable name="affiliate_6">Wert der abgeschlossenen Bestellungen</iaixsl:variable>
  <iaixsl:variable name="affiliate_7">(ohne Versandkosten)</iaixsl:variable>
          ...
          <div class="affiliate__table --six table">
            ...
            <iaixsl:if test="page/orders/client_sum">
              <div class="table__row --summary mb-5 mb-md-0 p-3 p-md-0">
                <span class="table__cell d-flex justify-content-between">Summe</span>
