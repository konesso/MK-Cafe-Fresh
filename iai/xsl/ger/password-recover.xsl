...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (password-recover, 60dd8e7e14d055.39041804.3)-->
            ...
            <div id="signin_password_recovery">
                ...
                <div class="row flex-column align-items-center ">
                    <p class="reminder_desc col-12 col-sm-6 mb-3">An Ihre E-Mail-Adresse wird ein Link gesendet, der Sie automatisch im Shop einloggt. Hier können Sie sowohl Ihr Passwort als auch andere Daten festlegen.</p>
