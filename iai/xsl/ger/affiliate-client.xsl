...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
  ...
  <iaixsl:variable name="affiliate_1">Bestellungs-ID</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">Bestelldatum</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">Versanddatum</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">Bestellwert</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">Anzahl der Produkte</iaixsl:variable>
  <iaixsl:variable name="affiliate_6">Zahlung</iaixsl:variable>
  <iaixsl:variable name="affiliate_7">Status</iaixsl:variable>
  <iaixsl:variable name="affiliate_8">Partner</iaixsl:variable>
  <iaixsl:variable name="affiliate_9">Kommission</iaixsl:variable>
