...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!-- (envelope, 60dd8eb7808547.00364708.18)-->
	...
	<iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
		...
		<head>
			...
			<script src="/gfx/ger/partners_list.js.gzip?r=1696937760"></script>
...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (partners_list, 60dd8e774b14e8.43212670.5)-->
  ...
  <iaixsl:variable name="country_check">true</iaixsl:variable>
    ...
    <iaixsl:variable name="scControl"/> 
  ...
  <iaixsl:variable name="mapCustomMarkers"/>  
  <iaixsl:variable name="partnersLimit">6</iaixsl:variable>    
  
    <script>
    var mapTypePartners = &quot;<iaixsl:value-of select="$mapType"/>&quot;;
    var navControlPartners = &quot;<iaixsl:value-of select="$navControl"/>&quot;;
    var mapTypeControlPartners = &quot;<iaixsl:value-of select="$mapTypeControl"/>&quot;;
    var scControlPartners = &quot;<iaixsl:value-of select="$scControl"/>&quot;;
    var controlTypePartners = &quot;<iaixsl:value-of select="$controlType"/>&quot;;
    var mapTypeControlStylePartners = &quot;<iaixsl:value-of select="$mapTypeControlStyle"/>&quot;;  
    var markersAnimationPartners = &quot;<iaixsl:value-of select="$markersAnimation"/>&quot;;
    var bCordPartners = &quot;<iaixsl:value-of select="$bCord"/>&quot;;
    var lCordPartners = &quot;<iaixsl:value-of select="$lCord"/>&quot;;
    var partnersLanguage   = &quot;<iaixsl:value-of select="$mapLanguage"/>&quot;;
    var partnersZoom     = parseInt(&quot;<iaixsl:value-of select="$mapZoom"/>&quot;);
    var markerPartnersCustomIcon      = &quot;<iaixsl:value-of select="$mapCustomMarkers"/>&quot;; 
    var google_api_key = &apos;<iaixsl:value-of select="/shop/page/partners/google_api_key/@value"/>&apos;; 
    </script> 
  
  
  <iaixsl:if test="count(page/partners/city)">
    ...
    <script>
      var countryFirst = &quot;<iaixsl:value-of select="page/partners/city/partner/@country"/>&quot;; 
    </script>
    
    
    <div class="partners_list_header">
<iaixsl:attribute name="class">big_label partners_list_header</iaixsl:attribute>
      <div class="partners_list_header_sub">
        <span class="partners_list_label">Unsere Partner</span>
      </div>
    </div>    
    
    
    
    <iaixsl:if test="(count(page/partners/city) &gt; 1 ) and (count(page/partners/city/partner) &gt; $partnersLimit)">
    <div class="partners_text_info">
      <p>
        Hier eine Liste unserer Geschäftspartner. Um Firmen in Ihrer Umgebung zu finden, klicken Sie auf die Schaltfläche Stadt wählen.
      </p>
    </div>

    <iaixsl:if test="/shop/page/partners/google_api_key/@value">
      <div class="partners_show_city_button">
      <div class="button_image"/>
      <a class="partners_show_city_button" onclick="event.stopPropagation();partners_map.showCityList();">
  <iaixsl:attribute name="class">btn-large partners_show_city_button</iaixsl:attribute>
        <iaixsl:attribute name="title">Klicken Sie hier, um eine Stadt auszuwählen</iaixsl:attribute>
        Stadt auswählen  
      </a>
      </div>
    ...
    <iaixsl:if test="count(page/partners/city) = 1">
      <div class="partners_text_info_oneCity">
        <p>
          Hier eine Liste unserer Geschäftspartner:
        </p>
      </div>  
      <script>
    ...
    <iaixsl:if test="(count(page/partners/city) &gt; 1 ) and not(count(page/partners/city/partner) &gt; $partnersLimit)">
      ...
      <script>
        partners_map.partnersLimitCount = <iaixsl:value-of select="count(page/partners/city/partner)"/>;    
      </script>     
    </iaixsl:if>  
        ...
        <div class="loadingContent">
          <div class="loadingBox">
            ...
            <span class="loadingMarkers">
              Informationen zu den Standorten unserer Partner werden geladen
              <span class="loadingMarkersComplete"/>
               aus 
              <span class="loadingMarkersCount"/>
            </span>
            <img class="loadingMapImg" src="/gfx/standards/mapLoader.gif?r=1696937716"/>
          </div>
        </div>
      </div>
      <img class="marker_face" src="/gfx/standards/marker_face.png?r=1696937716"/> 
    ...
    <div class="partners_list_under">
      <iaixsl:if test="(count(page/partners/city) &gt; 1 ) and (count(page/partners/city/partner) &gt; $partnersLimit)">
        <iaixsl:for-each select="page/partners/city">
          <div>
            <iaixsl:attribute name="class">
              city_<iaixsl:number value="position()"/> city_wrapper
            </iaixsl:attribute>
          
            <div class="partners_list_under_sub">
<iaixsl:attribute name="class">big_label partners_list_under_sub</iaixsl:attribute>
            ...
            <iaixsl:for-each select="partner">
              <div class="partners_list_under_wrapper">
              
                <div class="partners_list_under_wrapper_sub">
                  <iaixsl:choose>
                    <iaixsl:when test="not(card/@name = '') and card">
                      <span class="city_firm_name">            
                        <iaixsl:value-of select="card/@name"/>          
                      </span> 
                    </iaixsl:when>
                    <iaixsl:otherwise>
                      <iaixsl:choose>
                        <iaixsl:when test="not(@firmname = '')">
                          <span class="city_firm_name">            
                            <iaixsl:value-of select="@firmname"/>         
                          </span> 
                        </iaixsl:when>
                        <iaixsl:otherwise>
                          <span class="city_firm_name">
                            <iaixsl:if test="@name">                          
                              <span class="city_name"><iaixsl:value-of select="@name"/></span>
                            </iaixsl:if>
                            <iaixsl:if test="@lastname">
                              <iaixsl:value-of select="@lastname"/> 
                            </iaixsl:if>  
                          </span>                                               
                  ...
                  <iaixsl:if test="not(@address = '')">
                    <span class="city_address">           
                      <iaixsl:value-of select="@address"/>          
                    </span> 
                  </iaixsl:if>    
                  <iaixsl:if test="not(@zipcode = '')">
                    <span class="city_zipcode">           
                      <iaixsl:value-of select="@zipcode"/>          
                    </span> 
                  </iaixsl:if>  
                  <iaixsl:if test="not(@city = '')">
                    <span class="city_city">            
                      <iaixsl:value-of select="@city"/>         
                    </span> 
                  </iaixsl:if>
                  
                  <iaixsl:if test="not(@country = '')">

                    <script>
                      if ( partners_map.countryCheck ) {
                      var countryTemp = &apos;<iaixsl:value-of select="@country"/>&apos;;
                    ...
                    <span class="city_country">           
                      (<iaixsl:if test="@province"><iaixsl:value-of select="@province"/><iaixsl:text>, </iaixsl:text></iaixsl:if><iaixsl:value-of select="@country"/>)      
                    </span> 
                  </iaixsl:if>  
                  <iaixsl:if test="not(@phone1 = '')">
                    <span class="city_tel1">
                      Tel.: 
                      <iaixsl:value-of select="@phone1"/>         
                    </span> 
                  </iaixsl:if>  
                  <iaixsl:if test="not(@phone2 = '')">
                    <span class="city_tel2">
                      Tel.: 
                      <iaixsl:value-of select="@phone2"/>         
                    </span> 
                  </iaixsl:if>  
                  <iaixsl:if test="not(@email = '')">
                    <a class="city_email">
                    <iaixsl:attribute name="href">  
                      mailto:<iaixsl:value-of select="@email"/> 
                    </iaixsl:attribute>
                    <iaixsl:value-of select="@email"/>
                    </a>
                  </iaixsl:if>
                  <iaixsl:if test="not(card/@wwww = '')">
                    <a class="city_www" target="_blank">
                    <iaixsl:attribute name="href">  
                      http://<iaixsl:value-of select="card/@www"/>  
                    </iaixsl:attribute>
                    <iaixsl:value-of select="card/@www"/>
                    </a>
                  </iaixsl:if>
                  <iaixsl:if test="card/desc">
                    <a class="city_showDesc" onclick="event.stopPropagation();partners_map.showDesc(this);">
<iaixsl:attribute name="class">btn-small city_showDesc</iaixsl:attribute>
                      Beschreibung anzeigen  
                      <div class="city_desc">
                        <div class="city_desc_wrapper">
                          <iaixsl:value-of disable-output-escaping="yes" select="card/desc"/>
                        </div>
                      </div>
                    </a>
                  </iaixsl:if>
                    <a class="show_on_map" onclick="partners_map.markerOnClick(this);">
<iaixsl:attribute name="class">btn-small show_on_map</iaixsl:attribute>
                      <iaixsl:if test="not(card/desc)"><iaixsl:attribute name="class">show_on_map btn-small noDesc</iaixsl:attribute></iaixsl:if>Auf Karte anzeigen</a>
                  <iaixsl:if test="card/@icon">
                    <img class="city_img"><iaixsl:attribute name="src"><iaixsl:value-of select="card/@icon"/></iaixsl:attribute></img>
                  </iaixsl:if>                
                </div>
              </div>
            </iaixsl:for-each>
      ...
      <iaixsl:if test="not(count(page/partners/city/partner) &gt; $partnersLimit)">
        <iaixsl:attribute name="class">
           partners_list_under limit
        </iaixsl:attribute>       
        <div class="partners_list_under_sub">
<iaixsl:attribute name="class">big_label partners_list_under_sub</iaixsl:attribute>
          <span class="partners_list_under_label">
              ...
              <div class="partners_list_under_wrapper under_limit">
                ...
                <div class="partners_list_under_wrapper_sub">
                  ...
                  <iaixsl:if test="not(@country = '')">
                    ...
                    <span class="city_country">           
                      <iaixsl:value-of select="@country"/>          
                    </span> 
                  </iaixsl:if>  
                  <iaixsl:if test="not(@phone1 = '')">
                    <span class="city_tel1">
                  ...
                  <iaixsl:if test="card/desc">
                    ...
                    <a class="show_on_map" onclick="partners_map.markerOnClick(this);">
                      <iaixsl:if test="not(card/desc)"><iaixsl:attribute name="class">show_on_map noDesc</iaixsl:attribute></iaixsl:if>Auf Karte anzeigen</a>
                  <iaixsl:if test="card/@icon">
                    <img class="city_img"><iaixsl:attribute name="src"><iaixsl:value-of select="card/@icon"/></iaixsl:attribute>  </img>
                  </iaixsl:if>                
                </div>
    ...
    <div id="partners_list_none">
      ...
      <div id="partners_list_city_pop">
        ...
        <div class="partners_list_city_search_wrapper">
          <input class="partners_list_city_search" id="city_search" type="text" name="text" onkeyup="partners_map.citySearch(this);" onfocus="partners_map.clearInput(this)" onblur="partners_map.clearInput(this)">
            <iaixsl:attribute name="value">Stadt suchen ...</iaixsl:attribute>
          </input>
        </div>
        
        <div class="partners_list_city_list_wrapper">
          <span class="partners_list_noResult">
            die Stadt wurde nicht gefunden
          </span>
          <iaixsl:for-each select="page/partners/city">
            <div class="city_list_element">
              <a class="city_list_city" onclick="partners_map.showSelectedCityList(this);">
                <iaixsl:attribute name="rel">
                  <iaixsl:number value="position()"/>
                </iaixsl:attribute>         
                <iaixsl:value-of select="@name"/>  
              </a>
              <span class="city_list_info">
                (Partner: 
                <iaixsl:value-of select="count(partner)"/> 
                )
              </span>
            </div>
          </iaixsl:for-each>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
        ...
        <!-- (menu_maps, 63764495e0cb08.91568922.2)-->
		</footer>
	</iaixsl:if>
	<iaixsl:variable name="projector_script_bottom">true</iaixsl:variable>
