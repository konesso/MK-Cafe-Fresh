...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (signin_cms, 60dd8e7ab50b99.33137233.2)-->
        ...
        <!-- (signin-form, 61b0b16d3e6ce9.24410838.3)-->
            ...
            <div id="signin-form_box_left" class="signin-form_box col-md-8 col-sm-7 col-12">
                ...
                <iaixsl:choose>
                    <iaixsl:when test="not(/shop/client_data/@signin = 'cookie') and /shop/client_data/@iai_accounts = 'consent' and (not(/shop/client_data/@last_login_option = 'shop'))">
                        ...
                        <iaixsl:if test="count(login_options/service) &gt; 0">
                            <div id="cookie_login_social_more">
                                <ul>
                                    <iaixsl:for-each select="login_options/service[not(@name='shop_register')]">
                                        <li class="tooltip__wrapper">
																				<iaixsl:if test="@name = $social_media_name">
																					<iaixsl:attribute name="class">tooltip__wrapper --active</iaixsl:attribute>
																				</iaixsl:if>
																						<iaixsl:if test="@name = $social_media_name">
																							<div id="cookie_login_social" class="iai_accounts tooltip --top">
																									<span id="cookie_login_social_desc" class="iai_accounts">
																													Melden Sie sich bei <strong>IdoAccounts</strong> über <iaixsl:value-of select="$social_media_name"/>, an und Ihre Versanddaten werden basierend auf früheren Bestellungen automatisch vervollständigt.
																									</span>
																							</div>
                                            </iaixsl:if>
                                            <iaixsl:choose>
                                                <iaixsl:when test="@login_url">
                                                    <a class="btn --outline --medium --icon-left service_item">
                                                        ...
                                                        <span style="display: none;"><iaixsl:value-of select="@name"/></span>
                                                    </a>
                                                </iaixsl:when>
                                                <iaixsl:otherwise>
                                    ...
                                    <iaixsl:for-each select="login_options/service[not(@name='shop_register')]">
                                        <li class="tooltip__wrapper">
																					<iaixsl:if test="@name = $social_media_name">
																						...
																						<iaixsl:if test="@name = $social_media_name">
																							<div id="cookie_login_social" class="tooltip --top">
																								...
																								<span id="cookie_login_social_desc">
																										<iaixsl:choose>
																												<iaixsl:when test="not(/shop/client_data/@iai_accounts = 'consent')">
																														...
																														Erneut über <iaixsl:value-of select="$social_media_name"/>, einloggen. 
																												</iaixsl:when>
																												<iaixsl:otherwise>
																														<iaixsl:attribute name="class">iai_accounts</iaixsl:attribute>
																														Melden Sie sich bei <strong>IdoAccounts</strong> über <iaixsl:value-of select="$social_media_name"/>, an und Ihre Versanddaten werden basierend auf früheren Bestellungen automatisch vervollständigt.
                                ...
                                <div id="client_new_social">
                                    ...
                                    <div class="client_new_social_sub">
                                        ...
                                        <iaixsl:if test="not(page/client-data/@allow_register = 'false')">
                                            <p> Wenn Sie ein Konto bei einem der folgenden Dienste haben, können Sie damit ein Konto erstellen und sich später anmelden.<br/><br/> <b>Wenn Sie bereits ein Konto haben</b> Zu Ihrer eigenen Bequemlichkeit können Sie es mit einer Anmeldung bei Ihrem bevorzugten Dienst kombinieren. Loggen Sie sich dazu zunächst ein und gehen Sie dann zur Bearbeitung Ihrer Daten, wo Sie das entsprechende Tool finden, um Ihr Konto zu verknüpfen.</p>
                                        </iaixsl:if>
                            ...
                            <div class="form-group">
                                <div class="has-feedback">
                                    <input id="user_login" type="text" class="form-control" name="login">
                                        <iaixsl:choose>
                                          <iaixsl:when test="/shop/client_data/@signin = 'cookie' and /shop/client_data/@email">
                                          ...
                                          <iaixsl:when test="/shop/client_data/@signin = 'cookie' and /shop/basket/@login">
                        ...
                        <div class="signin_inputs col-md-10 col-12">
                            <div class="form-group">
                                <div class="has-feedback">
                                    ...
                                    <label for="user_mail_recover" class="control-label">E-Mail-Adresse</label>
                                    <span class="form-control-feedback"/>
                                </div>
                                <div class="form-desc">
                    ...
                    <div class="signin-form_box_sub">
                        <iaixsl:choose>
                            <iaixsl:when test="page/actions/client_once">
                                ...
                                <p class="registration_desc">Wenn Sie noch kein Konto in unserem Shop erstellt haben, bitten wir Sie darum, Ihre Daten anzugebe.</p>
