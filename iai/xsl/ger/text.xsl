...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (text, 60dd8e849cfa75.78919745.4)-->
			<section id="Text" class="text_menu">
				
				<iaixsl:if test="page/text/@name != ''">
					<h1 class="text_menu__label headline">
						<span class="headline__name"><iaixsl:value-of disable-output-escaping="yes" select="page/text/@name"/></span>
					</h1>
				</iaixsl:if>
				...
				<iaixsl:if test="/shop/page/text/@displayindex='true' and /shop/page/cmsindex/documentsgroup[@type = /shop/page/text/@type]/subdocument">
					<div class="text_menu__wrapper px-3 pt-3 pb-2 mb-4">
						<strong class="text_menu__sublabel d-block mb-2">Inhaltsverzeichnis</strong>
						<ul class="text_menu__list row">
							<iaixsl:for-each select="/shop/page/cmsindex/documentsgroup[@type = /shop/page/text/@type]/subdocument">
								<li class="text_menu__item col-12 col-sm-6 col-md-4 mb-1">
									<a class="text_menu__link">
										<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
										<iaixsl:value-of select="@name"/>
									</a>
								</li>
		...
		<!-- (text_facebook_comments, 60dd8e7d79b0f8.86094661.2)-->
            <iaixsl:if test="page/facebook_comments">
        ...
        <!-- (text_cms_associated, 614c5cefdc1769.06773402.4)-->
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/ger/envelope.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_omnibus.js.gzip?r=1696937760"></script>
