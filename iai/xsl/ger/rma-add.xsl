            ...
            <form id="rma_add_form" method="post" action="/rma-add.php">
                ...
                <div class="rma_add_form_section" id="rma_add_form_section1">
                    <div class="rma_add_form_sectionheader">
                        <span class="rma_add_form_sectionheader">Rechnungsdaten und Lieferadresse</span>
                    </div>
                    <iaixsl:if test="not(page/rma/@action = 'view')">
                                        ...
                                        <iaixsl:choose>
                                            <iaixsl:when test="page/rma/@action = 'view'">
                                                <iaixsl:choose>
                                                    ...
                                                    <iaixsl:when test="page/rma/payments/payment[@checked = 'true']/@type = 't'">Geld, das Sie bei künftigen Einkäufen verwenden können</iaixsl:when>
                                                </iaixsl:choose>
                                            </iaixsl:when>
                                            <iaixsl:otherwise>
                                                    ...
                                                    <iaixsl:when test="@type = 'p'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/standards/need.gif?r=1696937716"><iaixsl:attribute name="alt">Dieses Feld muss ausgefüllt werden, um die Bestellung aufzugeben</iaixsl:attribute></img>
