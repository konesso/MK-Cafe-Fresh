...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
	...
	<iaixsl:variable name="grossPriceReturnDetails"> inkl. MwSt</iaixsl:variable>
				...
				<div class="returnDetails__list">
					<iaixsl:choose>
						...
						<iaixsl:when test="page/return_method/@id=1">
							<iaixsl:variable name="returns_1">Laden Sie das Rücksendeformular und das Versandetikett herunter.</iaixsl:variable>
							<iaixsl:variable name="returns_1_2">Ladenpersonal wird es brauchen.</iaixsl:variable>
							<iaixsl:variable name="returns_1_3">Laden Sie das Rücksendeformular herunter</iaixsl:variable>

							<iaixsl:variable name="returns_2">Verpacken Sie die zurückgesendete Ware und legen Sie das ausgedruckte Rücksendeformular bei.</iaixsl:variable>
							<iaixsl:variable name="returns_2_2">Das Dokument erleichtert Ihnen die Abwicklung Ihrer Rücksendung.</iaixsl:variable>
							
							<iaixsl:variable name="returns_3">Liefern Sie das Paket selbst bei </iaixsl:variable>
							<iaixsl:variable name="returns_3_2">Informieren Sie sich vor der Abfahrt über die Öffnungszeiten der Abgabestelle.</iaixsl:variable>
									...
									<b>
										...
										<iaixsl:if test="page/return_method/@id=1 or page/return_method/@id=3">
											<a>
												...
												<iaixsl:attribute name="title"> Adresse des Rückkehrpunkts.</iaixsl:attribute>
													Adresse des Rückkehrpunkts.
											</a>
										</iaixsl:if>
									</b>
						...
						<iaixsl:when test="page/return_method/@id=2 or page/return_method/@id=5">
							<iaixsl:variable name="returns_1">Laden Sie das Rücksendeformular und das Versandetikett herunter.</iaixsl:variable>
							<iaixsl:variable name="returns_1_2">Das Etikett wird benötigt, um das Paket zu versenden.</iaixsl:variable>
							<iaixsl:variable name="returns_1_3">Formular und Versandetikett herunterladen</iaixsl:variable>

							<iaixsl:variable name="returns_2">Verpacken Sie die zurückgesendete Ware und legen Sie das ausgedruckte Rücksendeformular bei.</iaixsl:variable>
							<iaixsl:variable name="returns_2_2">Bringen Sie das beigefügte Etikett am Paket an. Das Dokument erleichtert Ihnen die Abwicklung Ihrer Rücksendung.</iaixsl:variable>
							
							<iaixsl:variable name="returns_3">Senden Sie das Paket gemäß den Anweisungen im Rücksendeformular.</iaixsl:variable>
							<iaixsl:variable name="returns_3_2">Denken Sie daran, dass dem Paket ein Kurieretikett beigefügt ist.</iaixsl:variable>
						...
						<iaixsl:when test="page/return_method/@id=4">
							<iaixsl:variable name="returns_1">Laden Sie das Rücksendeformular und den Rücksendecode herunter.</iaixsl:variable>
							<iaixsl:variable name="returns_1_2">Der Retourencode wird benötigt, um ein Paket in einem Paketschließfach zu versenden.</iaixsl:variable>
							<iaixsl:variable name="returns_1_3">Laden Sie das Rücksendeformular und den Code herunter</iaixsl:variable>

							<iaixsl:variable name="returns_2">Verpacken Sie die zurückgesendete Ware und drucken Sie, wenn möglich, das Rücksendeformular aus und fügen Sie es bei.</iaixsl:variable>
							<iaixsl:variable name="returns_2_2">Das Dokument erleichtert Ihnen die Abwicklung Ihrer Rücksendung.</iaixsl:variable>
							
							<iaixsl:variable name="returns_3">Versenden Sie das Paket am InPost Paketfach oder PaczkoPunkt.</iaixsl:variable>
								...
								<div class="returnDetails__listDesc">
									...
									<iaixsl:choose>
										<iaixsl:when test="page/return_method/@return_code">
											Verwenden Sie den generierten Rückkehrcode:
										</iaixsl:when>
										<iaixsl:otherwise>
											Verwenden Sie den generierten Returncode, den Sie im heruntergeladenen Formular finden.
										</iaixsl:otherwise>
									</iaixsl:choose>
									</span>
								</div>
						...
						<iaixsl:otherwise>
							...
							<iaixsl:variable name="returns_3">Senden Sie das Paket an </iaixsl:variable>
							<iaixsl:variable name="returns_3_2">Die Adresse finden Sie unten auf der Seite.</iaixsl:variable>
			...
			<div class="returnDetails__buttons">
				<iaixsl:if test="/shop/page/editlink/@url">
					<a class="btn --solid --medium --outline prepaid-edit">
						...
						<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/editlink/@url"/></iaixsl:attribute>ändern Beschwerde</a>
				</iaixsl:if>
				<iaixsl:if test="/shop/page/cancellink/@url">
					<a class="btn --solid --medium --outline prepaid-cancel">
						...
						<iaixsl:attribute name="title">Retoure stornieren</iaixsl:attribute>
