...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
	...
	<iaixsl:variable name="grossPriceOrder2"> inkl. MwSt</iaixsl:variable>
	...
	<div class="n57856_order_overtaker">
		<form class="order2_form">
			...
			<div class="big_label order2_info_label">
				<span class="n57856_label d-none d-lg-block" id="labels">Einzelheiten:
				</span>
			</div>
							...
							<iaixsl:choose>
								...
								<iaixsl:when test="/shop/page/order2/orderdetails/@express_checkout = 'true' and /shop/page/order2/orderdetails/@payment_id = '236' and (not(page/order2/deliveryaddress/@phone) or page/order2/deliveryaddress/@phone = '')">
									<span class="order2_info1_sub_phone --no-phone">
										...
										<span class="order2_info1_sub_phone_label">Telefonnummer: </span>
										...
										<span class="f-group --small order2_info1_sub_phone_empty">
											...
											<label class="f-label" for="order2TelInput">Telefonnummer</label>
							...
							<iaixsl:if test="/shop/basket/delivery_time/@days and not(basket/@shipping_undefined = 'true')">
									...
									<span>
										<iaixsl:choose>
											<iaixsl:when test="(/shop/page/order2/orderdetails/@deliveryid = '0-0') or (/shop/page/order2/orderdetails/@deliveryid = '0-1')">
												<span class="delivery_time_order_text">Ihre Bestellung abholen - </span>
											</iaixsl:when>
											<iaixsl:otherwise>
												<span class="delivery_time_order_text">Voraussichtliche Lieferung - </span>
											</iaixsl:otherwise>
										</iaixsl:choose>
								...
								<iaixsl:if test="/shop/allow_division_order/@turn_on = 'yes' and /shop/basket/shipping_division_time/@week_amount">
									<div class="shipping_time_division">
										...
										<span>
											Produkte mit längeren Wartezeiten - bereit für den Versand <span class="order2__division_literal">Versand in </span>
											<strong/>
										</span>
									</div>
								</iaixsl:if>
			...
			<iaixsl:if test="/shop/basket/delay_time/@unknown_delivery_time = 'true'">
				<div class="unknown_delivery_time">
					<i class="icon-truck"/>
					<div>
						<b>Es befindet sich ein individuelles Produkt im Warenkorb.</b> Um die für die Vorbereitung der Bestellung zum Versand benötigte Zeit einzuschätzen,
						<a target="_blank">
					...
					<div class="basketedit_summary_sub">
						...
						<div class="basketedit_summary_right">
							...
							<div class="basketedit_total_summary">
								...
								<strong>
									<iaixsl:value-of select="/shop/basket/summary/total_to_pay/@value_formatted"/><iaixsl:if test="not($priceTypeVat = '')"><span class="price_vat"> inkl. MwSt</span></iaixsl:if>
								</strong>
							...
							<iaixsl:if test="not($returns_agree_control)">
								<div class="order2_terms_wrapper_sub">
									<label class="order2_cancel">
										...
										<i class="css-label"/>
										<span><i class="icon-need"/>  Ich habe die
											<a target="_blank"><iaixsl:attribute name="title">Widerruf</iaixsl:attribute><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/order_cancel/@url"/></iaixsl:attribute>Widerrufsbelehrung gelesen</a><iaixsl:text>.</iaixsl:text>
										</span>
									</label>
								</div>
							</iaixsl:if>
							...
							<iaixsl:if test="page/order2/ordersproducts//product[@product_type = 'product_virtual']">
								<div class="order2_terms_wrapper_sub virtual">
									<label class="order2_virtual">
										...
										<i class="css-label"/>
										<span><i class="icon-need"/>  Ja, ich möchte sofort Zugang zu dem digitalen Inhalt und weiß, dass mein Widerrufsrecht mit dem Zugang erlischt.</span>
									</label>
								</div>
							</iaixsl:if>
							...
							<iaixsl:if test="page/order2/ordersproducts//product[@product_type = 'product_service']">
								<div class="order2_terms_wrapper_sub service">
									<label class="order2_service">
										...
										<i class="css-label"/>
										<span><i class="icon-need"/>  Ja, bitte beginnen Sie sofort mit der Dienstleistung. Mein Widerrufsrecht erlischt mit vollständiger Ausführung.</span>
									</label>
								</div>
							</iaixsl:if>
								...
								<input class="btn --solid --large order2_button_order terms_required" type="submit">
									<iaixsl:choose>
										<iaixsl:when test="/shop/page/order2/orderdetails/@express_checkout = 'true'">
											<iaixsl:attribute name="value">Kauf bestätigen</iaixsl:attribute>
										</iaixsl:when>
										
										<iaixsl:when test="/shop/page/order2/orderdetails/@payment_id = '203'">
											<iaixsl:attribute name="value">Ich bestelle und bezahle später</iaixsl:attribute>
										</iaixsl:when>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/ger/envelope.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/ger/order2.js.gzip?r=1696937760"></script>
