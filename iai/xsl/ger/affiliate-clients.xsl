...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (affiliate_clients_list, 60dd8e84073dd6.22755800.2)-->
  ...
  <iaixsl:if test="not(page/@type='affiliate-not-active')">
    ...
    <iaixsl:choose>
      <iaixsl:when test="count(page/clients_list/login)">
        <section class="affiliate --clients mb-4">
          <div class="affiliate__desc mb-4">Unten befindet sich die Liste aller Kunden, die aufgrund Ihrer Empfehlung ein Konto erstellt haben.</div>
          <div class="affiliate__table --two table">
...
<!-- (affiliate_clients_paging, 60dd8e7f2cae64.92284033.3)-->
