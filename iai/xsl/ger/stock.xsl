...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!-- (envelope, 60dd8eb7808547.00364708.18)-->
	...
	<iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
		...
		<head>
			...
			<script src="/gfx/ger/stock_info.js.gzip?r=1696937760"></script>
...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (stock_cms, 60dd8e763e11f7.71656539.9)-->
...
<iaixsl:attribute name="class">stock_cms_label  big_label</iaixsl:attribute>
    ...
    <!-- (stock_info, 60dd8e7d022be7.14557922.3)-->
                ...
                <div class="stock_info_details">
                    ...
                    <iaixsl:if test="page/stock/@city and (page/stock/@city != '')">
                        <div class="stock_info_section" id="stock_info_details_city">
                            <span class="stock_info_title">Ort</span>
                    ...
                    <iaixsl:if test="page/stock/@street and (page/stock/@street != '') or page/stock/@zipcode or (page/stock/@zipcode != '') or page/stock/@city and (page/stock/@city != '')">
                        <iaixsl:if test="($mapHide != '') and page/stock/google_api_key/@value">
                            ...
                            <a class="btn --solid show_on_map">
                                ...
                                <i class="icon-globe"/> <span class="d-none d-sm-inline">Auf Karte anzeigen</span><span class="d-sm-none">Landkarte</span>
                            </a>
                        </iaixsl:if>
                    </iaixsl:if>
                </div>
