...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (product_compare_cms, 60dd8e77ee9b56.08164048.3)-->
...
<iaixsl:if test="/shop/compare/@active"> </iaixsl:if>
    <!-- (product_compare_list, 614c5da6a40b48.32753671.6)-->
			<div id="product_compare_list_wrapper" class="hidePrev">
				<div id="product_compare_list" class="compare_page">
					...
					<iaixsl:variable name="nettoPrice"><iaixsl:if test="/shop/page/@price_type = 'net'"><iaixsl:value-of select="$priceTypeText"/></iaixsl:if></iaixsl:variable>
									...
									<td class="cmp_product">
										<div class="configure_item item_width">
											<a>
												...
												<iaixsl:attribute name="data-toggleTxt"><i class="icon-plus"/> Anzeigen</iaixsl:attribute>
												<i class="icon-minus"/> Verbirg
											</a>
											<a class="hideCol">
                        	...
                        	<iaixsl:otherwise>
                        		<img class="b-lazy" src="/gfx/standards/loader.gif?r=1696937716">
                        			...
                        			<iaixsl:attribute name="alt"><iaixsl:value-of disable-output-escaping="yes" select="name"/></iaixsl:attribute>
											...
											<iaixsl:variable name="var_size_min_formatted"><iaixsl:choose><iaixsl:when test="not($nettoPrice = '')"><iaixsl:value-of select="price/price/@size_min_net_formatted"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="price/price/@size_min_formatted"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
											<iaixsl:variable name="var_size_max_formatted"><iaixsl:choose><iaixsl:when test="not($nettoPrice = '')"><iaixsl:value-of select="price/price/@size_max_net_formatted"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="price/price/@size_max_formatted"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
											<iaixsl:variable name="var_points"><iaixsl:value-of select="price/price/@points"/></iaixsl:variable>
											<iaixsl:variable name="var_value"><iaixsl:choose><iaixsl:when test="not($nettoPrice = '')"><iaixsl:value-of select="price/price/@price_net"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="price/price/@value"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
											<iaixsl:variable name="var_price_formatted"><iaixsl:choose><iaixsl:when test="not($nettoPrice = '')"><iaixsl:value-of select="price/price/@price_net_formatted"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="price/price/@price_formatted"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
											<iaixsl:variable name="var_maxprice_formatted"><iaixsl:choose><iaixsl:when test="not($nettoPrice = '')"><iaixsl:value-of select="price/price/@maxprice_net_formatted"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="price/price/@maxprice_formatted"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
											...
											<div class="product_prices hideCol">
												<iaixsl:choose>
													<iaixsl:when test="$var_size_min_formatted != $var_size_max_formatted">
														<span class="price">
															...
															<iaixsl:value-of select="$var_size_max_formatted"/><span class="price_vat"><iaixsl:value-of select="$nettoPrice"/></span>
														</span>
													...
													<iaixsl:otherwise>
														<span class="price">
															...
															<iaixsl:value-of select="$var_price_formatted"/><span class="price_vat"><iaixsl:value-of select="$nettoPrice"/></span>
														</span>
														<iaixsl:if test="$var_maxprice_formatted != ''">
															<del class="max-price">
																
																<iaixsl:value-of select="$var_maxprice_formatted"/><span class="price_vat"><iaixsl:value-of select="$nettoPrice"/></span>
															</del>
														</iaixsl:if>
														<iaixsl:if test="$var_points != ''">
															<span class="point-price">
												...
												<iaixsl:if test="price/price/@unit_converted_price_formatted"><small class="unit_price"><iaixsl:value-of select="price/price/@unit_converted_price_formatted"/><iaixsl:text> / </iaixsl:text><iaixsl:value-of select="price/price/@unit_converted_format"/><span class="price_vat"><iaixsl:value-of select="$nettoPrice"/></span></small>
												</iaixsl:if>
											</div>
				...
				<div class="navigation">
					<a class="prev" href="#prev"><i class="icon-chevron-left"/></a>
					<a class="next" href="#next"><i class="icon-chevron-right"/></a>
				</div>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
        ...
        <!-- (menu_compare, 6374c9a3a9b958.90333095.2)-->
		</footer>
	</iaixsl:if>
	<iaixsl:variable name="projector_script_bottom">true</iaixsl:variable>
	...
	<script src="/gfx/ger/envelope.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/ger/menu_compare.js.gzip?r=1696937760"></script>
