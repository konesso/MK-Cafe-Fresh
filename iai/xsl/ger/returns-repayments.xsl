...
<iaixsl:stylesheet xmlns:php="http://php.net/xsl" xmlns:iaixsl="http://www.w3.org/1999/XSL/Transform" xmlns:iaielement="http://iai-system.com/ddd" xmlns:fb="http://www.facebook.com/2008/fbml" version="1.0" exclude-result-prefixes="php iaielement fb"><iaixsl:output indent="no" method="html" doctype-system="about:legacy-compat" version="1.0" encoding="UTF-8"/><iaixsl:strip-space elements="table tr td img"/><iaixsl:decimal-format name="yen" NaN="" grouping-separator="," decimal-separator="."/><iaixsl:template match="shop"><!-- (envelope, 60dd8eb7808547.00364708.18)-->
	...
	<iaixsl:if test="(action/set_render/item/@name = 'popup') or not(action/set_render/item)">
		...
		<head>
			...
			<script src="/gfx/ger/returns_repayments_form.js.gzip?r=1696937760"></script>
...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (returns_repayments_cms, 60dd8e77d847d8.34024099.2)-->
    ...
    <!-- (returns_repayments_form, 61f91642869651.04466349.4)-->
...
<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/returnsProducts/@url"/></iaixsl:attribute>
                        <span>2</span>
                        <p>
                            <i/>
...
<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/returnsMethod/@url"/></iaixsl:attribute>
                        <span>3</span>
                        <p>
                            <i/>
            	...
            	<div class="progress__item --rma --fifth --active d-md-none py-3">
					...
					<div class="progress__text">
						<strong class="progress__name">Rückerstattungsart auswählen </strong>
					</div>
				</div>

                <h1 class="big_label return_label d-none d-md-block">Rückerstattungsart auswählen </h1>
                                            ...
                                            <iaixsl:if test="@additional_field_name">
                                                <div class="form-group clearfix">
                                                    <div>
                                                        ...
                                                        <div>
                                                            <iaixsl:attribute name="class">has-feedback has-required</iaixsl:attribute>
