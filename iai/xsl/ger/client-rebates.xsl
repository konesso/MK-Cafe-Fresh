...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (client_rebates_cms, 60dd8e76e6d8a9.84064530.9)-->
    ...
    <!-- (client_rebates_info, 60dd8f7a276ef4.64348930.7)-->
			<div id="client_rebates_info" class="rebates_info">
				
				<iaixsl:if test="not(page/rebate_code/@active = 'y') and not(page/rebates_for_points/rebate) and not(page/basket_rebate or page/global_rebate or page/rebates/range_rebate/range or (page/rebates/@type = 'z' and (page/rebates/category or page/rebates/producer or page/rebates/series or page/rebates/product)) or not(page/rebates/other/@value = '0.00'))">
					<div class="rebates_message menu_messages_message mb-4">
						Im Moment haben Sie keinen Rabatt. Machen Sie sich bitte mit 
						<a href="/terms.php">
							<iaixsl:if test="not(/shop/action/terms/@url = '')">
				...
				<iaixsl:if test="page/rebates_codes/@active = 'y' or page/rebate_code/@active = 'y' or page/@card_discount_program_activated = 'true'">
					...
					<iaixsl:variable name="cardform">
						<form class="rebates_form --card d-flex align-items-center" action="/settings.php?from=client_rebate" method="post">
							<input name="global_rebates_codes" value="add" type="hidden"/>
							<div class="f-group m-0">
								<input name="rebates_codes" type="text" value="" class="f-control">
								...
								<label class="f-label">Rabattkartennummer</label>
							</div>
							<button class="rebates_form__submit btn --large --solid ml-3" type="submit">Aktivieren</button>
						</form>
					</iaixsl:variable>

					
					<iaixsl:variable name="codeform">
						<form class="rebates_form --code d-flex" action="/settings.php?from=client_rebate" method="post">
							<input name="global_rebates_codes" value="add" type="hidden"/>
							<div class="f-group m-0">
								<input name="rebates_codes" type="text" value="" class="f-control">
								</input>
								<label class="f-label">Rabattcodenummer</label>
							</div>
							<button class="rebates_form__submit btn --large --solid ml-3" type="submit">Aktivieren</button>
						</form>
					</iaixsl:variable>
					...
					<section class="rebates_forms mb-2">
						...
						<div class="row rebates_forms__wrapper mt-2 mt-md-4">
							<iaixsl:if test="page/@card_discount_program_activated = 'true' and not(page/rebate_code/@type='card_discount')">
								<div class="rebates_forms__sub --card col-sm-6 col-12 mb-3">
									...
									<iaixsl:if test="/shop/rebate_card_delete_client_advanced_rebate/@active = 'y' or /shop/rebate_card_delete_rebate_for_profit_points/@active = 'y' ">
										<div class="rebates_forms__info d-flex mt-1">
											Nach der Aktivierung der Rabattkarte wird der auf Ihrem Konto verfügbare Rabatt in der Bestellung nicht berücksichtigt.
										</div>
									</iaixsl:if>
								</div>
							</iaixsl:if>

							<iaixsl:if test="(page/rebates_codes/@active =  'y' or page/rebate_code/@active = 'y') and not(page/rebate_code/@type='rebate')">
								<div class="rebates_forms__sub --code col-sm-6 col-12 mb-3">
									
									<iaixsl:copy-of select="$codeform"/>
									...
									<iaixsl:if test="/shop/rebate_code_delete_client_advanced_rebate/@active = 'y' or /shop/rebate_code_delete_rebate_for_profit_points/@active = 'y' ">
										<div class="rebates_forms__info d-flex mt-1">
											Nach der Aktivierung des Rabattcodes wird der auf Ihrem Konto verfügbare Rabatt in der Bestellung nicht berücksichtigt.
										</div>
									</iaixsl:if>
								</div>
							</iaixsl:if>
					...
					<iaixsl:if test="page/rebate_code/@type='rebate' or page/rebate_code/@type='card_discount'">
						
						<iaixsl:variable name="rebate_type"><iaixsl:value-of select="page/rebate_code/@type"/></iaixsl:variable>
						<section class="rebates_active mb-4">
							<iaixsl:choose>
								<iaixsl:when test="$rebate_type = 'rebate'">
									<iaixsl:attribute name="data-type">code</iaixsl:attribute>
								</iaixsl:when>
								<iaixsl:otherwise>
									<iaixsl:attribute name="data-type">card</iaixsl:attribute>
								</iaixsl:otherwise>
							</iaixsl:choose>
							...
							<div class="rebates_active__wrapper p-2 d-sm-flex align-items-sm-center p-sm-4">
								
								<div class="rebates_active__sub --name">
									<iaixsl:choose>
										<iaixsl:when test="$rebate_type = 'rebate'">
											<span class="rebates_active__name">Aktiver Code:<strong><iaixsl:value-of disable-output-escaping="yes" select="page/rebate_code/@number"/></strong></span>
										</iaixsl:when>
										<iaixsl:otherwise>
											<span class="rebates_active__name"><strong><iaixsl:value-of disable-output-escaping="yes" select="page/discount_cards/item[@number = /shop/page/rebate_code/@number]/@name"/></strong></span>
										</iaixsl:otherwise>
									</iaixsl:choose>
								</div>
								...
								<div class="rebates_active__sub --info">
									...
									<iaixsl:if test="$rebate_type = 'card_discount'">
										<div class="rebates_active__param --number">
											Kartennummer: 
											<strong><iaixsl:value-of select="page/rebate_code/@number"/></strong>
										</div>
									</iaixsl:if>
									
									<iaixsl:if test="page/rebate_code/@min_order &gt; 0">
										<div class="rebates_active__param --min">
											Erforderlicher Warenkorbwert: 
											<strong><iaixsl:value-of select="page/rebate_code/@min_order_formatted"/></strong>
										</div>
									</iaixsl:if>
									
									<iaixsl:if test="page/rebate_code/@max_order &gt; 0">
										<div class="rebates_active__param --max">
									...
									<iaixsl:if test="page/rebate_code/@expires">
										<div class="rebates_active__param --expires">
											...
											<strong><iaixsl:value-of select="page/rebate_code/@expires"/></strong>
										</div>
									</iaixsl:if>
									...
									<iaixsl:if test="page/rebate_code/inactive_zones/item">
										<div class="rebates_active__param --inactive label_icons">
											...
											<iaixsl:for-each select="page/rebate_code/inactive_zones/item">
                                                <iaixsl:choose>
                                                    <iaixsl:when test="@name = 'promotion'">
                                                        <strong class="label --promo">Im Sonderangebot</strong>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@name = 'new'">
                                                        <strong class="label --new">Neu</strong>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@name = 'bestseller'">
                                                        <strong class="label --bestseller">Unser Bestseller</strong>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@name = 'discount'">
                                                        <strong class="label --discount">Preisreduzierung</strong>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@name = 'distinguished'">
                                                        <strong class="label --distinguished">Empfohlen</strong>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@name = 'special'">
                                                        <strong class="label --special">Produkt specjalny</strong>
                                                    </iaixsl:when>
                                                </iaixsl:choose>
											</iaixsl:for-each>
										</div>
								...
								<div class="rebates_active__sub --form d-none">
									<iaixsl:choose>
										<iaixsl:when test="$rebate_type = 'rebate'">
											<iaixsl:copy-of select="$codeform"/>
										</iaixsl:when>
								...
								<div class="rebates_active__sub --buttons --code">
                  <iaixsl:choose>
                    <iaixsl:when test="$rebate_type = 'rebate'">
                          <a class="btn --solid rebates_active__button --change" href="#">Ändern Sie die Kartennummer</a>
                    </iaixsl:when>
                    <iaixsl:otherwise>
                        <a class="btn --solid rebates_active__button --change" href="#">Ändern Sie die Kartennummer</a>
                    </iaixsl:otherwise>
                  </iaixsl:choose>
									<iaixsl:if test="$rebate_type = 'rebate'">
										<a class="btn --solid --secondary rebates_active__button --remove  mt-2 mt-sm-0 ml-sm-2" href="#">
					...
					<iaixsl:if test="page/discount_cards/item[not(@number = /shop/page/rebate_code/@number)]">
						<section class="rebates_inactive mb-4">
							<h2 class="headline">
								<span class="headline__name">
							...
							<div class="rebates_inactive__wrapper">
								<iaixsl:for-each select="page/discount_cards/item[not(@number = /shop/page/rebate_code/@number)]">
									<div class="rebates_inactive__item p-2 d-sm-flex align-items-sm-center p-sm-4">
										
										<div class="rebates_inactive__sub --name">
											<span class="rebates_inactive__name"><strong><iaixsl:value-of disable-output-escaping="yes" select="@name"/></strong></span>
										</div>

										
										<div class="rebates_inactive__sub --info">
											
											<div class="rebates_inactive__param --number">
												Kartennummer: 
												<strong><iaixsl:value-of select="@number"/></strong>
											</div>
											
											<iaixsl:if test="@expires">
												<div class="rebates_inactive__param --expires">
													Gültig bis: 
										...
										<div class="rebates_inactive__sub --buttons">
											<form class="rebates_inactive__sub --form" action="/settings.php?from=client_rebate" method="post">
												<input name="global_rebates_codes" value="add" type="hidden"/>
												<input name="rebates_codes" type="hidden">
													<iaixsl:attribute name="value"><iaixsl:value-of select="@number"/></iaixsl:attribute>
												</input>
												<button class="btn --solid rebates_inactive__button --active" type="submit">Aktivieren</button>
											</form>
										</div>
									</div>
								</iaixsl:for-each>
					...
					<iaixsl:if test="page/cards/item">
						<section class="rebates_cards mb-4">
							<h2 class="headline">
								<span class="headline__name">
									Kundenkarten
								</span>
							...
							<div class="rebates_cards__wrapper">
								<iaixsl:for-each select="page/cards/item">
									<div class="rebates_cards__item p-2 d-sm-flex align-items-sm-center p-sm-4">
										
										<div class="rebates_cards__sub --name">
											<span class="rebates_cards__name"><strong><iaixsl:value-of disable-output-escaping="yes" select="@name"/></strong>Gültig bis: <iaixsl:value-of select="@expires"/></span>
										</div>

										
										<div class="rebates_cards__sub --info">
											
											<div class="rebates_cards__param --number">
												Kartennummer: 
												<strong><iaixsl:value-of select="@number"/></strong>
											</div>
										</div>
										...
										<div class="rebates_cards__sub --status">
											<iaixsl:choose>
												<iaixsl:when test="@active = 'y'">
													<strong class="rebates_cards__active">aktiv</strong>
												</iaixsl:when>
												<iaixsl:when test="@active = 'n'">
													<strong class="rebates_cards__inactive">inaktiv</strong>
												</iaixsl:when>
											</iaixsl:choose>
										</div>
									</div>
				...
				<iaixsl:if test="page/basket_rebate or page/global_rebate or page/rebates/range_rebate/range or (page/rebates/@type = 'z' and (page/rebates/category or page/rebates/producer or page/rebates/series or page/rebates/product)) or not(page/rebates/other/@value = '0.00')">
					<section class="rebates_range mb-4">
						<h2 class="headline">
							<span class="headline__name">
								Verfügbare Rabatte
							</span>
						...
						<iaixsl:if test="page/rebates/range_rebate/range and not(/shop/page/basket_rebate/range)">
							<div class="rebates_range__wrapper --range">
								<div class="rebates_range__label">
									<strong class="rebates_range__label_txt">Staffelrabatt</strong>
									<div class="rebates_range__description">
										Wird anhand des Warenkorbwerts berechnet. 
										<iaixsl:choose>
											<iaixsl:when test="page/rebates/range_rebate/@combined='y' or page/rebates/range_rebate/@combined='m'">
												Der Rabatt wird mit anderen Rabatten summiert.
											</iaixsl:when>
											<iaixsl:otherwise>
												Der Rabatt wird mit anderen Rabatten nicht summiert.
								...
								<div class="rebates_range__table">
									
									<div class="rebates_range__block --label">
										<div class="rebates_range__item --threshold">
											Ab dem Bestellwert von
										</div>
										<iaixsl:if test="page/rebates/range_rebate[range/@points != '0.00']">
											<div class="rebates_range__item --points">
												Punktebonus
												</div>
										</iaixsl:if>
										<div class="rebates_range__item --value">
											Rabatthöhe
										</div>
									</div>
									...
									<iaixsl:for-each select="page/rebates/range_rebate/range">
										<div class="rebates_range__block">
											<iaixsl:if test="@used='y'"><iaixsl:attribute name="data-active">true</iaixsl:attribute></iaixsl:if>
											<div class="rebates_range__item --threshold">
												<iaixsl:value-of select="@threshold_formatted"/>
											</div>
											<iaixsl:if test="@points != '0.00'">
												<div class="rebates_range__item --points">
													<strong>+ <iaixsl:value-of select="format-number(@points, '#')"/> Pkt.</strong>
												</div>
											</iaixsl:if>
											<div class="rebates_range__item --value">
												<strong>
													<iaixsl:choose>
														<iaixsl:when test="contains(@value, '.00')">
															<iaixsl:value-of disable-output-escaping="yes" select="format-number(@value, '#')"/> %
														</iaixsl:when>
														<iaixsl:otherwise>
						...
						<iaixsl:if test="page/basket_rebate">
							<div class="rebates_range__wrapper --basket">
								<div class="rebates_range__label">
									<strong class="rebates_range__label_txt">Staffelrabatt</strong>
									<div class="rebates_range__description">
										Wird anhand des Warenkorbwerts berechnet. 
						...
						<iaixsl:if test="page/global_rebate">
							<div class="rebates_range__wrapper --global">
								<div class="rebates_range__label">
									<strong class="rebates_range__label_txt">Kumulativer Rabatt</strong>
									<div class="rebates_range__description">
										<iaixsl:choose>
											<iaixsl:when test="page/global_rebate/@order_days">
												Wird anhand des Gesamtwerts der in den letzten <iaixsl:value-of disable-output-escaping="yes" select="page/global_rebate/@order_days"/> Tage.
											</iaixsl:when>
											<iaixsl:otherwise>
												Wird anhand des Gesamtwerts der zuvor gekauften Produkte berechnet.
											</iaixsl:otherwise>
										</iaixsl:choose>
										<iaixsl:choose>
						...
						<iaixsl:if test="page/rebates/@type = 'z' and (page/rebates/category or page/rebates/producer or page/rebates/series)">
							<div class="rebates_range__wrapper --group">
								<div class="rebates_range__label">
									<strong class="rebates_range__label_txt">Gruppenrabatt</strong>
									<div class="rebates_range__description">
										Gruppenrabatte sind nicht kombinierbar. Im Fall der Überlagerung wird der höchste Wert genommen.
									</div>
								</div>

								<div class="rebates_range__products --group">
									
									<iaixsl:if test="page/rebates/category">
										<div class="rebates_product --category">
											<div class="rebates_product__label py-1 mb-2">
												Für ausgewählte Kategorien
											</div>
											<div class="rebates_product__products d-flex flex-wrap">
												<iaixsl:for-each select="page/rebates/category/item">
													<div class="rebates_product__product col-6 col-sm-3 d-flex flex-column p-2">
														<a class="rebates_product__name">
															<iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="@link"/></iaixsl:attribute>
															<iaixsl:attribute name="title"><iaixsl:value-of disable-output-escaping="yes" select="@name"/></iaixsl:attribute>
															<iaixsl:value-of disable-output-escaping="yes" select="@name"/>
														</a>
														<strong class="rebates_product__percent">
															<iaixsl:choose>
																<iaixsl:when test="contains(@value, '.00')">
									...
									<iaixsl:if test="page/rebates/producer">
										<div class="rebates_product --producer">
											<div class="rebates_product__label py-1 mb-2">
												Auf ausgewählte Marken
											</div>
											<div class="rebates_product__products d-flex flex-wrap">
												<iaixsl:for-each select="page/rebates/producer/item">
													<div class="rebates_product__product col-6 col-sm-3 d-flex flex-column p-2">
														<a class="rebates_product__name">
															<iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="@link"/></iaixsl:attribute>
															<iaixsl:attribute name="title"><iaixsl:value-of disable-output-escaping="yes" select="@name"/></iaixsl:attribute>
									...
									<iaixsl:if test="page/rebates/series">
										<div class="rebates_product --series">
											<div class="rebates_product__label py-1 mb-2">
												Auf ausgewählten Serien
											</div>
											<div class="rebates_product__products d-flex flex-wrap">
												<iaixsl:for-each select="page/rebates/series/item">
													<div class="rebates_product__product col-6 col-sm-3 d-flex flex-column p-2">
														<a class="rebates_product__name">
															<iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="@link"/></iaixsl:attribute>
															<iaixsl:attribute name="title"><iaixsl:value-of disable-output-escaping="yes" select="@name"/></iaixsl:attribute>
						...
						<iaixsl:if test="page/rebates/@type = 'z' and page/rebates/product">
							<div class="rebates_range__wrapper --specific">
								<div class="rebates_range__label">
									<strong class="rebates_range__label_txt">Detaillierter Rabatt</strong>
									<iaixsl:choose>
								...
								<div class="rebates_range__products --specific">
									<div class="rebates_product --specific">
										<div class="rebates_product__label py-1 mb-2">
											Auf ausgewählte Produkte
										</div>
										<div class="rebates_product__products d-flex flex-wrap">
											<iaixsl:for-each select="page/rebates/product/item">
												<div class="rebates_product__product col-6 col-sm-3 d-flex flex-column p-2">
													<a class="rebates_product__name">
														<iaixsl:attribute name="href"><iaixsl:value-of disable-output-escaping="yes" select="@link"/></iaixsl:attribute>
														<iaixsl:attribute name="title"><iaixsl:value-of disable-output-escaping="yes" select="@name"/></iaixsl:attribute>
						...
						<iaixsl:if test="not(page/rebates/other/@value = '0.00')">
							<div class="rebates_range__wrapper --other">
								<div class="rebates_range__label">
									<strong class="rebates_range__label_txt">Allgemeiner Rabatt</strong>
									<div class="rebates_range__description">
										<iaixsl:choose>
								...
								<div class="rebates_other --other">
									<div class="rebates_other__value --txt">
										<iaixsl:choose>
									...
									<strong class="rebates_other__value --percent">
										<iaixsl:choose>
				...
				<iaixsl:if test="page/rebate_code/@active = 'y' or page/rebates_for_points/rebate">
					<section class="rebates_individual mb-4">
						<h2 class="headline">
							<span class="headline__name">
						...
						<div class="rebates_individual__wrapper">
							
							<iaixsl:if test="page/rebate_code/inactive_zones/item">
								<div class="rebates_individual__label">
									<div class="rebates_individual__description label_icons">
										Der Rabatt betrifft nicht die folgendermaßen gekennzeichneten Produkte: 
										<iaixsl:for-each select="page/rebate_code/inactive_zones/item">
                                            <iaixsl:choose>
                                                <iaixsl:when test="@name = 'promotion'">
							...
							<iaixsl:if test="page/rebates_for_points/rebate">
								<div class="rebates_product --points">
									<div class="rebates_product__label py-1 mb-2">
										Punkte gegen Rabatt tauschen
									</div>
									<div class="rebates_product__products --points row mx-n1">
										<iaixsl:for-each select="page/rebates_for_points/rebate">
											<div class="rebates_product__product --points col-12 col-sm-4 col-md-3 d-flex flex-column pb-2 px-1">
												<iaixsl:choose>
													
													<iaixsl:when test="@selected = 'selected'">
														<iaixsl:attribute name="data-selected">true</iaixsl:attribute>
														<div class="rebates_product__points --selected">
															<strong class="rebates_product__point --rebate">IHR RABATT:</strong>
															<span class="rebates_product__point --txt">
																Rabatt 
															...
															<span class="rebates_product__point --value"><iaixsl:value-of select="format-number(@points, '#')"/> Pkt.</span>
														</div>
													</iaixsl:when>
													
													<iaixsl:otherwise>
														<a class="rebates_product__points --link">
															<iaixsl:attribute name="href"><iaixsl:value-of select="@order_link"/></iaixsl:attribute>
															<iaixsl:if test="/shop/rebate_for_profit_points_delete_client_advanced_rebate/@active = 'y' or /shop/rebate_for_profit_points_delete_rebate_code/@active = 'y'">
																<iaixsl:choose>
																	<iaixsl:when test="/shop/rebate_for_profit_points_delete_client_advanced_rebate/@active = 'y'">
																...
																<iaixsl:attribute name="class">rebates_product__points --link confirmation_link</iaixsl:attribute>
															</iaixsl:if>
							...
							<iaixsl:if test="page/rebate_code/@active = 'y'">
								...
								<iaixsl:if test="page/rebate_code/product/@active = 'y'">
									<div class="rebates_product --products">
										<div class="rebates_product__label py-1 mb-2">
											Auf ausgewählte Produkte
										</div>
										<div class="rebates_product__products d-flex flex-wrap">
											<iaixsl:for-each select="page/rebate_code/product/item">
												<div class="rebates_product__product col-6 col-sm-3 d-flex flex-column p-2">
													
													<a class="rebates_product__icon d-flex justify-content-center align-items-center">
														...
														<img src="/gfx/standards/loader.gif?r=1696937716" class="b-lazy">
															<iaixsl:attribute name="data-src-small"><iaixsl:value-of disable-output-escaping="yes" select="iconsmall"/></iaixsl:attribute>
															<iaixsl:attribute name="data-src"><iaixsl:value-of disable-output-escaping="yes" select="icon_src"/></iaixsl:attribute>
															<iaixsl:attribute name="alt"><iaixsl:value-of disable-output-escaping="yes" select="@name"/></iaixsl:attribute>
														</img>
													</a>
													...
													<strong class="rebates_product__percent">
                                                                                                                <iaixsl:if test="@maxprice_formatted">
                                                                                                                        <iaixsl:attribute name="class">rebates_product__percent --price</iaixsl:attribute>
                                                                                                                        <span class="maxPrice">
                                                                                                                                <iaixsl:value-of select="@maxprice_formatted"/>
                                                                                                                        </span>
                                                                                                                        <span class="price">
														...
														<iaixsl:choose>
															...
															<iaixsl:when test="@rebate_type='fixed_amount' or @rebate_type='quota'">
																<iaixsl:text> </iaixsl:text><iaixsl:value-of select="/shop/currency/@name"/>
															</iaixsl:when>
														</iaixsl:choose>
													</strong>
													
													<iaixsl:if test="(@calculate_from_price='client_price' and @price_type='net') or @calculate_from_price='suggested_retail_price' or @calculate_from_price='crossed_out_price'">
														<div class="rebates_product__info">
															<iaixsl:choose>
								...
								<iaixsl:if test="page/rebate_code/producer/@active = 'y'">
									<div class="rebates_product --producer">
										...
										<div class="rebates_product__products d-flex flex-wrap">
											<iaixsl:for-each select="page/rebate_code/producer/item">
												<div class="rebates_product__product col-6 col-sm-3 d-flex flex-column p-2">
													...
													<a class="rebates_product__icon d-flex justify-content-center align-items-center">
														...
														<iaixsl:choose>
															<iaixsl:when test="not(icon_src)">
																<iaixsl:attribute name="data-img">default</iaixsl:attribute>
															</iaixsl:when>
															<iaixsl:otherwise>
																<img src="/gfx/standards/loader.gif?r=1696937716" class="b-lazy">
																	<iaixsl:attribute name="data-src"><iaixsl:value-of disable-output-escaping="yes" select="icon_src"/></iaixsl:attribute>
								...
								<iaixsl:if test="page/rebate_code/series/@active = 'y'">
									<div class="rebates_product --series">
										...
										<div class="rebates_product__products d-flex flex-wrap">
											<iaixsl:for-each select="page/rebate_code/series/item">
												<div class="rebates_product__product col-6 col-sm-3 d-flex flex-column p-2">
								...
								<iaixsl:if test="(page/rebate_code/main_cat/@active = 'y') or (page/rebate_code/menu/@active = 'y')">
									<div class="rebates_product --category">
										...
										<div class="rebates_product__products d-flex flex-wrap">
											<iaixsl:for-each select="page/rebate_code/main_cat/item">
												<div class="rebates_product__product col-6 col-sm-3 d-flex flex-column p-2">
											...
											<iaixsl:for-each select="page/rebate_code/menu/item">
												<div class="rebates_product__product col-6 col-sm-3 d-flex flex-column p-2">
								...
								<iaixsl:if test="page/rebate_code/gratis/@active = 'y'">
									<div class="rebates_product --gratis">
										<div class="rebates_product__label py-1 mb-2">
											Geschenk zur Bestellung
										</div>
										<div class="rebates_product__products d-flex flex-wrap">
											<iaixsl:for-each select="page/rebate_code/gratis/item">
												<div class="rebates_product__product col-6 col-sm-3 d-flex flex-column p-2">
								...
								<iaixsl:if test="page/rebate_code/products_rebate/@active = 'y'">
									<div class="rebates_other --entire">
										<div class="rebates_other__value --txt">
											
											Für das gesamte Sortiment
											
											<iaixsl:if test="(page/rebate_code/products_rebate/@calculate_from_price='client_price' and page/rebate_code/products_rebate/@price_type='net') or page/rebate_code/products_rebate/@calculate_from_price='suggested_retail_price' or page/rebate_code/products_rebate/@calculate_from_price='crossed_out_price'">
												<div class="rebates_other__info">
													<iaixsl:choose>
								...
								<iaixsl:if test="page/rebate_code/other_products_rebate/@active = 'y'">
									<div class="rebates_other --another">
										<div class="rebates_other__value --txt">
											
											Rabatt für weitere Produkte
											
											<iaixsl:if test="(page/rebate_code/other_products_rebate/@calculate_from_price='client_price' and page/rebate_code/other_products_rebate/@price_type='net') or page/rebate_code/other_products_rebate/@calculate_from_price='suggested_retail_price' or page/rebate_code/other_products_rebate/@calculate_from_price='crossed_out_price'">
												<div class="rebates_other__info">
													<iaixsl:choose>
								...
								<iaixsl:if test="page/rebate_code/shipping_cost_rebate/@active = 'y'">
									<div class="rebates_other --shipping">
										<div class="rebates_other__value --txt">
											
											Versandkostenrabatt
											
											<iaixsl:if test="page/rebate_code/shipping_cost_rebate/@price_type='net'">
												<div class="rebates_other__info">
										...
										<strong class="rebates_other__value --percent">
											...
											<iaixsl:choose>
												<iaixsl:when test="page/rebate_code/shipping_cost_rebate/@rebate_type='p' or page/rebate_code/shipping_cost_rebate/@rebate_type='percentage'">
													 %
												</iaixsl:when>
												<iaixsl:when test="page/rebate_code/shipping_cost_rebate/@rebate_type='fixed_amount' or page/rebate_code/shipping_cost_rebate/@rebate_type='quota'">
													<iaixsl:text> </iaixsl:text><iaixsl:value-of select="/shop/currency/@name"/>
												</iaixsl:when>
											</iaixsl:choose>
										</strong>
