...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (rma_sites_cms, 60dd8e7836d9e5.12636508.2)-->
    ...
    <!-- (rma_sites_form, 61f913c77e41f2.01513174.2)-->
...
<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/rmaMethod/@url"/></iaixsl:attribute>
                ...
                <iaixsl:choose>
                    <iaixsl:when test="count(page/pickups/pickup) &gt; 1">
                    	<div class="progress__item --rma --fourth --active d-md-none py-3">
        					<div class="progress__icons">
        						<div class="progress__icon --mobile d-md-none">
        							<span class="progress__step"><strong>4</strong><span>/6</span></span>
        							<svg class="progress__svg"><circle class="progress__circle_back"/><circle class="progress__circle"/></svg>
        						</div>
        					</div>
        					<div class="progress__text">
        						<strong class="progress__name">Wählen Sie den gewünschten Standort für die Rückgabe Ihrer Bestellung aus</strong>
        					</div>
        				</div>
                        <h1 class="big_label return_label d-none d-md-block">Wählen Sie den gewünschten Standort für die Rückgabe Ihrer Bestellung aus</h1>
                    ...
                    <iaixsl:otherwise>
                    	<div class="progress__item --rma --fourth --active d-md-none py-3">
        					...
        					<div class="progress__text">
        						<strong class="progress__name">Standort für die Rückgabe der Bestellung</strong>
        					</div>
        				</div>
                        <h1 class="big_label return_label d-none d-md-block">Standort für die Rückgabe der Bestellung</h1>
