...
<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/rmaProducts/@url"/></iaixsl:attribute>
            	...
            	<div class="progress__item --rma --third --active d-md-none py-3">
					...
					<div class="progress__text">
						<strong class="progress__name">W jaki sposób chciałbyś dostarczyć reklamowany produkt?</strong>
					</div>
				</div>

                <h1 class="big_label return_label d-none d-md-block">W jaki sposób chciałbyś dostarczyć reklamowany produkt?</h1>
