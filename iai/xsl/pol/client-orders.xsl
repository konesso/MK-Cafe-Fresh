			...
			<iaixsl:when test="page/orders/@mode = 'rma'">
				...
				<div class="progress__item --rma --first d-md-none --active py-3">
							...
							<div class="progress__text">
								<strong class="progress__name">Wybierz zamówienie, z którego chcesz reklamować produkt</strong>
							</div>
						</div>
				<div class="client_order__labelWrapper my-2">
					<h1 class="big_label d-none d-md-block">
						Wybierz zamówienie, z którego chcesz reklamować towary
					</h1>
					<div>
						<span class="progress__listIcon"/>
						<a href="client-orders.php?display=closed"><iaixsl:if test="/shop/action/clientOrders/@url"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientOrders/@url"/>?display=closed</iaixsl:attribute></iaixsl:if>Lista zrealizowanych zamówień</a>
					</div>
				</div>

        <div class="progress__rmaHelper">
          <span class="progress__iconRMA"/> Wygodny kreator poprowadzi Cię krok po kroku przez cały proces.
        </div>
			...
			<iaixsl:when test="page/orders/@mode = 'returns'">
				...
				<div class="progress__item --rma --first d-md-none --active py-3">
							...
							<div class="progress__text">
								<strong class="progress__name">Wybierz zamówienie, z którego chcesz zwrócić produkty</strong>
							</div>
						</div>
				<div class="client_order__labelWrapper my-2">
					<h1 class="big_label d-none d-md-block">
			...
			<iaixsl:when test="page/orders/@mode = 'closed'">
				<div class="client_order__labelWrapper my-2">
					...
					<div>
            <span class="progress__listIcon"/>
            <a href="client-orders.php?display=opened"><iaixsl:if test="/shop/action/clientOrders/@url"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/clientOrders/@url"/>?display=opened</iaixsl:attribute></iaixsl:if>Lista aktualnie realizowanych zamówień</a>
          </div>
				</div>
			</iaixsl:when>
			<iaixsl:otherwise>
									...
									<div><iaixsl:attribute name="class">btn-icon prepaid-icon status-<iaixsl:value-of select="$status_order"/></iaixsl:attribute>
										<iaixsl:choose>
											...
											<iaixsl:when test="$status_order = 'wp'">
												<span><i class="icon-clock"/></span>
												<small>oczekuje na termin pakowania</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'wr'">
												<span><i class="icon-clock"/></span>
												<small>oczekuje na termin odbioru</small>
											</iaixsl:when>
											<iaixsl:when test="$status_order = 'wd'">
												<span><i class="icon-clock"/></span>
												<small>oczekuje na termin wysłania</small>
											</iaixsl:when>
								...
								<td>
									<iaixsl:choose>
										<iaixsl:when test="@returns_url">
											<a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@returns_url"/></iaixsl:attribute><span><i class="icon-plus"/></span><small>Wybierz</small></a>
										</iaixsl:when>
										<iaixsl:when test="@rma_url">
											<a class="btn see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@rma_url"/></iaixsl:attribute><span><i class="icon-plus"/></span><small>Wybierz towary do reklamacji</small></a>
										</iaixsl:when>
										<iaixsl:otherwise>
											<a class="btn --icon-left icon-plus --medium see_button pr-0"><iaixsl:attribute name="href"><iaixsl:value-of select="@orderdetails"/></iaixsl:attribute><span><i class="icon-plus"/></span><small>Zobacz</small></a>
										</iaixsl:otherwise>
									</iaixsl:choose>
								</td>
							</tr>
