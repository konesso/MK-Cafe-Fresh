                ...
                <iaixsl:choose>
                    <iaixsl:when test="count(page/pickups/pickup) &gt; 1">
                    	<div class="progress__item --rma --fourth --active d-md-none py-3">
        					...
        					<div class="progress__text">
        						<strong class="progress__name">Wybierz adres punktu reklamacyjnego</strong>
        					</div>
        				</div>
                        <h1 class="big_label return_label d-none d-md-block">Wybierz adres punktu reklamacyjnego</h1>
                    ...
                    <iaixsl:otherwise>
                    	<div class="progress__item --rma --fourth --active d-md-none py-3">
        					...
        					<div class="progress__text">
        						<strong class="progress__name">Adres punktu reklamacyjnego</strong>
        					</div>
        				</div>
                        <h1 class="big_label return_label d-none d-md-block">Adres punktu reklamacyjnego</h1>
