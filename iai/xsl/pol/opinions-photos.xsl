		...
		<iaixsl:when test="count(page/opinions-photos/opinions/opinion[@image_small or @image_large]) &gt; 0">
			...
			<div id="opinions">
				...
				<p class="opinions-description">
					Chcesz dodać swoje zdjęcie? Możesz to zrobić pisząc opinię i dodając swoje zdjęcie o jednym z produktów. Aby szybciej znaleźć takie produkty, skorzystaj z <a href="/products-bought.php">listy kupionych produktów</a>.
					<iaixsl:if test="page/opinions-photos/opinions/@product_photo_loyalty_points">
					<br/>

						Za każdą opinię ze zdjęciem otrzymasz od nas <iaixsl:value-of select="page/opinions-photos/opinions/@product_photo_loyalty_points"/> 
						pkt. w programie lojalnościowym.</iaixsl:if>
		...
		<iaixsl:otherwise>
			<div id="opinions" class="d-flex flex-column align-items-center --empty">
				...
				<p class="opinions-description">
					...
					Dodaj zdjęcie do opinii o dowolnym produkcie. Aby szybciej znaleźć takie produkty, skorzystaj z <a href="/products-bought.php">listy kupionych produktów</a>.
					<iaixsl:if test="false">
					
					<br/>
						Za każdą opinię ze zdjęciem otrzymasz od nas %s
						pkt. w programie lojalnościowym.</iaixsl:if> 
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/pol/envelope.js.gzip?r=1696937760"></script><script src="/gfx/pol/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/pol/opinions_photos_display.js.gzip?r=1696937760"></script>
