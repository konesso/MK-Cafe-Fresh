                    ...
                    <iaixsl:when test="@name = 'creditCard[system]'">
                        <div class="payment_card_formel cc_wrapper">
                            ...
                            <span class="payment_card_need">
                                <img src="/gfx/standards/need.gif?r=1696937716" class="payment_card_nedd_img"><iaixsl:attribute name="alt">To pole jest wymagane do dokonania płatności</iaixsl:attribute><iaixsl:attribute name="title">To pole jest wymagane do złożenia zamówienia</iaixsl:attribute></img>
