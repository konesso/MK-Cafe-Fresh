...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (menu_blog, 60dd8eb6ef6318.25576994.3)-->
                ...
                <iaixsl:if test="action/blog_rss"> 
                    <div id="menu_blog_rss">
                        <a>
                            ...
                            <iaixsl:attribute name="title">Kanał RSS <i class="icon-rss"/></iaixsl:attribute>
                            Kanał RSS <i class="icon-rss"/>
                        </a>
                    </div>
                </iaixsl:if> 
			...
			<iaixsl:if test="not(action/set_render/item) or (action/set_render/item/@name = 'content')">
				<div id="content" class="span9">
					<iaixsl:choose>
						...
						<iaixsl:when test="page/@type = 'blog-list'">
							<iaixsl:attribute name="class">col-xl-10 col-12</iaixsl:attribute>
						</iaixsl:when>
						<iaixsl:when test="page/@type = 'blog-item'">
							<iaixsl:attribute name="class">col-xl-10 col-12</iaixsl:attribute>
						</iaixsl:when>
        ...
        <!-- (blog_list_categoriesdescription, 60dd8e7b666ac8.57257959.10)-->
	<div class="blog_categoriesdescription mb-4">
		...
		<iaixsl:if test="not(page/blogitems/additional/category_list/description = '') and (page/blogitems/additional/category_list/description) ">
				...
				<div class="blog_categoriesdescription_sub clearfix cm">
					<iaixsl:value-of disable-output-escaping="yes" select="page/blogitems/additional/category_list/description"/>
				</div>
		
		</iaixsl:if>
	</div>
<!-- (blog_list_display, 60dd8e80de4044.86435454.4)-->
		<iaixsl:variable name="blog_list_date">1</iaixsl:variable>
		...
		<section id="blog_list" class="article mb-4">
			<iaixsl:choose>
				<iaixsl:when test="page/blogitems/additional/category_list/@id = '39' or page/blogitems/additional/category_list/@id = '38'">
						<div class="blogCategories">
							<iaixsl:for-each select="page/blogitems/blogitem">
							<a href="/Porady-bloglist-pol-38.html">
							<iaixsl:attribute name="href"><iaixsl:value-of select="more/@href"/></iaixsl:attribute>
									...
									<img src="/gfx/standards/loader.gif?r=1696937716" class="article__image blogCategories b-lazy">
										...
										</img><span class="btn --outline categoryTitle"><iaixsl:value-of disable-output-escaping="yes" select="title"/></span></a>
							</iaixsl:for-each>
						</div>
	...
	<!-- (blog_list_paging, 60dd8e7f666911.18625091.3)-->
