			...
			<div class="col-12 col-md-6">
				<section class="order__payments mb-3 mb-md-5">
											...
											<span class="order__payments_names d-flex flex-column mr-2 align-items-md-center flex-md-row">
												<iaixsl:choose>
													<iaixsl:when test="@method_as_group = 'true' or (not(/shop/page/order1/groupList/item[@id = $groupID]) and not(@id = '153'))">
														<iaixsl:choose>
															<iaixsl:when test="@id = '2'">
																<strong class="order__payments_name d-block">Bon towarowy</strong>
															</iaixsl:when>
															<iaixsl:when test="@id = '190'">
																<strong class="order__payments_name d-block">Karta podarunkowa</strong>
															</iaixsl:when>
															<iaixsl:otherwise>
													...
													<iaixsl:when test="$groupID = 'simple_transfer'">
														<strong class="order__payments_name d-block">Przelew zwykły</strong>
													</iaixsl:when>
													<iaixsl:when test="$groupID = 'transfer'">
														<strong class="order__payments_name d-block">Przelew online</strong>
													</iaixsl:when>
													<iaixsl:when test="$groupID = 'card'">
														<strong class="order__payments_name d-block">Karta płatnicza</strong>
													</iaixsl:when>
													<iaixsl:when test="$groupID = 'installment'">
														<strong class="order__payments_name d-block">Płatność ratalna</strong>
													</iaixsl:when>
													<iaixsl:when test="$groupID = 'others'">
														<strong class="order__payments_name d-block">Bony, karty podarunkowe</strong>
													</iaixsl:when>
													<iaixsl:when test="@id = '153'">
														<strong class="order__payments_name d-block">Faktura na termin</strong>
													</iaixsl:when>
													<iaixsl:otherwise>
					...
					<iaixsl:if test="/shop/basket/groups/group/types/type[@value = 'subscription'] and not(/shop/page/order1/prepaid_methods/item) and not(count(/shop/page/order1/shipping/delivery[@type = 'dvp']) &gt; 0)">
						<div class="order__payments_subscription_info">Płatność za subskrypcję możliwa jest wyłącznie przy użyciu karty płatniczej.</div>
					</iaixsl:if>
				</section>
			</div>
				...
				<section class="order__delivery --normal mb-3 mb-md-5">
												...
												<iaixsl:choose>
													...
													<iaixsl:when test="not(@sameday='true')">
														<iaixsl:choose>
															<iaixsl:when test="@id = '0-1' or @id='0-0'">
																<iaixsl:for-each select="/shop/page/order1/stocks/stock[@selected = 'selected']">
																	<iaixsl:choose>
																		...
																		<iaixsl:otherwise>
																			<span class="order__delivery_desc_item --txt">Odbierz zamówienie - </span>
																					...
																					<iaixsl:otherwise>
																						<iaixsl:choose>
																							<iaixsl:when test="@pickup_minutes &gt; 0">
																								za <iaixsl:value-of select="@pickup_hours + 1"/> godz. 
																							</iaixsl:when>
																							<iaixsl:otherwise>
																								za <iaixsl:value-of select="@pickup_hours"/>
																								<iaixsl:choose>
															...
															<iaixsl:otherwise>
																<span class="order__delivery_desc_item --txt">Przewidywana dostawa - </span>
																<span class="order__delivery_desc_item --value">
					...
					<div class="order__time align-items-center p-2 flex-wrap justify-content-center px-sm-3">
						...
						<div class="order__time_calendar mt-1 mt-sm-0 ml-sm-3">
							<a href="#preferred_delivery_day" class="order__time_btn btn --icon-left icon-clock py-0">Wybierz inny dzień dostawy</a>
						</div>
					</div>
																						...
																						<iaixsl:otherwise>
																							<iaixsl:choose>
																								<iaixsl:when test="@pickup_minutes_division &gt; 0">
																									za <iaixsl:value-of select="@pickup_hours_division + 1"/> godz. 
																								</iaixsl:when>
																								<iaixsl:otherwise>
																									za <iaixsl:value-of select="@pickup_hours_division"/>
																									<iaixsl:choose>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/pol/envelope.js.gzip?r=1696937760"></script><script src="/gfx/pol/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/pol/order1.js.gzip?r=1696937760"></script>
