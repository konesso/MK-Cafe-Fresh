		...
		<div class="subscriptions_list__header">
			<h1 class="headline">
				<span class="headline__name">
					<iaixsl:choose>
						...
						<iaixsl:otherwise>
							Lista zakończonych subskrypcji
						</iaixsl:otherwise>
					</iaixsl:choose>
				</span>
			</h1>
			<iaixsl:if test="(/shop/page/subscriptions/@display = 'active' and /shop/action/subscriptions_terminated/@count != 0) or (/shop/page/subscriptions/@display != 'active' and /shop/action/subscriptions_active/@count != 0) ">
				<div class="subscriptions_list__see_also">
					<span class="subscriptions_list__see_also_text">Zobacz też: </span>
					<a class="subscriptions_list__see_also_link">
						<iaixsl:choose>
							<iaixsl:when test="/shop/page/subscriptions/@display = 'active'">
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/subscriptions_terminated/@url"/></iaixsl:attribute>Lista zakończonych subskrypcji
							</iaixsl:when>
							<iaixsl:otherwise>
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/subscriptions_active/@url"/></iaixsl:attribute>Lista aktywnych subskrypcji
							</iaixsl:otherwise>
						</iaixsl:choose>
					</a>
				</div>
				...
				<div class="subscriptions__item">
									...
									<div class="subscriptions__product_details">
										...
										<iaixsl:if test="size/@name != '' and size/@id != 'uniw'">
											<div class="subscriptions__product_detail --size">
												<span class="subscriptions__product_detail_name">Rozmiar:</span>
					...
					<div class="subscriptions__info">
						<div class="subscriptions__price">
							...
							<span> / co <span class="subscriptions__product_price_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="@days_in_period"/> dni</span></span>
						</div>
						<div class="subscriptions__dates">
							<div class="subscriptions__date --order">
								<span class="subscriptions__date_name">Kolejna dostawa</span>
							...
							<div class="subscriptions__date --payment">
								<span class="subscriptions__date_name">Data kolejnej płatności</span>
								<strong class="subscriptions__date_value">
									<span class="subscriptions__day_name">
										<iaixsl:choose>
					...
					<iaixsl:if test="count(products/product) &gt; $subscriptionProductsHidden">
						<a href="#moreProducts" class="subscriptions__more_products">
							<iaixsl:attribute name="data-literal">Ukryj</iaixsl:attribute>
							+<iaixsl:value-of select="count(products/product) - $subscriptionProductsHidden"/> produkty w subskrypcji
						</a>
					</iaixsl:if>
				</div>
			</iaixsl:for-each>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/pol/envelope.js.gzip?r=1696937760"></script><script src="/gfx/pol/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/pol/menu_filter.js.gzip?r=1696937760"></script><script src="/gfx/pol/subscriptions_list.js.gzip?r=1696937760"></script>
