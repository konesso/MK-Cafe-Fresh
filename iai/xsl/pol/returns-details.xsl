...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
	...
	<iaixsl:variable name="grossPriceReturnDetails"> brutto</iaixsl:variable>
		...
		<div class="step7 returnDetails">
									...
									<div class="moreInfo orderdetails_info__more d-none d-md-flex">
											...
											<div style="display:none;" class="moreInfo__desc"><iaixsl:value-of disable-output-escaping="yes" select="page/details/@status_description"/></div>
															...
															<div class="orderdetails_info__dates">
																	<span>Nr zwrotu: <iaixsl:value-of select="page/details/@id"/></span>
																	<iaixsl:if test="not(page/details/@status_description = '')">
																			<a href="#showDescription" class="moreInfo__show d-md-none">Więcej</a>
				...
				<div class="returnDetails__list">
					<iaixsl:choose>
						...
						<iaixsl:when test="page/return_method/@id=1">
							<iaixsl:variable name="returns_1">Pobierz formularz zwrotu oraz etykietę na przesyłkę.</iaixsl:variable>
							<iaixsl:variable name="returns_1_2">Będzie potrzebować go obsługa sklepu.</iaixsl:variable>
							<iaixsl:variable name="returns_1_3">Pobierz formularz zwrotu</iaixsl:variable>

							<iaixsl:variable name="returns_2">Spakuj zwracane produkty oraz dołącz wydrukowany formularz zwrotu.</iaixsl:variable>
							<iaixsl:variable name="returns_2_2">Dokument ułatwi obsługę Twojego zwrotu.</iaixsl:variable>
							
							<iaixsl:variable name="returns_3">Dostarcz samodzielnie przesyłkę pod </iaixsl:variable>
							<iaixsl:variable name="returns_3_2">Przed wyjazdem sprawdź godziny pracy punktu zwrotu.</iaixsl:variable>
									...
									<b>
										...
										<iaixsl:if test="page/return_method/@id=1 or page/return_method/@id=3">
											<a>
												...
												<iaixsl:attribute name="title"> adres punktu zwrotu.</iaixsl:attribute>
													adres punktu zwrotu.
											</a>
										</iaixsl:if>
									</b>
						...
						<iaixsl:when test="page/return_method/@id=2 or page/return_method/@id=5">
							<iaixsl:variable name="returns_1">Pobierz formularz zwrotu oraz etykietę na przesyłkę.</iaixsl:variable>
							<iaixsl:variable name="returns_1_2">Etykieta potrzebna będzie aby nadać paczkę.</iaixsl:variable>
							<iaixsl:variable name="returns_1_3">Pobierz formularz i etykietę na przesyłkę</iaixsl:variable>

							<iaixsl:variable name="returns_2">Spakuj zwracane produkty oraz dołącz wydrukowany formularz zwrotu.</iaixsl:variable>
							<iaixsl:variable name="returns_2_2">Na paczkę naklej dołączoną etykietę. Dokument ułatwi obsługę Twojego zwrotu.</iaixsl:variable>
							
							<iaixsl:variable name="returns_3">Nadaj przesyłkę zgodnie z instrukcją podaną w formularza zwrotu.</iaixsl:variable>
							<iaixsl:variable name="returns_3_2">Pamiętaj, aby paczka miała naklejoną etykietę kuriera.</iaixsl:variable>
						...
						<iaixsl:when test="page/return_method/@id=4">
							<iaixsl:variable name="returns_1">Pobierz formularz zwrotu oraz kod zwrotu.</iaixsl:variable>
							<iaixsl:variable name="returns_1_2">Kod zwrotu potrzebny będzie aby nadać paczkę w paczkomacie.</iaixsl:variable>
							<iaixsl:variable name="returns_1_3">Pobierz formularz i kod zwrotu</iaixsl:variable>

							<iaixsl:variable name="returns_2">Spakuj zwracane produkty oraz jak możesz wydrukuj i dołącz formularz zwrotu.</iaixsl:variable>
							<iaixsl:variable name="returns_2_2">Dokument ułatwi obsługę Twojego zwrotu.</iaixsl:variable>
							
							<iaixsl:variable name="returns_3">Nadaj przesyłkę w Paczkomacie InPostu lub PaczkoPunkcie.</iaixsl:variable>
								...
								<div class="returnDetails__listDesc">
									...
									<iaixsl:choose>
										<iaixsl:when test="page/return_method/@return_code">
											Użyj wygenerowanego kodu zwrotu:
										</iaixsl:when>
										<iaixsl:otherwise>
											Użyj wygenerowanego kodu zwrotu, który znajdziesz w pobranym formularzu.
										</iaixsl:otherwise>
									</iaixsl:choose>
									</span>
								</div>
						...
						<iaixsl:otherwise>
							...
							<iaixsl:variable name="returns_3">Nadaj przesyłkę na </iaixsl:variable>
							<iaixsl:variable name="returns_3_2">Adres znajdziesz na dole strony.</iaixsl:variable>
			...
			<iaixsl:if test="page/returnproducts/products">
				...
				<div id="return_order_products" class="mb-5">
					<h2 class="orderdetails_label"><span>Zwracane produkty</span></h2>
												...
												<iaixsl:for-each select="bundled/product">
													<li>
														...
														<iaixsl:if test="not(@size_id = 'uniw') or ((version) and (not(version/@product_name='')))">
															(<iaixsl:if test="not(@size_id = 'uniw')">Rozmiar: <b><iaixsl:value-of select="@size_desc"/></b></iaixsl:if>
						...
						<div class="return_detials_shipment_desc">
							<iaixsl:choose>
								<iaixsl:when test="/shop/page/repayment_method/@id = 't'">
									<b class="product_name">Saldo klienta</b>
									<div class="return_description">
								...
								<iaixsl:when test="/shop/page/repayment_method/@id = 'b'">
									<b class="product_name">Przelew</b>
									<div class="return_description">
										Jeśli naprawa lub wymiana produktu nie będzie możliwa, sklep dokona zwrotu należności w formie przelewu bankowego na konto.
									</div>
								</iaixsl:when>
								<iaixsl:when test="/shop/page/repayment_method/@id = 'tc'">
									<b class="product_name">Przywróć kredyt kupiecki</b>
									<div class="return_description">
			...
			<iaixsl:if test="/shop/page/pickup/name">
				<div id="returnDetails_adress" class="mb-6">
					...
					<div class="returnDetails__adres">
						...
						<div class="mt-3">
							<a>
								<iaixsl:attribute name="title">Szczegółowe informacje</iaixsl:attribute>
								<iaixsl:attribute name="href">
		...
		<div class="returnDetails__summarySub">
			<iaixsl:if test="/shop/page/costs/cost[@type='products']/@value_formatted">
				<div class="returnDetails__summaryItem">
					<label>Wartość zwracanych produktów:</label>
			...
			<iaixsl:if test="/shop/page/costs/cost[@type='shipping']/@value_formatted">
				<div class="returnDetails__summaryItem">
					<label>Zwrot kosztu dostawy do klienta:</label>
			...
			<iaixsl:if test="/shop/page/costs/cost[@type='shop_shipping']/@value_formatted">
				<div class="returnDetails__summaryItem">
					<label>Koszt przesyłki zwrotnej:</label>
			...
			<div class="returnDetails__buttons">
				<iaixsl:if test="/shop/page/editlink/@url">
					<a class="btn --solid --medium --outline prepaid-edit">
						...
						<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/editlink/@url"/></iaixsl:attribute>Zmień zwrot</a>
				</iaixsl:if>
