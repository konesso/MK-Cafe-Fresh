    ...
    <iaixsl:choose>
      <iaixsl:when test="not((0 &gt; page/payments/@total) or (page/payments/@total = '0.00'))">
        <section class="affiliate --resources --withdraw mb-4">
          <div class="affiliate__desc mb-4">
            ...
            Jeśli chcesz zamienić zgromadzone środki na bon towarowy, wpisz w poniższe pola kwotę nie mniejszą niż  
            <iaixsl:value-of select="page/shop/@minpayment"/><iaixsl:value-of select="/shop/currency/@name"/>
             i nie większą niż środki zgromadzone na Twoim koncie, a następnie kliknij przycisk "Zgłoś chęć wypłaty&quot;.
          </div>
            ...
            <iaixsl:choose>
              <iaixsl:when test="page/client/@paymenttype = 'cash'">
                <div class="f-group --radio">
                  ...
                  <label class="f-label mx-1" for="voucher">Bon </label>
                  <input type="radio" name="method" class="f-control" value="cash" id="cash"/>
                  <label class="f-label mx-1" for="cash">Przelew</label>
                </div>
              </iaixsl:when>
              <iaixsl:otherwise>
                <span class="mb-3">Powyższa wartość będzie wypłacona w bonie towarowym.</span>
              </iaixsl:otherwise>
            </iaixsl:choose>
      ...
      <iaixsl:otherwise>
        <div class="affiliate__info">
          Obecnie nie masz środków które mógłbyś wykorzystać.
        </div>
      </iaixsl:otherwise>
    </iaixsl:choose>
  </iaixsl:if>
<!-- (affiliate_resources_list, 60dd8e84da9e33.27373055.2)-->
  <iaixsl:variable name="affiliate_1">Data wypłaty</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">Rodzaj wypłaty</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">Numer bonu</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">Aktualne do</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">Kwota</iaixsl:variable>
  <iaixsl:variable name="affiliate_6">Wykorzystano</iaixsl:variable>
            ...
            <span class="status --table">
              <iaixsl:choose>
                ...
                <iaixsl:otherwise>
                  ...
                  <span>Potwierdzone <small>(<iaixsl:value-of select="@status"/>)</small></span>
                </iaixsl:otherwise>
              </iaixsl:choose>
            </span>
          </span>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/pol/envelope.js.gzip?r=1696937760"></script><script src="/gfx/pol/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/pol/affiliate_resources_form.js.gzip?r=1696937760"></script>
