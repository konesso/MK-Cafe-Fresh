                                                    ...
                                                    <iaixsl:when test="@type = 'p'">
                                                        ...
                                                        <span class="rma_add_form_infotitle2">
                                                            ...
                                                            <iaixsl:if test="/shop/page/rma/payments/@active = '1'">
                                                                <img class="rma_need" src="/gfx/standards/need.gif?r=1696937716"><iaixsl:attribute name="alt">To pole jest wymagane do złożenia zamówienia</iaixsl:attribute></img>
