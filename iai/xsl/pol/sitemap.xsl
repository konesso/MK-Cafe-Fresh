...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
	...
	<section id="Sitemap" class="sitemap_tree">
		<h1 class="headline">
			<span class="headline__name">Mapa strony</span>
		</h1>
			...
			<div class="sitemap_tree__wrapper">
				...
				<iaixsl:choose>
					<iaixsl:when test="@id='mainpage'">
						<label class="sitemap_tree__label">Informacje</label>
					</iaixsl:when>
					<iaixsl:when test="@id='searchpage'">
						<label class="sitemap_tree__label">Asortyment</label>
					</iaixsl:when>
					<iaixsl:otherwise>
						<label class="sitemap_tree__label">Konto klienta</label>
					</iaixsl:otherwise>
				</iaixsl:choose>
...
<!-- (menu_tree4, 60dd8ed25e26f0.75652046.6)-->
	...
	</div>ntact, 614c5cf21f7b08.81498360.3)-->
