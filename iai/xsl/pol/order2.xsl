...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (order2, 61f913c891a2c5.80489614.9)-->
	...
	<iaixsl:variable name="returns_agree_control"/>
	<iaixsl:variable name="b2b_mask"/>
	
	<iaixsl:variable name="setIconLarge"/>
	<iaixsl:variable name="nettoPriceOrder2"><iaixsl:if test="/shop/page/@price_type = 'net'">true</iaixsl:if></iaixsl:variable>
	<iaixsl:variable name="grossPriceOrder2"> brutto</iaixsl:variable>
	
	<iaixsl:variable name="visibleProductsInGroupOrder2">2</iaixsl:variable>
	...
	<div class="n57856_order_overtaker">
		<form class="order2_form">
			...
			<div class="big_label order2_info_label">
				<span class="n57856_label d-none d-lg-block" id="labels">Weryfikacja danych:
				</span>
			</div>
			...
			<div class="order2_info">
				...
				<div class="order2_info_sub" id="order2_info_sub1">
					...
					<div class="order2_info1" id="order2_box_1">
						<div class="order2_info1_sub">
							...
							<iaixsl:choose>
								<iaixsl:when test="(page/order2/orderclient/@phone1) and not(page/order2/orderclient/@phone1 = '')">
									telefon: <iaixsl:value-of select="page/order2/orderclient/@phone1"/><br/>
								</iaixsl:when>
								<iaixsl:when test="/shop/page/order2/orderdetails/@express_checkout = 'true' and /shop/page/order2/orderdetails/@payment_id = '236' and (not(page/order2/deliveryaddress/@phone) or page/order2/deliveryaddress/@phone = '')">
									<span class="order2_info1_sub_phone --no-phone">
										<iaixsl:attribute name="data-firstname"><iaixsl:value-of select="page/order2/orderclient/@firstname"/></iaixsl:attribute>
										<iaixsl:attribute name="data-lastname"><iaixsl:value-of select="page/order2/orderclient/@lastname"/></iaixsl:attribute>
										<iaixsl:if test="page/order2/orderclient/@firm">
											<iaixsl:attribute name="data-firm"><iaixsl:value-of select="page/order2/orderclient/@firm"/></iaixsl:attribute>
										</iaixsl:if>
										<iaixsl:if test="page/order2/orderclient/@nip">
											<iaixsl:attribute name="data-nip"><iaixsl:value-of select="page/order2/orderclient/@nip"/></iaixsl:attribute>
										</iaixsl:if>
										<iaixsl:attribute name="data-city"><iaixsl:value-of select="page/order2/orderclient/@city"/></iaixsl:attribute>
										<iaixsl:attribute name="data-street"><iaixsl:value-of select="page/order2/orderclient/@street"/></iaixsl:attribute>
										<iaixsl:attribute name="data-zipcode"><iaixsl:value-of select="page/order2/orderclient/@zipcode"/></iaixsl:attribute>
										<iaixsl:attribute name="data-region"><iaixsl:value-of select="page/order2/orderclient/@country_id"/></iaixsl:attribute>
										<span class="order2_info1_sub_phone_label">telefon: </span>
										<span class="order2_info1_sub_phone_value"/>
										<span class="f-group --small order2_info1_sub_phone_empty">
											<input type="tel" class="f-control" id="order2TelInput"/>
											<label class="f-label" for="order2TelInput">Numer telefonu</label>
											<a href="#send" class="order2_info1_sub_phone_confirm"/>
										</span>
									</span>
								</iaixsl:when>
							</iaixsl:choose>
				...
				<div class="order2_info_sub" id="order2_info_sub3">
					<div class="order2_info_label_sub">
						...
						<iaixsl:if test="not(/shop/client_data/association/@parentClientId)">
									...
									<span>
										<iaixsl:choose>
											<iaixsl:when test="(/shop/page/order2/orderdetails/@deliveryid = '0-0') or (/shop/page/order2/orderdetails/@deliveryid = '0-1')">
												<span class="delivery_time_order_text">Odbierz zamówienie - </span>
											</iaixsl:when>
											<iaixsl:otherwise>
												<span class="delivery_time_order_text">Przewidywana dostawa - </span>
											</iaixsl:otherwise>
										</iaixsl:choose>

										<iaixsl:choose>
											<iaixsl:when test="/shop/page/order2/orderremarks/@select_date and (/shop/page/order2/orderremarks/@select_date != '')">
												<strong class="delivery_time_order_time"><iaixsl:value-of select="/shop/page/order2/orderremarks/@select_date"/><iaixsl:if test="/shop/page/order2/orderremarks/@select_time and (/shop/page/order2/orderremarks/@select_time != '')">,  <iaixsl:value-of select="/shop/page/order2/orderremarks/@select_time"/></iaixsl:if></strong>
											</iaixsl:when>
											<iaixsl:otherwise>
												<strong class="delivery_time_order_time">
													<span class="delivery_time_order_week_day">
														<iaixsl:choose>
													...
													<iaixsl:if test="not(/shop/basket/delivery_time/@week_amount = 0)">
														...
														<span class="delivery_time_order_date_wrapper"> (<span class="delivery_time_order_date"><iaixsl:value-of select="$dalivery_time_formatted"/></span>)</span>
													</iaixsl:if>
												</strong>
											</iaixsl:otherwise>
										</iaixsl:choose>
			...
			<div class="order2_info comment_container clearfix">
				...
				<div class="order2_info_sub order_comments">
					...
					<div class="order2_info1" id="order2_box_5">
						<div class="order2_info1_sub">
							<textarea name="remarks" class="order2_text"><iaixsl:if test="/shop/page/order2/orderremarks"><iaixsl:value-of select="/shop/page/order2/orderremarks"/></iaixsl:if><iaixsl:if test="not(/shop/page/order2/orderremarks)"/></textarea>
						</div>
					</div>
				</div>
				...
				<div class="order2_info_sub">
					...
					<div class="order2_info1" id="order2_box_6">
						<div class="order2_info1_sub">
							<textarea name="deliverer_remarks" class="order2_text"><iaixsl:if test="/shop/page/order2/deliverer_remarks"><iaixsl:value-of select="/shop/page/order2/deliverer_remarks"/></iaixsl:if><iaixsl:if test="not(/shop/page/order2/deliverer_remarks)"/></textarea>
						</div>
					</div>
				</div>
			</div>
			...
			<iaixsl:if test="page/order2/ordersproducts/product">
				...
				<div id="order2_products" class="ordered_products mb-5">
					<iaixsl:if test="page/order2/ordersproducts/product[@basket_group_id]">
					...
					<iaixsl:for-each select="page/order2/ordersproducts/product">
						<div class="ordered_product">
							...
							<iaixsl:if test="@basket_group_id">
								...
								<iaixsl:if test="count(preceding-sibling::product[@basket_group_id = $groupId]) &gt;= $visibleProductsInGroupOrder2">
									<iaixsl:attribute name="data-hide">true</iaixsl:attribute>
								</iaixsl:if>
								<iaixsl:if test="count(preceding-sibling::product[@basket_group_id = $groupId]) = $visibleProductsInGroupOrder2 - 1 and $groupId = following-sibling::product/@basket_group_id">
							...
							<iaixsl:if test="count(preceding-sibling::product[@basket_group_id = $groupId]) &gt;= $visibleProductsInGroupOrder2 and not($groupId = following-sibling::product/@basket_group_id)">
                          ...
                          <iaixsl:otherwise>
							...
							<div class="ordered_product__price">
								<iaixsl:if test="@vat and /shop/client_data/@uses_vat">
									<span class="ordered_product__price-vat">VAT <iaixsl:value-of select="@vat"/> %</span>
								</iaixsl:if>
									...
									<iaixsl:choose>
										<iaixsl:when test="@quantity != '1'">
											<iaixsl:choose>
												...
												<iaixsl:otherwise>
													<iaixsl:choose>
														<iaixsl:when test="not($nettoPriceOrder2 = '') and not($priceTypeVat = '')">
															...
															<span class="ordered_product__price_gross gross_price">(<iaixsl:value-of select="@bruttoworth_formatted"/><span class="price_vat"><iaixsl:value-of select="$grossPriceOrder2"/></span>)</span>
														</iaixsl:when>
														<iaixsl:otherwise>
								...
								<iaixsl:if test="$subscriptionGroup = 'true'">
									<span class="ordered_product__price_subscription"> / co <span class="ordered_product__price_subscription_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="/shop/basket/groups/group[@id = $groupId]/details/subscription/@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="/shop/basket/groups/group[@id = $groupId]/details/subscription/@days_in_period"/> dni</span></span>
								</iaixsl:if>
							</div>
						</div>
					</iaixsl:for-each>
					...
					<div class="basketedit_summary_sub">
							...
							<div class="order2__orderdetails mb-5">
								...
								<div class="order2__orderdetails_block">
									...
									<div class="order2__delivery mb-3">
										<div class="order2__delivery_item d-flex flex-wrap align-items-start">
												...
												<div class="order2__payment_wrapper">
													<strong class="order2__payment_name">
														<iaixsl:choose>
															...
															<iaixsl:when test="page/order2/orderdetails/@payment_system_id = '29' and page/order2/orderdetails/@payment_group_id='card'">
																<iaixsl:value-of select="page/order2/orderdetails/@payment_group_name"/>
															</iaixsl:when>
															<iaixsl:otherwise>
													...
													<iaixsl:if test="page/order2/instalment">
														<a class="order2__payment_instalment"><iaixsl:attribute name="onclick">event.stopPropagation(); calculate_instalments(&apos;<iaixsl:value-of select="page/order2/instalment/@minprice"/>&apos;,&apos;<iaixsl:value-of select="page/order2/instalment/@maxprice"/>&apos;,&apos;<iaixsl:value-of select="page/order2/instalment/@priceTotal"/>&apos;,&apos;<iaixsl:value-of select="page/order2/instalment/@alert"/>&apos;,$(this).attr(&apos;data-window&apos;),&apos;<iaixsl:value-of select="page/order2/instalment/@maxquantity"/>&apos;); return false;</iaixsl:attribute><iaixsl:attribute name="href">javascript:<iaixsl:value-of select="page/order2/instalment/@calculate"/></iaixsl:attribute><iaixsl:attribute name="data-window"><iaixsl:value-of select="page/order2/instalment/@calculate"/></iaixsl:attribute>oblicz ratę</a>
													</iaixsl:if>
						...
						<div class="basketedit_summary_right">
							...
							<div class="basketedit_total_summary">
								...
								<strong>
									<iaixsl:value-of select="/shop/basket/summary/total_to_pay/@value_formatted"/><iaixsl:if test="not($priceTypeVat = '')"><span class="price_vat"> brutto</span></iaixsl:if>
								</strong>
							...
							<iaixsl:if test="/shop/basket/groups/group/types/type[@value = 'subscription']">
								<div class="basketedit_summary_subscription">
									<iaixsl:variable name="subscriptionTotalValue"><iaixsl:value-of select="/shop/basket/groups/group[types/type/@value = 'subscription']/details/prices/@price_total_formatted"/></iaixsl:variable>
						...
						<div class="order2_terms_wrapper">
							<div class="order2_terms_wrapper_sub">
								<label class="order2_terms_conditions">
									...
									<i class="css-label"/>
									<span><i class="icon-need"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="/shop/page/order2/personal_data_processing_texts/personal_data" disable-output-escaping="yes"/></span>
								</label>
							</div>
							...
							<iaixsl:if test="not($returns_agree_control)">
								<div class="order2_terms_wrapper_sub">
									<label class="order2_cancel">
										...
										<i class="css-label"/>
										<span><i class="icon-need"/>  Zapoznałem się z moim
											<a target="_blank"><iaixsl:attribute name="title">Odstąpienie od umowy</iaixsl:attribute><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/order_cancel/@url"/></iaixsl:attribute>prawem do odstąpienia od umowy</a><iaixsl:text>.</iaixsl:text>
										</span>
									</label>
								</div>
							</iaixsl:if>
							...
							<iaixsl:if test="page/order2/ordersproducts//product[@product_type = 'product_virtual']">
								<div class="order2_terms_wrapper_sub virtual">
									<label class="order2_virtual">
										...
										<i class="css-label"/>
										<span><i class="icon-need"/>  Wyrażam zgodę i proszę zarazem o spełnienie świadczenia przed upływem terminu do odstąpienia od umowy. Jestem świadomy/a, że udzielając niniejszej zgody tracę moje prawo do odstąpienia od umowy wraz z momentem rozpoczęcia świadczenia.</span>
									</label>
								</div>
							</iaixsl:if>
							...
							<iaixsl:if test="page/order2/ordersproducts//product[@product_type = 'product_service']">
								<div class="order2_terms_wrapper_sub service">
									<label class="order2_service">
										...
										<i class="css-label"/>
										<span><i class="icon-need"/>  Wyrażam zgodę i proszę zarazem o rozpoczęcie świadczenia usługi przed upływem terminu do odstąpienia od umowy. Jestem świadomy/a, że w przypadku pełnego wykonania usługi tracę moje prawo do odstąpienia od umowy.</span>
									</label>
								</div>
							</iaixsl:if>
						...
						<div class="basketedit_summary_buttons table_display">
							<div class="btn_wrapper">
								<input class="btn --solid --large order2_button_order terms_required" type="submit">
									<iaixsl:choose>
										<iaixsl:when test="/shop/page/order2/orderdetails/@express_checkout = 'true'">
											<iaixsl:attribute name="value">Potwierdź zakup</iaixsl:attribute>
										</iaixsl:when>
										
										<iaixsl:when test="/shop/page/order2/orderdetails/@payment_id = '203'">
											<iaixsl:attribute name="value">Zamawiam i płacę później</iaixsl:attribute>
										</iaixsl:when>
										<iaixsl:when test="/shop/action/terms/@regulations_button_text and /shop/action/terms/@regulations_button_text != ''">
											<iaixsl:attribute name="value"><iaixsl:value-of select="/shop/action/terms/@regulations_button_text"/></iaixsl:attribute>
										</iaixsl:when>
										<iaixsl:otherwise>
											<iaixsl:attribute name="value">Zamawiam i płacę</iaixsl:attribute>
										</iaixsl:otherwise>
									</iaixsl:choose>
								...
								<div class="button_legend">
									<i class="icon-need"/> Pola oznaczone gwiazdką są wymagane.
								</div>
							</div>
						</div>
					</div>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/pol/envelope.js.gzip?r=1696937760"></script><script src="/gfx/pol/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/pol/order2.js.gzip?r=1696937760"></script>
