...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
  ...
  <iaixsl:variable name="affiliate_1">Zwykłe linki</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">Bannery</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">Kody promocyjne</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">Reklamy Flash</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">Reklamy PHP</iaixsl:variable>
  <iaixsl:variable name="affiliate_6">Reklamy JavaSript</iaixsl:variable>
  <iaixsl:if test="page/affiliate_statistics">
    ...
    <section class="affiliate --stats mb-4">
      <div class="affiliate__desc mb-4">
        Poniżej znajduje się zestawienie wszystkich przekierowań do sklepu z Twojego polecenia.
      </div>
