										...
										<span class="n68137_desc_value">
											<iaixsl:choose>
												<iaixsl:when test="@available = 'y'">
													pliki są dostępne do pobrania
												</iaixsl:when>
												<iaixsl:otherwise>
													pliki nie są dostępne do pobrania ponieważ zamówienie nie zostało opłacone
												</iaixsl:otherwise>
											</iaixsl:choose>
										</span>
									</div>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/pol/envelope.js.gzip?r=1696937760"></script><script src="/gfx/pol/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/pol/client_files_files.js.gzip?r=1696937760"></script>
