...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css"/>
			...
			<script src="/gfx/pol/returns_repayments_form.js.gzip?r=1696937760"></script>
...
<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/returnsMethod/@url"/></iaixsl:attribute>
            	...
            	<div class="progress__item --rma --fifth --active d-md-none py-3">
					...
					<div class="progress__text">
						<strong class="progress__name">Wybierz formę zwrotu należności </strong>
					</div>
				</div>

                <h1 class="big_label return_label d-none d-md-block">Wybierz formę zwrotu należności </h1>
