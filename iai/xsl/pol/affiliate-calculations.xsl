...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
  ...
  <iaixsl:variable name="affiliate_1">Data przyznania prowizji</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">Ważna od</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">Ważna do</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">Twoje wynagrodzenie</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">Opis</iaixsl:variable>
                  ...
                  <iaixsl:variable name="orderid"><iaixsl:choose><iaixsl:when test="@orderid"><iaixsl:value-of select="@orderid"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="@id"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable> 
                    <iaixsl:choose>
                      <iaixsl:when test="@type = 'gd'">
                        Wynagrodzenie bezpośrednie za zamówienie <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'rd'">
                      Anulowano wynagrodzenie bezpośrednie za zamówienie  <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'gi'">
                        Wynagrodzenie pośrednie za zamówienie <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'ri'">
                        Anulowano wynagrodzenie pośrednie za zamówienie <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'gv'">
                        Wygenerowano bon o numerze <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      
                      <iaixsl:when test="@type = 'rv'">
                        Zablokowano bon o numerze <iaixsl:value-of select="$orderid"/>
                      </iaixsl:when>
                      ...
                      <iaixsl:when test="@type = 'rc'">
                        Wypłata gotówki została odrzucona 
                      </iaixsl:when>
