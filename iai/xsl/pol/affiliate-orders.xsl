...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
  ...
  <iaixsl:variable name="affiliate_1">Id klienta</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">Data założenia konta</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">Ilość złożonych zamówień</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">Wartość zamówionych produktów</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">Ilość wykonanych zamówień</iaixsl:variable>
  <iaixsl:variable name="affiliate_6">Kwota wykonanych zamówień</iaixsl:variable>
  <iaixsl:variable name="affiliate_7">(bez kosztów przesyłki)</iaixsl:variable>
      ...
      <iaixsl:when test="count(page/orders/client)">
        <section class="affiliate --orders mb-4">
          <div class="affiliate__desc mb-4">
            W poniższej tabeli umieszczone są osoby, które dokonały zakupu lub założyły u nas konto z Twojego polecenia. Podane kwoty dotyczą zamówień wykonanych z Twoim partnerstwem. Aby wyświetlić szczegółowe informacje na temat danej osoby, kliknij jej ID.
          </div>
          ...
          <div class="affiliate__table --six table">
            ...
            <iaixsl:if test="page/orders/client_sum">
              <div class="table__row --summary mb-5 mb-md-0 p-3 p-md-0">
                <span class="table__cell d-flex justify-content-between">Suma</span>
