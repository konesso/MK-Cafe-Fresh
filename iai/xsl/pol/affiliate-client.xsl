...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (affiliate_client_orders, 60dd8e83d9a076.30620063.2)-->
  <iaixsl:variable name="affiliate_1">Id zamówienia</iaixsl:variable>
  <iaixsl:variable name="affiliate_2">Data zamówienia</iaixsl:variable>
  <iaixsl:variable name="affiliate_3">Data wysyłki</iaixsl:variable>
  <iaixsl:variable name="affiliate_4">Wartość zamówienia</iaixsl:variable>
  <iaixsl:variable name="affiliate_5">Ilość produktów</iaixsl:variable>
  <iaixsl:variable name="affiliate_6">Płatność</iaixsl:variable>
  <iaixsl:variable name="affiliate_7">Status</iaixsl:variable>
  <iaixsl:variable name="affiliate_8">Partner</iaixsl:variable>
  <iaixsl:variable name="affiliate_9">Prowizja</iaixsl:variable>
  <iaixsl:if test="page/client/item">
    ...
    <section class="affiliate --client mb-4">
      <div class="affiliate__table --nine table">
        <div class="table__row --head">
          ...
          <span class="table__cell d-flex justify-content-between"><iaixsl:value-of select="$affiliate_8"/></span>
          <span class="table__cell d-flex justify-content-between"><iaixsl:value-of select="$affiliate_9"/></span>
        </div>
        <iaixsl:for-each select="page/client/item">
          <div class="table__row mb-5 mb-md-0 p-3 p-md-0">
            <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_1"/></span>
              <iaixsl:choose>
            ...
            <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_2"/></span><iaixsl:value-of select="@date"/></span>
            <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_3"/></span><iaixsl:value-of select="@dispatch"/></span>
            <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_4"/></span><iaixsl:value-of select="@cost_formatted"/></span>
            <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_5"/></span><iaixsl:value-of select="@numprod"/></span>
            <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_6"/></span><iaixsl:value-of select="@prepaid_formatted"/></span>
            <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_7"/></span><iaixsl:value-of select="@status"/></span>
            <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_8"/></span><iaixsl:value-of select="@affiliate"/></span>
            <span class="table__cell d-flex justify-content-between"><span class="d-inline d-md-none"><iaixsl:value-of select="$affiliate_9"/></span><iaixsl:value-of select="@commission_formatted"/></span>
          </div>
        </iaixsl:for-each>
      </div>
    </section>
...
<!-- (affiliate_client_paging, 60dd8e7f1696c2.31458425.3)-->
