...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
			...
			<iaixsl:if test="not(action/set_render/item) or (action/set_render/item/@name = 'content')">
				<div id="content" class="span9">
					...
					<!-- (menu_affiliate, 60dd8e7da570e0.58394354.10)-->
        ...
        <!-- (affiliate_generator_mode, 60dd8e851505b0.80343040.2)-->
  <iaixsl:if test="page/generator">
	<span class="headline d-none">
	<span class="headline__name">
		Generator kodu
	</span>
	</span>
	<section class="affiliate --generator --menu px-sm-4 pb-sm-4">
		...
		<iaixsl:if test="page/generator/@type='html' or page/generator/@type='js' or page/generator/@type='php'">
			<div class="affiliate__info mt-2 mb-3 mb-sm-2 --small">
			<iaixsl:choose>
				<iaixsl:when test="page/generator/@type='html'">Poniższy generator służy do stworzenia kodu HTML, który możesz skopiować i wkleić na swojej stronie. Powstały w ten sposób banner będzie prowadzić na stronę naszego sklepu, a jeżeli ktoś wejdzie na naszą stronę po kliknięciu go i w czasie trwania sesji założy sobie konto i złoży zamówienie, lub przynajmniej założy konto, jego zamówienia będą zarabiały na Ciebie.</iaixsl:when>
				<iaixsl:when test="page/generator/@type='js'">Poniższy generator służy do stworzenia kodu JavaScript, który możesz skopiować i wkleić na swojej stronie. Powstały w ten sposób banner będzie prowadzić do poszczególnych produktów na stronie naszego sklepu, a jeżeli ktoś wejdzie na naszą stronę po kliknięciu go i w czasie trwania sesji założy sobie konto i złoży zamówienie, lub przynajmniej założy konto, jego zamówienia będą zarabiały na Ciebie.</iaixsl:when>
				<iaixsl:when test="page/generator/@type='php'">Poniższy generator służy do stworzenia kodu PHP, który możesz skopiować i wkleić na swojej stronie. Powstały w ten sposób banner będzie prowadzić do poszczególnych produktów na stronie naszego sklepu, a jeżeli ktoś wejdzie na naszą stronę po kliknięciu go i w czasie trwania sesji założy sobie konto i złoży zamówienie, lub przynajmniej założy konto, jego zamówienia będą zarabiały na Ciebie.</iaixsl:when>
			</iaixsl:choose>
			</div>
		</iaixsl:if>
	</section>
	<iaixsl:if test="not(page/generator/@type='promoCodes' or page/generator/@type='html' or page/generator/@type='php' or page/generator/@type='js')">
		<section class="affiliate --generator --content --noactive px-sm-4 pb-sm-4">
			<div class="affiliate__info mb-0">
				Nie wybrano typu generatora.
			</div>
		</section>
 	 </iaixsl:if>
  </iaixsl:if>
<!-- (affiliate_generator_javascript, 60dd8e852ccc30.38395459.3)-->
  <iaixsl:if test="page/generator/@type='js'">
    <section>
      <form class="affiliate --generator --content --js px-sm-4 pb-4" method="POST">
        <span class="headline">
          <span class="headline__name">
        ...
        <div class="f-group">
          <div class="f-feedback">
            <input class="f-control" type="text" name="link" id="affiliate__link">
              <iaixsl:attribute name="value"><iaixsl:value-of select="/shop/page/generator/default_link"/></iaixsl:attribute>
            </input>
            <label for="affiliate__link" class="f-label">Wpisz URL do produktów , które zostaną zwrócone w reklamie.</label>
            <span class="f-control-feedback"/>
            <a href="#check" class="affiliate__button --check btn --solid mt-2">Sprawdź produkty</a>
          </div>
        </div>
        <span class="headline">
          <span class="headline__name">
        ...
        <div class="affiliate__desc mb-2">Dostosuj wygląd reklamy podając parametry jej wyświetlania, rozmiar i kolorystykę. Aby otworzyć przybornik wyboru koloru kliknij na kolorową ikonkę</div>
        <div class="row">
          <div class="col-12 col-md-6">
            <strong class="d-block mb-4">Ustawienia wyświetlania</strong>
            <div class="row">
              <div class="col-12">
                <iaixsl:choose>
                  <iaixsl:when test="count(/shop/language/option) = 1">
                    <input type="hidden" name="language"><iaixsl:attribute name="value"><iaixsl:value-of select="/shop/language/option/@id"/></iaixsl:attribute></input>
                  </iaixsl:when>
                  <iaixsl:otherwise>
                    <select class="f-select --small" name="language">
                      <iaixsl:attribute name="data-label">Język: </iaixsl:attribute>
                      <iaixsl:for-each select="/shop/language/option">
                        <option>
              ...
              <div class="col-12">
                <iaixsl:choose>
                  <iaixsl:when test="count(/shop/currency/option) = 1">
                    <input type="hidden" name="currency"><iaixsl:attribute name="value"><iaixsl:value-of select="/shop/currency/option/@id"/></iaixsl:attribute></input>
                  </iaixsl:when>
                  <iaixsl:otherwise>
                    <select class="f-select --small" name="currency">
                      <iaixsl:attribute name="data-label">Waluta: </iaixsl:attribute>
                      <iaixsl:for-each select="/shop/currency/option">
                        <option>
                          <iaixsl:attribute name="value"><iaixsl:value-of select="@id"/></iaixsl:attribute>
                          <iaixsl:value-of select="@id"/> (<iaixsl:value-of select="@symbol"/>)
                        </option>
                      </iaixsl:for-each>
                    </select>
                  </iaixsl:otherwise>
              ...
              <div class="col-12">
                <select class="f-select --small" name="products_count">
                  <iaixsl:attribute name="data-label">Ilość produktów: </iaixsl:attribute>
                  <option>
                    <iaixsl:attribute name="value">1</iaixsl:attribute>
                    1
                  </option>
                  <option>
                    <iaixsl:attribute name="value">2</iaixsl:attribute>
                    2
                  </option>
                  <option>
                    <iaixsl:attribute name="value">3</iaixsl:attribute>
                    3
                  </option>
                  <option>
                    <iaixsl:attribute name="value">4</iaixsl:attribute>
                    4
                  </option>
                </select>
              </div>
              <div class="col-12">
                <select class="f-select --small" name="products_uklad">
                  <iaixsl:attribute name="data-label">Układ produktów: </iaixsl:attribute>
                  <option>
                    <iaixsl:attribute name="value">poziomy</iaixsl:attribute>
                    poziomy
                  </option>
                  <option>
                    <iaixsl:attribute name="value">pionowy</iaixsl:attribute>
                    pionowy
                  </option>
                </select>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small ">
                  <input id="banner_width" class="f-control" type="text" name="banner_width" value="225"/>
                  <label for="banner_width" class="f-label">Szerokość jednego produktu (px)</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small ">
                  <input id="banner_height" class="f-control" type="text" name="banner_height" value="300"/>
                  <label for="banner_height" class="f-label">Wysokość jednego produktu (px)</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small ">
                  <input id="image_width" class="f-control" type="text" name="image_width" value="225"/>
                  <label for="image_width" class="f-label">Szerokość grafiki produktu (px)</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small ">
                  <input id="image_height" class="f-control" type="text" name="image_height" value="220"/>
                  <label for="image_height" class="f-label">Wysokość grafiki produktu (px)</label>
                </div>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6">
            <strong class="d-block mb-4">Kolorystyka</strong>
            <div class="row">
              <div class="col-12 col-sm-6">
                <div class="f-group --small --color">
                  <input id="color3" class="f-control" type="text" name="color3" maxlength="7" value="#000000"/>
                  <label for="color3" class="f-label">Kolor nazwy produktu</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 align-self-center mb-2 mb-sm-0">
                <div class="f-group --checkbox">
                  <input id="nazwa_bold" class="f-control" type="checkbox" name="nazwa_bold"/>
                  <label for="nazwa_bold" class="f-label">Pogrubienie</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small --color">
                  <input id="color4" class="f-control" type="text" name="color4" maxlength="7" value="#d9592b"/>
                  <label for="color4" class="f-label">Kolor ceny</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 align-self-center mb-2 mb-sm-0">
                <div class="f-group --checkbox">
                  <input id="cena_bold" class="f-control" type="checkbox" name="cena_bold"/>
                  <label for="cena_bold" class="f-label">Pogrubienie</label>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="f-group --small --color">
                  <input id="color5" class="f-control" type="text" name="color5" maxlength="7" value="#8d8d8d"/>
                  <label for="color5" class="f-label">Kolor przekreślonej ceny</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 align-self-center mb-2 mb-sm-0">
                <div class="f-group --checkbox">
                  <input id="cena_promo_bold" class="f-control" type="checkbox" name="cena_promo_bold"/>
                  <label for="cena_promo_bold" class="f-label">Pogrubienie</label>
                </div>
              </div>
              <div class="col-12">
                <div class="f-group --radio d-flex align-items-center">
                  <span class="mr-2 d-flex align-items-center ">Ramka:</span>
                  <input name="border_radio" class="f-control" type="radio" id="border_radio1" value="nie" checked="checked"/><label for="border_radio1" class="f-label">nie</label>
                  <input name="border_radio" class="f-control" type="radio" id="border_radio2" value="tak"/><label for="border_radio2" class="f-label">tak</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 d-none" id="border_color">
                <div class="f-group --small --color">
                  <input id="color1" class="f-control" type="text" name="color1" maxlength="7" value="#ffffff"/>
                  <label for="color1" class="f-label">Kolor ramki</label>
                </div>
              </div>
              <div class="col-12 col-sm-3 d-none" id="border_width">
                <div class="f-group --small ">
                  <input id="border_width" class="f-control" type="text" name="border_width" value="1"/>
                  <label for="border_width" class="f-label">Grubość (px)</label>
                </div>
              </div>
              <div class="col-12">
                <div class="f-group --radio d-flex align-items-center">
                  <span class="mr-2 d-flex align-items-center ">Tło:</span>
                  <input name="background_radio" class="f-control" type="radio" id="background_radio1" value="nie" checked="checked"/><label for="background_radio1" class="f-label">nie</label>
                  <input name="background_radio" class="f-control" type="radio" id="background_radio2" value="tak"/><label for="background_radio2" class="f-label">tak</label>
                </div>
              </div>
              <div class="col-12 col-sm-6 d-none" id="background">
                <div class="f-group --small --color">
                  <input id="color2" class="f-control" type="text" name="color2" maxlength="7" value="#ffffff"/>
                  <label for="color2" class="f-label">Kolor tła</label>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="affiliate__desc mb-2">Aby sprawdzić jak będzie wyglądała reklama z powyższymi ustawieniami, kliknij przycisk "Pokaż podgląd reklamy&quot;.</div>
        <a href="#preview" class="affiliate__button --preview btn --solid ">Pokaż podgląd reklamy</a>
        <div class="affiliate__preview pt-3 pb-3"/>
        <span class="headline">
          <span class="headline__name">
            Krok 3 - Gotowe!
          </span>
        </span>
        <div class="affiliate__desc mb-2">Po wcisnięciu przycisku "Generuj kod JavaScript" pojawi się kod JavaSscript, który możesz skopiować i wkleić na swojej stronie. Kliknij na ten button za każdym razem jak dokonasz jakiś zmian w ustawieniach reklam.</div>
        <div class="f-group">
          <textarea class="f-control" readonly="true" cols="65" rows="4" name="output"/>
        </div>
        <a href="#generate" class="affiliate__button --generate btn --solid">Generuj kod JavaScript</a>
      </form>
    </section>
</iaixsl:if>
<!-- (affiliate_generator_php, 60dd8e85b83e11.23108809.2)-->
  <iaixsl:if test="page/generator/@type='php'">
    <section>
      <form class="affiliate --generator --content --php px-sm-4 pb-4" method="POST">
        <span class="headline">
          <span class="headline__name">
            Krok 1 - Wybierz produkty
          </span>
        ...
        <div class="f-group">
          <div class="f-feedback">
            ...
            <label for="affiliate__link" class="f-label">Wpisz URL do listy produktów lub do karty pojedynczego produktu.</label>
            <span class="f-control-feedback"/>
            <a href="#check" class="affiliate__button --check btn --solid mt-2">Sprawdź produkty</a>
          </div>
        </div>
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-3 d-none" id="border_width">
                <div class="f-group --small ">
                  <input id="border_width" class="f-control" type="text" name="border_width" value="1"/>
                  <label for="border_width" class="f-label">Grubość </label>
                </div>
              </div>
              <div class="col-12">
                <div class="f-group --radio d-flex align-items-center">
        ...
        <div class="affiliate__desc mb-2">Aby sprawdzić jak będzie wyglądała reklama z powyższymi ustawieniami, kliknij krzycisk "Pokaż podgląd reklamy&quot;.</div>
        <a href="#preview" class="affiliate__button --preview btn --solid ">Pokaż podgląd reklamy</a>
        <div class="affiliate__preview pt-3 pb-3"/>
        <span class="headline">
          <span class="headline__name">
        ...
        <div class="affiliate__desc mb-2">
          <p>Po wciśnięciu przycisku "Generuj kod PHP" pojawi się przykładowy kod PHP, który możesz skopiować i wkleić do swojego skryptu. Możesz go dowolnie modyfikować.</p>
          <p>Skrypt będzie pobierał XML zakodowany w UTF-8. Aby polskie znaki były prawidłowo wyświetlane, ustaw w kodzie odpowiednie kodowanie wejściowe i wyjściowe. Kodowanie wyjściowe musi był zgodne z kodowaniem, jakiego używasz na swojej stronie. Domyślnie zdefiniowane jest:</p>
          <ul class="ml-4">
            <li>wejściowe (INPUT_ENCODING): UTF-8</li>
            <li>wyjściowe - wyświetlane na Twojej stronie (OUTPUT_ENCODING): ISO-8859-2</li>
          </ul>
          <p>Jest to ustawienie odpowiednie dla PHP5. W przypadku PHP 4 i wcześniejszych, konieczne jest ustawienie kodowania wejściowego na ISO-8859-2. Najpopularniejsze dostępne w PHP kodowania to:</p>
          <ul class="ml-4">
            <li>UTF-8</li>
            <li>Windows-1251</li>
            <li>Windows-1252</li>
          ...
          <p>Do konwersji otrzymanego xmla używana jest funkcja iconv(), dostępna dla PHP od wersji 4.0.5. Obsługa określonych zestawów znaków jest zależna od implementacji iconv() w Twoim systemie. Proszę pamiętać, że w niektórych systemach funkcja iconv() działa niezgodnie z oczekiwaniami. W takich przypadkach nalezy zainstalować bibliotekę libiconv. Więcej informacji o funkcji iconv() i kodowaniu szukaj na stronie <a href="http://php.net/"/></p>
        </div>
        <div class="f-group">
          <textarea class="f-control" readonly="true" cols="65" rows="4" name="output"/>
        </div>
        <a href="#generate" class="affiliate__button --generate btn --solid">Generuj kod PHP</a>
      </form>
    </section>
  </iaixsl:if>
<!-- (affiliate_generator_code, 60dd8e85584e81.30672396.5)-->
  <iaixsl:if test="page/generator/@type ='promoCodes'">
    <section class="affiliate --generator --content --code px-sm-4 pb-4">
      <span class="headline">
        <span class="headline__name">
      ...
      <iaixsl:choose>
        <iaixsl:when test="page/generator/rebate_codes/rebate_code">
          <div class="affiliate__desc mb-4">Zarabianie na kodach nic Cię nie kosztuje, wymaga jedynie Twojego zaangażowania i czasu, który zainwestujesz w promocję.<br/>Sprawdź jak jest to proste i zacznij zarabiać pieniądze. </div>
          <div class="row mb-4">
            <div class="col-12 col-md-4 affiliate__manual d-flex align-items-center flex-wrap flex-md-nowrap">
              <span>
                <strong class="mb-2">Wybierz kod</strong>
                Udostępniamy Ci indywidualny kod powiązany z Twoim kontem partnerskim w naszym sklepie.
              </span>
            </div>
            <div class="col-12 col-md-4 affiliate__manual d-flex align-items-center flex-wrap flex-md-nowrap">
              <span>
                <strong class="mb-2">Promuj kody rabatowe</strong>
                Udostępnij wybrany kod dalej np. w portalach społecznościowych lub na swojej stronie internetowej.
              </span>
            </div>
            <div class="col-12 col-md-4 affiliate__manual d-flex align-items-center flex-wrap flex-md-nowrap">
              <span>
                <strong class="mb-2">Zarabiaj pieniądze</strong>
                Na twoje konto wróci część kwoty zapłaconej przez klientów, którzy użyli tego kodu rabatowego.
              </span>
            </div>
          </div>
          <div class="affiliate__desc mb-4">Chcesz otrzymać niesamowite wynagrodzenie pieniężne dla siebie i swoich przyjaciół? Jeśli odpowiedź brzmi tak, po prostu skopiuj kod rabatowy i wyślij go swoim znajomym.</div>
          <div class="row mb-4">
            <iaixsl:for-each select="page/generator/rebate_codes/rebate_code">
              <div class="col-12 col-sm-6 col-md-4 d-flex mb-3">
                <div class="affiliate__promo p-3 d-flex align-items-center flex-wrap">
                  <span>
                    Kod:
                    <strong class="affiliate__code">
                      <iaixsl:value-of disable-output-escaping="yes" select="@number"/>
                    </strong>
                  </span>
                  <span class="affiliate__tooltip pb-1 d-block">
                    <a href="#" class="affiliate__tooltip --trigger">
                      Szczegóły rabatu
                    </a>
                    <small class="affiliate__tooltip --content">
                      Aktywny w sklepach
                      <iaixsl:for-each select="active_in_shops/shop_name">
                        <strong class="d-block"><iaixsl:value-of select="text()"/></strong>
                      </iaixsl:for-each>
                      <iaixsl:if test="products_rebate">
                        <span class="affiliate__rebate d-block">
                          <a href="/search.php">Na cały asortyment</a>
                          <span><iaixsl:value-of select="products_rebate/@rebate_value_formatted"/></span>
                        </span>
                      </iaixsl:if>
                      <iaixsl:if test="producer/item">
                        <span class="d-block pt-1">Na wybrane marki</span>
                      ...
                      <iaixsl:if test="series/item">
                        <span class="d-block pt-1">Na wybrane serie</span>
                      ...
                      <iaixsl:if test="main_cat/item">
                        <span class="d-block pt-1">Na wybrane kategorie</span>
                ...
                <div class="affiliate__promo --info p-3 d-flex align-items-center justify-content-start flex-wrap">
                  <small>
                    Ważny do:
                  </small>
          ...
          <div class="affiliate__desc mb-4">Jeśli jesteś doświadczonym developerem i chcesz rozwinąć opcje dostosowania wyglądu przycisku z kodem rabatowym, kliknij przycisk poniżej.</div>
          <div class="f-group">
            <a class="affiliate__button --develop btn --solid --medium" href="#develop"> Jestem developerem</a>
          </div>
          <form class="affiliate__form --code" method="POST">
            <span class="headline">
              <span class="headline__name">
                Krok 1 - Wybierz kod rabatowy
              </span>
            </span>
            <div class="affiliate__desc mb-4">Poniżej znajduje się lista wszystkich kodów promocyjnych aktywnych w sklepach biorących udział w programie partnerskim</div>
            <div class="row mb-4">
              <div class="col-12 col-sm-6">
                <select class="f-select" name="promo_codes_shop">
                  <iaixsl:attribute name="data-label">Wybierz sklep: </iaixsl:attribute>
                ...
                <select class="f-select" name="promo_codes_code">
                  <iaixsl:attribute name="data-label">Wybierz kod: </iaixsl:attribute>
                  <iaixsl:for-each select="/shop/page/generator/rebate_codes/rebate_code">
                    <option>
                      <iaixsl:attribute name="value">
                        <iaixsl:value-of select="@number"/>
                      </iaixsl:attribute>
                      <iaixsl:attribute name="data-shop"><iaixsl:for-each select="active_in_shops/shop_name"><iaixsl:value-of select="text()"/><iaixsl:if test="not(position() = last())">,</iaixsl:if></iaixsl:for-each></iaixsl:attribute>
                      <iaixsl:value-of select="@number"/>
                    </option>
                  </iaixsl:for-each>
                </select>
              </div>
              <div class="rebates_active col-12 col-sm-6">
                <iaixsl:for-each select="/shop/page/generator/rebate_codes/rebate_code">
                  <div class="rebates_active__wrapper d-sm-flex align-items-sm-center p-2 p-sm-4 mb-2">
                    <iaixsl:attribute name="data-shops"><iaixsl:for-each select="active_in_shops/shop_name"><iaixsl:value-of select="text()"/><iaixsl:if test="not(position() = last())">,</iaixsl:if></iaixsl:for-each></iaixsl:attribute>
                    <iaixsl:attribute name="data-code"><iaixsl:value-of select="@number"/></iaixsl:attribute>
                    <div class="rebates_active__sub --name">
                      <span class="rebates_active__name">Wybrany kod:<strong><iaixsl:value-of select="@number"/></strong></span>
                    </div>
                    <div class="rebates_active__sub --info">
                      <iaixsl:if test="@min_order &gt; 0">
                        <div class="rebates_active__param --min_order">
                      ...
                      <iaixsl:if test="@max_order &gt; 0 and $max_order_value != ''">
                        <div class="rebates_active__param --max_order">
                          Maksymalna wartość produktów w koszyku: 
                          <strong><iaixsl:value-of select="@max_order_formatted"/></strong>
                        </div>
                      </iaixsl:if>
                      <iaixsl:if test="@expires">
                        <div class="rebates_active__param --expires">
                          Ważny do dnia: 
                          <strong><iaixsl:value-of select="@expires"/></strong>
                        </div>
                      </iaixsl:if>
                      <div class="rebates_active__param --combined">
                        <iaixsl:choose>
                      ...
                      <iaixsl:if test="inactive_zones/item">
                        <div class="rebates_active__param --inactive">
                ...
                <div class="affiliate__info col-12 --no_code">
            ...
            <div class="row mb-4">
              <div class="col-12 col-md-6">
                ...
                <div class="affiliate__desc mb-4"/>
                <div class="f-group --radio">
                  <input name="promo_code_radio" class="f-control" type="radio" id="promo_code_radio1" value="0-0" checked="checked"/>
									<label for="promo_code_radio1" class="f-label --text"><a>Link tekstowy</a></label>
                </div>
                <div class="f-group --radio">
                  <input name="promo_code_radio" class="f-control" type="radio" id="promo_code_radio2" value="0-1"/>
									<label for="promo_code_radio2" class="f-label --text_icon"><a><i class="icon-tags"/> Link tekstowy + ikona</a></label>
                </div>
                <div class="f-group --radio">
                  <input name="promo_code_radio" class="f-control" type="radio" id="promo_code_radio3" value="1-0"/>
									<label for="promo_code_radio3" class="f-label --button"><a class="btn --solid">Przycisk</a></label>
                </div>
                <div class="f-group --radio">
                  <input name="promo_code_radio" class="f-control" type="radio" id="promo_code_radio4" value="1-1"/>
									<label for="promo_code_radio4" class="f-label --button_icon"><a class="btn --solid"><i class="icon-tags"/> Przycisk + ikona</a></label>
                </div>
              </div>
              <div class="col-12 col-md-6">
                <span class="headline">
                  <span class="headline__name">
                    Krok 3 - Dopasuj wygląd
                  </span>
                </span>
                <div class="affiliate__desc mb-4"/>
								<div class="row mb-4">
									<div class="col-12 col-md-6">
										<div class="f-group --small">
											<input id="promo_code_text" class="f-control" type="text" name="promo_code_text">
												<iaixsl:attribute name="value">Kliknij, aby aktywować kod: %s</iaixsl:attribute>
											</input>
											<label for="promo_code_text" class="f-label">Tekst na przycisku</label>
										</div>
									</div>
									<div class="col-12 col-md-6">
										<div class="f-group --small">
											<input id="promo_code_text_size" class="f-control" type="text" name="promo_code_text_size">
												<iaixsl:attribute name="value">14</iaixsl:attribute>
											</input>
											<label for="promo_code_text_size" class="f-label">Wielkość tekstu (px)</label>
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="f-group --color --small">
											<input id="color3" class="f-control" type="text" name="color3" maxlength="7" value="#000000"/>
											<label for="color3" class="f-label">Kolor tekstu</label>
										</div>
									</div>
									<div class="col-12 col-sm-3 align-self-center mb-2 mb-sm-0">
										<div class="f-group --checkbox">
											<input id="nazwa_bold" class="f-control" type="checkbox" name="nazwa_bold"/>
											<label for="nazwa_bold" class="f-label">Pogrubienie</label>
										</div>
									...
									<div class="col-12 col-sm-3 align-self-center mb-2 mb-sm-0">
										<div class="f-group --checkbox">
											<input id="nazwa_radius" class="f-control" type="checkbox" name="nazwa_radius"/>
											<label for="nazwa_radius" class="f-label">Zaokrąglenie</label>
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="f-group --color --small">
											<input id="color4" class="f-control" type="text" name="color4" maxlength="7" value="#000000"/>
											<label for="color4" class="f-label">Kolor ikony</label>
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="f-group --color --small">
											<input id="color5" class="f-control" type="text" name="color5" maxlength="7" value="#000000"/>
											<label for="color5" class="f-label">Kolor tla</label>
										</div>
									</div>
									<div class="col-12">
										<div class="f-group --radio d-flex flex-wrap flex-sm-nowrap align-items-center">
											<span class="col-12 px-0 col-sm flex-sm-grow-0 mr-2 d-flex align-items-center ">Wybierz ikonę:</span>
											<input name="ikona" class="f-control" type="radio" id="ikona1" checked="checked"/><label for="ikona1" class="f-label"><i class="icon-tags"/></label>
											<input name="ikona" class="f-control" type="radio" id="ikona2"/><label for="ikona2" class="f-label"><i class="icon-star"/></label>
											<input name="ikona" class="f-control" type="radio" id="ikona3"/><label for="ikona3" class="f-label"><i class="icon-credit-card"/></label>
											<input name="ikona" class="f-control" type="radio" id="ikona4"/><label for="ikona4" class="f-label"><i class="icon-link"/></label>
											<input name="ikona" class="f-control" type="radio" id="ikona5"/><label for="ikona5" class="f-label"><i class="icon-heart"/></label>
										</div>
									</div>
								</div>
              </div>
            </div>
            <div class="affiliate__desc mb-4">Aby sprawdzić jak będzie wyglądał przycisk z kodem rabatowym z powyższymi ustawieniami, kliknij przycisk "Pokaż podgląd przycisku&quot;.</div>
            <a href="#preview" class="affiliate__button --previewCode btn --solid ">Pokaż podgląd przycisku</a>
						<div class="affiliate__preview mt-3 mb-3"/>
            <span class="headline">
              <span class="headline__name">
                Krok 4 - Gotowe!
              </span>
            </span>
            <div class="affiliate__desc mb-4">Masz możliwość wygenerowania bezpośredniego linku, dzięki czemu klienci nie muszą ręcznie wpisywać kodu w sklepie. Klikając w wygenerowany link, klient zostanie przeniesiony do sklepu z aktywnym juz kodem promocyjnym, złożone zamówienia będa zarabiały na Ciebie. Aby wygenerować bezpośredni url wybierz sklep i kliknij "Generuj url linka" jeśli potrzebujesz gotowy kod HTML do wstawienia na stronę lub e-maila kliknij "Generuj kod linka.&quot;</div>
						<div class="row mb-0">
							<div class="col-12 col-sm-3 ">
								<a class="affiliate__button --generateCode btn --solid mb-3" href="#generateCode">
									Generuj kod linka
								</a>
								<a class="affiliate__button --generateUrl btn --solid mb-3 mb-sm-0" href="#generateUrl">
									Generuj url linka
								</a>
							</div>
  ...
  <!-- (affiliate_generator_html, 60dd8e873be6b1.24407835.2)-->
	<iaixsl:if test="page/generator/@type='html'">
		<section class="affiliate --generator --content --html px-sm-4 pb-4">
			<span class="headline">
				<span class="headline__name">
					KROK 1 - ODNOŚNIK
				</span>
			...
			<div class="row">
				<div class="col-12 col-sm-6">
					<div class="f-group">
						<input id="affiliate__link" class="f-control" type="text" name="shop_url"><iaixsl:attribute name="value"><iaixsl:value-of select="/shop/@baseurl"/></iaixsl:attribute></input>
						<label for="affiliate__link" class="f-label">Podaj adres, pod który trafi klient (przykład: http://nazwasklepu.pl/)</label>
					</div>
				</div>
				<div class="col-12 col-sm-6">
					<div class="f-group">
						<input id="affiliate__link_name" class="f-control" type="text" name="link_name"><iaixsl:attribute name="value"><iaixsl:value-of select="/shop/contact/owner/@shopname"/></iaixsl:attribute></input>
						<label for="affiliate__link_name" class="f-label">Podaj zawartość odnośnika (konieczne przy generowaniu kodu jako odnośnik)</label>
					</div>
				</div>
			</div>
			<span class="headline">
			...
			<iaixsl:choose>
				<iaixsl:when test="page/generator/banners/banner">
					<iaixsl:for-each select="page/generator/banners/banner">
						<div class="col-12">
							<div class="f-group --radio">
								<input class="f-control" type="radio" name="banner">
									<iaixsl:attribute name="value"><iaixsl:value-of select="@link"/></iaixsl:attribute>
									<iaixsl:attribute name="id">affiliate__banner<iaixsl:value-of select="position()"/></iaixsl:attribute>
									<iaixsl:if test="@checked = 'checked'">
										<iaixsl:attribute name="checked"/>
									</iaixsl:if>
								</input>
								<label class="f-label">
									<iaixsl:attribute name="for">affiliate__banner<iaixsl:value-of select="position()"/></iaixsl:attribute>
									<iaixsl:choose>
										<iaixsl:when test="@type = 'swf'">
											<iaixsl:attribute name="data-width"><iaixsl:value-of select="@height"/></iaixsl:attribute>
											<iaixsl:attribute name="data-height"><iaixsl:value-of select="@width"/></iaixsl:attribute>
										...
										<iaixsl:otherwise>
											<img><iaixsl:attribute name="src">/<iaixsl:value-of select="@link"/></iaixsl:attribute></img>
										</iaixsl:otherwise>
									</iaixsl:choose>
								</label>
							</div>
				...
				<iaixsl:otherwise>
					<div class="affiliate__info">Brak bannerów do wyboru.</div>
				</iaixsl:otherwise>
			</iaixsl:choose>
			<span class="headline">
				<span class="headline__name">
			...
			<div class="affiliate__desc mb-2">
				Po wciśnięciu przycisku "Generuj kod bannera" pojawi się kod HTML, który po wstawieniu na Twoją stronę zaowocuje bannerem kierującym do wybranej przez Ciebie podstrony naszego sklepu. Jeśli chcesz otrzymać zwykły link tekstowy prowadzący do wybranej podstrony, kliknij przycisk "Generuj url linka". Aby otrzymać adres URL, którego możesz użyć np. do rozsyłania w e-mailach, wciśnij przycisk "Generuj kod linka&quot;.
			</div>
			<div class="row mb-0">
				<div class="col-12 col-sm-3 ">
					<a class="affiliate__button --generateHtmlCode btn --solid mb-3" href="#generateHtmlCode">
						<iaixsl:if test="not(page/generator/banners/banner)"><iaixsl:attribute name="disabled">disabled</iaixsl:attribute></iaixsl:if>
						Generuj kod bannera
					</a>
					<a class="affiliate__button --generateHtmlUrl btn --solid mb-3" href="#generateHtmlUrl">
						Generuj url linka
					</a>
					<a class="affiliate__button --generateHtmlLink btn --solid mb-3 mb-sm-0" href="#generateHtmlLink">
						Generuj kod linka
					</a>
				</div>
				<div class="col-12 col-sm-9">
					<div class="f-group mb-0 --full">
						<textarea class="f-control" readonly="true" cols="65" rows="6" name="output">
							<iaixsl:attribute name="data-baseurl"><iaixsl:value-of select="@baseurl"/></iaixsl:attribute>
							<iaixsl:attribute name="data-affiliate"><iaixsl:value-of select="basket/@client_id"/></iaixsl:attribute>
						</textarea>
					</div>
				</div>
			</div>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/pol/envelope.js.gzip?r=1696937760"></script><script src="/gfx/pol/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/pol/affiliate_generator_javascript.js.gzip?r=1696937760"></script><script src="/gfx/pol/affiliate_generator_code.js.gzip?r=1696937760"></script><script src="/gfx/pol/affiliate_generator_html.js.gzip?r=1696937760"></script>
