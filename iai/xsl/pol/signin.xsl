																						...
																						<iaixsl:if test="@name = $social_media_name">
																							<div id="cookie_login_social" class="iai_accounts tooltip --top">
																									<span id="cookie_login_social_desc" class="iai_accounts">
																													Zaloguj się z <strong>IdoAccounts</strong> przez <iaixsl:value-of select="$social_media_name"/>, a Twoje dane do wysyłki zostaną uzupełnione automatycznie na podstawie poprzednich zamówień.
																									</span>
																							</div>
                                            </iaixsl:if>
                                            <iaixsl:choose>
																								...
																								<span id="cookie_login_social_desc">
																										<iaixsl:choose>
																												<iaixsl:when test="not(/shop/client_data/@iai_accounts = 'consent')">
																														...
																														Zaloguj się ponownie przez <iaixsl:value-of select="$social_media_name"/>, abyśmy mieli pewność że to Ty. 
																												</iaixsl:when>
																												<iaixsl:otherwise>
																														<iaixsl:attribute name="class">iai_accounts</iaixsl:attribute>
																														Zaloguj się z <strong>IdoAccounts</strong> przez <iaixsl:value-of select="$social_media_name"/>, a Twoje dane do wysyłki zostaną uzupełnione automatycznie na podstawie poprzednich zamówień.
