...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (navigation_categoriesdescription, 61b0b16cc45856.47733212.2)-->
	<div class="navigation_description">
		...
		<iaixsl:if test="page/description/desc and page/description/desc != ''">
			<div class="navigation_desc --top cm">
				<div class="navigation_desc__wrapper">
					<iaixsl:value-of disable-output-escaping="yes" select="page/description/desc"/>
				</div>
			</div>
		</iaixsl:if>
	</div>
<!-- (navigation_elements, 61b0b16cd7eab6.92498629.3)-->
        ...
        <div class="navigation_items">
            <iaixsl:for-each select="page/navigation/item">
                	...
                	<a class="image-block">
	                    ...
	                    <span class="title-text text-uppercase">
	                        <iaixsl:value-of disable-output-escaping="yes" select="@name"/>
	                    </span>
...
<!-- (navigation_categoriesdescription_bottom, 61b0b16dd341b1.53902198.3)-->
	<iaixsl:if test="/shop/page/description/desc_bottom and /shop/page/description/desc_bottom != ''">
		<div class="navigation_desc --bottom cm">
			<div class="navigation_desc__wrapper">
				<iaixsl:value-of disable-output-escaping="yes" select="/shop/page/description/desc_bottom"/>
			</div>
		</div>
	</iaixsl:if>
