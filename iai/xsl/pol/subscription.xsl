...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
	...
	<iaixsl:if test="/shop/page/products/navigation/filtering/filter/@id='filter_instock'"> </iaixsl:if>
        ...
        <!-- (subscription_settings, 6377846f78f1f3.82929292.3)-->
	<iaixsl:if test="/shop/page/subscription">
		<iaixsl:variable name="status"><iaixsl:value-of select="/shop/page/subscription/@status"/></iaixsl:variable>
		<iaixsl:variable name="dateNextOrder"><iaixsl:value-of select="translate(/shop/page/subscription/dates/@date_next_order, '-', '')"/></iaixsl:variable>
		<iaixsl:variable name="minNextDate"><iaixsl:value-of select="translate(/shop/page/subscription/dates/@min_next_date, '-', '')"/></iaixsl:variable>
		<iaixsl:variable name="maxNextDate"><iaixsl:value-of select="translate(/shop/page/subscription/dates/@max_next_date, '-', '')"/></iaixsl:variable>
		<div class="subscription_settings">
			<iaixsl:if test="/shop/page/subscription/@next_order_in_progress = 'true' or $dateNextOrder &gt; $maxNextDate or $minNextDate &gt; $maxNextDate">
				<iaixsl:attribute name="class">subscription_settings --in-progress</iaixsl:attribute>
			</iaixsl:if>
			<iaixsl:attribute name="data-status"><iaixsl:value-of select="$status"/></iaixsl:attribute>
			<h1 class="headline">
				<iaixsl:variable name="subscriptionId"><iaixsl:value-of select="/shop/page/subscription/@id"/></iaixsl:variable>
				<iaixsl:variable name="terminatedSubscriptionText">Zakończona subskrypcja nr %s</iaixsl:variable>
				<iaixsl:variable name="subscriptionSettingsText">Ustawienia subskrypcji nr %s</iaixsl:variable>
				<span class="headline__name"><iaixsl:choose><iaixsl:when test="$status = 'finished'"><iaixsl:value-of select="php:function('sprintf', $terminatedSubscriptionText, $subscriptionId)"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="php:function('sprintf', $subscriptionSettingsText, $subscriptionId)"/></iaixsl:otherwise></iaixsl:choose></span>
			</h1>
			<div class="subscription_settings__wrapper">
				
				<iaixsl:if test="$status != 'finished'">
					<div class="subscription_settings__dates">
						<h4 class="subscription_settings__label">Daty dostawy</h4>
						<div class="subscription_settings__dates_wrapper">
							<div class="subscription_settings__date --upcoming">
								<span class="subscription_settings__date_label">Najbliższa:</span>
								<strong class="subscription_settings__date_value">
									<span class="subscription_settings__day_name">
										<iaixsl:choose>
											<iaixsl:when test="/shop/page/subscription/dates/@next_order_week_day = 1">
												Poniedziałek
											</iaixsl:when>
											<iaixsl:when test="/shop/page/subscription/dates/@next_order_week_day = 2">
												Wtorek
											</iaixsl:when>
											<iaixsl:when test="/shop/page/subscription/dates/@next_order_week_day = 3">
												Środa
											</iaixsl:when>
											<iaixsl:when test="/shop/page/subscription/dates/@next_order_week_day = 4">
												Czwartek
											</iaixsl:when>
											<iaixsl:when test="/shop/page/subscription/dates/@next_order_week_day = 5">
												Piątek
											</iaixsl:when>
											<iaixsl:when test="/shop/page/subscription/dates/@next_order_week_day = 6">
												Sobota
											</iaixsl:when>
											<iaixsl:when test="/shop/page/subscription/dates/@next_order_week_day = 7">
												Niedziela
											</iaixsl:when>
										</iaixsl:choose>
									</span>
									<iaixsl:variable name="next_order_time"><iaixsl:value-of select="/shop/page/subscription/dates/@date_next_order"/></iaixsl:variable>
									...
									<span class="subscription_settings__day_month"> (<span><iaixsl:value-of select="$next_order_time_formatted"/></span>)</span>
								</strong>
							</div>
							<div class="subscription_settings__date --next">
								<iaixsl:attribute name="data-default"><iaixsl:value-of select="/shop/page/subscription/dates/@date_next_next_order"/></iaixsl:attribute>
								<span class="subscription_settings__date_label">Kolejne co <span class="subscription_settings__date_label_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/> dni</span>:</span>
								<strong class="subscription_settings__date_value">
									<span class="subscription_settings__day_name">
										<iaixsl:choose>
											<iaixsl:when test="/shop/page/subscription/dates/@next_next_order_week_day = 1">
												Poniedziałek
											</iaixsl:when>
											<iaixsl:when test="/shop/page/subscription/dates/@next_next_order_week_day = 2">
												Wtorek
											</iaixsl:when>
											<iaixsl:when test="/shop/page/subscription/dates/@next_next_order_week_day = 3">
												Środa
											</iaixsl:when>
											<iaixsl:when test="/shop/page/subscription/dates/@next_next_order_week_day = 4">
												Czwartek
											</iaixsl:when>
											<iaixsl:when test="/shop/page/subscription/dates/@next_next_order_week_day = 5">
												Piątek
											</iaixsl:when>
											<iaixsl:when test="/shop/page/subscription/dates/@next_next_order_week_day = 6">
												Sobota
											</iaixsl:when>
											<iaixsl:when test="/shop/page/subscription/dates/@next_next_order_week_day = 7">
												Niedziela
											</iaixsl:when>
										</iaixsl:choose>
									</span>
									<iaixsl:variable name="next_next_order_time"><iaixsl:value-of select="/shop/page/subscription/dates/@date_next_next_order"/></iaixsl:variable>
									<iaixsl:variable name="next_next_order_time_month_day"><iaixsl:value-of select="substring($next_next_order_time, 6, 5)"/></iaixsl:variable>
									<iaixsl:variable name="next_next_order_time_formatted"><iaixsl:value-of select="substring-after($next_next_order_time_month_day, '-')"/>.<iaixsl:value-of select="substring-before($next_next_order_time_month_day, '-')"/></iaixsl:variable>
									<span class="subscription_settings__day_month"> (<span><iaixsl:value-of select="$next_next_order_time_formatted"/></span>)</span>
								</strong>
							</div>
							<iaixsl:if test="/shop/page/subscription/@max_days_number_next_order != 0">
								<div class="subscription_settings__calendar_info">
									<div class="subscription_settings__info --upcoming">
										<h4 class="subscription_settings__label">Data najbliższej dostawy</h4>
										<p class="subscription_settings__info_text">Możesz zmienić datę najbliższej dostawy do <span class="subscription_settings__info_text_period"><iaixsl:attribute name="data-change-literal-days-up-to"><iaixsl:value-of select="/shop/page/subscription/@max_days_number_next_order"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@max_days_number_next_order"/> dni</span> od daty obecnie ustawionej.</p>
									</div>
									<div class="subscription_settings__info --next">
										<h4 class="subscription_settings__label">Data najbliższej dostawy oraz kolejnych</h4>
										<p class="subscription_settings__info_text">Wszystkie dostawy będą realizowane co <span class="subscription_settings__info_text_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/> dni</span> od wskazanej daty.</p>
									</div>
								</div>
								<div class="subscription_settings__calendar vanilla-calendar">
									<iaixsl:attribute name="data-date"><iaixsl:value-of select="/shop/page/subscription/dates/@date_next_order"/></iaixsl:attribute>
									<iaixsl:attribute name="data-period"><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/></iaixsl:attribute>
									<iaixsl:attribute name="data-min-date"><iaixsl:value-of select="/shop/page/subscription/dates/@min_next_date"/></iaixsl:attribute>
									<iaixsl:attribute name="data-max-date"><iaixsl:value-of select="/shop/page/subscription/dates/@max_next_date"/></iaixsl:attribute>
									<iaixsl:attribute name="data-unavailable-dates"><iaixsl:for-each select="/shop/page/subscription/dates/unavailable_dates/date"><iaixsl:value-of select="text()"/><iaixsl:if test="position() != last()">;</iaixsl:if></iaixsl:for-each></iaixsl:attribute>
								</div>
								<div class="subscription_settings__change --upcoming">
									<a href="#changeUpcomingDate" class="subscription_settings__change_link">Zmień tylko datę najbliższej dostawy</a>
								</div>
								<div class="subscription_settings__change --next">
									<a href="#changeNextDate" class="subscription_settings__change_link">Zmień datę najbliższej dostawy oraz kolejnych</a>
								</div>
								<iaixsl:if test="/shop/page/subscription/@next_order_in_progress = 'true' and not($dateNextOrder &gt; $maxNextDate) and not($minNextDate &gt; $maxNextDate)">
									<div class="subscription_settings__disabled_change">
										Zamówienie zostało wysłane, zmiana dat będzie możliwa po dostarczeniu.
									</div>
								</iaixsl:if>
							</iaixsl:if>
						</div>
						<iaixsl:choose>
							<iaixsl:when test="/shop/page/subscription/@next_order_in_progress = 'true' or $dateNextOrder &gt; $maxNextDate or $minNextDate &gt; $maxNextDate"/>
							<iaixsl:when test="/shop/page/subscription/@max_days_number_next_order != 0">
								<p class="subscription_settings__dates_description">Możesz zmienić datę najbliższej dostawy do <span class="subscription_settings__dates_description_period"><iaixsl:attribute name="data-change-literal-days-up-to"><iaixsl:value-of select="/shop/page/subscription/@max_days_number_next_order"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@max_days_number_next_order"/> dni</span> od daty obecnie ustawionej. Jeżeli zmienisz datę kolejnej dostawy spowoduje to przesunięcie daty kolejnej płatności (dotyczy następnej dostawy w ramach tej subskrypcji).</p>
							</iaixsl:when>
							<iaixsl:otherwise>
								<p class="subscription_settings__dates_description">Możliwość zmiany daty dostawy nie jest dostępna dla tej subskrypcji.</p>
							</iaixsl:otherwise>
						</iaixsl:choose>
					</div>
				</iaixsl:if>
				
				<div class="subscription_settings__shipping">
					<h4 class="subscription_settings__label">Adres dostawy</h4>
					<div class="subscription_settings__addresses">
						<iaixsl:variable name="currentRegionId"><iaixsl:choose><iaixsl:when test="/shop/page/subscription/addresses/address[@selected = 'yes']"><iaixsl:value-of select="/shop/page/subscription/addresses/address[@selected = 'yes']/@region_id"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="/shop/page/subscription/addresses/address/@region_id"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
						<iaixsl:for-each select="/shop/page/subscription/addresses/address[@region_id = $currentRegionId]">
							<div class="subscription_settings__address">
								<iaixsl:if test="@selected = 'yes'">
									<iaixsl:attribute name="class">subscription_settings__address --selected</iaixsl:attribute>
								</iaixsl:if>
								<iaixsl:attribute name="data-id"><iaixsl:value-of select="@id"/></iaixsl:attribute>
								<iaixsl:attribute name="data-additional"><iaixsl:value-of select="@additional"/></iaixsl:attribute>
								<iaixsl:attribute name="data-firstname"><iaixsl:value-of select="@firstname"/></iaixsl:attribute>
								<iaixsl:attribute name="data-lastname"><iaixsl:value-of select="@lastname"/></iaixsl:attribute>
								<iaixsl:attribute name="data-street"><iaixsl:value-of select="@street"/></iaixsl:attribute>
								<iaixsl:attribute name="data-city"><iaixsl:value-of select="@city"/></iaixsl:attribute>
								...
								<iaixsl:attribute name="data-country"><iaixsl:value-of select="@country_name"/></iaixsl:attribute>
								...
								<div class="subscription_settings__address_wrapper">
									
									<iaixsl:if test="@additional and @additional != ''">
										<span class="subscription_settings__address_item --additional"><iaixsl:value-of select="@additional"/></span>
									</iaixsl:if>
									
									<span class="subscription_settings__address_item --name"><iaixsl:value-of select="@firstname"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="@lastname"/></span>
									
									<span class="subscription_settings__address_item --street"><iaixsl:value-of select="@street"/></span>
									
									<span class="subscription_settings__address_item --city"><iaixsl:value-of select="@zipcode"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="@city"/></span>
									
									<iaixsl:if test="@phone and @phone != ''">
										<span class="subscription_settings__address_item --phone"><span class="subscription_settings__address_phone_txt">telefon: </span><span class="subscription_settings__address_phone_value"><iaixsl:value-of select="@phone"/></span></span>
									</iaixsl:if>
								</div>
								
								<iaixsl:if test="@editable = 'yes'">
									<a href="#addressEdit" class="subscription_settings__address_edit">Edytuj</a>
								</iaixsl:if>
							</div>
						</iaixsl:for-each>
					</div>
					<a href="#addNewAddress" class="subscription_settings__address_add">Dodaj nowy adres</a>
				</div>
				
				<iaixsl:if test="$status != 'finished'">
					<div class="subscription_settings__payment">
						<h4 class="subscription_settings__label">Płatność</h4>
						<div class="subscription_settings__card">
							<span class="subscription_settings__card_icon">
								<img>
									<iaixsl:attribute name="src"><iaixsl:value-of select="/shop/page/subscription/payment/@method_icon"/></iaixsl:attribute>
									<iaixsl:attribute name="alt"><iaixsl:value-of select="/shop/page/subscription/payment/@card_number"/></iaixsl:attribute>
								</img>
							</span>
							<span class="subscription_settings__card_number"><iaixsl:value-of select="/shop/page/subscription/payment/@card_number"/></span>
							<a href="#cancelSubscription" class="subscription_settings__card_edit">Odepnij kartę</a>
						</div>
					</div>
				</iaixsl:if>
				
				<div class="subscription_settings__delivery_wrapper">
					<h4 class="subscription_settings__label">Forma dostawy</h4>
					<div class="subscription_settings__delivery">
						<span class="subscription_settings__delivery_icon">
							<img>
								<iaixsl:attribute name="alt"><iaixsl:value-of select="/shop/page/subscription/delivery/form/@name"/></iaixsl:attribute>
								<iaixsl:attribute name="src"><iaixsl:value-of select="/shop/page/subscription/delivery/form/@icon"/></iaixsl:attribute>
							</img>
						</span>
						<div class="subscription_settings__delivery_info">
							<strong class="subscription_settings__delivery_name">
								<iaixsl:value-of select="/shop/page/subscription/delivery/form/@name"/>
							</strong>
						</div>
						<div class="subscription_settings__product_price">
							<strong>
								<iaixsl:value-of select="/shop/page/subscription/delivery/cost/@price_formatted"/>
							</strong>
							<span> / co <span class="subscription_settings__product_price_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/> dni</span></span>
						</div>
					</div>
				</div>
				
				<div class="subscription_settings__products_wrapper">
					<h4 class="subscription_settings__label">Produkty w subskrypcji</h4>
					<div class="subscription_settings__products">
						<iaixsl:for-each select="/shop/page/subscription/products/product">
							<div class="subscription_settings__product">
								<a class="subscription_settings__product_icon">
									<iaixsl:attribute name="href"><iaixsl:value-of select="@url"/></iaixsl:attribute>
									<img>
										<iaixsl:attribute name="alt"><iaixsl:value-of select="@name"/></iaixsl:attribute>
										<iaixsl:attribute name="src"><iaixsl:value-of select="icons/@small"/></iaixsl:attribute>
									</img>
								</a>
								<div class="subscription_settings__product_info">
									<a class="subscription_settings__product_name">
										<iaixsl:attribute name="href"><iaixsl:value-of select="@url"/></iaixsl:attribute>
										<iaixsl:value-of select="@name"/>
									</a>
									<div class="subscription_settings__product_details">
										<div class="subscription_settings__product_detail --quantity">
											<span class="subscription_settings__product_detail_name">Ilość:</span>
											<span class="subscription_settings__product_detail_value"><iaixsl:value-of select="@quantity"/><iaixsl:text> </iaixsl:text><iaixsl:value-of select="@unit"/></span>
										</div>
										<iaixsl:if test="@symbol != ''">
											<div class="subscription_settings__product_detail --symbol">
												<span class="subscription_settings__product_detail_name">Symbol:</span>
												<span class="subscription_settings__product_detail_value"><iaixsl:value-of select="@symbol"/></span>
											</div>
										</iaixsl:if>
										<iaixsl:if test="size/@name != '' and size/@id != 'uniw'">
											<div class="subscription_settings__product_detail --size">
												<span class="subscription_settings__product_detail_name">Rozmiar:</span>
												<span class="subscription_settings__product_detail_value"><iaixsl:value-of select="size/@name"/></span>
											</div>
										</iaixsl:if>
									</div>
								</div>
								<div class="subscription_settings__product_price">
									<strong>
										<iaixsl:choose>
											<iaixsl:when test="/shop/page/@price_type = 'net'">
												<iaixsl:value-of select="prices/@price_net_formatted"/>
											</iaixsl:when>
											<iaixsl:otherwise>
												<iaixsl:value-of select="prices/@price_formatted"/>
											</iaixsl:otherwise>
										</iaixsl:choose>
									</strong>
									<span> / co <span class="subscription_settings__product_price_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/> dni</span></span>
			...
			<div class="subscription_settings__summary">
				<iaixsl:if test="$status = 'nonpayment'">
					<div class="subscription_settings__message menu_messages_error">
						<p>Wystąpił problem z płatnością. <a><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/contact"/></iaixsl:attribute>Skontaktuj się z obsługą sklepu</a>.</p>
					</div>
				</iaixsl:if>
				<div class="subscription_settings__price">
					<strong>
						<iaixsl:choose>
							<iaixsl:when test="/shop/page/@price_type = 'net'">
								<iaixsl:value-of select="/shop/page/subscription/prices/@price_net_formatted"/>
							</iaixsl:when>
							<iaixsl:otherwise>
								<iaixsl:value-of select="/shop/page/subscription/prices/@price_formatted"/>
							</iaixsl:otherwise>
						</iaixsl:choose>
					</strong>
					<span> / co <span class="subscription_settings__price_period"><iaixsl:attribute name="data-change-literal-days"><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/></iaixsl:attribute><iaixsl:value-of select="/shop/page/subscription/@days_in_period"/> dni</span></span>
				</div>
				<iaixsl:if test="$status != 'finished'">
					<div class="subscription_settings__price_info">
						<iaixsl:variable name="subscriptionTotalValue"><iaixsl:choose><iaixsl:when test="/shop/page/@price_type = 'net'"><iaixsl:value-of select="/shop/page/subscription/prices/@price_net_formatted"/></iaixsl:when><iaixsl:otherwise><iaixsl:value-of select="/shop/page/subscription/prices/@price_formatted"/></iaixsl:otherwise></iaixsl:choose></iaixsl:variable>
						<iaixsl:variable name="subscriptionTotalText">Będziemy obciążać twoją kartę płatniczą opłatą za subskrypcję w wysokości: %s zgodnie z wybranym cyklem wysyłki aż do zakończenia subskrypcji.</iaixsl:variable>
						<iaixsl:value-of select="php:function('sprintf', $subscriptionTotalText, $subscriptionTotalValue)"/>
					</div>
				</iaixsl:if>
				<iaixsl:if test="$status != 'finished'">
					<div class="subscription_settings__payment_date">
						<span class="subscription_settings__payment_date_name">Data kolejnej płatności</span>
						<strong class="subscription_settings__payment_date_value">
							<span class="subscription_settings__day_name">
								<iaixsl:choose>
									<iaixsl:when test="/shop/page/subscription/dates/@next_payment_week_day = 1">
										Poniedziałek
									</iaixsl:when>
									<iaixsl:when test="/shop/page/subscription/dates/@next_payment_week_day = 2">
										Wtorek
									</iaixsl:when>
									<iaixsl:when test="/shop/page/subscription/dates/@next_payment_week_day = 3">
										Środa
									</iaixsl:when>
									<iaixsl:when test="/shop/page/subscription/dates/@next_payment_week_day = 4">
										Czwartek
									</iaixsl:when>
									<iaixsl:when test="/shop/page/subscription/dates/@next_payment_week_day = 5">
										Piątek
									</iaixsl:when>
									<iaixsl:when test="/shop/page/subscription/dates/@next_payment_week_day = 6">
										Sobota
									</iaixsl:when>
									<iaixsl:when test="/shop/page/subscription/dates/@next_payment_week_day = 7">
										Niedziela
									</iaixsl:when>
								</iaixsl:choose>
							</span>
							<iaixsl:variable name="next_payment_time"><iaixsl:value-of select="/shop/page/subscription/dates/@date_next_payment"/></iaixsl:variable>
							<iaixsl:variable name="next_payment_time_month_day"><iaixsl:value-of select="substring($next_payment_time, 6, 5)"/></iaixsl:variable>
							<iaixsl:variable name="next_payment_time_formatted"><iaixsl:value-of select="substring-after($next_payment_time_month_day, '-')"/>.<iaixsl:value-of select="substring-before($next_payment_time_month_day, '-')"/></iaixsl:variable>
							<span class="subscription_settings__day_month"> (<span><iaixsl:value-of select="$next_payment_time_formatted"/></span>)</span>
						</strong>
					</div>
				</iaixsl:if>
				<div class="subscription_settings__buttons">
					<form class="subscription_settings__form" method="post">
						<iaixsl:attribute name="action"><iaixsl:value-of select="/shop/page/subscription/@save_url"/></iaixsl:attribute>
						
						<input type="hidden" name="date_next_order" id="subscription_date_next_order_input">
							<iaixsl:attribute name="value"><iaixsl:value-of select="/shop/page/subscription/dates/@date_next_order"/></iaixsl:attribute>
						</input>
						<input type="hidden" name="change_next_next_order" id="subscription_change_next_next_order_input" value="false"/>
						<button class="subscription_settings__submit btn --solid --large" type="submit" data-ignore-status="true">
							<iaixsl:choose>
								<iaixsl:when test="$status = 'finished'">
									<iaixsl:attribute name="class">subscription_settings__submit btn --solid --large --icon-left</iaixsl:attribute>
					...
					<a class="subscription_settings__list">
						<iaixsl:choose>
							<iaixsl:when test="$status = 'finished'">
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/subscriptions_terminated/@url"/></iaixsl:attribute>Wróć do listy zakończonych subskrypcji
							</iaixsl:when>
							<iaixsl:otherwise>
								<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/subscriptions_active/@url"/></iaixsl:attribute>Wróć do listy aktywnych subskrypcji
							</iaixsl:otherwise>
						</iaixsl:choose>
					</a>
					<iaixsl:if test="$status != 'finished'">
						<a href="#cancelSubscription" class="subscription_settings__cancel">
							Zakończ subskrypcję
						</a>
					</iaixsl:if>
				</div>
		...
		<iaixsl:if test="$status != 'finished'">
			<div class="subscription_cancel">
				<h4 class="subscription_cancel__label">Czy na pewno chcesz zakończyć subskrypcję i odpiąć kartę?</h4>
				<div class="subscription_cancel__description">Po zakończeniu nie będziesz mógł jej wznowić. Będzie to wymagało złożenia nowego zamówienia.</div>
				<div class="subscription_cancel__order">
					<iaixsl:if test="/shop/page/subscription/@next_order_in_progress = 'true'">
						<iaixsl:attribute name="class">subscription_cancel__order --in-progress</iaixsl:attribute>
					</iaixsl:if>
					<span class="subscription_cancel__order_text --first">Kolejna dostawa dla</span>
					<span class="subscription_cancel__date_value">
						<span class="subscription_cancel__day_name">
							<iaixsl:choose>
								<iaixsl:when test="/shop/page/subscription/dates/@next_order_week_day = 1">
									Poniedziałek
								</iaixsl:when>
						...
						<iaixsl:variable name="next_order_time_month_day"><iaixsl:value-of select="substring($next_order_time, 6, 5)"/></iaixsl:variable>
						<iaixsl:variable name="next_order_time_formatted"><iaixsl:value-of select="substring-after($next_order_time_month_day, '-')"/>.<iaixsl:value-of select="substring-before($next_order_time_month_day, '-')"/></iaixsl:variable>
						<span class="subscription_cancel__day_month"> (<span><iaixsl:value-of select="$next_order_time_formatted"/></span>)</span>
					</span>
					<span class="subscription_cancel__order_text --last">
						<iaixsl:choose>
							<iaixsl:when test="/shop/page/subscription/@next_order_in_progress = 'true'">
								zostanie jeszcze wysłana.
							</iaixsl:when>
							<iaixsl:otherwise>
				...
				<div class="subscription_cancel__buttons">
					<a href="#abortCancellation" class="subscription_cancel__abort btn --solid --medium">Przerwij operację</a>
					<a class="subscription_cancel__terminate" data-ignore-status="true"><iaixsl:attribute name="href"><iaixsl:value-of select="/shop/page/subscription/@termination_url"/></iaixsl:attribute>Tak, chcę zakończyć subskrypcję i odpiąć kartę</a>
				</div>
			</div>
			<template id="subscription_address_form">
				<form class="subscription_address f-group" action="/ajax/client-new.php?addDeliveryAddress=true" method="post">
					<iaixsl:attribute name="data-edit">/ajax/client-new.php?editDeliveryAddress=true</iaixsl:attribute>
					<input type="hidden" name="delivery_region">
						<iaixsl:attribute name="value"><iaixsl:value-of select="/shop/page/subscription/addresses/address[@selected = 'yes']/@region_id"/></iaixsl:attribute>
					</input>
					<h5 class="subscription_address__label">Adres dostawy</h5>
					<div class="subscription_address__inputs">
						
						<div class="subscription_address__item --firstname f-feedback">
							<input id="delivery_firstname" type="text" class="f-control --validate" name="delivery_firstname" required="required" data-graphql="firstname"/>
							<label for="delivery_firstname" class="f-label">Imię</label>
							<span class="f-control-feedback"/>
							<div class="f-message"/>
						</div>
						
						<div class="subscription_address__item --lastname f-feedback">
							<input id="delivery_lastname" type="text" class="f-control --validate" name="delivery_lastname" required="required" data-graphql="lastname"/>
							<label for="delivery_lastname" class="f-label">Nazwisko</label>
							<span class="f-control-feedback"/>
							<div class="f-message"/>
						</div>
						
						<div class="subscription_address__item --additional f-feedback">
							<input id="delivery_additional" type="text" class="f-control --validate" name="delivery_additional" data-graphql="additional" placeholder=" "/>
							<label for="delivery_additional" class="f-label">Nazwa firmy</label>
							<span class="f-control-feedback"/>
							<div class="f-message"/>
						</div>
						
						<div class="subscription_address__item --street f-feedback">
							<input id="delivery_street" type="text" class="f-control --validate" name="delivery_street" required="required" data-graphql="street" data-concat-from="#delivery_street_number">
								<iaixsl:attribute name="data-region"><iaixsl:value-of select="/shop/page/subscription/addresses/address[@selected = 'yes']/@region_id"/></iaixsl:attribute>
							</input>
						...
						<div class="subscription_address__item --street-number f-feedback">
							<input id="delivery_street_number" type="text" class="f-control --validate" name="delivery_street_number" data-concat-to="#delivery_street" placeholder=" "/>
							<label for="delivery_street_number" class="f-label">Nr domu / lokalu</label>
							<span class="f-control-feedback"/>
							<div class="f-message"/>
						</div>
						
						<div class="subscription_address__item --zipcode f-feedback">
							<input id="delivery_zipcode" type="text" class="f-control --validate" name="delivery_zipcode" required="required" data-graphql="zipcode">
								<iaixsl:attribute name="data-region"><iaixsl:value-of select="/shop/page/subscription/addresses/address[@selected = 'yes']/@region_id"/></iaixsl:attribute>
							</input>
						...
						<div class="subscription_address__item --city f-feedback">
							<input id="delivery_city" type="text" class="f-control --validate" name="delivery_city" required="required" data-graphql="city"/>
							<label for="delivery_city" class="f-label">Miejscowość</label>
							<span class="f-control-feedback"/>
							<div class="f-message"/>
						</div>
						
						<div class="subscription_address__item --phone f-feedback">
							<input id="delivery_phone" type="text" class="f-control --validate" name="delivery_phone" required="required" data-graphql="phone">
								<iaixsl:attribute name="data-region"><iaixsl:value-of select="/shop/page/subscription/addresses/address[@selected = 'yes']/@region_id"/></iaixsl:attribute>
							</input>
					...
					<div class="subscription_address__submit">
						<button type="submit" class="subscription_address__button btn --solid --medium">
							<iaixsl:attribute name="data-edit">Edytuj adres dostawy</iaixsl:attribute>
							Dodaj adres dostawy
						</button>
					</div>
				</form>
			</template>
			<template id="subscription_address_wrapper">
				<div class="subscription_settings__address">
					<div class="subscription_settings__address_wrapper">
						
						<span class="subscription_settings__address_item --additional"/>
						
						<span class="subscription_settings__address_item --name"/>
						
						<span class="subscription_settings__address_item --street"/>
						
						<span class="subscription_settings__address_item --city"/>
						
						<span class="subscription_settings__address_item --phone">
							<span class="subscription_settings__address_phone_txt">telefon: </span><span class="subscription_settings__address_phone_value"><iaixsl:value-of select="@phone"/></span>
						</span>
					</div>
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/pol/envelope.js.gzip?r=1696937760"></script><script src="/gfx/pol/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/pol/menu_filter.js.gzip?r=1696937760"></script><script src="/gfx/pol/subscription_settings.js.gzip?r=1696937760"></script>
