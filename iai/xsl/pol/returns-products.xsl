...
<iaixsl:attribute name="href"><iaixsl:value-of select="/shop/action/addReturn/@url"/></iaixsl:attribute>
					...
					<div class="progress__item --rma --second --active d-md-none py-3">
						...
						<div class="progress__text">
							<strong class="progress__name">Wybierz produkty do zwrotu</strong>
						</div>
					</div>

					<h1 class="big_label return_label d-none d-md-block">Wybierz produkty do zwrotu</h1>
							...
							<div id="basketedit_productslist" class="basketedit_productslist return_productslist">
								...
								<table>
									...
									<tr class="basketedit_productslist_label">
										...
										<th>
											Cena jedn.<span class="price_vat"> brutto</span>
										</th>
										<th>
											Ilość 
										</th>
