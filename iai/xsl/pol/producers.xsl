...
<!-- (menu_additional1, 614c5d2d239131.78356405.2)-->
        ...
        <!-- (producers, 610bfde1ef1470.69954167.3)-->
      <div id="producers-list" class="producers">
        <h1 class="big_label">
            Marki
        </h1>
            <div id="producers-list_sub" class="producers__list">
                <iaixsl:if test="@icon">
                        <iaixsl:attribute name="class">producers__list --icon</iaixsl:attribute>
                </iaixsl:if>
		        <iaixsl:for-each select="page/producers-list/firm">
                    <div class="producers__item">
                        <iaixsl:if test="@icon">
                            <a class="producers__icon">
                                <iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
                                <iaixsl:attribute name="title"><iaixsl:value-of select="@name"/></iaixsl:attribute>
