	...
	<section class="shopping_list mb-5">
		...
		<div class="shopping_list__block --header sl_header d-flex align-items-center justify-content-between mb-2 justify-content-md-start mb-3">
			...
			<span class="sl_header__total d-none d-md-block mr-md-2">
				<span class="sl_header__total_before">(ilość produktów: </span>
			...
			<div class="sl_header__options ml-md-auto">
				...
				<a href="#share" class="sl_header__share d-none d-md-flex align-items-md-center">Udostępnij tę listę</a>
			</div>
		</div>
		<div class="shopping_list__block --settings sl_settings d-flex mx-n1 mx-md-n2">
			<div class="sl_settings__item --group px-1 px-md-2">
				<a href="#groupEdit" class="sl_settings__group d-block">
					<span class="sl_settings__group_button --mobile d-flex align-items-center btn --outline --large --icon-left mb-2 mb-sm-3 d-md-none">Edycja grupowa</span>
					<span class="sl_settings__group_button --desktop btn --outline --icon-left mb-2 d-none mb-sm-3 d-md-inline-block">Edycja grupowa</span>
				</a>
			</div>
			<iaixsl:if test="/shop/page/navigation/@sort">
				<form class="sl_settings__item --sort px-0 col-sm-4 px-sm-1 col-md-auto px-md-2" action="/settings.php">
					<span class="sl_settings__label --sort">Sortuj</span>
					<select class="sl_settings__select --sort --small-md" name="sort_order">
						<option value="name-a">Sortuj po nazwie rosnąco</option>
						<option value="name-d">Sortuj po nazwie malejąco</option>
						<option value="price-a">Sortuj po cenie rosnąco</option>
						<option value="price-d">Sortuj po cenie malejąco</option>
						<option value="date-a">Sortuj po dacie rosnąco</option>
						<option value="date-d">Sortuj po dacie malejąco</option>
					</select>
				</form>
			</iaixsl:if>
			<iaixsl:if test="/shop/page/navigation/category">
				<form class="sl_settings__item --category px-0 col-sm-4 px-sm-1 col-md-auto px-md-2" action="/settings.php">
					<span class="sl_settings__label --category">Kategoria</span>
			...
			<div class="sl_settings__item --view d-flex ml-auto align-items-center mb-2 mb-sm-3 px-1 px-md-2">
				<span class="sl_settings__label --view">Widok</span>
						...
						<iaixsl:if test="/shop/page/@is_owner = 'true'">
							<div class="sl_products__remove --top">
								<a href="#remove" class="sl_products__link --remove">
									<iaixsl:attribute name="title">Kliknij, aby usunąć produkt z tej listy</iaixsl:attribute>
								</a>
							</div>
						</iaixsl:if>
                    ...
                    <iaixsl:attribute name="alt"><iaixsl:value-of disable-output-escaping="yes" select="name"/></iaixsl:attribute>
							...
							<iaixsl:if test="sizes/size[1]/availability/@status = 'disable' or (not($var_net_prices = '') and price/@price_net = 0) or ($var_net_prices = '' and price/@value = 0)">
								<strong class="label_icons">
									<span class="label --disable">Chwilowo niedostępny</span>
								</strong>
							</iaixsl:if>
						</a>
					</div>
							...
							<iaixsl:when test="$var_net_prices and not($var_net_prices = '')">
								<iaixsl:choose>
									<iaixsl:when test="price/@price_net = 0">
										<a class="sl_products__price --phone" href="/contact.php">Cena na telefon</a>
									</iaixsl:when>
									<iaixsl:otherwise>
						...
						<iaixsl:if test="/shop/page/@is_owner = 'true'">
							<div class="sl_products__move">
								<a href="#move" class="sl_products__link --move btn --outline p-1 d-flex align-items-center justify-content-center">
									<iaixsl:attribute name="title">Kliknij, aby przenieść/skopiować produkt do innej listy</iaixsl:attribute>
								</a>
								<div class="sl_products__move_options p-4 px-sm-0 p-md-3">
									...
									<a href="#move" class="sl_products__option --move d-flex align-items-center mb-2">Przenieś do innej listy</a>
									<a href="#copy" class="sl_products__option --copy d-flex align-items-center">Kopiuj do innej listy</a>
								</div>
							</div>
						</iaixsl:if>
						<iaixsl:choose>
							<iaixsl:when test="@product_type = 'product_bundle' or @product_type = 'product_configurable'">
								<a href="#card" class="sl_products__card btn --solid --secondary">
									<iaixsl:attribute name="href"><iaixsl:value-of select="@link"/></iaixsl:attribute>
									<iaixsl:attribute name="title">Kliknij, aby przejść do karty produktu</iaixsl:attribute>
									Przejdź do produktu
								</a>
							</iaixsl:when>
							<iaixsl:otherwise>
								<div class="sl_products__buy_wrapper">
									...
									<a href="#buy" class="sl_products__buy btn --solid">
										<iaixsl:attribute name="title">Kliknij, aby dodać do koszyka</iaixsl:attribute>
										Do koszyka
									</a>
								</div>
							</iaixsl:otherwise>
		...
		<div class="shopping_list__block --footer sl_footer">
			<div class="sl_footer__wrapper row flex-nowrap mx-sm-0 py-md-3">
				<div class="sl_footer__item --select f-group --checkbox col-3 align-self-center pl-sm-0 col-md-auto ">
					...
					<label for="checkboxSelectAll" class="sl_footer__label f-label p-0 d-flex flex-column align-items-center justify-content-center d-md-block">Wybierz wszystkie</label>
				</div>
				<iaixsl:if test="/shop/page/@is_owner = 'true'">
					<div class="sl_footer__item --move col-3 col-md-auto">
						<a href="#move" class="sl_footer__link --move d-flex flex-column align-items-center justify-content-center flex-md-row">
							<iaixsl:attribute name="title">Kliknij, aby przenieść/skopiować wybrane produkty do innej listy</iaixsl:attribute>
							Przenieś / kopiuj<span> do innej listy</span>
						</a>
						<div class="sl_footer__move_options p-4 px-sm-0 py-md-3">
							...
							<a href="#move" class="sl_footer__option --move d-flex align-items-center mb-2 px-md-3 mb-md-0 px-lg-4">Przenieś do innej listy</a>
							<a href="#copy" class="sl_footer__option --copy d-flex align-items-center px-md-3 px-lg-4">Kopiuj do innej listy</a>
						</div>
					</div>
					<div class="sl_footer__item --remove col-3 col-md-auto">
						<a href="#remove" class="sl_footer__link --remove d-flex flex-column align-items-center justify-content-center flex-md-row">
							<iaixsl:attribute name="title">Kliknij, aby usunąć wybrane produkty z tej listy</iaixsl:attribute>
							Usuń z tej listy
						</a>
					</div>
				</iaixsl:if>
				<div class="sl_footer__item --buy col-3 col-md-auto">
					<a href="#buy" class="sl_footer__link --buy btn --solid d-flex flex-column align-items-center justify-content-center flex-md-row">
						<iaixsl:attribute name="title">Kliknij, aby dodać wybrane produkty do koszyka</iaixsl:attribute>
						Dodaj do koszyka
					</a>
				</div>
			</div>
				...
				<div class="sl_m_manage__wrapper sl_dialog__wrapper">
					<div class="sl_m_manage__item --current">
						...
						<div class="sl_m_manage__options">
							<div class="sl_m_manage__option --share py-4">
								<a href="#share" class="sl_m_manage__link --share align-items-center">Udostępnij tę listę</a>
								<iaixsl:if test="/shop/page/@is_owner = 'true'">
									<iaixsl:choose>
										<iaixsl:when test="/shop/page/list/@shared = 'true'">
											<a href="#stop" class="sl_m_manage__link --stop align-items-center mt-2">Wyłącz udostępnianie tej listy</a>
										</iaixsl:when>
										<iaixsl:otherwise>
											<a href="#start" class="sl_m_manage__link --start align-items-center mt-2">Włącz udostępnianie tej listy</a>
										</iaixsl:otherwise>
									</iaixsl:choose>
								</iaixsl:if>
							</div>
							<iaixsl:if test="/shop/page/@is_owner = 'true'">
								<div class="sl_m_manage__option --change-name py-4">
									<a href="#change-name" class="sl_m_manage__link --change-name align-items-center">Zmień nazwę listy</a>
									<form class="sl_change_name align-items-center">
										...
										<button type="submit" class="sl_change_name__button btn --solid ml-2 ml-md-3">Zmień nazwę</button>
									</form>
								</div>
								<div class="sl_m_manage__option --remove py-4">
									<a href="#remove" class="sl_m_manage__link --remove align-items-center">Usuń tę listę</a>
									<div class="sl_remove align-items-center justify-content-center">
										<div class="sl_remove__label mr-2">
											<span class="sl_remove__txt_before">Usunąć listę &apos;</span>
										...
										<div class="sl_remove__sure d-flex">
											<a href="#yes" class="sl_remove__link --yes btn --outline mr-2">Tak</a>
											<a href="#no" class="sl_remove__link --no btn --outline --secondary">Nie</a>
										</div>
									</div>
								</div>
							</iaixsl:if>
					...
					<div class="sl_m_manage__item --other mx-n4 mb-n4 p-4">
						<div class="sl_m_manage__top --other mb-1">
							<strong class="sl_m_manage__label --other">Inne listy zakupowe</strong>
						</div>
			...
			<div class="sl_manage__sub --desktop sl_d_manage sl_dialog d-none d-md-flex">
				<div class="sl_d_manage__wrapper sl_dialog__wrapper">
					...
					<div class="sl_d_manage__top mb-3">
						<strong class="sl_d_manage__label">Listy zakupowe</strong>
					</div>
		...
		<div class="shopping_list__block --share sl_share sl_dialog">
			<div class="sl_share__wrapper sl_dialog__wrapper">
				<div class="sl_share__top mb-3 mb-md-4">
					<strong class="sl_share__label sl_dialog_close">Udostępnij listę</strong>
					<iaixsl:if test="/shop/page/@is_owner = 'true'">
						<p class="sl_share__description d-block">Każda osoba posiadająca link do listy może ją wyświetlić, ale nie może jej edytować.</p>
					</iaixsl:if>
				</div>
				<div class="sl_share__options">
					<div class="sl_share__option --copy py-4 d-md-flex justify-content-md-between">
						<a href="#copy" class="sl_share__link --copy d-flex align-items-center">Skopiuj link do tej listy zakupowej</a>
						<div class="sl_share__copy d-flex align-items-center mt-2 ml-md-2 mt-md-0">
							<span class="sl_share__copy_txt ml-2 align-items-center ml-md-0 mr-md-2">Skopiowano</span>
					...
					<div class="sl_share__option --mail py-4 d-md-flex justify-content-md-between">
						<a class="sl_share__link --mail d-flex align-items-center">
							<iaixsl:attribute name="href">mailto:?subject=Sprawdź moją listę zakupową - <iaixsl:value-of disable-output-escaping="yes" select="/shop/page/list/@name"/>&amp;body=Link: <iaixsl:value-of select="/shop/page/list/share/@link"/></iaixsl:attribute>
							Wyślij link do tej listy zakupowej e-mailem
						</a>
					</div>
				</div>
				<iaixsl:if test="/shop/page/@is_owner = 'true'">
					<div class="sl_share__stop">
						<iaixsl:choose>
							<iaixsl:when test="/shop/page/list/@shared = 'true'">
								<a href="#stop" class="sl_share__link --stop d-flex align-items-center">Wyłącz udostępnianie tej listy</a>
							</iaixsl:when>
							<iaixsl:otherwise>
								<a href="#start" class="sl_share__link --start d-flex align-items-center">Włącz udostępnianie tej listy</a>
							</iaixsl:otherwise>
						</iaixsl:choose>
					</div>
				</iaixsl:if>
			...
			<div class="shopping_list__block --move sl_move sl_dialog">
				<div class="sl_move__wrapper sl_dialog__wrapper">
					<div class="sl_move__item --top sl_dialog_close mb-2">
						<strong class="sl_move__label --move">Przenieś do innej listy</strong>
						<strong class="sl_move__label --copy">Kopiuj do innej listy</strong>
					</div>
					<div class="sl_move__item --lists" data-empty="false">
						...
						<div class="sl_move__list f-group --radio m-0 d-md-flex align-items-md-center justify-content-md-between" data-list_skeleton="true" data-list_id="true" data-shared="true">
							...
							<button class="sl_move__button --desktop btn --solid ml-md-2">
								<span class="sl_move__button_txt --move">Przenieś</span>
								<span class="sl_move__button_txt --copy">Kopiuj</span>
							</button>
						</div>
						<iaixsl:for-each select="/shop/shopping_lists/list[not(@id = /shop/page/list/@id)]">
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/pol/envelope.js.gzip?r=1696937760"></script><script src="/gfx/pol/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/pol/menu_shoppinglist.js.gzip?r=1696937760"></script><script src="/gfx/pol/shoppinglist_manage.js.gzip?r=1696937760"></script>
