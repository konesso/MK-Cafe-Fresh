    ...
    <!-- (client_rebates_info, 60dd8f7a276ef4.64348930.7)-->
			<div id="client_rebates_info" class="rebates_info">
				...
				<iaixsl:if test="not(page/rebate_code/@active = 'y') and not(page/rebates_for_points/rebate) and not(page/basket_rebate or page/global_rebate or page/rebates/range_rebate/range or (page/rebates/@type = 'z' and (page/rebates/category or page/rebates/producer or page/rebates/series or page/rebates/product)) or not(page/rebates/other/@value = '0.00'))">
					<div class="rebates_message menu_messages_message mb-4">
						...
						<a href="/terms.php">
							...
							Informacjeem i progami rabatowymi
						</a>
						 w naszym sklepie.
					</div>
				</iaixsl:if>
				...
				<iaixsl:if test="page/rebates_codes/@active = 'y' or page/rebate_code/@active = 'y' or page/@card_discount_program_activated = 'true'">
					...
					<iaixsl:variable name="cardform">
						<form class="rebates_form --card d-flex align-items-center" action="/settings.php?from=client_rebate" method="post">
							...
							<div class="f-group m-0">
								...
								<label class="f-label">Numer karty rabatowej</label>
							</div>
							<button class="rebates_form__submit btn --large --solid ml-3" type="submit">Aktywuj</button>
						</form>
					</iaixsl:variable>
					...
					<iaixsl:variable name="codeform">
						<form class="rebates_form --code d-flex" action="/settings.php?from=client_rebate" method="post">
							...
							<div class="f-group m-0">
								...
								<label class="f-label">Numer kodu rabatowego</label>
							</div>
							<button class="rebates_form__submit btn --large --solid ml-3" type="submit">Aktywuj</button>
						</form>
					</iaixsl:variable>
								...
								<div class="rebates_forms__sub --card col-sm-6 col-12 mb-3">
									...
									<iaixsl:if test="/shop/rebate_card_delete_client_advanced_rebate/@active = 'y' or /shop/rebate_card_delete_rebate_for_profit_points/@active = 'y' ">
										<div class="rebates_forms__info d-flex mt-1">
											Aktywacja karty rabatowej spowoduje, że rabat przypisany do Twojego konta będzie ignorowany w tym zamówieniu.
										</div>
									</iaixsl:if>
								</div>
							</iaixsl:if>
							...
							<iaixsl:if test="(page/rebates_codes/@active =  'y' or page/rebate_code/@active = 'y') and not(page/rebate_code/@type='rebate')">
								<div class="rebates_forms__sub --code col-sm-6 col-12 mb-3">
									...
									<iaixsl:if test="/shop/rebate_code_delete_client_advanced_rebate/@active = 'y' or /shop/rebate_code_delete_rebate_for_profit_points/@active = 'y' ">
										<div class="rebates_forms__info d-flex mt-1">
											Aktywacja kodu rabatowego spowoduje, że rabat przypisany do Twojego konta będzie ignorowany w tym zamówieniu.
										</div>
									</iaixsl:if>
								</div>
							</iaixsl:if>
						...
						<section class="rebates_active mb-4">
							...
							<h2 class="headline">
								<span class="headline__name">
									<iaixsl:choose>
										<iaixsl:when test="$rebate_type = 'rebate'">
											Wpisany kod rabatowy dla tego zamówienia 
										</iaixsl:when>
										<iaixsl:otherwise>
							...
							<div class="rebates_active__wrapper p-2 d-sm-flex align-items-sm-center p-sm-4">
								...
								<div class="rebates_active__sub --name">
									<iaixsl:choose>
										<iaixsl:when test="$rebate_type = 'rebate'">
											<span class="rebates_active__name">Aktywny kod:<strong><iaixsl:value-of disable-output-escaping="yes" select="page/rebate_code/@number"/></strong></span>
										</iaixsl:when>
										<iaixsl:otherwise>
											...
											<iaixsl:for-each select="page/rebate_code/inactive_zones/item">
                                                <iaixsl:choose>
                                                    <iaixsl:when test="@name = 'promotion'">
                                                        <strong class="label --promo">W promocji</strong>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@name = 'new'">
                                                        <strong class="label --new">Nowość</strong>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@name = 'bestseller'">
                                                        <strong class="label --bestseller">Nasz bestseller</strong>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@name = 'discount'">
                                                        <strong class="label --discount">Przecena</strong>
                                                    </iaixsl:when>
                                                    <iaixsl:when test="@name = 'distinguished'">
                                                        <strong class="label --distinguished">Polecany</strong>
                                                    </iaixsl:when>
                  ...
                  <iaixsl:choose>
                    <iaixsl:when test="$rebate_type = 'rebate'">
                          <a class="btn --solid rebates_active__button --change" href="#">Zmień kod</a>
                    </iaixsl:when>
                    <iaixsl:otherwise>
                        <a class="btn --solid rebates_active__button --change" href="#">Zmień kartę</a>
                    </iaixsl:otherwise>
                  </iaixsl:choose>
									...
									<div class="rebates_inactive__item p-2 d-sm-flex align-items-sm-center p-sm-4">
										...
										<div class="rebates_inactive__sub --buttons">
											<form class="rebates_inactive__sub --form" action="/settings.php?from=client_rebate" method="post">
												...
												<button class="btn --solid rebates_inactive__button --active" type="submit">Aktywuj</button>
											</form>
										</div>
									</div>
								</iaixsl:for-each>
								...
								<iaixsl:for-each select="page/cards/item">
									<div class="rebates_cards__item p-2 d-sm-flex align-items-sm-center p-sm-4">
										...
										<div class="rebates_cards__sub --name">
											<span class="rebates_cards__name"><strong><iaixsl:value-of disable-output-escaping="yes" select="@name"/></strong>Ważna do: <iaixsl:value-of select="@expires"/></span>
										</div>
										...
										<div class="rebates_cards__sub --status">
											<iaixsl:choose>
												<iaixsl:when test="@active = 'y'">
													<strong class="rebates_cards__active">aktywna</strong>
												</iaixsl:when>
												<iaixsl:when test="@active = 'n'">
													<strong class="rebates_cards__inactive">nieaktywna</strong>
												</iaixsl:when>
											</iaixsl:choose>
										</div>
									</div>
					...
					<section class="rebates_range mb-4">
						...
						<iaixsl:if test="page/rebates/range_rebate/range and not(/shop/page/basket_rebate/range)">
							<div class="rebates_range__wrapper --range">
								<div class="rebates_range__label">
									<strong class="rebates_range__label_txt">Rabat progowy</strong>
						...
						<iaixsl:if test="page/global_rebate">
							<div class="rebates_range__wrapper --global">
								<div class="rebates_range__label">
									<strong class="rebates_range__label_txt">Rabat kumulacyjny</strong>
									<div class="rebates_range__description">
										<iaixsl:choose>
											...
											<iaixsl:otherwise>
												Naliczany od wartości wcześniej kupionych produktów.
											</iaixsl:otherwise>
										</iaixsl:choose>
										<iaixsl:choose>
						...
						<iaixsl:if test="page/rebates/@type = 'z' and (page/rebates/category or page/rebates/producer or page/rebates/series)">
							<div class="rebates_range__wrapper --group">
								<div class="rebates_range__label">
									<strong class="rebates_range__label_txt">Rabat grupowy</strong>
									<div class="rebates_range__description">
						...
						<iaixsl:if test="page/rebates/@type = 'z' and page/rebates/product">
							<div class="rebates_range__wrapper --specific">
								<div class="rebates_range__label">
									<strong class="rebates_range__label_txt">Rabat szczegółowy</strong>
									<iaixsl:choose>
						...
						<iaixsl:if test="not(page/rebates/other/@value = '0.00')">
							<div class="rebates_range__wrapper --other">
								<div class="rebates_range__label">
									<strong class="rebates_range__label_txt">Rabat ogólny</strong>
									<div class="rebates_range__description">
										<iaixsl:choose>
												...
												<iaixsl:choose>
													...
													<iaixsl:when test="@selected = 'selected'">
														...
														<div class="rebates_product__points --selected">
															<strong class="rebates_product__point --rebate">TWÓJ RABAT:</strong>
