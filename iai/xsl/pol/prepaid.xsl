...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css"/>
			...
			<iaixsl:if test="not(/shop/page/@type = 'main') and not(/shop/page/@type = 'search') and not(/shop/page/@type = 'place-order') and not(/shop/page/@type = 'noproduct') and not($projector_script_bottom and /shop/page/@type = 'projector')">
				...
				<script src="/gfx/pol/orderdetails_payments.js.gzip?r=1696937760"></script>
			</iaixsl:if>
						...
						<div class="orderdetails_info__label">
							<strong class="orderdetails_info__label_text">
								<iaixsl:choose>
									...
									<iaixsl:when test="(page/prepaid/details/@wykonane = 'wd')">Oczekuje na termin wysłania</iaixsl:when>
								</iaixsl:choose>
							</strong>
  ...
  <template id="prepaid_terms_item_template">
	...
	<iaixsl:if test="/shop/page/prepaid/details/@checkout_type = 'idosell'">
		<template id="expchck_retry_modal">
			<h4 class="expchck__title">Zamówienie nr<iaixsl:text> </iaixsl:text><iaixsl:value-of select="page/prepaid/details/@orderid"/></h4>
            ...
            <iaixsl:if test="$prepaidrt_txt and /shop/page/prepaid/actions/return/@url">
                <div class="actions_return col-12 col-sm-6">
                    <div class="actions_return_sub col-12 mb-4">
                        ...
                        <div>
                            <img alt="returns" src="/gfx/standards/returns_action.png?r=1696937716"/><span>Jeżeli chcesz skorzystać z prawa do zwrotu zakupionych produktów bez podania przyczyny - skorzystaj z naszego systemu do zwrotów, który uczyni proces prostym i bezpiecznym.</span></div>
                            <a class="btn --solid">
            ...
            <iaixsl:if test="$prepaidzt_txt and /shop/page/prepaid/actions/rma/@url">
                <div class="actions_rma col-12 col-sm-6">
                    <div class="actions_rma_sub col-12">
                        ...
                        <div>
                            <img alt="rma" src="/gfx/standards/rma_action.png?r=1696937716"/><span>Jeżeli produkt w momencie dostawy był sprawny, ale popsuł się i chcesz zgłosić reklamację z tytułu gwarancji poprzez nasz sklep, skorzystaj z naszego systemu zgłaszania reklamacji, co uczyni proces łatwiejszym i szybszym.</span></div>
                            <a class="btn --solid">
...
<!-- (menu_dynamically_added_content, 60dd8e7a061521.50730639.3)-->
	...
	<script src="/gfx/pol/envelope.js.gzip?r=1696937760"></script><script src="/gfx/pol/menu_suggested_shop_for_language.js.gzip?r=1696937760"></script><script src="/gfx/pol/prepaid_order_products.js.gzip?r=1696937760"></script>
